(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function n(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(r){if(r.ep)return;r.ep=!0;const s=n(r);fetch(r.href,s)}})();var Cm={exports:{}},Bl={},Rm={exports:{}},$e={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(L,H){var K=L.length;L.push(H);e:for(;0<K;){var te=K-1>>>1,pe=L[te];if(0<r(pe,H))L[te]=H,L[K]=pe,K=te;else break e}}function n(L){return L.length===0?null:L[0]}function i(L){if(L.length===0)return null;var H=L[0],K=L.pop();if(K!==H){L[0]=K;e:for(var te=0,pe=L.length,Fe=pe>>>1;te<Fe;){var $=2*(te+1)-1,re=L[$],ve=$+1,me=L[ve];if(0>r(re,K))ve<pe&&0>r(me,re)?(L[te]=me,L[ve]=K,te=ve):(L[te]=re,L[$]=K,te=$);else if(ve<pe&&0>r(me,K))L[te]=me,L[ve]=K,te=ve;else break e}}return H}function r(L,H){var K=L.sortIndex-H.sortIndex;return K!==0?K:L.id-H.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],u=[],d=1,h=null,f=3,p=!1,x=!1,y=!1,m=typeof setTimeout=="function"?setTimeout:null,c=typeof clearTimeout=="function"?clearTimeout:null,g=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function _(L){for(var H=n(u);H!==null;){if(H.callback===null)i(u);else if(H.startTime<=L)i(u),H.sortIndex=H.expirationTime,e(l,H);else break;H=n(u)}}function v(L){if(y=!1,_(L),!x)if(n(l)!==null)x=!0,W(N);else{var H=n(u);H!==null&&j(v,H.startTime-L)}}function N(L,H){x=!1,y&&(y=!1,c(I),I=-1),p=!0;var K=f;try{for(_(H),h=n(l);h!==null&&(!(h.expirationTime>H)||L&&!P());){var te=h.callback;if(typeof te=="function"){h.callback=null,f=h.priorityLevel;var pe=te(h.expirationTime<=H);H=t.unstable_now(),typeof pe=="function"?h.callback=pe:h===n(l)&&i(l),_(H)}else i(l);h=n(l)}if(h!==null)var Fe=!0;else{var $=n(u);$!==null&&j(v,$.startTime-H),Fe=!1}return Fe}finally{h=null,f=K,p=!1}}var C=!1,w=null,I=-1,E=5,S=-1;function P(){return!(t.unstable_now()-S<E)}function A(){if(w!==null){var L=t.unstable_now();S=L;var H=!0;try{H=w(!0,L)}finally{H?F():(C=!1,w=null)}}else C=!1}var F;if(typeof g=="function")F=function(){g(A)};else if(typeof MessageChannel<"u"){var Y=new MessageChannel,V=Y.port2;Y.port1.onmessage=A,F=function(){V.postMessage(null)}}else F=function(){m(A,0)};function W(L){w=L,C||(C=!0,F())}function j(L,H){I=m(function(){L(t.unstable_now())},H)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(L){L.callback=null},t.unstable_continueExecution=function(){x||p||(x=!0,W(N))},t.unstable_forceFrameRate=function(L){0>L||125<L?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):E=0<L?Math.floor(1e3/L):5},t.unstable_getCurrentPriorityLevel=function(){return f},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(L){switch(f){case 1:case 2:case 3:var H=3;break;default:H=f}var K=f;f=H;try{return L()}finally{f=K}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(L,H){switch(L){case 1:case 2:case 3:case 4:case 5:break;default:L=3}var K=f;f=L;try{return H()}finally{f=K}},t.unstable_scheduleCallback=function(L,H,K){var te=t.unstable_now();switch(typeof K=="object"&&K!==null?(K=K.delay,K=typeof K=="number"&&0<K?te+K:te):K=te,L){case 1:var pe=-1;break;case 2:pe=250;break;case 5:pe=1073741823;break;case 4:pe=1e4;break;default:pe=5e3}return pe=K+pe,L={id:d++,callback:H,priorityLevel:L,startTime:K,expirationTime:pe,sortIndex:-1},K>te?(L.sortIndex=K,e(u,L),n(l)===null&&L===n(u)&&(y?(c(I),I=-1):y=!0,j(v,K-te))):(L.sortIndex=pe,e(l,L),x||p||(x=!0,W(N))),L},t.unstable_shouldYield=P,t.unstable_wrapCallback=function(L){var H=f;return function(){var K=f;f=H;try{return L.apply(this,arguments)}finally{f=K}}}})(Bm);zm.exports=Bm;var X_=zm.exports;/**
 * @license React
...
`)+`
`+c);const _=g+m+o,v=g+c+a,N=nm(r,r.VERTEX_SHADER,_),C=nm(r,r.FRAGMENT_SHADER,v);r.attachShader(y,N),r.attachShader(y,C),n.index0AttributeName!==void 0?r.bindAttribLocation(y,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(y,0,"position"),r.linkProgram(y);function w(P){if(t.debug.checkShaderErrors){const A=r.getProgramInfoLog(y).trim(),F=r.getShaderInfoLog(N).trim(),Y=r.getShaderInfoLog(C).trim();let V=!0,W=!0;if(r.getProgramParameter(y,r.LINK_STATUS)===!1)if(V=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,y,N,C);else{const j=im(r,N,"vertex"),L=im(r,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(y,r.VALIDATE_STATUS)+`
...
Program Info Log: `+A+`
`+j+`
`+L)}else A!==""?console.warn("THREE.WebGLProgram: Program Info Log:",A):(F===""||Y==="")&&(W=!1);W&&(P.diagnostics={runnable:V,programLog:A,vertexShader:{log:F,prefix:m},fragmentShader:{log:Y,prefix:c}})}r.deleteShader(N),r.deleteShader(C),I=new sl(r,y),E=fw(r,y)}let I;this.getUniforms=function(){return I===void 0&&w(this),I};let E;this.getAttributes=function(){return E===void 0&&w(this),E};let S=n.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return S===!1&&(S=r.getProgramParameter(y,nw)),S},this.destroy=function(){i.releaseStatesOfProgram(this),r.deleteProgram(y),this.program=void 0},this.type=n.shaderType,this.name=n.shaderName,this.id=iw++,this.cacheKey=e,this.usedTimes=1,this.program=y,this.vertexShader=N,this.fragmentShader=C,this}let Ew=0;class ww{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const n=e.vertexShader,i=e.fragmentShader,r=this._getShaderStage(n),s=this._getShaderStage(i),o=this._getShaderCacheForMaterial(e);return o.has(r)===!1&&(o.add(r),r.usedTimes++),o.has(s)===!1&&(o.add(s),s.usedTimes++),this}remove(e){const n=this.materialCache.get(e);for(const i of n)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const n=this.materialCache;let i=n.get(e);return i===void 0&&(i=new Set,n.set(e,i)),i}_getShaderStage(e){const n=this.shaderCache;let i=n.get(e);return i===void 0&&(i=new Tw(e),n.set(e,i)),i}}class Tw{constructor(e){this.id=Ew++,this.code=e,this.usedTimes=0}}function Aw(t,e,n,i,r,s,o){const a=new Zd,l=new ww,u=new Set,d=[],h=r.logarithmicDepthBuffer,f=r.vertexTextures;let p=r.precision;const x={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function y(E){return u.add(E),E===0?"uv":`uv${E}`}function m(E,S,P,A,F){const Y=A.fog,V=F.geometry,W=E.isMeshStandardMaterial?A.environment:null,j=(E.isMeshStandardMaterial?n:e).get(E.envMap||W),L=j&&j.mapping===iu?j.image.height:null,H=x[E.type];E.precision!==null&&(p=r.getMaxPrecision(E.precision),p!==E.precision&&console.warn("THREE.WebGLProgram.getParameters:",E.precision,"not supported, using",p,"instead."));const K=V.morphAttributes.position||V.morphAttributes.normal||V.morphAttributes.color,te=K!==void 0?K.length:0;let pe=0;V.morphAttributes.position!==void 0&&(pe=1),V.morphAttributes.normal!==void 0&&(pe=2),V.morphAttributes.color!==void 0&&(pe=3);let Fe,$,re,ve;if(H){const Ze=Yn[H];Fe=Ze.vertexShader,$=Ze.fragmentShader}else Fe=E.vertexShader,$=E.fragmentShader,l.update(E),re=l.getVertexShaderID(E),ve=l.getFragmentShaderID(E);const me=t.getRenderTarget(),Le=F.isInstancedMesh===!0,Ne=F.isBatchedMesh===!0,Be=!!E.map,he=!!E.matcap,U=!!j,He=!!E.aoMap,ce=!!E.lightMap,ge=!!E.bumpMap,ue=!!E.normalMap,De=!!E.displacementMap,be=!!E.emissiveMap,Me=!!E.metalnessMap,b=!!E.roughnessMap,M=E.anisotropy>0,X=E.clearcoat>0,ee=E.dispersion>0,oe=E.iridescence>0,ie=E.sheen>0,Pe=E.transmission>0,xe=M&&!!E.anisotropyMap,J=X&&!!E.clearcoatMap,D=X&&!!E.clearcoatNormalMap,R=X&&!!E.clearcoatRoughnessMap,Q=oe&&!!E.iridescenceMap,ae=oe&&!!E.iridescenceThicknessMap,Se=ie&&!!E.sheenColorMap,Te=ie&&!!E.sheenRoughnessMap,Ve=!!E.specularMap,Xe=!!E.specularColorMap,st=!!E.specularIntensityMap,O=Pe&&!!E.transmissionMap,fe=Pe&&!!E.thicknessMap,ne=!!E.gradientMap,se=!!E.alphaMap,_e=E.alphaTest>0,Oe=!!E.alphaHash,qe=!!E.extensions;let vt=Wi;E.toneMapped&&(me===null||me.isXRRenderTarget===!0)&&(vt=t.toneMapping);const Lt={shaderID:H,shaderType:E.type,shaderName:E.name,vertexShader:Fe,fragmentShader:$,defines:E.defines,customVertexShaderID:re,customFragmentShaderID:ve,isRawShaderMaterial:E.isRawShaderMaterial===!0,glslVersion:E.glslVersion,precision:p,batching:Ne,batchingColor:Ne&&F._colorsTexture!==null,instancing:Le,instancingColor:Le&&F.instanceColor!==null,instancingMorph:Le&&F.morphTexture!==null,supportsVertexTextures:f,outputColorSpace:me===null?t.outputColorSpace:me.isXRRenderTarget===!0?me.texture.colorSpace:Ji,alphaToCoverage:!!E.alphaToCoverage,map:Be,matcap:he,envMap:U,envMapMode:U&&j.mapping,envMapCubeUVHeight:L,aoMap:He,lightMap:ce,bumpMap:ge,normalMap:ue,displacementMap:f&&De,emissiveMap:be,normalMapObjectSpace:ue&&E.normalMapType===Ny,normalMapTangentSpace:ue&&E.normalMapType===$d,metalnessMap:Me,roughnessMap:b,anisotropy:M,anisotropyMap:xe,clearcoat:X,clearcoatMap:J,clearcoatNormalMap:D,clearcoatRoughnessMap:R,dispersion:ee,iridescence:oe,iridescenceMap:Q,iridescenceThicknessMap:ae,sheen:ie,sheenColorMap:Se,sheenRoughnessMap:Te,specularMap:Ve,specularColorMap:Xe,specularIntensityMap:st,transmission:Pe,transmissionMap:O,thicknessMap:fe,gradientMap:ne,opaque:E.transparent===!1&&E.blending===xs&&E.alphaToCoverage===!1,alphaMap:se,alphaTest:_e,alphaHash:Oe,combine:E.combine,mapUv:Be&&y(E.map.channel),aoMapUv:He&&y(E.aoMap.channel),lightMapUv:ce&&y(E.lightMap.channel),bumpMapUv:ge&&y(E.bumpMap.channel),normalMapUv:ue&&y(E.normalMap.channel),displacementMapUv:De&&y(E.displacementMap.channel),emissiveMapUv:be&&y(E.emissiveMap.channel),metalnessMapUv:Me&&y(E.metalnessMap.channel),roughnessMapUv:b&&y(E.roughnessMap.channel),anisotropyMapUv:xe&&y(E.anisotropyMap.channel),clearcoatMapUv:J&&y(E.clearcoatMap.channel),clearcoatNormalMapUv:D&&y(E.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:R&&y(E.clearcoatRoughnessMap.channel),iridescenceMapUv:Q&&y(E.iridescenceMap.channel),iridescenceThicknessMapUv:ae&&y(E.iridescenceThicknessMap.channel),sheenColorMapUv:Se&&y(E.sheenColorMap.channel),sheenRoughnessMapUv:Te&&y(E.sheenRoughnessMap.channel),specularMapUv:Ve&&y(E.specularMap.channel),specularColorMapUv:Xe&&y(E.specularColorMap.channel),specularIntensityMapUv:st&&y(E.specularIntensityMap.channel),transmissionMapUv:O&&y(E.transmissionMap.channel),thicknessMapUv:fe&&y(E.thicknessMap.channel),alphaMapUv:se&&y(E.alphaMap.channel),vertexTangents:!!V.attributes.tangent&&(ue||M),vertexColors:E.vertexColors,vertexAlphas:E.vertexColors===!0&&!!V.attributes.color&&V.attributes.color.itemSize===4,pointsUvs:F.isPoints===!0&&!!V.attributes.uv&&(Be||se),fog:!!Y,useFog:E.fog===!0,fogExp2:!!Y&&Y.isFogExp2,flatShading:E.flatShading===!0,sizeAttenuation:E.sizeAttenuation===!0,logarithmicDepthBuffer:h,skinning:F.isSkinnedMesh===!0,morphTargets:V.morphAttributes.position!==void 0,morphNormals:V.morphAttributes.normal!==void 0,morphColors:V.morphAttributes.color!==void 0,morphTargetsCount:te,morphTextureStride:pe,numDirLights:S.directional.length,numPointLights:S.point.length,numSpotLights:S.spot.length,numSpotLightMaps:S.spotLightMap.length,numRectAreaLights:S.rectArea.length,numHemiLights:S.hemi.length,numDirLightShadows:S.directionalShadowMap.length,numPointLightShadows:S.pointShadowMap.length,numSpotLightShadows:S.spotShadowMap.length,numSpotLightShadowsWithMaps:S.numSpotLightShadowsWithMaps,numLightProbes:S.numLightProbes,numClippingPlanes:o.numPlanes,numClipIntersection:o.numIntersection,dithering:E.dithering,shadowMapEnabled:t.shadowMap.enabled&&P.length>0,shadowMapType:t.shadowMap.type,toneMapping:vt,decodeVideoTexture:Be&&E.map.isVideoTexture===!0&&tt.getTransfer(E.map.colorSpace)===at,premultipliedAlpha:E.premultipliedAlpha,doubleSided:E.side===Nn,flipSided:E.side===nn,useDepthPacking:E.depthPacking>=0,depthPacking:E.depthPacking||0,index0AttributeName:E.index0AttributeName,extensionClipCullDistance:qe&&E.extensions.clipCullDistance===!0&&i.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(qe&&E.extensions.multiDraw===!0||Ne)&&i.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:i.has("KHR_parallel_shader_compile"),customProgramCacheKey:E.customProgramCacheKey()};return Lt.vertexUv1s=u.has(1),Lt.vertexUv2s=u.has(2),Lt.vertexUv3s=u.has(3),u.clear(),Lt}function c(E){const S=[];if(E.shaderID?S.push(E.shaderID):(S.push(E.customVertexShaderID),S.push(E.customFragmentShaderID)),E.defines!==void 0)for(const P in E.defines)S.push(P),S.push(E.defines[P]);return E.isRawShaderMaterial===!1&&(g(S,E),_(S,E),S.push(t.outputColorSpace)),S.push(E.customProgramCacheKey),S.join()}function g(E,S){E.push(S.precision),E.push(S.outputColorSpace),E.push(S.envMapMode),E.push(S.envMapCubeUVHeight),E.push(S.mapUv),E.push(S.alphaMapUv),E.push(S.lightMapUv),E.push(S.aoMapUv),E.push(S.bumpMapUv),E.push(S.normalMapUv),E.push(S.displacementMapUv),E.push(S.emissiveMapUv),E.push(S.metalnessMapUv),E.push(S.roughnessMapUv),E.push(S.anisotropyMapUv),E.push(S.clearcoatMapUv),E.push(S.clearcoatNormalMapUv),E.push(S.clearcoatRoughnessMapUv),E.push(S.iridescenceMapUv),E.push(S.iridescenceThicknessMapUv),E.push(S.sheenColorMapUv),E.push(S.sheenRoughnessMapUv),E.push(S.specularMapUv),E.push(S.specularColorMapUv),E.push(S.specularIntensityMapUv),E.push(S.transmissionMapUv),E.push(S.thicknessMapUv),E.push(S.combine),E.push(S.fogExp2),E.push(S.sizeAttenuation),E.push(S.morphTargetsCount),E.push(S.morphAttributeCount),E.push(S.numDirLights),E.push(S.numPointLights),E.push(S.numSpotLights),E.push(S.numSpotLightMaps),E.push(S.numHemiLights),E.push(S.numRectAreaLights),E.push(S.numDirLightShadows),E.push(S.numPointLightShadows),E.push(S.numSpotLightShadows),E.push(S.numSpotLightShadowsWithMaps),E.push(S.numLightProbes),E.push(S.shadowMapType),E.push(S.toneMapping),E.push(S.numClippingPlanes),E.push(S.numClipIntersection),E.push(S.depthPacking)}function _(E,S){a.disableAll(),S.supportsVertexTextures&&a.enable(0),S.instancing&&a.enable(1),S.instancingColor&&a.enable(2),S.instancingMorph&&a.enable(3),S.matcap&&a.enable(4),S.envMap&&a.enable(5),S.normalMapObjectSpace&&a.enable(6),S.normalMapTangentSpace&&a.enable(7),S.clearcoat&&a.enable(8),S.iridescence&&a.enable(9),S.alphaTest&&a.enable(10),S.vertexColors&&a.enable(11),S.vertexAlphas&&a.enable(12),S.vertexUv1s&&a.enable(13),S.vertexUv2s&&a.enable(14),S.vertexUv3s&&a.enable(15),S.vertexTangents&&a.enable(16),S.anisotropy&&a.enable(17),S.alphaHash&&a.enable(18),S.batching&&a.enable(19),S.dispersion&&a.enable(20),S.batchingColor&&a.enable(21),E.push(a.mask),a.disableAll(),S.fog&&a.enable(0),S.useFog&&a.enable(1),S.flatShading&&a.enable(2),S.logarithmicDepthBuffer&&a.enable(3),S.skinning&&a.enable(4),S.morphTargets&&a.enable(5),S.morphNormals&&a.enable(6),S.morphColors&&a.enable(7),S.premultipliedAlpha&&a.enable(8),S.shadowMapEnabled&&a.enable(9),S.doubleSided&&a.enable(10),S.flipSided&&a.enable(11),S.useDepthPacking&&a.enable(12),S.dithering&&a.enable(13),S.transmission&&a.enable(14),S.sheen&&a.enable(15),S.opaque&&a.enable(16),S.pointsUvs&&a.enable(17),S.decodeVideoTexture&&a.enable(18),S.alphaToCoverage&&a.enable(19),E.push(a.mask)}function v(E){const S=x[E.type];let P;if(S){const A=Yn[S];P=uS.clone(A.uniforms)}else P=E.uniforms;return P}function N(E,S){let P;for(let A=0,F=d.length;A<F;A++){const Y=d[A];if(Y.cacheKey===S){P=Y,++P.usedTimes;break}}return P===void 0&&(P=new Mw(t,S,E,s),d.push(P)),P}function C(E){if(--E.usedTimes===0){const S=d.indexOf(E);d[S]=d[d.length-1],d.pop(),E.destroy()}}function w(E){l.remove(E)}function I(){l.dispose()}return{getParameters:m,getProgramCacheKey:c,getUniforms:v,acquireProgram:N,releaseProgram:C,releaseShaderCache:w,programs:d,dispose:I}}function Cw(){let t=new WeakMap;function e(o){return t.has(o)}function n(o){let a=t.get(o);return a===void 0&&(a={},t.set(o,a)),a}function i(o){t.delete(o)}function r(o,a,l){t.get(o)[a]=l}function s(){t=new WeakMap}return{has:e,get:n,remove:i,update:r,dispose:s}}function Rw(t,e){return t.groupOrder!==e.groupOrder?t.groupOrder-e.groupOrder:t.renderOrder!==e.renderOrder?t.renderOrder-e.renderOrder:t.material.id!==e.material.id?t.material.id-e.material.id:t.z!==e.z?t.z-e.z:t.id-e.id}function lm(t,e){return t.groupOrder!==e.groupOrder?t.groupOrder-e.groupOrder:t.renderOrder!==e.renderOrder?t.renderOrder-e.renderOrder:t.z!==e.z?e.z-t.z:t.id-e.id}function um(){const t=[];let e=0;const n=[],i=[],r=[];function s(){e=0,n.length=0,i.length=0,r.length=0}function o(h,f,p,x,y,m){let c=t[e];return c===void 0?(c={id:h.id,object:h,geometry:f,material:p,groupOrder:x,renderOrder:h.renderOrder,z:y,group:m},t[e]=c):(c.id=h.id,c.object=h,c.geometry=f,c.material=p,c.groupOrder=x,c.renderOrder=h.renderOrder,c.z=y,c.group=m),e++,c}function a(h,f,p,x,y,m){const c=o(h,f,p,x,y,m);p.transmission>0?i.push(c):p.transparent===!0?r.push(c):n.push(c)}function l(h,f,p,x,y,m){const c=o(h,f,p,x,y,m);p.transmission>0?i.unshift(c):p.transparent===!0?r.unshift(c):n.unshift(c)}function u(h,f){n.length>1&&n.sort(h||Rw),i.length>1&&i.sort(f||lm),r.length>1&&r.sort(f||lm)}function d(){for(let h=e,f=t.length;h<f;h++){const p=t[h];if(p.id===null)break;p.id=null,p.object=null,p.geometry=null,p.material=null,p.group=null}}return{opaque:n,transmissive:i,transparent:r,init:s,push:a,unshift:l,finish:d,sort:u}}function bw(){let t=new WeakMap;function e(i,r){const s=t.get(i);let o;return s===void 0?(o=new um,t.set(i,[o])):r>=s.length?(o=new um,s.push(o)):o=s[r],o}function n(){t=new WeakMap}return{get:e,dispose:n}}function Pw(){const t={};return{get:function(e){if(t[e.id]!==void 0)return t[e.id];let n;switch(e.type){case"DirectionalLight":n={direction:new G,color:new Ge};break;case"SpotLight":n={position:new G,direction:new G,color:new Ge,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":n={position:new G,color:new Ge,distance:0,decay:0};break;case"HemisphereLight":n={direction:new G,skyColor:new Ge,groundColor:new Ge};break;case"RectAreaLight":n={color:new Ge,position:new G,halfWidth:new G,halfHeight:new G};break}return t[e.id]=n,n}}}function Lw(){const t={};return{get:function(e){if(t[e.id]!==void 0)return t[e.id];let n;switch(e.type){case"DirectionalLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new We};break;case"SpotLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new We};break;case"PointLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new We,shadowCameraNear:1,shadowCameraFar:1e3};break}return t[e.id]=n,n}}}let Dw=0;function Iw(t,e){return(e.castShadow?2:0)-(t.castShadow?2:0)+(e.map?1:0)-(t.map?1:0)}function Uw(t){const e=new Pw,n=Lw(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let u=0;u<9;u++)i.probe.push(new G);const r=new G,s=new ct,o=new ct;function a(u){let d=0,h=0,f=0;for(let E=0;E<9;E++)i.probe[E].set(0,0,0);let p=0,x=0,y=0,m=0,c=0,g=0,_=0,v=0,N=0,C=0,w=0;u.sort(Iw);for(let E=0,S=u.length;E<S;E++){const P=u[E],A=P.color,F=P.intensity,Y=P.distance,V=P.shadow&&P.shadow.map?P.shadow.map.texture:null;if(P.isAmbientLight)d+=A.r*F,h+=A.g*F,f+=A.b*F;else if(P.isLightProbe){for(let W=0;W<9;W++)i.probe[W].addScaledVector(P.sh.coefficients[W],F);w++}else if(P.isDirectionalLight){const W=e.get(P);if(W.color.copy(P.color).multiplyScalar(P.intensity),P.castShadow){const j=P.shadow,L=n.get(P);L.shadowIntensity=j.intensity,L.shadowBias=j.bias,L.shadowNormalBias=j.normalBias,L.shadowRadius=j.radius,L.shadowMapSize=j.mapSize,i.directionalShadow[p]=L,i.directionalShadowMap[p]=V,i.directionalShadowMatrix[p]=P.shadow.matrix,g++}i.directional[p]=W,p++}else if(P.isSpotLight){const W=e.get(P);W.position.setFromMatrixPosition(P.matrixWorld),W.color.copy(A).multiplyScalar(F),W.distance=Y,W.coneCos=Math.cos(P.angle),W.penumbraCos=Math.cos(P.angle*(1-P.penumbra)),W.decay=P.decay,i.spot[y]=W;const j=P.shadow;if(P.map&&(i.spotLightMap[N]=P.map,N++,j.updateMatrices(P),P.castShadow&&C++),i.spotLightMatrix[y]=j.matrix,P.castShadow){const L=n.get(P);L.shadowIntensity=j.intensity,L.shadowBias=j.bias,L.shadowNormalBias=j.normalBias,L.shadowRadius=j.radius,L.shadowMapSize=j.mapSize,i.spotShadow[y]=L,i.spotShadowMap[y]=V,v++}y++}else if(P.isRectAreaLight){const W=e.get(P);W.color.copy(A).multiplyScalar(F),W.halfWidth.set(P.width*.5,0,0),W.halfHeight.set(0,P.height*.5,0),i.rectArea[m]=W,m++}else if(P.isPointLight){const W=e.get(P);if(W.color.copy(P.color).multiplyScalar(P.intensity),W.distance=P.distance,W.decay=P.decay,P.castShadow){const j=P.shadow,L=n.get(P);L.shadowIntensity=j.intensity,L.shadowBias=j.bias,L.shadowNormalBias=j.normalBias,L.shadowRadius=j.radius,L.shadowMapSize=j.mapSize,L.shadowCameraNear=j.camera.near,L.shadowCameraFar=j.camera.far,i.pointShadow[x]=L,i.pointShadowMap[x]=V,i.pointShadowMatrix[x]=P.shadow.matrix,_++}i.point[x]=W,x++}else if(P.isHemisphereLight){const W=e.get(P);W.skyColor.copy(P.color).multiplyScalar(F),W.groundColor.copy(P.groundColor).multiplyScalar(F),i.hemi[c]=W,c++}}m>0&&(t.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=ye.LTC_FLOAT_1,i.rectAreaLTC2=ye.LTC_FLOAT_2):(i.rectAreaLTC1=ye.LTC_HALF_1,i.rectAreaLTC2=ye.LTC_HALF_2)),i.ambient[0]=d,i.ambient[1]=h,i.ambient[2]=f;const I=i.hash;(I.directionalLength!==p||I.pointLength!==x||I.spotLength!==y||I.rectAreaLength!==m||I.hemiLength!==c||I.numDirectionalShadows!==g||I.numPointShadows!==_||I.numSpotShadows!==v||I.numSpotMaps!==N||I.numLightProbes!==w)&&(i.directional.length=p,i.spot.length=y,i.rectArea.length=m,i.point.length=x,i.hemi.length=c,i.directionalShadow.length=g,i.directionalShadowMap.length=g,i.pointShadow.length=_,i.pointShadowMap.length=_,i.spotShadow.length=v,i.spotShadowMap.length=v,i.directionalShadowMatrix.length=g,i.pointShadowMatrix.length=_,i.spotLightMatrix.length=v+N-C,i.spotLightMap.length=N,i.numSpotLightShadowsWithMaps=C,i.numLightProbes=w,I.directionalLength=p,I.pointLength=x,I.spotLength=y,I.rectAreaLength=m,I.hemiLength=c,I.numDirectionalShadows=g,I.numPointShadows=_,I.numSpotShadows=v,I.numSpotMaps=N,I.numLightProbes=w,i.version=Dw++)}function l(u,d){let h=0,f=0,p=0,x=0,y=0;const m=d.matrixWorldInverse;for(let c=0,g=u.length;c<g;c++){const _=u[c];if(_.isDirectionalLight){const v=i.directional[h];v.direction.setFromMatrixPosition(_.matrixWorld),r.setFromMatrixPosition(_.target.matrixWorld),v.direction.sub(r),v.direction.transformDirection(m),h++}else if(_.isSpotLight){const v=i.spot[p];v.position.setFromMatrixPosition(_.matrixWorld),v.position.applyMatrix4(m),v.direction.setFromMatrixPosition(_.matrixWorld),r.setFromMatrixPosition(_.target.matrixWorld),v.direction.sub(r),v.direction.transformDirection(m),p++}else if(_.isRectAreaLight){const v=i.rectArea[x];v.position.setFromMatrixPosition(_.matrixWorld),v.position.applyMatrix4(m),o.identity(),s.copy(_.matrixWorld),s.premultiply(m),o.extractRotation(s),v.halfWidth.set(_.width*.5,0,0),v.halfHeight.set(0,_.height*.5,0),v.halfWidth.applyMatrix4(o),v.halfHeight.applyMatrix4(o),x++}else if(_.isPointLight){const v=i.point[f];v.position.setFromMatrixPosition(_.matrixWorld),v.position.applyMatrix4(m),f++}else if(_.isHemisphereLight){const v=i.hemi[y];v.direction.setFromMatrixPosition(_.matrixWorld),v.direction.transformDirection(m),y++}}}return{setup:a,setupView:l,state:i}}function cm(t){const e=new Uw(t),n=[],i=[];function r(d){u.camera=d,n.length=0,i.length=0}function s(d){n.push(d)}function o(d){i.push(d)}function a(){e.setup(n)}function l(d){e.setupView(n,d)}const u={lightsArray:n,shadowsArray:i,camera:null,lights:e,transmissionRenderTarget:{}};return{init:r,state:u,setupLights:a,setupLightsView:l,pushLight:s,pushShadow:o}}function Nw(t){let e=new WeakMap;function n(r,s=0){const o=e.get(r);let a;return o===void 0?(a=new cm(t),e.set(r,[a])):s>=o.length?(a=new cm(t),o.push(a)):a=o[s],a}function i(){e=new WeakMap}return{get:n,dispose:i}}class Fw extends er{constructor(e){super(),this.isMeshDepthMaterial=!0,this.type="MeshDepthMaterial",this.depthPacking=Iy,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.setValues(e)}copy(e){return super.copy(e),this.depthPacking=e.depthPacking,this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this}}class Ow extends er{constructor(e){super(),this.isMeshDistanceMaterial=!0,this.type="MeshDistanceMaterial",this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.setValues(e)}copy(e){return super.copy(e),this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this}}const kw=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function Bw(t,e,n){let i=new Qd;const r=new We,s=new We,o=new Et,a=new Fw({depthPacking:Uy}),l=new Ow,u={},d=n.maxTextureSize,h={[$i]:nn,[nn]:$i,[Nn]:Nn},f=new qi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new We},radius:{value:4}},vertexShader:kw,fragmentShader:zw}),p=f.clone();p.defines.HORIZONTAL_PASS=1;const x=new dn;x.setAttribute("position",new Bn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const y=new Zt(x,f),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=B0;let c=this.type;this.render=function(C,w,I){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||C.length===0)return;const E=t.getRenderTarget(),S=t.getActiveCubeFace(),P=t.getActiveMipmapLevel(),A=t.state;A.setBlending(Gi),A.buffers.color.setClear(1,1,1,1),A.buffers.depth.setTest(!0),A.setScissorTest(!1);const F=c!==ri&&this.type===ri,Y=c===ri&&this.type!==ri;for(let V=0,W=C.length;V<W;V++){const j=C[V],L=j.shadow;if(L===void 0){console.warn("THREE.WebGLShadowMap:",j,"has no shadow.");continue}if(L.autoUpdate===!1&&L.needsUpdate===!1)continue;r.copy(L.mapSize);const H=L.getFrameExtents();if(r.multiply(H),s.copy(L.mapSize),(r.x>d||r.y>d)&&(r.x>d&&(s.x=Math.floor(d/H.x),r.x=s.x*H.x,L.mapSize.x=s.x),r.y>d&&(s.y=Math.floor(d/H.y),r.y=s.y*H.y,L.mapSize.y=s.y)),L.map===null||F===!0||Y===!0){const te=this.type!==ri?{minFilter:Mn,magFilter:Mn}:{};L.map!==null&&L.map.dispose(),L.map=new Ar(r.x,r.y,te),L.map.texture.name=j.name+".shadowMap",L.camera.updateProjectionMatrix()}t.setRenderTarget(L.map),t.clear();const K=L.getViewportCount();for(let te=0;te<K;te++){const pe=L.getViewport(te);o.set(s.x*pe.x,s.y*pe.y,s.x*pe.z,s.y*pe.w),A.viewport(o),L.updateMatrices(j,te),i=L.getFrustum(),v(w,I,L.camera,j,this.type)}L.isPointLightShadow!==!0&&this.type===ri&&g(L,I),L.needsUpdate=!1}c=this.type,m.needsUpdate=!1,t.setRenderTarget(E,S,P)};function g(C,w){const I=e.update(y);f.defines.VSM_SAMPLES!==C.blurSamples&&(f.defines.VSM_SAMPLES=C.blurSamples,p.defines.VSM_SAMPLES=C.blurSamples,f.needsUpdate=!0,p.needsUpdate=!0),C.mapPass===null&&(C.mapPass=new Ar(r.x,r.y)),f.uniforms.shadow_pass.value=C.map.texture,f.uniforms.resolution.value=C.mapSize,f.uniforms.radius.value=C.radius,t.setRenderTarget(C.mapPass),t.clear(),t.renderBufferDirect(w,null,I,f,y,null),p.uniforms.shadow_pass.value=C.mapPass.texture,p.uniforms.resolution.value=C.mapSize,p.uniforms.radius.value=C.radius,t.setRenderTarget(C.map),t.clear(),t.renderBufferDirect(w,null,I,p,y,null)}function _(C,w,I,E){let S=null;const P=I.isPointLight===!0?C.customDistanceMaterial:C.customDepthMaterial;if(P!==void 0)S=P;else if(S=I.isPointLight===!0?l:a,t.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0){const A=S.uuid,F=w.uuid;let Y=u[A];Y===void 0&&(Y={},u[A]=Y);let V=Y[F];V===void 0&&(V=S.clone(),Y[F]=V,w.addEventListener("dispose",N)),S=V}if(S.visible=w.visible,S.wireframe=w.wireframe,E===ri?S.side=w.shadowSide!==null?w.shadowSide:w.side:S.side=w.shadowSide!==null?w.shadowSide:h[w.side],S.alphaMap=w.alphaMap,S.alphaTest=w.alphaTest,S.map=w.map,S.clipShadows=w.clipShadows,S.clippingPlanes=w.clippingPlanes,S.clipIntersection=w.clipIntersection,S.displacementMap=w.displacementMap,S.displacementScale=w.displacementScale,S.displacementBias=w.displacementBias,S.wireframeLinewidth=w.wireframeLinewidth,S.linewidth=w.linewidth,I.isPointLight===!0&&S.isMeshDistanceMaterial===!0){const A=t.properties.get(S);A.light=I}return S}function v(C,w,I,E,S){if(C.visible===!1)return;if(C.layers.test(w.layers)&&(C.isMesh||C.isLine||C.isPoints)&&(C.castShadow||C.receiveShadow&&S===ri)&&(!C.frustumCulled||i.intersectsObject(C))){C.modelViewMatrix.multiplyMatrices(I.matrixWorldInverse,C.matrixWorld);const F=e.update(C),Y=C.material;if(Array.isArray(Y)){const V=F.groups;for(let W=0,j=V.length;W<j;W++){const L=V[W],H=Y[L.materialIndex];if(H&&H.visible){const K=_(C,H,E,S);C.onBeforeShadow(t,C,w,I,F,K,L),t.renderBufferDirect(I,null,F,K,C,L),C.onAfterShadow(t,C,w,I,F,K,L)}}}else if(Y.visible){const V=_(C,Y,E,S);C.onBeforeShadow(t,C,w,I,F,V,null),t.renderBufferDirect(I,null,F,V,C,null),C.onAfterShadow(t,C,w,I,F,V,null)}}const A=C.children;for(let F=0,Y=A.length;F<Y;F++)v(A[F],w,I,E,S)}function N(C){C.target.removeEventListener("dispose",N);for(const I in u){const E=u[I],S=C.target.uuid;S in E&&(E[S].dispose(),delete E[S])}}}function Hw(t){function e(){let O=!1;const fe=new Et;let ne=null;const se=new Et(0,0,0,0);return{setMask:function(_e){ne!==_e&&!O&&(t.colorMask(_e,_e,_e,_e),ne=_e)},setLocked:function(_e){O=_e},setClear:function(_e,Oe,qe,vt,Lt){Lt===!0&&(_e*=vt,Oe*=vt,qe*=vt),fe.set(_e,Oe,qe,vt),se.equals(fe)===!1&&(t.clearColor(_e,Oe,qe,vt),se.copy(fe))},reset:function(){O=!1,ne=null,se.set(-1,0,0,0)}}}function n(){let O=!1,fe=null,ne=null,se=null;return{setTest:function(_e){_e?ve(t.DEPTH_TEST):me(t.DEPTH_TEST)},setMask:function(_e){fe!==_e&&!O&&(t.depthMask(_e),fe=_e)},setFunc:function(_e){if(ne!==_e){switch(_e){case gy:t.depthFunc(t.NEVER);break;case _y:t.depthFunc(t.ALWAYS);break;case vy:t.depthFunc(t.LESS);break;case Ll:t.depthFunc(t.LEQUAL);break;case xy:t.depthFunc(t.EQUAL);break;case yy:t.depthFunc(t.GEQUAL);break;case Sy:t.depthFunc(t.GREATER);break;case My:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}ne=_e}},setLocked:function(_e){O=_e},setClear:function(_e){se!==_e&&(t.clearDepth(_e),se=_e)},reset:function(){O=!1,fe=null,ne=null,se=null}}}function i(){let O=!1,fe=null,ne=null,se=null,_e=null,Oe=null,qe=null,vt=null,Lt=null;return{setTest:function(Ze){O||(Ze?ve(t.STENCIL_TEST):me(t.STENCIL_TEST))},setMask:function(Ze){fe!==Ze&&!O&&(t.stencilMask(Ze),fe=Ze)},setFunc:function(Ze,Qn,Gn){(ne!==Ze||se!==Qn||_e!==Gn)&&(t.stencilFunc(Ze,Qn,Gn),ne=Ze,se=Qn,_e=Gn)},setOp:function(Ze,Qn,Gn){(Oe!==Ze||qe!==Qn||vt!==Gn)&&(t.stencilOp(Ze,Qn,Gn),Oe=Ze,qe=Qn,vt=Gn)},setLocked:function(Ze){O=Ze},setClear:function(Ze){Lt!==Ze&&(t.clearStencil(Ze),Lt=Ze)},reset:function(){O=!1,fe=null,ne=null,se=null,_e=null,Oe=null,qe=null,vt=null,Lt=null}}}const r=new e,s=new n,o=new i,a=new WeakMap,l=new WeakMap;let u={},d={},h=new WeakMap,f=[],p=null,x=!1,y=null,m=null,c=null,g=null,_=null,v=null,N=null,C=new Ge(0,0,0),w=0,I=!1,E=null,S=null,P=null,A=null,F=null;const Y=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let V=!1,W=0;const j=t.getParameter(t.VERSION);j.indexOf("WebGL")!==-1?(W=parseFloat(/^WebGL (\d)/.exec(j)[1]),V=W>=1):j.indexOf("OpenGL ES")!==-1&&(W=parseFloat(/^OpenGL ES (\d)/.exec(j)[1]),V=W>=2);let L=null,H={};const K=t.getParameter(t.SCISSOR_BOX),te=t.getParameter(t.VIEWPORT),pe=new Et().fromArray(K),Fe=new Et().fromArray(te);function $(O,fe,ne,se){const _e=new Uint8Array(4),Oe=t.createTexture();t.bindTexture(O,Oe),t.texParameteri(O,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(O,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let qe=0;qe<ne;qe++)O===t.TEXTURE_3D||O===t.TEXTURE_2D_ARRAY?t.texImage3D(fe,0,t.RGBA,1,1,se,0,t.RGBA,t.UNSIGNED_BYTE,_e):t.texImage2D(fe+qe,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,_e);return Oe}const re={};re[t.TEXTURE_2D]=$(t.TEXTURE_2D,t.TEXTURE_2D,1),re[t.TEXTURE_CUBE_MAP]=$(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),re[t.TEXTURE_2D_ARRAY]=$(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),re[t.TEXTURE_3D]=$(t.TEXTURE_3D,t.TEXTURE_3D,1,1),r.setClear(0,0,0,1),s.setClear(1),o.setClear(0),ve(t.DEPTH_TEST),s.setFunc(Ll),ge(!1),ue(_p),ve(t.CULL_FACE),He(Gi);function ve(O){u[O]!==!0&&(t.enable(O),u[O]=!0)}function me(O){u[O]!==!1&&(t.disable(O),u[O]=!1)}function Le(O,fe){return d[O]!==fe?(t.bindFramebuffer(O,fe),d[O]=fe,O===t.DRAW_FRAMEBUFFER&&(d[t.FRAMEBUFFER]=fe),O===t.FRAMEBUFFER&&(d[t.DRAW_FRAMEBUFFER]=fe),!0):!1}function Ne(O,fe){let ne=f,se=!1;if(O){ne=h.get(fe),ne===void 0&&(ne=[],h.set(fe,ne));const _e=O.textures;if(ne.length!==_e.length||ne[0]!==t.COLOR_ATTACHMENT0){for(let Oe=0,qe=_e.length;Oe<qe;Oe++)ne[Oe]=t.COLOR_ATTACHMENT0+Oe;ne.length=_e.length,se=!0}}else ne[0]!==t.BACK&&(ne[0]=t.BACK,se=!0);se&&t.drawBuffers(ne)}function Be(O){return p!==O?(t.useProgram(O),p=O,!0):!1}const he={[fr]:t.FUNC_ADD,[Jx]:t.FUNC_SUBTRACT,[ey]:t.FUNC_REVERSE_SUBTRACT};he[ty]=t.MIN,he[ny]=t.MAX;const U={[iy]:t.ZERO,[ry]:t.ONE,[sy]:t.SRC_COLOR,[uf]:t.SRC_ALPHA,[fy]:t.SRC_ALPHA_SATURATE,[uy]:t.DST_COLOR,[ay]:t.DST_ALPHA,[oy]:t.ONE_MINUS_SRC_COLOR,[cf]:t.ONE_MINUS_SRC_ALPHA,[cy]:t.ONE_MINUS_DST_COLOR,[ly]:t.ONE_MINUS_DST_ALPHA,[dy]:t.CONSTANT_COLOR,[hy]:t.ONE_MINUS_CONSTANT_COLOR,[py]:t.CONSTANT_ALPHA,[my]:t.ONE_MINUS_CONSTANT_ALPHA};function He(O,fe,ne,se,_e,Oe,qe,vt,Lt,Ze){if(O===Gi){x===!0&&(me(t.BLEND),x=!1);return}if(x===!1&&(ve(t.BLEND),x=!0),O!==Qx){if(O!==y||Ze!==I){if((m!==fr||_!==fr)&&(t.blendEquation(t.FUNC_ADD),m=fr,_=fr),Ze)switch(O){case xs:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case vp:t.blendFunc(t.ONE,t.ONE);break;case xp:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case yp:t.blendFuncSeparate(t.ZERO,t.SRC_COLOR,t.ZERO,t.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",O);break}else switch(O){case xs:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case vp:t.blendFunc(t.SRC_ALPHA,t.ONE);break;case xp:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case yp:t.blendFunc(t.ZERO,t.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",O);break}c=null,g=null,v=null,N=null,C.set(0,0,0),w=0,y=O,I=Ze}return}_e=_e||fe,Oe=Oe||ne,qe=qe||se,(fe!==m||_e!==_)&&(t.blendEquationSeparate(he[fe],he[_e]),m=fe,_=_e),(ne!==c||se!==g||Oe!==v||qe!==N)&&(t.blendFuncSeparate(U[ne],U[se],U[Oe],U[qe]),c=ne,g=se,v=Oe,N=qe),(vt.equals(C)===!1||Lt!==w)&&(t.blendColor(vt.r,vt.g,vt.b,Lt),C.copy(vt),w=Lt),y=O,I=!1}function ce(O,fe){O.side===Nn?me(t.CULL_FACE):ve(t.CULL_FACE);let ne=O.side===nn;fe&&(ne=!ne),ge(ne),O.blending===xs&&O.transparent===!1?He(Gi):He(O.blending,O.blendEquation,O.blendSrc,O.blendDst,O.blendEquationAlpha,O.blendSrcAlpha,O.blendDstAlpha,O.blendColor,O.blendAlpha,O.premultipliedAlpha),s.setFunc(O.depthFunc),s.setTest(O.depthTest),s.setMask(O.depthWrite),r.setMask(O.colorWrite);const se=O.stencilWrite;o.setTest(se),se&&(o.setMask(O.stencilWriteMask),o.setFunc(O.stencilFunc,O.stencilRef,O.stencilFuncMask),o.setOp(O.stencilFail,O.stencilZFail,O.stencilZPass)),be(O.polygonOffset,O.polygonOffsetFactor,O.polygonOffsetUnits),O.alphaToCoverage===!0?ve(t.SAMPLE_ALPHA_TO_COVERAGE):me(t.SAMPLE_ALPHA_TO_COVERAGE)}function ge(O){E!==O&&(O?t.frontFace(t.CW):t.frontFace(t.CCW),E=O)}function ue(O){O!==Kx?(ve(t.CULL_FACE),O!==S&&(O===_p?t.cullFace(t.BACK):O===Zx?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):me(t.CULL_FACE),S=O}function De(O){O!==P&&(V&&t.lineWidth(O),P=O)}function be(O,fe,ne){O?(ve(t.POLYGON_OFFSET_FILL),(A!==fe||F!==ne)&&(t.polygonOffset(fe,ne),A=fe,F=ne)):me(t.POLYGON_OFFSET_FILL)}function Me(O){O?ve(t.SCISSOR_TEST):me(t.SCISSOR_TEST)}function b(O){O===void 0&&(O=t.TEXTURE0+Y-1),L!==O&&(t.activeTexture(O),L=O)}function M(O,fe,ne){ne===void 0&&(L===null?ne=t.TEXTURE0+Y-1:ne=L);let se=H[ne];se===void 0&&(se={type:void 0,texture:void 0},H[ne]=se),(se.type!==O||se.texture!==fe)&&(L!==ne&&(t.activeTexture(ne),L=ne),t.bindTexture(O,fe||re[O]),se.type=O,se.texture=fe)}function X(){const O=H[L];O!==void 0&&O.type!==void 0&&(t.bindTexture(O.type,null),O.type=void 0,O.texture=void 0)}function ee(){try{t.compressedTexImage2D.apply(t,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function oe(){try{t.compressedTexImage3D.apply(t,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function ie(){try{t.texSubImage2D.apply(t,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function Pe(){try{t.texSubImage3D.apply(t,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function xe(){try{t.compressedTexSubImage2D.apply(t,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function J(){try{t.compressedTexSubImage3D.apply(t,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function D(){try{t.texStorage2D.apply(t,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function R(){try{t.texStorage3D.apply(t,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function Q(){try{t.texImage2D.apply(t,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function ae(){try{t.texImage3D.apply(t,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function Se(O){pe.equals(O)===!1&&(t.scissor(O.x,O.y,O.z,O.w),pe.copy(O))}function Te(O){Fe.equals(O)===!1&&(t.viewport(O.x,O.y,O.z,O.w),Fe.copy(O))}function Ve(O,fe){let ne=l.get(fe);ne===void 0&&(ne=new WeakMap,l.set(fe,ne));let se=ne.get(O);se===void 0&&(se=t.getUniformBlockIndex(fe,O.name),ne.set(O,se))}function Xe(O,fe){const se=l.get(fe).get(O);a.get(fe)!==se&&(t.uniformBlockBinding(fe,se,O.__bindingPointIndex),a.set(fe,se))}function st(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),u={},L=null,H={},d={},h=new WeakMap,f=[],p=null,x=!1,y=null,m=null,c=null,g=null,_=null,v=null,N=null,C=new Ge(0,0,0),w=0,I=!1,E=null,S=null,P=null,A=null,F=null,pe.set(0,0,t.canvas.width,t.canvas.height),Fe.set(0,0,t.canvas.width,t.canvas.height),r.reset(),s.reset(),o.reset()}return{buffers:{color:r,depth:s,stencil:o},enable:ve,disable:me,bindFramebuffer:Le,drawBuffers:Ne,useProgram:Be,setBlending:He,setMaterial:ce,setFlipSided:ge,setCullFace:ue,setLineWidth:De,setPolygonOffset:be,setScissorTest:Me,activeTexture:b,bindTexture:M,unbindTexture:X,compressedTexImage2D:ee,compressedTexImage3D:oe,texImage2D:Q,texImage3D:ae,updateUBOMapping:Ve,uniformBlockBinding:Xe,texStorage2D:D,texStorage3D:R,texSubImage2D:ie,texSubImage3D:Pe,compressedTexSubImage2D:xe,compressedTexSubImage3D:J,scissor:Se,viewport:Te,reset:st}}function fm(t,e,n,i){const r=Vw(i);switch(n){case j0:return t*e;case $0:return t*e;case q0:return t*e*2;case K0:return t*e/r.components*r.byteLength;case Xd:return t*e/r.components*r.byteLength;case Z0:return t*e*2/r.components*r.byteLength;case jd:return t*e*2/r.components*r.byteLength;case Y0:return t*e*3/r.components*r.byteLength;case On:return t*e*4/r.components*r.byteLength;case Yd:return t*e*4/r.components*r.byteLength;case Ja:case el:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*8;case tl:case nl:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*16;case gf:case vf:return Math.max(t,16)*Math.max(e,8)/4;case mf:case _f:return Math.max(t,8)*Math.max(e,8)/2;case xf:case yf:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*8;case Sf:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*16;case Mf:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*16;case Ef:return Math.floor((t+4)/5)*Math.floor((e+3)/4)*16;case wf:return Math.floor((t+4)/5)*Math.floor((e+4)/5)*16;case Tf:return Math.floor((t+5)/6)*Math.floor((e+4)/5)*16;case Af:return Math.floor((t+5)/6)*Math.floor((e+5)/6)*16;case Cf:return Math.floor((t+7)/8)*Math.floor((e+4)/5)*16;case Rf:return Math.floor((t+7)/8)*Math.floor((e+5)/6)*16;case bf:return Math.floor((t+7)/8)*Math.floor((e+7)/8)*16;case Pf:return Math.floor((t+9)/10)*Math.floor((e+4)/5)*16;case Lf:return Math.floor((t+9)/10)*Math.floor((e+5)/6)*16;case Df:return Math.floor((t+9)/10)*Math.floor((e+7)/8)*16;case If:return Math.floor((t+9)/10)*Math.floor((e+9)/10)*16;case Uf:return Math.floor((t+11)/12)*Math.floor((e+9)/10)*16;case Nf:return Math.floor((t+11)/12)*Math.floor((e+11)/12)*16;case il:case Ff:case Of:return Math.ceil(t/4)*Math.ceil(e/4)*16;case Q0:case kf:return Math.ceil(t/4)*Math.ceil(e/4)*8;case zf:case Bf:return Math.ceil(t/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${n} format.`)}function Vw(t){switch(t){case gi:case G0:return{byteLength:1,components:1};case No:case W0:case Ho:return{byteLength:2,components:1};case Gd:case Wd:return{byteLength:2,components:4};case Tr:case Vd:case ui:return{byteLength:4,components:1};case X0:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${t}.`)}function Gw(t,e,n,i,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),u=new We,d=new WeakMap;let h;const f=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function x(b,M){return p?new OffscreenCanvas(b,M):Fl("canvas")}function y(b,M,X){let ee=1;const oe=Me(b);if((oe.width>X||oe.height>X)&&(ee=X/Math.max(oe.width,oe.height)),ee<1)if(typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&b instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&b instanceof ImageBitmap||typeof VideoFrame<"u"&&b instanceof VideoFrame){const ie=Math.floor(ee*oe.width),Pe=Math.floor(ee*oe.height);h===void 0&&(h=x(ie,Pe));const xe=M?x(ie,Pe):h;return xe.width=ie,xe.height=Pe,xe.getContext("2d").drawImage(b,0,0,ie,Pe),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+oe.width+"x"+oe.height+") to ("+ie+"x"+Pe+")."),xe}else return"data"in b&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+oe.width+"x"+oe.height+")."),b;return b}function m(b){return b.generateMipmaps&&b.minFilter!==Mn&&b.minFilter!==Fn}function c(b){t.generateMipmap(b)}function g(b,M,X,ee,oe=!1){if(b!==null){if(t[b]!==void 0)return t[b];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+b+"'")}let ie=M;if(M===t.RED&&(X===t.FLOAT&&(ie=t.R32F),X===t.HALF_FLOAT&&(ie=t.R16F),X===t.UNSIGNED_BYTE&&(ie=t.R8)),M===t.RED_INTEGER&&(X===t.UNSIGNED_BYTE&&(ie=t.R8UI),X===t.UNSIGNED_SHORT&&(ie=t.R16UI),X===t.UNSIGNED_INT&&(ie=t.R32UI),X===t.BYTE&&(ie=t.R8I),X===t.SHORT&&(ie=t.R16I),X===t.INT&&(ie=t.R32I)),M===t.RG&&(X===t.FLOAT&&(ie=t.RG32F),X===t.HALF_FLOAT&&(ie=t.RG16F),X===t.UNSIGNED_BYTE&&(ie=t.RG8)),M===t.RG_INTEGER&&(X===t.UNSIGNED_BYTE&&(ie=t.RG8UI),X===t.UNSIGNED_SHORT&&(ie=t.RG16UI),X===t.UNSIGNED_INT&&(ie=t.RG32UI),X===t.BYTE&&(ie=t.RG8I),X===t.SHORT&&(ie=t.RG16I),X===t.INT&&(ie=t.RG32I)),M===t.RGB&&X===t.UNSIGNED_INT_5_9_9_9_REV&&(ie=t.RGB9_E5),M===t.RGBA){const Pe=oe?Dl:tt.getTransfer(ee);X===t.FLOAT&&(ie=t.RGBA32F),X===t.HALF_FLOAT&&(ie=t.RGBA16F),X===t.UNSIGNED_BYTE&&(ie=Pe===at?t.SRGB8_ALPHA8:t.RGBA8),X===t.UNSIGNED_SHORT_4_4_4_4&&(ie=t.RGBA4),X===t.UNSIGNED_SHORT_5_5_5_1&&(ie=t.RGB5_A1)}return(ie===t.R16F||ie===t.R32F||ie===t.RG16F||ie===t.RG32F||ie===t.RGBA16F||ie===t.RGBA32F)&&e.get("EXT_color_buffer_float"),ie}function _(b,M){let X;return b?M===null||M===Tr||M===Ds?X=t.DEPTH24_STENCIL8:M===ui?X=t.DEPTH32F_STENCIL8:M===No&&(X=t.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):M===null||M===Tr||M===Ds?X=t.DEPTH_COMPONENT24:M===ui?X=t.DEPTH_COMPONENT32F:M===No&&(X=t.DEPTH_COMPONENT16),X}function v(b,M){return m(b)===!0||b.isFramebufferTexture&&b.minFilter!==Mn&&b.minFilter!==Fn?Math.log2(Math.max(M.width,M.height))+1:b.mipmaps!==void 0&&b.mipmaps.length>0?b.mipmaps.length:b.isCompressedTexture&&Array.isArray(b.image)?M.mipmaps.length:1}function N(b){const M=b.target;M.removeEventListener("dispose",N),w(M),M.isVideoTexture&&d.delete(M)}function C(b){const M=b.target;M.removeEventListener("dispose",C),E(M)}function w(b){const M=i.get(b);if(M.__webglInit===void 0)return;const X=b.source,ee=f.get(X);if(ee){const oe=ee[M.__cacheKey];oe.usedTimes--,oe.usedTimes===0&&I(b),Object.keys(ee).length===0&&f.delete(X)}i.remove(b)}function I(b){const M=i.get(b);t.deleteTexture(M.__webglTexture);const X=b.source,ee=f.get(X);delete ee[M.__cacheKey],o.memory.textures--}function E(b){const M=i.get(b);if(b.depthTexture&&b.depthTexture.dispose(),b.isWebGLCubeRenderTarget)for(let ee=0;ee<6;ee++){if(Array.isArray(M.__webglFramebuffer[ee]))for(let oe=0;oe<M.__webglFramebuffer[ee].length;oe++)t.deleteFramebuffer(M.__webglFramebuffer[ee][oe]);else t.deleteFramebuffer(M.__webglFramebuffer[ee]);M.__webglDepthbuffer&&t.deleteRenderbuffer(M.__webglDepthbuffer[ee])}else{if(Array.isArray(M.__webglFramebuffer))for(let ee=0;ee<M.__webglFramebuffer.length;ee++)t.deleteFramebuffer(M.__webglFramebuffer[ee]);else t.deleteFramebuffer(M.__webglFramebuffer);if(M.__webglDepthbuffer&&t.deleteRenderbuffer(M.__webglDepthbuffer),M.__webglMultisampledFramebuffer&&t.deleteFramebuffer(M.__webglMultisampledFramebuffer),M.__webglColorRenderbuffer)for(let ee=0;ee<M.__webglColorRenderbuffer.length;ee++)M.__webglColorRenderbuffer[ee]&&t.deleteRenderbuffer(M.__webglColorRenderbuffer[ee]);M.__webglDepthRenderbuffer&&t.deleteRenderbuffer(M.__webglDepthRenderbuffer)}const X=b.textures;for(let ee=0,oe=X.length;ee<oe;ee++){const ie=i.get(X[ee]);ie.__webglTexture&&(t.deleteTexture(ie.__webglTexture),o.memory.textures--),i.remove(X[ee])}i.remove(b)}let S=0;function P(){S=0}function A(){const b=S;return b>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+b+" texture units while this GPU supports only "+r.maxTextures),S+=1,b}function F(b){const M=[];return M.push(b.wrapS),M.push(b.wrapT),M.push(b.wrapR||0),M.push(b.magFilter),M.push(b.minFilter),M.push(b.anisotropy),M.push(b.internalFormat),M.push(b.format),M.push(b.type),M.push(b.generateMipmaps),M.push(b.premultiplyAlpha),M.push(b.flipY),M.push(b.unpackAlignment),M.push(b.colorSpace),M.join()}function Y(b,M){const X=i.get(b);if(b.isVideoTexture&&De(b),b.isRenderTargetTexture===!1&&b.version>0&&X.__version!==b.version){const ee=b.image;if(ee===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(ee.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Fe(X,b,M);return}}n.bindTexture(t.TEXTURE_2D,X.__webglTexture,t.TEXTURE0+M)}function V(b,M){const X=i.get(b);if(b.version>0&&X.__version!==b.version){Fe(X,b,M);return}n.bindTexture(t.TEXTURE_2D_ARRAY,X.__webglTexture,t.TEXTURE0+M)}function W(b,M){const X=i.get(b);if(b.version>0&&X.__version!==b.version){Fe(X,b,M);return}n.bindTexture(t.TEXTURE_3D,X.__webglTexture,t.TEXTURE0+M)}function j(b,M){const X=i.get(b);if(b.version>0&&X.__version!==b.version){$(X,b,M);return}n.bindTexture(t.TEXTURE_CUBE_MAP,X.__webglTexture,t.TEXTURE0+M)}const L={[hf]:t.REPEAT,[gr]:t.CLAMP_TO_EDGE,[pf]:t.MIRRORED_REPEAT},H={[Mn]:t.NEAREST,[Dy]:t.NEAREST_MIPMAP_NEAREST,[ua]:t.NEAREST_MIPMAP_LINEAR,[Fn]:t.LINEAR,[Ou]:t.LINEAR_MIPMAP_NEAREST,[_r]:t.LINEAR_MIPMAP_LINEAR},K={[Fy]:t.NEVER,[Vy]:t.ALWAYS,[Oy]:t.LESS,[J0]:t.LEQUAL,[ky]:t.EQUAL,[Hy]:t.GEQUAL,[zy]:t.GREATER,[By]:t.NOTEQUAL};function te(b,M){if(M.type===ui&&e.has("OES_texture_float_linear")===!1&&(M.magFilter===Fn||M.magFilter===Ou||M.magFilter===ua||M.magFilter===_r||M.minFilter===Fn||M.minFilter===Ou||M.minFilter===ua||M.minFilter===_r)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),t.texParameteri(b,t.TEXTURE_WRAP_S,L[M.wrapS]),t.texParameteri(b,t.TEXTURE_WRAP_T,L[M.wrapT]),(b===t.TEXTURE_3D||b===t.TEXTURE_2D_ARRAY)&&t.texParameteri(b,t.TEXTURE_WRAP_R,L[M.wrapR]),t.texParameteri(b,t.TEXTURE_MAG_FILTER,H[M.magFilter]),t.texParameteri(b,t.TEXTURE_MIN_FILTER,H[M.minFilter]),M.compareFunction&&(t.texParameteri(b,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(b,t.TEXTURE_COMPARE_FUNC,K[M.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(M.magFilter===Mn||M.minFilter!==ua&&M.minFilter!==_r||M.type===ui&&e.has("OES_texture_float_linear")===!1)return;if(M.anisotropy>1||i.get(M).__currentAnisotropy){const X=e.get("EXT_texture_filter_anisotropic");t.texParameterf(b,X.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(M.anisotropy,r.getMaxAnisotropy())),i.get(M).__currentAnisotropy=M.anisotropy}}}function pe(b,M){let X=!1;b.__webglInit===void 0&&(b.__webglInit=!0,M.addEventListener("dispose",N));const ee=M.source;let oe=f.get(ee);oe===void 0&&(oe={},f.set(ee,oe));const ie=F(M);if(ie!==b.__cacheKey){oe[ie]===void 0&&(oe[ie]={texture:t.createTexture(),usedTimes:0},o.memory.textures++,X=!0),oe[ie].usedTimes++;const Pe=oe[b.__cacheKey];Pe!==void 0&&(oe[b.__cacheKey].usedTimes--,Pe.usedTimes===0&&I(M)),b.__cacheKey=ie,b.__webglTexture=oe[ie].texture}return X}function Fe(b,M,X){let ee=t.TEXTURE_2D;(M.isDataArrayTexture||M.isCompressedArrayTexture)&&(ee=t.TEXTURE_2D_ARRAY),M.isData3DTexture&&(ee=t.TEXTURE_3D);const oe=pe(b,M),ie=M.source;n.bindTexture(ee,b.__webglTexture,t.TEXTURE0+X);const Pe=i.get(ie);if(ie.version!==Pe.__version||oe===!0){n.activeTexture(t.TEXTURE0+X);const xe=tt.getPrimaries(tt.workingColorSpace),J=M.colorSpace===Li?null:tt.getPrimaries(M.colorSpace),D=M.colorSpace===Li||xe===J?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,M.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,M.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,D);let R=y(M.image,!1,r.maxTextureSize);R=be(M,R);const Q=s.convert(M.format,M.colorSpace),ae=s.convert(M.type);let Se=g(M.internalFormat,Q,ae,M.colorSpace,M.isVideoTexture);te(ee,M);let Te;const Ve=M.mipmaps,Xe=M.isVideoTexture!==!0,st=Pe.__version===void 0||oe===!0,O=ie.dataReady,fe=v(M,R);if(M.isDepthTexture)Se=_(M.format===Is,M.type),st&&(Xe?n.texStorage2D(t.TEXTURE_2D,1,Se,R.width,R.height):n.texImage2D(t.TEXTURE_2D,0,Se,R.width,R.height,0,Q,ae,null));else if(M.isDataTexture)if(Ve.length>0){Xe&&st&&n.texStorage2D(t.TEXTURE_2D,fe,Se,Ve[0].width,Ve[0].height);for(let ne=0,se=Ve.length;ne<se;ne++)Te=Ve[ne],Xe?O&&n.texSubImage2D(t.TEXTURE_2D,ne,0,0,Te.width,Te.height,Q,ae,Te.data):n.texImage2D(t.TEXTURE_2D,ne,Se,Te.width,Te.height,0,Q,ae,Te.data);M.generateMipmaps=!1}else Xe?(st&&n.texStorage2D(t.TEXTURE_2D,fe,Se,R.width,R.height),O&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,R.width,R.height,Q,ae,R.data)):n.texImage2D(t.TEXTURE_2D,0,Se,R.width,R.height,0,Q,ae,R.data);else if(M.isCompressedTexture)if(M.isCompressedArrayTexture){Xe&&st&&n.texStorage3D(t.TEXTURE_2D_ARRAY,fe,Se,Ve[0].width,Ve[0].height,R.depth);for(let ne=0,se=Ve.length;ne<se;ne++)if(Te=Ve[ne],M.format!==On)if(Q!==null)if(Xe){if(O)if(M.layerUpdates.size>0){const _e=fm(Te.width,Te.height,M.format,M.type);for(const Oe of M.layerUpdates){const qe=Te.data.subarray(Oe*_e/Te.data.BYTES_PER_ELEMENT,(Oe+1)*_e/Te.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,ne,0,0,Oe,Te.width,Te.height,1,Q,qe,0,0)}M.clearLayerUpdates()}else n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,ne,0,0,0,Te.width,Te.height,R.depth,Q,Te.data,0,0)}else n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,ne,Se,Te.width,Te.height,R.depth,0,Te.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Xe?O&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,ne,0,0,0,Te.width,Te.height,R.depth,Q,ae,Te.data):n.texImage3D(t.TEXTURE_2D_ARRAY,ne,Se,Te.width,Te.height,R.depth,0,Q,ae,Te.data)}else{Xe&&st&&n.texStorage2D(t.TEXTURE_2D,fe,Se,Ve[0].width,Ve[0].height);for(let ne=0,se=Ve.length;ne<se;ne++)Te=Ve[ne],M.format!==On?Q!==null?Xe?O&&n.compressedTexSubImage2D(t.TEXTURE_2D,ne,0,0,Te.width,Te.height,Q,Te.data):n.compressedTexImage2D(t.TEXTURE_2D,ne,Se,Te.width,Te.height,0,Te.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Xe?O&&n.texSubImage2D(t.TEXTURE_2D,ne,0,0,Te.width,Te.height,Q,ae,Te.data):n.texImage2D(t.TEXTURE_2D,ne,Se,Te.width,Te.height,0,Q,ae,Te.data)}else if(M.isDataArrayTexture)if(Xe){if(st&&n.texStorage3D(t.TEXTURE_2D_ARRAY,fe,Se,R.width,R.height,R.depth),O)if(M.layerUpdates.size>0){const ne=fm(R.width,R.height,M.format,M.type);for(const se of M.layerUpdates){const _e=R.data.subarray(se*ne/R.data.BYTES_PER_ELEMENT,(se+1)*ne/R.data.BYTES_PER_ELEMENT);n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,se,R.width,R.height,1,Q,ae,_e)}M.clearLayerUpdates()}else n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,R.width,R.height,R.depth,Q,ae,R.data)}else n.texImage3D(t.TEXTURE_2D_ARRAY,0,Se,R.width,R.height,R.depth,0,Q,ae,R.data);else if(M.isData3DTexture)Xe?(st&&n.texStorage3D(t.TEXTURE_3D,fe,Se,R.width,R.height,R.depth),O&&n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,R.width,R.height,R.depth,Q,ae,R.data)):n.texImage3D(t.TEXTURE_3D,0,Se,R.width,R.height,R.depth,0,Q,ae,R.data);else if(M.isFramebufferTexture){if(st)if(Xe)n.texStorage2D(t.TEXTURE_2D,fe,Se,R.width,R.height);else{let ne=R.width,se=R.height;for(let _e=0;_e<fe;_e++)n.texImage2D(t.TEXTURE_2D,_e,Se,ne,se,0,Q,ae,null),ne>>=1,se>>=1}}else if(Ve.length>0){if(Xe&&st){const ne=Me(Ve[0]);n.texStorage2D(t.TEXTURE_2D,fe,Se,ne.width,ne.height)}for(let ne=0,se=Ve.length;ne<se;ne++)Te=Ve[ne],Xe?O&&n.texSubImage2D(t.TEXTURE_2D,ne,0,0,Q,ae,Te):n.texImage2D(t.TEXTURE_2D,ne,Se,Q,ae,Te);M.generateMipmaps=!1}else if(Xe){if(st){const ne=Me(R);n.texStorage2D(t.TEXTURE_2D,fe,Se,ne.width,ne.height)}O&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,Q,ae,R)}else n.texImage2D(t.TEXTURE_2D,0,Se,Q,ae,R);m(M)&&c(ee),Pe.__version=ie.version,M.onUpdate&&M.onUpdate(M)}b.__version=M.version}function $(b,M,X){if(M.image.length!==6)return;const ee=pe(b,M),oe=M.source;n.bindTexture(t.TEXTURE_CUBE_MAP,b.__webglTexture,t.TEXTURE0+X);const ie=i.get(oe);if(oe.version!==ie.__version||ee===!0){n.activeTexture(t.TEXTURE0+X);const Pe=tt.getPrimaries(tt.workingColorSpace),xe=M.colorSpace===Li?null:tt.getPrimaries(M.colorSpace),J=M.colorSpace===Li||Pe===xe?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,M.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,M.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,J);const D=M.isCompressedTexture||M.image[0].isCompressedTexture,R=M.image[0]&&M.image[0].isDataTexture,Q=[];for(let se=0;se<6;se++)!D&&!R?Q[se]=y(M.image[se],!0,r.maxCubemapSize):Q[se]=R?M.image[se].image:M.image[se],Q[se]=be(M,Q[se]);const ae=Q[0],Se=s.convert(M.format,M.colorSpace),Te=s.convert(M.type),Ve=g(M.internalFormat,Se,Te,M.colorSpace),Xe=M.isVideoTexture!==!0,st=ie.__version===void 0||ee===!0,O=oe.dataReady;let fe=v(M,ae);te(t.TEXTURE_CUBE_MAP,M);let ne;if(D){Xe&&st&&n.texStorage2D(t.TEXTURE_CUBE_MAP,fe,Ve,ae.width,ae.height);for(let se=0;se<6;se++){ne=Q[se].mipmaps;for(let _e=0;_e<ne.length;_e++){const Oe=ne[_e];M.format!==On?Se!==null?Xe?O&&n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+se,_e,0,0,Oe.width,Oe.height,Se,Oe.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+se,_e,Ve,Oe.width,Oe.height,0,Oe.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Xe?O&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+se,_e,0,0,Oe.width,Oe.height,Se,Te,Oe.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+se,_e,Ve,Oe.width,Oe.height,0,Se,Te,Oe.data)}}}else{if(ne=M.mipmaps,Xe&&st){ne.length>0&&fe++;const se=Me(Q[0]);n.texStorage2D(t.TEXTURE_CUBE_MAP,fe,Ve,se.width,se.height)}for(let se=0;se<6;se++)if(R){Xe?O&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+se,0,0,0,Q[se].width,Q[se].height,Se,Te,Q[se].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+se,0,Ve,Q[se].width,Q[se].height,0,Se,Te,Q[se].data);for(let _e=0;_e<ne.length;_e++){const qe=ne[_e].image[se].image;Xe?O&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+se,_e+1,0,0,qe.width,qe.height,Se,Te,qe.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+se,_e+1,Ve,qe.width,qe.height,0,Se,Te,qe.data)}}else{Xe?O&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+se,0,0,0,Se,Te,Q[se]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+se,0,Ve,Se,Te,Q[se]);for(let _e=0;_e<ne.length;_e++){const Oe=ne[_e];Xe?O&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+se,_e+1,0,0,Se,Te,Oe.image[se]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+se,_e+1,Ve,Se,Te,Oe.image[se])}}}m(M)&&c(t.TEXTURE_CUBE_MAP),ie.__version=oe.version,M.onUpdate&&M.onUpdate(M)}b.__version=M.version}function re(b,M,X,ee,oe,ie){const Pe=s.convert(X.format,X.colorSpace),xe=s.convert(X.type),J=g(X.internalFormat,Pe,xe,X.colorSpace);if(!i.get(M).__hasExternalTextures){const R=Math.max(1,M.width>>ie),Q=Math.max(1,M.height>>ie);oe===t.TEXTURE_3D||oe===t.TEXTURE_2D_ARRAY?n.texImage3D(oe,ie,J,R,Q,M.depth,0,Pe,xe,null):n.texImage2D(oe,ie,J,R,Q,0,Pe,xe,null)}n.bindFramebuffer(t.FRAMEBUFFER,b),ue(M)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,ee,oe,i.get(X).__webglTexture,0,ge(M)):(oe===t.TEXTURE_2D||oe>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&oe<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,ee,oe,i.get(X).__webglTexture,ie),n.bindFramebuffer(t.FRAMEBUFFER,null)}function ve(b,M,X){if(t.bindRenderbuffer(t.RENDERBUFFER,b),M.depthBuffer){const ee=M.depthTexture,oe=ee&&ee.isDepthTexture?ee.type:null,ie=_(M.stencilBuffer,oe),Pe=M.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,xe=ge(M);ue(M)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,xe,ie,M.width,M.height):X?t.renderbufferStorageMultisample(t.RENDERBUFFER,xe,ie,M.width,M.height):t.renderbufferStorage(t.RENDERBUFFER,ie,M.width,M.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,Pe,t.RENDERBUFFER,b)}else{const ee=M.textures;for(let oe=0;oe<ee.length;oe++){const ie=ee[oe],Pe=s.convert(ie.format,ie.colorSpace),xe=s.convert(ie.type),J=g(ie.internalFormat,Pe,xe,ie.colorSpace),D=ge(M);X&&ue(M)===!1?t.renderbufferStorageMultisample(t.RENDERBUFFER,D,J,M.width,M.height):ue(M)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,D,J,M.width,M.height):t.renderbufferStorage(t.RENDERBUFFER,J,M.width,M.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function me(b,M){if(M&&M.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(n.bindFramebuffer(t.FRAMEBUFFER,b),!(M.depthTexture&&M.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!i.get(M.depthTexture).__webglTexture||M.depthTexture.image.width!==M.width||M.depthTexture.image.height!==M.height)&&(M.depthTexture.image.width=M.width,M.depthTexture.image.height=M.height,M.depthTexture.needsUpdate=!0),Y(M.depthTexture,0);const ee=i.get(M.depthTexture).__webglTexture,oe=ge(M);if(M.depthTexture.format===ys)ue(M)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,ee,0,oe):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,ee,0);else if(M.depthTexture.format===Is)ue(M)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,ee,0,oe):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,ee,0);else throw new Error("Unknown depthTexture format")}function Le(b){const M=i.get(b),X=b.isWebGLCubeRenderTarget===!0;if(M.__boundDepthTexture!==b.depthTexture){const ee=b.depthTexture;if(M.__depthDisposeCallback&&M.__depthDisposeCallback(),ee){const oe=()=>{delete M.__boundDepthTexture,delete M.__depthDisposeCallback,ee.removeEventListener("dispose",oe)};ee.addEventListener("dispose",oe),M.__depthDisposeCallback=oe}M.__boundDepthTexture=ee}if(b.depthTexture&&!M.__autoAllocateDepthBuffer){if(X)throw new Error("target.depthTexture not supported in Cube render targets");me(M.__webglFramebuffer,b)}else if(X){M.__webglDepthbuffer=[];for(let ee=0;ee<6;ee++)if(n.bindFramebuffer(t.FRAMEBUFFER,M.__webglFramebuffer[ee]),M.__webglDepthbuffer[ee]===void 0)M.__webglDepthbuffer[ee]=t.createRenderbuffer(),ve(M.__webglDepthbuffer[ee],b,!1);else{const oe=b.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ie=M.__webglDepthbuffer[ee];t.bindRenderbuffer(t.RENDERBUFFER,ie),t.framebufferRenderbuffer(t.FRAMEBUFFER,oe,t.RENDERBUFFER,ie)}}else if(n.bindFramebuffer(t.FRAMEBUFFER,M.__webglFramebuffer),M.__webglDepthbuffer===void 0)M.__webglDepthbuffer=t.createRenderbuffer(),ve(M.__webglDepthbuffer,b,!1);else{const ee=b.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,oe=M.__webglDepthbuffer;t.bindRenderbuffer(t.RENDERBUFFER,oe),t.framebufferRenderbuffer(t.FRAMEBUFFER,ee,t.RENDERBUFFER,oe)}n.bindFramebuffer(t.FRAMEBUFFER,null)}function Ne(b,M,X){const ee=i.get(b);M!==void 0&&re(ee.__webglFramebuffer,b,b.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),X!==void 0&&Le(b)}function Be(b){const M=b.texture,X=i.get(b),ee=i.get(M);b.addEventListener("dispose",C);const oe=b.textures,ie=b.isWebGLCubeRenderTarget===!0,Pe=oe.length>1;if(Pe||(ee.__webglTexture===void 0&&(ee.__webglTexture=t.createTexture()),ee.__version=M.version,o.memory.textures++),ie){X.__webglFramebuffer=[];for(let xe=0;xe<6;xe++)if(M.mipmaps&&M.mipmaps.length>0){X.__webglFramebuffer[xe]=[];for(let J=0;J<M.mipmaps.length;J++)X.__webglFramebuffer[xe][J]=t.createFramebuffer()}else X.__webglFramebuffer[xe]=t.createFramebuffer()}else{if(M.mipmaps&&M.mipmaps.length>0){X.__webglFramebuffer=[];for(let xe=0;xe<M.mipmaps.length;xe++)X.__webglFramebuffer[xe]=t.createFramebuffer()}else X.__webglFramebuffer=t.createFramebuffer();if(Pe)for(let xe=0,J=oe.length;xe<J;xe++){const D=i.get(oe[xe]);D.__webglTexture===void 0&&(D.__webglTexture=t.createTexture(),o.memory.textures++)}if(b.samples>0&&ue(b)===!1){X.__webglMultisampledFramebuffer=t.createFramebuffer(),X.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,X.__webglMultisampledFramebuffer);for(let xe=0;xe<oe.length;xe++){const J=oe[xe];X.__webglColorRenderbuffer[xe]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,X.__webglColorRenderbuffer[xe]);const D=s.convert(J.format,J.colorSpace),R=s.convert(J.type),Q=g(J.internalFormat,D,R,J.colorSpace,b.isXRRenderTarget===!0),ae=ge(b);t.renderbufferStorageMultisample(t.RENDERBUFFER,ae,Q,b.width,b.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+xe,t.RENDERBUFFER,X.__webglColorRenderbuffer[xe])}t.bindRenderbuffer(t.RENDERBUFFER,null),b.depthBuffer&&(X.__webglDepthRenderbuffer=t.createRenderbuffer(),ve(X.__webglDepthRenderbuffer,b,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(ie){n.bindTexture(t.TEXTURE_CUBE_MAP,ee.__webglTexture),te(t.TEXTURE_CUBE_MAP,M);for(let xe=0;xe<6;xe++)if(M.mipmaps&&M.mipmaps.length>0)for(let J=0;J<M.mipmaps.length;J++)re(X.__webglFramebuffer[xe][J],b,M,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+xe,J);else re(X.__webglFramebuffer[xe],b,M,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+xe,0);m(M)&&c(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(Pe){for(let xe=0,J=oe.length;xe<J;xe++){const D=oe[xe],R=i.get(D);n.bindTexture(t.TEXTURE_2D,R.__webglTexture),te(t.TEXTURE_2D,D),re(X.__webglFramebuffer,b,D,t.COLOR_ATTACHMENT0+xe,t.TEXTURE_2D,0),m(D)&&c(t.TEXTURE_2D)}n.unbindTexture()}else{let xe=t.TEXTURE_2D;if((b.isWebGL3DRenderTarget||b.isWebGLArrayRenderTarget)&&(xe=b.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(xe,ee.__webglTexture),te(xe,M),M.mipmaps&&M.mipmaps.length>0)for(let J=0;J<M.mipmaps.length;J++)re(X.__webglFramebuffer[J],b,M,t.COLOR_ATTACHMENT0,xe,J);else re(X.__webglFramebuffer,b,M,t.COLOR_ATTACHMENT0,xe,0);m(M)&&c(xe),n.unbindTexture()}b.depthBuffer&&Le(b)}function he(b){const M=b.textures;for(let X=0,ee=M.length;X<ee;X++){const oe=M[X];if(m(oe)){const ie=b.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:t.TEXTURE_2D,Pe=i.get(oe).__webglTexture;n.bindTexture(ie,Pe),c(ie),n.unbindTexture()}}}const U=[],He=[];function ce(b){if(b.samples>0){if(ue(b)===!1){const M=b.textures,X=b.width,ee=b.height;let oe=t.COLOR_BUFFER_BIT;const ie=b.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,Pe=i.get(b),xe=M.length>1;if(xe)for(let J=0;J<M.length;J++)n.bindFramebuffer(t.FRAMEBUFFER,Pe.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+J,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,Pe.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+J,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,Pe.__webglMultisampledFramebuffer),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,Pe.__webglFramebuffer);for(let J=0;J<M.length;J++){if(b.resolveDepthBuffer&&(b.depthBuffer&&(oe|=t.DEPTH_BUFFER_BIT),b.stencilBuffer&&b.resolveStencilBuffer&&(oe|=t.STENCIL_BUFFER_BIT)),xe){t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,Pe.__webglColorRenderbuffer[J]);const D=i.get(M[J]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,D,0)}t.blitFramebuffer(0,0,X,ee,0,0,X,ee,oe,t.NEAREST),l===!0&&(U.length=0,He.length=0,U.push(t.COLOR_ATTACHMENT0+J),b.depthBuffer&&b.resolveDepthBuffer===!1&&(U.push(ie),He.push(ie),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,He)),t.invalidateFramebuffer(t.READ_FRAMEBUFFER,U))}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),xe)for(let J=0;J<M.length;J++){n.bindFramebuffer(t.FRAMEBUFFER,Pe.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+J,t.RENDERBUFFER,Pe.__webglColorRenderbuffer[J]);const D=i.get(M[J]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,Pe.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+J,t.TEXTURE_2D,D,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,Pe.__webglMultisampledFramebuffer)}else if(b.depthBuffer&&b.resolveDepthBuffer===!1&&l){const M=b.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[M])}}}function ge(b){return Math.min(r.maxSamples,b.samples)}function ue(b){const M=i.get(b);return b.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&M.__useRenderToTexture!==!1}function De(b){const M=o.render.frame;d.get(b)!==M&&(d.set(b,M),b.update())}function be(b,M){const X=b.colorSpace,ee=b.format,oe=b.type;return b.isCompressedTexture===!0||b.isVideoTexture===!0||X!==Ji&&X!==Li&&(tt.getTransfer(X)===at?(ee!==On||oe!==gi)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",X)),M}function Me(b){return typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement?(u.width=b.naturalWidth||b.width,u.height=b.naturalHeight||b.height):typeof VideoFrame<"u"&&b instanceof VideoFrame?(u.width=b.displayWidth,u.height=b.displayHeight):(u.width=b.width,u.height=b.height),u}this.allocateTextureUnit=A,this.resetTextureUnits=P,this.setTexture2D=Y,this.setTexture2DArray=V,this.setTexture3D=W,this.setTextureCube=j,this.rebindTextures=Ne,this.setupRenderTarget=Be,this.updateRenderTargetMipmap=he,this.updateMultisampleRenderTarget=ce,this.setupDepthRenderbuffer=Le,this.setupFrameBufferTexture=re,this.useMultisampledRTT=ue}function Ww(t,e){function n(i,r=Li){let s;const o=tt.getTransfer(r);if(i===gi)return t.UNSIGNED_BYTE;if(i===Gd)return t.UNSIGNED_SHORT_4_4_4_4;if(i===Wd)return t.UNSIGNED_SHORT_5_5_5_1;if(i===X0)return t.UNSIGNED_INT_5_9_9_9_REV;if(i===G0)return t.BYTE;if(i===W0)return t.SHORT;if(i===No)return t.UNSIGNED_SHORT;if(i===Vd)return t.INT;if(i===Tr)return t.UNSIGNED_INT;if(i===ui)return t.FLOAT;if(i===Ho)return t.HALF_FLOAT;if(i===j0)return t.ALPHA;if(i===Y0)return t.RGB;if(i===On)return t.RGBA;if(i===$0)return t.LUMINANCE;if(i===q0)return t.LUMINANCE_ALPHA;if(i===ys)return t.DEPTH_COMPONENT;if(i===Is)return t.DEPTH_STENCIL;if(i===K0)return t.RED;if(i===Xd)return t.RED_INTEGER;if(i===Z0)return t.RG;if(i===jd)return t.RG_INTEGER;if(i===Yd)return t.RGBA_INTEGER;if(i===Ja||i===el||i===tl||i===nl)if(o===at)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===Ja)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===el)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===tl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===nl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===Ja)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===el)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===tl)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===nl)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===mf||i===gf||i===_f||i===vf)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===mf)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===gf)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===_f)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===vf)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===xf||i===yf||i===Sf)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===xf||i===yf)return o===at?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===Sf)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===Mf||i===Ef||i===wf||i===Tf||i===Af||i===Cf||i===Rf||i===bf||i===Pf||i===Lf||i===Df||i===If||i===Uf||i===Nf)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===Mf)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Ef)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===wf)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Tf)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Af)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Cf)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Rf)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===bf)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Pf)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Lf)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Df)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===If)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Uf)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Nf)return o===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===il||i===Ff||i===Of)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===il)return o===at?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Ff)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Of)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Q0||i===kf||i===zf||i===Bf)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===il)return s.COMPRESSED_RED_RGTC1_EXT;if(i===kf)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===zf)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Bf)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Ds?t.UNSIGNED_INT_24_8:t[i]!==void 0?t[i]:null}return{convert:n}}class Xw extends xn{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class La extends Pt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const jw={type:"move"};class uc{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new La,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new La,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new G,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new G),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new La,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new G,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new G),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const n=this._hand;if(n)for(const i of e.hand.values())this._getHandJoint(n,i)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,n,i){let r=null,s=null,o=null;const a=this._targetRay,l=this._grip,u=this._hand;if(e&&n.session.visibilityState!=="visible-blurred"){if(u&&e.hand){o=!0;for(const y of e.hand.values()){const m=n.getJointPose(y,i),c=this._getHandJoint(u,y);m!==null&&(c.matrix.fromArray(m.transform.matrix),c.matrix.decompose(c.position,c.rotation,c.scale),c.matrixWorldNeedsUpdate=!0,c.jointRadius=m.radius),c.visible=m!==null}const d=u.joints["index-finger-tip"],h=u.joints["thumb-tip"],f=d.position.distanceTo(h.position),p=.02,x=.005;u.inputState.pinching&&f>p+x?(u.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!u.inputState.pinching&&f<=p-x&&(u.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=n.getPose(e.gripSpace,i),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(r=n.getPose(e.targetRaySpace,i),r===null&&s!==null&&(r=s),r!==null&&(a.matrix.fromArray(r.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,r.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(r.linearVelocity)):a.hasLinearVelocity=!1,r.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(r.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(jw)))}return a!==null&&(a.visible=r!==null),l!==null&&(l.visible=s!==null),u!==null&&(u.visible=o!==null),this}_getHandJoint(e,n){if(e.joints[n.jointName]===void 0){const i=new La;i.matrixAutoUpdate=!1,i.visible=!1,e.joints[n.jointName]=i,e.add(i)}return e.joints[n.jointName]}}const Yw=`
void main() {
...
}`;class qw{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,n,i){if(this.texture===null){const r=new jt,s=e.properties.get(r);s.__webglTexture=n.texture,(n.depthNear!=i.depthNear||n.depthFar!=i.depthFar)&&(this.depthNear=n.depthNear,this.depthFar=n.depthFar),this.texture=r}}getMesh(e){if(this.texture!==null&&this.mesh===null){const n=e.cameras[0].viewport,i=new qi({vertexShader:Yw,fragmentShader:$w,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new Zt(new Ui(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class Kw extends ks{constructor(e,n){super();const i=this;let r=null,s=1,o=null,a="local-floor",l=1,u=null,d=null,h=null,f=null,p=null,x=null;const y=new qw,m=n.getContextAttributes();let c=null,g=null;const _=[],v=[],N=new We;let C=null;const w=new xn;w.layers.enable(1),w.viewport=new Et;const I=new xn;I.layers.enable(2),I.viewport=new Et;const E=[w,I],S=new Xw;S.layers.enable(1),S.layers.enable(2);let P=null,A=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function($){let re=_[$];return re===void 0&&(re=new uc,_[$]=re),re.getTargetRaySpace()},this.getControllerGrip=function($){let re=_[$];return re===void 0&&(re=new uc,_[$]=re),re.getGripSpace()},this.getHand=function($){let re=_[$];return re===void 0&&(re=new uc,_[$]=re),re.getHandSpace()};function F($){const re=v.indexOf($.inputSource);if(re===-1)return;const ve=_[re];ve!==void 0&&(ve.update($.inputSource,$.frame,u||o),ve.dispatchEvent({type:$.type,data:$.inputSource}))}function Y(){r.removeEventListener("select",F),r.removeEventListener("selectstart",F),r.removeEventListener("selectend",F),r.removeEventListener("squeeze",F),r.removeEventListener("squeezestart",F),r.removeEventListener("squeezeend",F),r.removeEventListener("end",Y),r.removeEventListener("inputsourceschange",V);for(let $=0;$<_.length;$++){const re=v[$];re!==null&&(v[$]=null,_[$].disconnect(re))}P=null,A=null,y.reset(),e.setRenderTarget(c),p=null,f=null,h=null,r=null,g=null,Fe.stop(),i.isPresenting=!1,e.setPixelRatio(C),e.setSize(N.width,N.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function($){s=$,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function($){a=$,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return u||o},this.setReferenceSpace=function($){u=$},this.getBaseLayer=function(){return f!==null?f:p},this.getBinding=function(){return h},this.getFrame=function(){return x},this.getSession=function(){return r},this.setSession=async function($){if(r=$,r!==null){if(c=e.getRenderTarget(),r.addEventListener("select",F),r.addEventListener("selectstart",F),r.addEventListener("selectend",F),r.addEventListener("squeeze",F),r.addEventListener("squeezestart",F),r.addEventListener("squeezeend",F),r.addEventListener("end",Y),r.addEventListener("inputsourceschange",V),m.xrCompatible!==!0&&await n.makeXRCompatible(),C=e.getPixelRatio(),e.getSize(N),r.renderState.layers===void 0){const re={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:s};p=new XRWebGLLayer(r,n,re),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),g=new Ar(p.framebufferWidth,p.framebufferHeight,{format:On,type:gi,colorSpace:e.outputColorSpace,stencilBuffer:m.stencil})}else{let re=null,ve=null,me=null;m.depth&&(me=m.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,re=m.stencil?Is:ys,ve=m.stencil?Ds:Tr);const Le={colorFormat:n.RGBA8,depthFormat:me,scaleFactor:s};h=new XRWebGLBinding(r,n),f=h.createProjectionLayer(Le),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),g=new Ar(f.textureWidth,f.textureHeight,{format:On,type:gi,depthTexture:new d_(f.textureWidth,f.textureHeight,ve,void 0,void 0,void 0,void 0,void 0,void 0,re),stencilBuffer:m.stencil,colorSpace:e.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1})}g.isXRRenderTarget=!0,this.setFoveation(l),u=null,o=await r.requestReferenceSpace(a),Fe.setContext(r),Fe.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return y.getDepthTexture()};function V($){for(let re=0;re<$.removed.length;re++){const ve=$.removed[re],me=v.indexOf(ve);me>=0&&(v[me]=null,_[me].disconnect(ve))}for(let re=0;re<$.added.length;re++){const ve=$.added[re];let me=v.indexOf(ve);if(me===-1){for(let Ne=0;Ne<_.length;Ne++)if(Ne>=v.length){v.push(ve),me=Ne;break}else if(v[Ne]===null){v[Ne]=ve,me=Ne;break}if(me===-1)break}const Le=_[me];Le&&Le.connect(ve)}}const W=new G,j=new G;function L($,re,ve){W.setFromMatrixPosition(re.matrixWorld),j.setFromMatrixPosition(ve.matrixWorld);const me=W.distanceTo(j),Le=re.projectionMatrix.elements,Ne=ve.projectionMatrix.elements,Be=Le[14]/(Le[10]-1),he=Le[14]/(Le[10]+1),U=(Le[9]+1)/Le[5],He=(Le[9]-1)/Le[5],ce=(Le[8]-1)/Le[0],ge=(Ne[8]+1)/Ne[0],ue=Be*ce,De=Be*ge,be=me/(-ce+ge),Me=be*-ce;if(re.matrixWorld.decompose($.position,$.quaternion,$.scale),$.translateX(Me),$.translateZ(be),$.matrixWorld.compose($.position,$.quaternion,$.scale),$.matrixWorldInverse.copy($.matrixWorld).invert(),Le[10]===-1)$.projectionMatrix.copy(re.projectionMatrix),$.projectionMatrixInverse.copy(re.projectionMatrixInverse);else{const b=Be+be,M=he+be,X=ue-Me,ee=De+(me-Me),oe=U*he/M*b,ie=He*he/M*b;$.projectionMatrix.makePerspective(X,ee,oe,ie,b,M),$.projectionMatrixInverse.copy($.projectionMatrix).invert()}}function H($,re){re===null?$.matrixWorld.copy($.matrix):$.matrixWorld.multiplyMatrices(re.matrixWorld,$.matrix),$.matrixWorldInverse.copy($.matrixWorld).invert()}this.updateCamera=function($){if(r===null)return;let re=$.near,ve=$.far;y.texture!==null&&(y.depthNear>0&&(re=y.depthNear),y.depthFar>0&&(ve=y.depthFar)),S.near=I.near=w.near=re,S.far=I.far=w.far=ve,(P!==S.near||A!==S.far)&&(r.updateRenderState({depthNear:S.near,depthFar:S.far}),P=S.near,A=S.far);const me=$.parent,Le=S.cameras;H(S,me);for(let Ne=0;Ne<Le.length;Ne++)H(Le[Ne],me);Le.length===2?L(S,w,I):S.projectionMatrix.copy(w.projectionMatrix),K($,S,me)};function K($,re,ve){ve===null?$.matrix.copy(re.matrixWorld):($.matrix.copy(ve.matrixWorld),$.matrix.invert(),$.matrix.multiply(re.matrixWorld)),$.matrix.decompose($.position,$.quaternion,$.scale),$.updateMatrixWorld(!0),$.projectionMatrix.copy(re.projectionMatrix),$.projectionMatrixInverse.copy(re.projectionMatrixInverse),$.isPerspectiveCamera&&($.fov=Vf*2*Math.atan(1/$.projectionMatrix.elements[5]),$.zoom=1)}this.getCamera=function(){return S},this.getFoveation=function(){if(!(f===null&&p===null))return l},this.setFoveation=function($){l=$,f!==null&&(f.fixedFoveation=$),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=$)},this.hasDepthSensing=function(){return y.texture!==null},this.getDepthSensingMesh=function(){return y.getMesh(S)};let te=null;function pe($,re){if(d=re.getViewerPose(u||o),x=re,d!==null){const ve=d.views;p!==null&&(e.setRenderTargetFramebuffer(g,p.framebuffer),e.setRenderTarget(g));let me=!1;ve.length!==S.cameras.length&&(S.cameras.length=0,me=!0);for(let Ne=0;Ne<ve.length;Ne++){const Be=ve[Ne];let he=null;if(p!==null)he=p.getViewport(Be);else{const He=h.getViewSubImage(f,Be);he=He.viewport,Ne===0&&(e.setRenderTargetTextures(g,He.colorTexture,f.ignoreDepthValues?void 0:He.depthStencilTexture),e.setRenderTarget(g))}let U=E[Ne];U===void 0&&(U=new xn,U.layers.enable(Ne),U.viewport=new Et,E[Ne]=U),U.matrix.fromArray(Be.transform.matrix),U.matrix.decompose(U.position,U.quaternion,U.scale),U.projectionMatrix.fromArray(Be.projectionMatrix),U.projectionMatrixInverse.copy(U.projectionMatrix).invert(),U.viewport.set(he.x,he.y,he.width,he.height),Ne===0&&(S.matrix.copy(U.matrix),S.matrix.decompose(S.position,S.quaternion,S.scale)),me===!0&&S.cameras.push(U)}const Le=r.enabledFeatures;if(Le&&Le.includes("depth-sensing")){const Ne=h.getDepthInformation(ve[0]);Ne&&Ne.isValid&&Ne.texture&&y.init(e,Ne,r.renderState)}}for(let ve=0;ve<_.length;ve++){const me=v[ve],Le=_[ve];me!==null&&Le!==void 0&&Le.update(me,re,u||o)}te&&te($,re),re.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:re}),x=null}const Fe=new c_;Fe.setAnimationLoop(pe),this.setAnimationLoop=function($){te=$},this.dispose=function(){}}}const ar=new Vn,Zw=new ct;function Qw(t,e){function n(m,c){m.matrixAutoUpdate===!0&&m.updateMatrix(),c.value.copy(m.matrix)}function i(m,c){c.color.getRGB(m.fogColor.value,a_(t)),c.isFog?(m.fogNear.value=c.near,m.fogFar.value=c.far):c.isFogExp2&&(m.fogDensity.value=c.density)}function r(m,c,g,_,v){c.isMeshBasicMaterial||c.isMeshLambertMaterial?s(m,c):c.isMeshToonMaterial?(s(m,c),h(m,c)):c.isMeshPhongMaterial?(s(m,c),d(m,c)):c.isMeshStandardMaterial?(s(m,c),f(m,c),c.isMeshPhysicalMaterial&&p(m,c,v)):c.isMeshMatcapMaterial?(s(m,c),x(m,c)):c.isMeshDepthMaterial?s(m,c):c.isMeshDistanceMaterial?(s(m,c),y(m,c)):c.isMeshNormalMaterial?s(m,c):c.isLineBasicMaterial?(o(m,c),c.isLineDashedMaterial&&a(m,c)):c.isPointsMaterial?l(m,c,g,_):c.isSpriteMaterial?u(m,c):c.isShadowMaterial?(m.color.value.copy(c.color),m.opacity.value=c.opacity):c.isShaderMaterial&&(c.uniformsNeedUpdate=!1)}function s(m,c){m.opacity.value=c.opacity,c.color&&m.diffuse.value.copy(c.color),c.emissive&&m.emissive.value.copy(c.emissive).multiplyScalar(c.emissiveIntensity),c.map&&(m.map.value=c.map,n(c.map,m.mapTransform)),c.alphaMap&&(m.alphaMap.value=c.alphaMap,n(c.alphaMap,m.alphaMapTransform)),c.bumpMap&&(m.bumpMap.value=c.bumpMap,n(c.bumpMap,m.bumpMapTransform),m.bumpScale.value=c.bumpScale,c.side===nn&&(m.bumpScale.value*=-1)),c.normalMap&&(m.normalMap.value=c.normalMap,n(c.normalMap,m.normalMapTransform),m.normalScale.value.copy(c.normalScale),c.side===nn&&m.normalScale.value.negate()),c.displacementMap&&(m.displacementMap.value=c.displacementMap,n(c.displacementMap,m.displacementMapTransform),m.displacementScale.value=c.displacementScale,m.displacementBias.value=c.displacementBias),c.emissiveMap&&(m.emissiveMap.value=c.emissiveMap,n(c.emissiveMap,m.emissiveMapTransform)),c.specularMap&&(m.specularMap.value=c.specularMap,n(c.specularMap,m.specularMapTransform)),c.alphaTest>0&&(m.alphaTest.value=c.alphaTest);const g=e.get(c),_=g.envMap,v=g.envMapRotation;_&&(m.envMap.value=_,ar.copy(v),ar.x*=-1,ar.y*=-1,ar.z*=-1,_.isCubeTexture&&_.isRenderTargetTexture===!1&&(ar.y*=-1,ar.z*=-1),m.envMapRotation.value.setFromMatrix4(Zw.makeRotationFromEuler(ar)),m.flipEnvMap.value=_.isCubeTexture&&_.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=c.reflectivity,m.ior.value=c.ior,m.refractionRatio.value=c.refractionRatio),c.lightMap&&(m.lightMap.value=c.lightMap,m.lightMapIntensity.value=c.lightMapIntensity,n(c.lightMap,m.lightMapTransform)),c.aoMap&&(m.aoMap.value=c.aoMap,m.aoMapIntensity.value=c.aoMapIntensity,n(c.aoMap,m.aoMapTransform))}function o(m,c){m.diffuse.value.copy(c.color),m.opacity.value=c.opacity,c.map&&(m.map.value=c.map,n(c.map,m.mapTransform))}function a(m,c){m.dashSize.value=c.dashSize,m.totalSize.value=c.dashSize+c.gapSize,m.scale.value=c.scale}function l(m,c,g,_){m.diffuse.value.copy(c.color),m.opacity.value=c.opacity,m.size.value=c.size*g,m.scale.value=_*.5,c.map&&(m.map.value=c.map,n(c.map,m.uvTransform)),c.alphaMap&&(m.alphaMap.value=c.alphaMap,n(c.alphaMap,m.alphaMapTransform)),c.alphaTest>0&&(m.alphaTest.value=c.alphaTest)}function u(m,c){m.diffuse.value.copy(c.color),m.opacity.value=c.opacity,m.rotation.value=c.rotation,c.map&&(m.map.value=c.map,n(c.map,m.mapTransform)),c.alphaMap&&(m.alphaMap.value=c.alphaMap,n(c.alphaMap,m.alphaMapTransform)),c.alphaTest>0&&(m.alphaTest.value=c.alphaTest)}function d(m,c){m.specular.value.copy(c.specular),m.shininess.value=Math.max(c.shininess,1e-4)}function h(m,c){c.gradientMap&&(m.gradientMap.value=c.gradientMap)}function f(m,c){m.metalness.value=c.metalness,c.metalnessMap&&(m.metalnessMap.value=c.metalnessMap,n(c.metalnessMap,m.metalnessMapTransform)),m.roughness.value=c.roughness,c.roughnessMap&&(m.roughnessMap.value=c.roughnessMap,n(c.roughnessMap,m.roughnessMapTransform)),c.envMap&&(m.envMapIntensity.value=c.envMapIntensity)}function p(m,c,g){m.ior.value=c.ior,c.sheen>0&&(m.sheenColor.value.copy(c.sheenColor).multiplyScalar(c.sheen),m.sheenRoughness.value=c.sheenRoughness,c.sheenColorMap&&(m.sheenColorMap.value=c.sheenColorMap,n(c.sheenColorMap,m.sheenColorMapTransform)),c.sheenRoughnessMap&&(m.sheenRoughnessMap.value=c.sheenRoughnessMap,n(c.sheenRoughnessMap,m.sheenRoughnessMapTransform))),c.clearcoat>0&&(m.clearcoat.value=c.clearcoat,m.clearcoatRoughness.value=c.clearcoatRoughness,c.clearcoatMap&&(m.clearcoatMap.value=c.clearcoatMap,n(c.clearcoatMap,m.clearcoatMapTransform)),c.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=c.clearcoatRoughnessMap,n(c.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),c.clearcoatNormalMap&&(m.clearcoatNormalMap.value=c.clearcoatNormalMap,n(c.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(c.clearcoatNormalScale),c.side===nn&&m.clearcoatNormalScale.value.negate())),c.dispersion>0&&(m.dispersion.value=c.dispersion),c.iridescence>0&&(m.iridescence.value=c.iridescence,m.iridescenceIOR.value=c.iridescenceIOR,m.iridescenceThicknessMinimum.value=c.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=c.iridescenceThicknessRange[1],c.iridescenceMap&&(m.iridescenceMap.value=c.iridescenceMap,n(c.iridescenceMap,m.iridescenceMapTransform)),c.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=c.iridescenceThicknessMap,n(c.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),c.transmission>0&&(m.transmission.value=c.transmission,m.transmissionSamplerMap.value=g.texture,m.transmissionSamplerSize.value.set(g.width,g.height),c.transmissionMap&&(m.transmissionMap.value=c.transmissionMap,n(c.transmissionMap,m.transmissionMapTransform)),m.thickness.value=c.thickness,c.thicknessMap&&(m.thicknessMap.value=c.thicknessMap,n(c.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=c.attenuationDistance,m.attenuationColor.value.copy(c.attenuationColor)),c.anisotropy>0&&(m.anisotropyVector.value.set(c.anisotropy*Math.cos(c.anisotropyRotation),c.anisotropy*Math.sin(c.anisotropyRotation)),c.anisotropyMap&&(m.anisotropyMap.value=c.anisotropyMap,n(c.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=c.specularIntensity,m.specularColor.value.copy(c.specularColor),c.specularColorMap&&(m.specularColorMap.value=c.specularColorMap,n(c.specularColorMap,m.specularColorMapTransform)),c.specularIntensityMap&&(m.specularIntensityMap.value=c.specularIntensityMap,n(c.specularIntensityMap,m.specularIntensityMapTransform))}function x(m,c){c.matcap&&(m.matcap.value=c.matcap)}function y(m,c){const g=e.get(c).light;m.referencePosition.value.setFromMatrixPosition(g.matrixWorld),m.nearDistance.value=g.shadow.camera.near,m.farDistance.value=g.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function Jw(t,e,n,i){let r={},s={},o=[];const a=t.getParameter(t.MAX_UNIFORM_BUFFER_BINDINGS);function l(g,_){const v=_.program;i.uniformBlockBinding(g,v)}function u(g,_){let v=r[g.id];v===void 0&&(x(g),v=d(g),r[g.id]=v,g.addEventListener("dispose",m));const N=_.program;i.updateUBOMapping(g,N);const C=e.render.frame;s[g.id]!==C&&(f(g),s[g.id]=C)}function d(g){const _=h();g.__bindingPointIndex=_;const v=t.createBuffer(),N=g.__size,C=g.usage;return t.bindBuffer(t.UNIFORM_BUFFER,v),t.bufferData(t.UNIFORM_BUFFER,N,C),t.bindBuffer(t.UNIFORM_BUFFER,null),t.bindBufferBase(t.UNIFORM_BUFFER,_,v),v}function h(){for(let g=0;g<a;g++)if(o.indexOf(g)===-1)return o.push(g),g;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(g){const _=r[g.id],v=g.uniforms,N=g.__cache;t.bindBuffer(t.UNIFORM_BUFFER,_);for(let C=0,w=v.length;C<w;C++){const I=Array.isArray(v[C])?v[C]:[v[C]];for(let E=0,S=I.length;E<S;E++){const P=I[E];if(p(P,C,E,N)===!0){const A=P.__offset,F=Array.isArray(P.value)?P.value:[P.value];let Y=0;for(let V=0;V<F.length;V++){const W=F[V],j=y(W);typeof W=="number"||typeof W=="boolean"?(P.__data[0]=W,t.bufferSubData(t.UNIFORM_BUFFER,A+Y,P.__data)):W.isMatrix3?(P.__data[0]=W.elements[0],P.__data[1]=W.elements[1],P.__data[2]=W.elements[2],P.__data[3]=0,P.__data[4]=W.elements[3],P.__data[5]=W.elements[4],P.__data[6]=W.elements[5],P.__data[7]=0,P.__data[8]=W.elements[6],P.__data[9]=W.elements[7],P.__data[10]=W.elements[8],P.__data[11]=0):(W.toArray(P.__data,Y),Y+=j.storage/Float32Array.BYTES_PER_ELEMENT)}t.bufferSubData(t.UNIFORM_BUFFER,A,P.__data)}}}t.bindBuffer(t.UNIFORM_BUFFER,null)}function p(g,_,v,N){const C=g.value,w=_+"_"+v;if(N[w]===void 0)return typeof C=="number"||typeof C=="boolean"?N[w]=C:N[w]=C.clone(),!0;{const I=N[w];if(typeof C=="number"||typeof C=="boolean"){if(I!==C)return N[w]=C,!0}else if(I.equals(C)===!1)return I.copy(C),!0}return!1}function x(g){const _=g.uniforms;let v=0;const N=16;for(let w=0,I=_.length;w<I;w++){const E=Array.isArray(_[w])?_[w]:[_[w]];for(let S=0,P=E.length;S<P;S++){const A=E[S],F=Array.isArray(A.value)?A.value:[A.value];for(let Y=0,V=F.length;Y<V;Y++){const W=F[Y],j=y(W),L=v%N,H=L%j.boundary,K=L+H;v+=H,K!==0&&N-K<j.storage&&(v+=N-K),A.__data=new Float32Array(j.storage/Float32Array.BYTES_PER_ELEMENT),A.__offset=v,v+=j.storage}}}const C=v%N;return C>0&&(v+=N-C),g.__size=v,g.__cache={},this}function y(g){const _={boundary:0,storage:0};return typeof g=="number"||typeof g=="boolean"?(_.boundary=4,_.storage=4):g.isVector2?(_.boundary=8,_.storage=8):g.isVector3||g.isColor?(_.boundary=16,_.storage=12):g.isVector4?(_.boundary=16,_.storage=16):g.isMatrix3?(_.boundary=48,_.storage=48):g.isMatrix4?(_.boundary=64,_.storage=64):g.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",g),_}function m(g){const _=g.target;_.removeEventListener("dispose",m);const v=o.indexOf(_.__bindingPointIndex);o.splice(v,1),t.deleteBuffer(r[_.id]),delete r[_.id],delete s[_.id]}function c(){for(const g in r)t.deleteBuffer(r[g]);o=[],r={},s={}}return{bind:l,update:u,dispose:c}}class eT{constructor(e={}){const{canvas:n=Wy(),context:i=null,depth:r=!0,stencil:s=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:u=!1,powerPreference:d="default",failIfMajorPerformanceCaveat:h=!1}=e;this.isWebGLRenderer=!0;let f;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");f=i.getContextAttributes().alpha}else f=o;const p=new Uint32Array(4),x=new Int32Array(4);let y=null,m=null;const c=[],g=[];this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=jn,this.toneMapping=Wi,this.toneMappingExposure=1;const _=this;let v=!1,N=0,C=0,w=null,I=-1,E=null;const S=new Et,P=new Et;let A=null;const F=new Ge(0);let Y=0,V=n.width,W=n.height,j=1,L=null,H=null;const K=new Et(0,0,V,W),te=new Et(0,0,V,W);let pe=!1;const Fe=new Qd;let $=!1,re=!1;const ve=new ct,me=new G,Le=new Et,Ne={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Be=!1;function he(){return w===null?j:1}let U=i;function He(T,k){return n.getContext(T,k)}try{const T={alpha:!0,depth:r,stencil:s,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:u,powerPreference:d,failIfMajorPerformanceCaveat:h};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${Hd}`),n.addEventListener("webglcontextlost",ne,!1),n.addEventListener("webglcontextrestored",se,!1),n.addEventListener("webglcontextcreationerror",_e,!1),U===null){const k="webgl2";if(U=He(k,T),U===null)throw He(k)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(T){throw console.error("THREE.WebGLRenderer: "+T.message),T}let ce,ge,ue,De,be,Me,b,M,X,ee,oe,ie,Pe,xe,J,D,R,Q,ae,Se,Te,Ve,Xe,st;function O(){ce=new o1(U),ce.init(),Ve=new Ww(U,ce),ge=new e1(U,ce,e,Ve),ue=new Hw(U),De=new u1(U),be=new Cw,Me=new Gw(U,ce,ue,be,ge,Ve,De),b=new n1(_),M=new s1(_),X=new gS(U),Xe=new QE(U,X),ee=new a1(U,X,De,Xe),oe=new f1(U,ee,X,De),ae=new c1(U,ge,Me),D=new t1(be),ie=new Aw(_,b,M,ce,ge,Xe,D),Pe=new Qw(_,be),xe=new bw,J=new Nw(ce),Q=new ZE(_,b,M,ue,oe,f,l),R=new Bw(_,oe,ge),st=new Jw(U,De,ge,ue),Se=new JE(U,ce,De),Te=new l1(U,ce,De),De.programs=ie.programs,_.capabilities=ge,_.extensions=ce,_.properties=be,_.renderLists=xe,_.shadowMap=R,_.state=ue,_.info=De}O();const fe=new Kw(_,U);this.xr=fe,this.getContext=function(){return U},this.getContextAttributes=function(){return U.getContextAttributes()},this.forceContextLoss=function(){const T=ce.get("WEBGL_lose_context");T&&T.loseContext()},this.forceContextRestore=function(){const T=ce.get("WEBGL_lose_context");T&&T.restoreContext()},this.getPixelRatio=function(){return j},this.setPixelRatio=function(T){T!==void 0&&(j=T,this.setSize(V,W,!1))},this.getSize=function(T){return T.set(V,W)},this.setSize=function(T,k,q=!0){if(fe.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}V=T,W=k,n.width=Math.floor(T*j),n.height=Math.floor(k*j),q===!0&&(n.style.width=T+"px",n.style.height=k+"px"),this.setViewport(0,0,T,k)},this.getDrawingBufferSize=function(T){return T.set(V*j,W*j).floor()},this.setDrawingBufferSize=function(T,k,q){V=T,W=k,j=q,n.width=Math.floor(T*q),n.height=Math.floor(k*q),this.setViewport(0,0,T,k)},this.getCurrentViewport=function(T){return T.copy(S)},this.getViewport=function(T){return T.copy(K)},this.setViewport=function(T,k,q,Z){T.isVector4?K.set(T.x,T.y,T.z,T.w):K.set(T,k,q,Z),ue.viewport(S.copy(K).multiplyScalar(j).round())},this.getScissor=function(T){return T.copy(te)},this.setScissor=function(T,k,q,Z){T.isVector4?te.set(T.x,T.y,T.z,T.w):te.set(T,k,q,Z),ue.scissor(P.copy(te).multiplyScalar(j).round())},this.getScissorTest=function(){return pe},this.setScissorTest=function(T){ue.setScissorTest(pe=T)},this.setOpaqueSort=function(T){L=T},this.setTransparentSort=function(T){H=T},this.getClearColor=function(T){return T.copy(Q.getClearColor())},this.setClearColor=function(){Q.setClearColor.apply(Q,arguments)},this.getClearAlpha=function(){return Q.getClearAlpha()},this.setClearAlpha=function(){Q.setClearAlpha.apply(Q,arguments)},this.clear=function(T=!0,k=!0,q=!0){let Z=0;if(T){let B=!1;if(w!==null){const de=w.texture.format;B=de===Yd||de===jd||de===Xd}if(B){const de=w.texture.type,Ee=de===gi||de===Tr||de===No||de===Ds||de===Gd||de===Wd,Ce=Q.getClearColor(),Re=Q.getClearAlpha(),ke=Ce.r,ze=Ce.g,Ie=Ce.b;Ee?(p[0]=ke,p[1]=ze,p[2]=Ie,p[3]=Re,U.clearBufferuiv(U.COLOR,0,p)):(x[0]=ke,x[1]=ze,x[2]=Ie,x[3]=Re,U.clearBufferiv(U.COLOR,0,x))}else Z|=U.COLOR_BUFFER_BIT}k&&(Z|=U.DEPTH_BUFFER_BIT),q&&(Z|=U.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),U.clear(Z)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){n.removeEventListener("webglcontextlost",ne,!1),n.removeEventListener("webglcontextrestored",se,!1),n.removeEventListener("webglcontextcreationerror",_e,!1),xe.dispose(),J.dispose(),be.dispose(),b.dispose(),M.dispose(),oe.dispose(),Xe.dispose(),st.dispose(),ie.dispose(),fe.dispose(),fe.removeEventListener("sessionstart",Gn),fe.removeEventListener("sessionend",th),tr.stop()};function ne(T){T.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),v=!0}function se(){console.log("THREE.WebGLRenderer: Context Restored."),v=!1;const T=De.autoReset,k=R.enabled,q=R.autoUpdate,Z=R.needsUpdate,B=R.type;O(),De.autoReset=T,R.enabled=k,R.autoUpdate=q,R.needsUpdate=Z,R.type=B}function _e(T){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",T.statusMessage)}function Oe(T){const k=T.target;k.removeEventListener("dispose",Oe),qe(k)}function qe(T){vt(T),be.remove(T)}function vt(T){const k=be.get(T).programs;k!==void 0&&(k.forEach(function(q){ie.releaseProgram(q)}),T.isShaderMaterial&&ie.releaseShaderCache(T))}this.renderBufferDirect=function(T,k,q,Z,B,de){k===null&&(k=Ne);const Ee=B.isMesh&&B.matrixWorld.determinant()<0,Ce=y_(T,k,q,Z,B);ue.setMaterial(Z,Ee);let Re=q.index,ke=1;if(Z.wireframe===!0){if(Re=ee.getWireframeAttribute(q),Re===void 0)return;ke=2}const ze=q.drawRange,Ie=q.attributes.position;let Qe=ze.start*ke,pt=(ze.start+ze.count)*ke;de!==null&&(Qe=Math.max(Qe,de.start*ke),pt=Math.min(pt,(de.start+de.count)*ke)),Re!==null?(Qe=Math.max(Qe,0),pt=Math.min(pt,Re.count)):Ie!=null&&(Qe=Math.max(Qe,0),pt=Math.min(pt,Ie.count));const mt=pt-Qe;if(mt<0||mt===1/0)return;Xe.setup(B,Z,Ce,q,Re);let rn,Je=Se;if(Re!==null&&(rn=X.get(Re),Je=Te,Je.setIndex(rn)),B.isMesh)Z.wireframe===!0?(ue.setLineWidth(Z.wireframeLinewidth*he()),Je.setMode(U.LINES)):Je.setMode(U.TRIANGLES);else if(B.isLine){let Ue=Z.linewidth;Ue===void 0&&(Ue=1),ue.setLineWidth(Ue*he()),B.isLineSegments?Je.setMode(U.LINES):B.isLineLoop?Je.setMode(U.LINE_LOOP):Je.setMode(U.LINE_STRIP)}else B.isPoints?Je.setMode(U.POINTS):B.isSprite&&Je.setMode(U.TRIANGLES);if(B.isBatchedMesh)if(B._multiDrawInstances!==null)Je.renderMultiDrawInstances(B._multiDrawStarts,B._multiDrawCounts,B._multiDrawCount,B._multiDrawInstances);else if(ce.get("WEBGL_multi_draw"))Je.renderMultiDraw(B._multiDrawStarts,B._multiDrawCounts,B._multiDrawCount);else{const Ue=B._multiDrawStarts,Dt=B._multiDrawCounts,et=B._multiDrawCount,Cn=Re?X.get(Re).bytesPerElement:1,Pr=be.get(Z).currentProgram.getUniforms();for(let sn=0;sn<et;sn++)Pr.setValue(U,"_gl_DrawID",sn),Je.render(Ue[sn]/Cn,Dt[sn])}else if(B.isInstancedMesh)Je.renderInstances(Qe,mt,B.count);else if(q.isInstancedBufferGeometry){const Ue=q._maxInstanceCount!==void 0?q._maxInstanceCount:1/0,Dt=Math.min(q.instanceCount,Ue);Je.renderInstances(Qe,mt,Dt)}else Je.render(Qe,mt)};function Lt(T,k,q){T.transparent===!0&&T.side===Nn&&T.forceSinglePass===!1?(T.side=nn,T.needsUpdate=!0,Xo(T,k,q),T.side=$i,T.needsUpdate=!0,Xo(T,k,q),T.side=Nn):Xo(T,k,q)}this.compile=function(T,k,q=null){q===null&&(q=T),m=J.get(q),m.init(k),g.push(m),q.traverseVisible(function(B){B.isLight&&B.layers.test(k.layers)&&(m.pushLight(B),B.castShadow&&m.pushShadow(B))}),T!==q&&T.traverseVisible(function(B){B.isLight&&B.layers.test(k.layers)&&(m.pushLight(B),B.castShadow&&m.pushShadow(B))}),m.setupLights();const Z=new Set;return T.traverse(function(B){const de=B.material;if(de)if(Array.isArray(de))for(let Ee=0;Ee<de.length;Ee++){const Ce=de[Ee];Lt(Ce,q,B),Z.add(Ce)}else Lt(de,q,B),Z.add(de)}),g.pop(),m=null,Z},this.compileAsync=function(T,k,q=null){const Z=this.compile(T,k,q);return new Promise(B=>{function de(){if(Z.forEach(function(Ee){be.get(Ee).currentProgram.isReady()&&Z.delete(Ee)}),Z.size===0){B(T);return}setTimeout(de,10)}ce.get("KHR_parallel_shader_compile")!==null?de():setTimeout(de,10)})};let Ze=null;function Qn(T){Ze&&Ze(T)}function Gn(){tr.stop()}function th(){tr.start()}const tr=new c_;tr.setAnimationLoop(Qn),typeof self<"u"&&tr.setContext(self),this.setAnimationLoop=function(T){Ze=T,fe.setAnimationLoop(T),T===null?tr.stop():tr.start()},fe.addEventListener("sessionstart",Gn),fe.addEventListener("sessionend",th),this.render=function(T,k){if(k!==void 0&&k.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(v===!0)return;if(T.matrixWorldAutoUpdate===!0&&T.updateMatrixWorld(),k.parent===null&&k.matrixWorldAutoUpdate===!0&&k.updateMatrixWorld(),fe.enabled===!0&&fe.isPresenting===!0&&(fe.cameraAutoUpdate===!0&&fe.updateCamera(k),k=fe.getCamera()),T.isScene===!0&&T.onBeforeRender(_,T,k,w),m=J.get(T,g.length),m.init(k),g.push(m),ve.multiplyMatrices(k.projectionMatrix,k.matrixWorldInverse),Fe.setFromProjectionMatrix(ve),re=this.localClippingEnabled,$=D.init(this.clippingPlanes,re),y=xe.get(T,c.length),y.init(),c.push(y),fe.enabled===!0&&fe.isPresenting===!0){const de=_.xr.getDepthSensingMesh();de!==null&&au(de,k,-1/0,_.sortObjects)}au(T,k,0,_.sortObjects),y.finish(),_.sortObjects===!0&&y.sort(L,H),Be=fe.enabled===!1||fe.isPresenting===!1||fe.hasDepthSensing()===!1,Be&&Q.addToRenderList(y,T),this.info.render.frame++,$===!0&&D.beginShadows();const q=m.state.shadowsArray;R.render(q,T,k),$===!0&&D.endShadows(),this.info.autoReset===!0&&this.info.reset();const Z=y.opaque,B=y.transmissive;if(m.setupLights(),k.isArrayCamera){const de=k.cameras;if(B.length>0)for(let Ee=0,Ce=de.length;Ee<Ce;Ee++){const Re=de[Ee];ih(Z,B,T,Re)}Be&&Q.render(T);for(let Ee=0,Ce=de.length;Ee<Ce;Ee++){const Re=de[Ee];nh(y,T,Re,Re.viewport)}}else B.length>0&&ih(Z,B,T,k),Be&&Q.render(T),nh(y,T,k);w!==null&&(Me.updateMultisampleRenderTarget(w),Me.updateRenderTargetMipmap(w)),T.isScene===!0&&T.onAfterRender(_,T,k),Xe.resetDefaultState(),I=-1,E=null,g.pop(),g.length>0?(m=g[g.length-1],$===!0&&D.setGlobalState(_.clippingPlanes,m.state.camera)):m=null,c.pop(),c.length>0?y=c[c.length-1]:y=null};function au(T,k,q,Z){if(T.visible===!1)return;if(T.layers.test(k.layers)){if(T.isGroup)q=T.renderOrder;else if(T.isLOD)T.autoUpdate===!0&&T.update(k);else if(T.isLight)m.pushLight(T),T.castShadow&&m.pushShadow(T);else if(T.isSprite){if(!T.frustumCulled||Fe.intersectsSprite(T)){Z&&Le.setFromMatrixPosition(T.matrixWorld).applyMatrix4(ve);const Ee=oe.update(T),Ce=T.material;Ce.visible&&y.push(T,Ee,Ce,q,Le.z,null)}}else if((T.isMesh||T.isLine||T.isPoints)&&(!T.frustumCulled||Fe.intersectsObject(T))){const Ee=oe.update(T),Ce=T.material;if(Z&&(T.boundingSphere!==void 0?(T.boundingSphere===null&&T.computeBoundingSphere(),Le.copy(T.boundingSphere.center)):(Ee.boundingSphere===null&&Ee.computeBoundingSphere(),Le.copy(Ee.boundingSphere.center)),Le.applyMatrix4(T.matrixWorld).applyMatrix4(ve)),Array.isArray(Ce)){const Re=Ee.groups;for(let ke=0,ze=Re.length;ke<ze;ke++){const Ie=Re[ke],Qe=Ce[Ie.materialIndex];Qe&&Qe.visible&&y.push(T,Ee,Qe,q,Le.z,Ie)}}else Ce.visible&&y.push(T,Ee,Ce,q,Le.z,null)}}const de=T.children;for(let Ee=0,Ce=de.length;Ee<Ce;Ee++)au(de[Ee],k,q,Z)}function nh(T,k,q,Z){const B=T.opaque,de=T.transmissive,Ee=T.transparent;m.setupLightsView(q),$===!0&&D.setGlobalState(_.clippingPlanes,q),Z&&ue.viewport(S.copy(Z)),B.length>0&&Wo(B,k,q),de.length>0&&Wo(de,k,q),Ee.length>0&&Wo(Ee,k,q),ue.buffers.depth.setTest(!0),ue.buffers.depth.setMask(!0),ue.buffers.color.setMask(!0),ue.setPolygonOffset(!1)}function ih(T,k,q,Z){if((q.isScene===!0?q.overrideMaterial:null)!==null)return;m.state.transmissionRenderTarget[Z.id]===void 0&&(m.state.transmissionRenderTarget[Z.id]=new Ar(1,1,{generateMipmaps:!0,type:ce.has("EXT_color_buffer_half_float")||ce.has("EXT_color_buffer_float")?Ho:gi,minFilter:_r,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:tt.workingColorSpace}));const de=m.state.transmissionRenderTarget[Z.id],Ee=Z.viewport||S;de.setSize(Ee.z,Ee.w);const Ce=_.getRenderTarget();_.setRenderTarget(de),_.getClearColor(F),Y=_.getClearAlpha(),Y<1&&_.setClearColor(16777215,.5),_.clear(),Be&&Q.render(q);const Re=_.toneMapping;_.toneMapping=Wi;const ke=Z.viewport;if(Z.viewport!==void 0&&(Z.viewport=void 0),m.setupLightsView(Z),$===!0&&D.setGlobalState(_.clippingPlanes,Z),Wo(T,q,Z),Me.updateMultisampleRenderTarget(de),Me.updateRenderTargetMipmap(de),ce.has("WEBGL_multisampled_render_to_texture")===!1){let ze=!1;for(let Ie=0,Qe=k.length;Ie<Qe;Ie++){const pt=k[Ie],mt=pt.object,rn=pt.geometry,Je=pt.material,Ue=pt.group;if(Je.side===Nn&&mt.layers.test(Z.layers)){const Dt=Je.side;Je.side=nn,Je.needsUpdate=!0,rh(mt,q,Z,rn,Je,Ue),Je.side=Dt,Je.needsUpdate=!0,ze=!0}}ze===!0&&(Me.updateMultisampleRenderTarget(de),Me.updateRenderTargetMipmap(de))}_.setRenderTarget(Ce),_.setClearColor(F,Y),ke!==void 0&&(Z.viewport=ke),_.toneMapping=Re}function Wo(T,k,q){const Z=k.isScene===!0?k.overrideMaterial:null;for(let B=0,de=T.length;B<de;B++){const Ee=T[B],Ce=Ee.object,Re=Ee.geometry,ke=Z===null?Ee.material:Z,ze=Ee.group;Ce.layers.test(q.layers)&&rh(Ce,k,q,Re,ke,ze)}}function rh(T,k,q,Z,B,de){T.onBeforeRender(_,k,q,Z,B,de),T.modelViewMatrix.multiplyMatrices(q.matrixWorldInverse,T.matrixWorld),T.normalMatrix.getNormalMatrix(T.modelViewMatrix),B.onBeforeRender(_,k,q,Z,T,de),B.transparent===!0&&B.side===Nn&&B.forceSinglePass===!1?(B.side=nn,B.needsUpdate=!0,_.renderBufferDirect(q,k,Z,B,T,de),B.side=$i,B.needsUpdate=!0,_.renderBufferDirect(q,k,Z,B,T,de),B.side=Nn):_.renderBufferDirect(q,k,Z,B,T,de),T.onAfterRender(_,k,q,Z,B,de)}function Xo(T,k,q){k.isScene!==!0&&(k=Ne);const Z=be.get(T),B=m.state.lights,de=m.state.shadowsArray,Ee=B.state.version,Ce=ie.getParameters(T,B.state,de,k,q),Re=ie.getProgramCacheKey(Ce);let ke=Z.programs;Z.environment=T.isMeshStandardMaterial?k.environment:null,Z.fog=k.fog,Z.envMap=(T.isMeshStandardMaterial?M:b).get(T.envMap||Z.environment),Z.envMapRotation=Z.environment!==null&&T.envMap===null?k.environmentRotation:T.envMapRotation,ke===void 0&&(T.addEventListener("dispose",Oe),ke=new Map,Z.programs=ke);let ze=ke.get(Re);if(ze!==void 0){if(Z.currentProgram===ze&&Z.lightsStateVersion===Ee)return oh(T,Ce),ze}else Ce.uniforms=ie.getUniforms(T),T.onBeforeCompile(Ce,_),ze=ie.acquireProgram(Ce,Re),ke.set(Re,ze),Z.uniforms=Ce.uniforms;const Ie=Z.uniforms;return(!T.isShaderMaterial&&!T.isRawShaderMaterial||T.clipping===!0)&&(Ie.clippingPlanes=D.uniform),oh(T,Ce),Z.needsLights=M_(T),Z.lightsStateVersion=Ee,Z.needsLights&&(Ie.ambientLightColor.value=B.state.ambient,Ie.lightProbe.value=B.state.probe,Ie.directionalLights.value=B.state.directional,Ie.directionalLightShadows.value=B.state.directionalShadow,Ie.spotLights.value=B.state.spot,Ie.spotLightShadows.value=B.state.spotShadow,Ie.rectAreaLights.value=B.state.rectArea,Ie.ltc_1.value=B.state.rectAreaLTC1,Ie.ltc_2.value=B.state.rectAreaLTC2,Ie.pointLights.value=B.state.point,Ie.pointLightShadows.value=B.state.pointShadow,Ie.hemisphereLights.value=B.state.hemi,Ie.directionalShadowMap.value=B.state.directionalShadowMap,Ie.directionalShadowMatrix.value=B.state.directionalShadowMatrix,Ie.spotShadowMap.value=B.state.spotShadowMap,Ie.spotLightMatrix.value=B.state.spotLightMatrix,Ie.spotLightMap.value=B.state.spotLightMap,Ie.pointShadowMap.value=B.state.pointShadowMap,Ie.pointShadowMatrix.value=B.state.pointShadowMatrix),Z.currentProgram=ze,Z.uniformsList=null,ze}function sh(T){if(T.uniformsList===null){const k=T.currentProgram.getUniforms();T.uniformsList=sl.seqWithValue(k.seq,T.uniforms)}return T.uniformsList}function oh(T,k){const q=be.get(T);q.outputColorSpace=k.outputColorSpace,q.batching=k.batching,q.batchingColor=k.batchingColor,q.instancing=k.instancing,q.instancingColor=k.instancingColor,q.instancingMorph=k.instancingMorph,q.skinning=k.skinning,q.morphTargets=k.morphTargets,q.morphNormals=k.morphNormals,q.morphColors=k.morphColors,q.morphTargetsCount=k.morphTargetsCount,q.numClippingPlanes=k.numClippingPlanes,q.numIntersection=k.numClipIntersection,q.vertexAlphas=k.vertexAlphas,q.vertexTangents=k.vertexTangents,q.toneMapping=k.toneMapping}function y_(T,k,q,Z,B){k.isScene!==!0&&(k=Ne),Me.resetTextureUnits();const de=k.fog,Ee=Z.isMeshStandardMaterial?k.environment:null,Ce=w===null?_.outputColorSpace:w.isXRRenderTarget===!0?w.texture.colorSpace:Ji,Re=(Z.isMeshStandardMaterial?M:b).get(Z.envMap||Ee),ke=Z.vertexColors===!0&&!!q.attributes.color&&q.attributes.color.itemSize===4,ze=!!q.attributes.tangent&&(!!Z.normalMap||Z.anisotropy>0),Ie=!!q.morphAttributes.position,Qe=!!q.morphAttributes.normal,pt=!!q.morphAttributes.color;let mt=Wi;Z.toneMapped&&(w===null||w.isXRRenderTarget===!0)&&(mt=_.toneMapping);const rn=q.morphAttributes.position||q.morphAttributes.normal||q.morphAttributes.color,Je=rn!==void 0?rn.length:0,Ue=be.get(Z),Dt=m.state.lights;if($===!0&&(re===!0||T!==E)){const mn=T===E&&Z.id===I;D.setState(Z,T,mn)}let et=!1;Z.version===Ue.__version?(Ue.needsLights&&Ue.lightsStateVersion!==Dt.state.version||Ue.outputColorSpace!==Ce||B.isBatchedMesh&&Ue.batching===!1||!B.isBatchedMesh&&Ue.batching===!0||B.isBatchedMesh&&Ue.batchingColor===!0&&B.colorTexture===null||B.isBatchedMesh&&Ue.batchingColor===!1&&B.colorTexture!==null||B.isInstancedMesh&&Ue.instancing===!1||!B.isInstancedMesh&&Ue.instancing===!0||B.isSkinnedMesh&&Ue.skinning===!1||!B.isSkinnedMesh&&Ue.skinning===!0||B.isInstancedMesh&&Ue.instancingColor===!0&&B.instanceColor===null||B.isInstancedMesh&&Ue.instancingColor===!1&&B.instanceColor!==null||B.isInstancedMesh&&Ue.instancingMorph===!0&&B.morphTexture===null||B.isInstancedMesh&&Ue.instancingMorph===!1&&B.morphTexture!==null||Ue.envMap!==Re||Z.fog===!0&&Ue.fog!==de||Ue.numClippingPlanes!==void 0&&(Ue.numClippingPlanes!==D.numPlanes||Ue.numIntersection!==D.numIntersection)||Ue.vertexAlphas!==ke||Ue.vertexTangents!==ze||Ue.morphTargets!==Ie||Ue.morphNormals!==Qe||Ue.morphColors!==pt||Ue.toneMapping!==mt||Ue.morphTargetsCount!==Je)&&(et=!0):(et=!0,Ue.__version=Z.version);let Cn=Ue.currentProgram;et===!0&&(Cn=Xo(Z,k,B));let Pr=!1,sn=!1,lu=!1;const xt=Cn.getUniforms(),vi=Ue.uniforms;if(ue.useProgram(Cn.program)&&(Pr=!0,sn=!0,lu=!0),Z.id!==I&&(I=Z.id,sn=!0),Pr||E!==T){xt.setValue(U,"projectionMatrix",T.projectionMatrix),xt.setValue(U,"viewMatrix",T.matrixWorldInverse);const mn=xt.map.cameraPosition;mn!==void 0&&mn.setValue(U,me.setFromMatrixPosition(T.matrixWorld)),ge.logarithmicDepthBuffer&&xt.setValue(U,"logDepthBufFC",2/(Math.log(T.far+1)/Math.LN2)),(Z.isMeshPhongMaterial||Z.isMeshToonMaterial||Z.isMeshLambertMaterial||Z.isMeshBasicMaterial||Z.isMeshStandardMaterial||Z.isShaderMaterial)&&xt.setValue(U,"isOrthographic",T.isOrthographicCamera===!0),E!==T&&(E=T,sn=!0,lu=!0)}if(B.isSkinnedMesh){xt.setOptional(U,B,"bindMatrix"),xt.setOptional(U,B,"bindMatrixInverse");const mn=B.skeleton;mn&&(mn.boneTexture===null&&mn.computeBoneTexture(),xt.setValue(U,"boneTexture",mn.boneTexture,Me))}B.isBatchedMesh&&(xt.setOptional(U,B,"batchingTexture"),xt.setValue(U,"batchingTexture",B._matricesTexture,Me),xt.setOptional(U,B,"batchingIdTexture"),xt.setValue(U,"batchingIdTexture",B._indirectTexture,Me),xt.setOptional(U,B,"batchingColorTexture"),B._colorsTexture!==null&&xt.setValue(U,"batchingColorTexture",B._colorsTexture,Me));const uu=q.morphAttributes;if((uu.position!==void 0||uu.normal!==void 0||uu.color!==void 0)&&ae.update(B,q,Cn),(sn||Ue.receiveShadow!==B.receiveShadow)&&(Ue.receiveShadow=B.receiveShadow,xt.setValue(U,"receiveShadow",B.receiveShadow)),Z.isMeshGouraudMaterial&&Z.envMap!==null&&(vi.envMap.value=Re,vi.flipEnvMap.value=Re.isCubeTexture&&Re.isRenderTargetTexture===!1?-1:1),Z.isMeshStandardMaterial&&Z.envMap===null&&k.environment!==null&&(vi.envMapIntensity.value=k.environmentIntensity),sn&&(xt.setValue(U,"toneMappingExposure",_.toneMappingExposure),Ue.needsLights&&S_(vi,lu),de&&Z.fog===!0&&Pe.refreshFogUniforms(vi,de),Pe.refreshMaterialUniforms(vi,Z,j,W,m.state.transmissionRenderTarget[T.id]),sl.upload(U,sh(Ue),vi,Me)),Z.isShaderMaterial&&Z.uniformsNeedUpdate===!0&&(sl.upload(U,sh(Ue),vi,Me),Z.uniformsNeedUpdate=!1),Z.isSpriteMaterial&&xt.setValue(U,"center",B.center),xt.setValue(U,"modelViewMatrix",B.modelViewMatrix),xt.setValue(U,"normalMatrix",B.normalMatrix),xt.setValue(U,"modelMatrix",B.matrixWorld),Z.isShaderMaterial||Z.isRawShaderMaterial){const mn=Z.uniformsGroups;for(let cu=0,E_=mn.length;cu<E_;cu++){const ah=mn[cu];st.update(ah,Cn),st.bind(ah,Cn)}}return Cn}function S_(T,k){T.ambientLightColor.needsUpdate=k,T.lightProbe.needsUpdate=k,T.directionalLights.needsUpdate=k,T.directionalLightShadows.needsUpdate=k,T.pointLights.needsUpdate=k,T.pointLightShadows.needsUpdate=k,T.spotLights.needsUpdate=k,T.spotLightShadows.needsUpdate=k,T.rectAreaLights.needsUpdate=k,T.hemisphereLights.needsUpdate=k}function M_(T){return T.isMeshLambertMaterial||T.isMeshToonMaterial||T.isMeshPhongMaterial||T.isMeshStandardMaterial||T.isShadowMaterial||T.isShaderMaterial&&T.lights===!0}this.getActiveCubeFace=function(){return N},this.getActiveMipmapLevel=function(){return C},this.getRenderTarget=function(){return w},this.setRenderTargetTextures=function(T,k,q){be.get(T.texture).__webglTexture=k,be.get(T.depthTexture).__webglTexture=q;const Z=be.get(T);Z.__hasExternalTextures=!0,Z.__autoAllocateDepthBuffer=q===void 0,Z.__autoAllocateDepthBuffer||ce.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),Z.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(T,k){const q=be.get(T);q.__webglFramebuffer=k,q.__useDefaultFramebuffer=k===void 0},this.setRenderTarget=function(T,k=0,q=0){w=T,N=k,C=q;let Z=!0,B=null,de=!1,Ee=!1;if(T){const Re=be.get(T);if(Re.__useDefaultFramebuffer!==void 0)ue.bindFramebuffer(U.FRAMEBUFFER,null),Z=!1;else if(Re.__webglFramebuffer===void 0)Me.setupRenderTarget(T);else if(Re.__hasExternalTextures)Me.rebindTextures(T,be.get(T.texture).__webglTexture,be.get(T.depthTexture).__webglTexture);else if(T.depthBuffer){const Ie=T.depthTexture;if(Re.__boundDepthTexture!==Ie){if(Ie!==null&&be.has(Ie)&&(T.width!==Ie.image.width||T.height!==Ie.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");Me.setupDepthRenderbuffer(T)}}const ke=T.texture;(ke.isData3DTexture||ke.isDataArrayTexture||ke.isCompressedArrayTexture)&&(Ee=!0);const ze=be.get(T).__webglFramebuffer;T.isWebGLCubeRenderTarget?(Array.isArray(ze[k])?B=ze[k][q]:B=ze[k],de=!0):T.samples>0&&Me.useMultisampledRTT(T)===!1?B=be.get(T).__webglMultisampledFramebuffer:Array.isArray(ze)?B=ze[q]:B=ze,S.copy(T.viewport),P.copy(T.scissor),A=T.scissorTest}else S.copy(K).multiplyScalar(j).floor(),P.copy(te).multiplyScalar(j).floor(),A=pe;if(ue.bindFramebuffer(U.FRAMEBUFFER,B)&&Z&&ue.drawBuffers(T,B),ue.viewport(S),ue.scissor(P),ue.setScissorTest(A),de){const Re=be.get(T.texture);U.framebufferTexture2D(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_CUBE_MAP_POSITIVE_X+k,Re.__webglTexture,q)}else if(Ee){const Re=be.get(T.texture),ke=k||0;U.framebufferTextureLayer(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0,Re.__webglTexture,q||0,ke)}I=-1},this.readRenderTargetPixels=function(T,k,q,Z,B,de,Ee){if(!(T&&T.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ce=be.get(T).__webglFramebuffer;if(T.isWebGLCubeRenderTarget&&Ee!==void 0&&(Ce=Ce[Ee]),Ce){ue.bindFramebuffer(U.FRAMEBUFFER,Ce);try{const Re=T.texture,ke=Re.format,ze=Re.type;if(!ge.textureFormatReadable(ke)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!ge.textureTypeReadable(ze)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}k>=0&&k<=T.width-Z&&q>=0&&q<=T.height-B&&U.readPixels(k,q,Z,B,Ve.convert(ke),Ve.convert(ze),de)}finally{const Re=w!==null?be.get(w).__webglFramebuffer:null;ue.bindFramebuffer(U.FRAMEBUFFER,Re)}}},this.readRenderTargetPixelsAsync=async function(T,k,q,Z,B,de,Ee){if(!(T&&T.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Ce=be.get(T).__webglFramebuffer;if(T.isWebGLCubeRenderTarget&&Ee!==void 0&&(Ce=Ce[Ee]),Ce){ue.bindFramebuffer(U.FRAMEBUFFER,Ce);try{const Re=T.texture,ke=Re.format,ze=Re.type;if(!ge.textureFormatReadable(ke))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!ge.textureTypeReadable(ze))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(k>=0&&k<=T.width-Z&&q>=0&&q<=T.height-B){const Ie=U.createBuffer();U.bindBuffer(U.PIXEL_PACK_BUFFER,Ie),U.bufferData(U.PIXEL_PACK_BUFFER,de.byteLength,U.STREAM_READ),U.readPixels(k,q,Z,B,Ve.convert(ke),Ve.convert(ze),0),U.flush();const Qe=U.fenceSync(U.SYNC_GPU_COMMANDS_COMPLETE,0);await Xy(U,Qe,4);try{U.bindBuffer(U.PIXEL_PACK_BUFFER,Ie),U.getBufferSubData(U.PIXEL_PACK_BUFFER,0,de)}finally{U.deleteBuffer(Ie),U.deleteSync(Qe)}return de}}finally{const Re=w!==null?be.get(w).__webglFramebuffer:null;ue.bindFramebuffer(U.FRAMEBUFFER,Re)}}},this.copyFramebufferToTexture=function(T,k=null,q=0){T.isTexture!==!0&&(Ss("WebGLRenderer: copyFramebufferToTexture function signature has changed."),k=arguments[0]||null,T=arguments[1]);const Z=Math.pow(2,-q),B=Math.floor(T.image.width*Z),de=Math.floor(T.image.height*Z),Ee=k!==null?k.x:0,Ce=k!==null?k.y:0;Me.setTexture2D(T,0),U.copyTexSubImage2D(U.TEXTURE_2D,q,0,0,Ee,Ce,B,de),ue.unbindTexture()},this.copyTextureToTexture=function(T,k,q=null,Z=null,B=0){T.isTexture!==!0&&(Ss("WebGLRenderer: copyTextureToTexture function signature has changed."),Z=arguments[0]||null,T=arguments[1],k=arguments[2],B=arguments[3]||0,q=null);let de,Ee,Ce,Re,ke,ze;q!==null?(de=q.max.x-q.min.x,Ee=q.max.y-q.min.y,Ce=q.min.x,Re=q.min.y):(de=T.image.width,Ee=T.image.height,Ce=0,Re=0),Z!==null?(ke=Z.x,ze=Z.y):(ke=0,ze=0);const Ie=Ve.convert(k.format),Qe=Ve.convert(k.type);Me.setTexture2D(k,0),U.pixelStorei(U.UNPACK_FLIP_Y_WEBGL,k.flipY),U.pixelStorei(U.UNPACK_PREMULTIPLY_ALPHA_WEBGL,k.premultiplyAlpha),U.pixelStorei(U.UNPACK_ALIGNMENT,k.unpackAlignment);const pt=U.getParameter(U.UNPACK_ROW_LENGTH),mt=U.getParameter(U.UNPACK_IMAGE_HEIGHT),rn=U.getParameter(U.UNPACK_SKIP_PIXELS),Je=U.getParameter(U.UNPACK_SKIP_ROWS),Ue=U.getParameter(U.UNPACK_SKIP_IMAGES),Dt=T.isCompressedTexture?T.mipmaps[B]:T.image;U.pixelStorei(U.UNPACK_ROW_LENGTH,Dt.width),U.pixelStorei(U.UNPACK_IMAGE_HEIGHT,Dt.height),U.pixelStorei(U.UNPACK_SKIP_PIXELS,Ce),U.pixelStorei(U.UNPACK_SKIP_ROWS,Re),T.isDataTexture?U.texSubImage2D(U.TEXTURE_2D,B,ke,ze,de,Ee,Ie,Qe,Dt.data):T.isCompressedTexture?U.compressedTexSubImage2D(U.TEXTURE_2D,B,ke,ze,Dt.width,Dt.height,Ie,Dt.data):U.texSubImage2D(U.TEXTURE_2D,B,ke,ze,de,Ee,Ie,Qe,Dt),U.pixelStorei(U.UNPACK_ROW_LENGTH,pt),U.pixelStorei(U.UNPACK_IMAGE_HEIGHT,mt),U.pixelStorei(U.UNPACK_SKIP_PIXELS,rn),U.pixelStorei(U.UNPACK_SKIP_ROWS,Je),U.pixelStorei(U.UNPACK_SKIP_IMAGES,Ue),B===0&&k.generateMipmaps&&U.generateMipmap(U.TEXTURE_2D),ue.unbindTexture()},this.copyTextureToTexture3D=function(T,k,q=null,Z=null,B=0){T.isTexture!==!0&&(Ss("WebGLRenderer: copyTextureToTexture3D function signature has changed."),q=arguments[0]||null,Z=arguments[1]||null,T=arguments[2],k=arguments[3],B=arguments[4]||0);let de,Ee,Ce,Re,ke,ze,Ie,Qe,pt;const mt=T.isCompressedTexture?T.mipmaps[B]:T.image;q!==null?(de=q.max.x-q.min.x,Ee=q.max.y-q.min.y,Ce=q.max.z-q.min.z,Re=q.min.x,ke=q.min.y,ze=q.min.z):(de=mt.width,Ee=mt.height,Ce=mt.depth,Re=0,ke=0,ze=0),Z!==null?(Ie=Z.x,Qe=Z.y,pt=Z.z):(Ie=0,Qe=0,pt=0);const rn=Ve.convert(k.format),Je=Ve.convert(k.type);let Ue;if(k.isData3DTexture)Me.setTexture3D(k,0),Ue=U.TEXTURE_3D;else if(k.isDataArrayTexture||k.isCompressedArrayTexture)Me.setTexture2DArray(k,0),Ue=U.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}U.pixelStorei(U.UNPACK_FLIP_Y_WEBGL,k.flipY),U.pixelStorei(U.UNPACK_PREMULTIPLY_ALPHA_WEBGL,k.premultiplyAlpha),U.pixelStorei(U.UNPACK_ALIGNMENT,k.unpackAlignment);const Dt=U.getParameter(U.UNPACK_ROW_LENGTH),et=U.getParameter(U.UNPACK_IMAGE_HEIGHT),Cn=U.getParameter(U.UNPACK_SKIP_PIXELS),Pr=U.getParameter(U.UNPACK_SKIP_ROWS),sn=U.getParameter(U.UNPACK_SKIP_IMAGES);U.pixelStorei(U.UNPACK_ROW_LENGTH,mt.width),U.pixelStorei(U.UNPACK_IMAGE_HEIGHT,mt.height),U.pixelStorei(U.UNPACK_SKIP_PIXELS,Re),U.pixelStorei(U.UNPACK_SKIP_ROWS,ke),U.pixelStorei(U.UNPACK_SKIP_IMAGES,ze),T.isDataTexture||T.isData3DTexture?U.texSubImage3D(Ue,B,Ie,Qe,pt,de,Ee,Ce,rn,Je,mt.data):k.isCompressedArrayTexture?U.compressedTexSubImage3D(Ue,B,Ie,Qe,pt,de,Ee,Ce,rn,mt.data):U.texSubImage3D(Ue,B,Ie,Qe,pt,de,Ee,Ce,rn,Je,mt),U.pixelStorei(U.UNPACK_ROW_LENGTH,Dt),U.pixelStorei(U.UNPACK_IMAGE_HEIGHT,et),U.pixelStorei(U.UNPACK_SKIP_PIXELS,Cn),U.pixelStorei(U.UNPACK_SKIP_ROWS,Pr),U.pixelStorei(U.UNPACK_SKIP_IMAGES,sn),B===0&&k.generateMipmaps&&U.generateMipmap(Ue),ue.unbindTexture()},this.initRenderTarget=function(T){be.get(T).__webglFramebuffer===void 0&&Me.setupRenderTarget(T)},this.initTexture=function(T){T.isCubeTexture?Me.setTextureCube(T,0):T.isData3DTexture?Me.setTexture3D(T,0):T.isDataArrayTexture||T.isCompressedArrayTexture?Me.setTexture2DArray(T,0):Me.setTexture2D(T,0),ue.unbindTexture()},this.resetState=function(){N=0,C=0,w=null,ue.reset(),Xe.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return ci}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const n=this.getContext();n.drawingBufferColorSpace=e===qd?"display-p3":"srgb",n.unpackColorSpace=tt.workingColorSpace===ru?"display-p3":"srgb"}}class eh{constructor(e,n=25e-5){this.isFogExp2=!0,this.name="",this.color=new Ge(e),this.density=n}clone(){return new eh(this.color,this.density)}toJSON(){return{type:"FogExp2",name:this.name,color:this.color.getHex(),density:this.density}}}class tT extends Pt{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new Vn,this.environmentIntensity=1,this.environmentRotation=new Vn,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,n){return super.copy(e,n),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,this.backgroundRotation.copy(e.backgroundRotation),this.environmentIntensity=e.environmentIntensity,this.environmentRotation.copy(e.environmentRotation),e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const n=super.toJSON(e);return this.fog!==null&&(n.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(n.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(n.object.backgroundIntensity=this.backgroundIntensity),n.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(n.object.environmentIntensity=this.environmentIntensity),n.object.environmentRotation=this.environmentRotation.toArray(),n}}class nT{constructor(e,n){this.isInterleavedBuffer=!0,this.array=e,this.stride=n,this.count=e!==void 0?e.length/n:0,this.usage=Hf,this._updateRange={offset:0,count:-1},this.updateRanges=[],this.version=0,this.uuid=Xi()}onUploadCallback(){}set needsUpdate(e){e===!0&&this.version++}get updateRange(){return Ss("THREE.InterleavedBuffer: updateRange() is deprecated and will be removed in r169. Use addUpdateRange() instead."),this._updateRange}setUsage(e){return this.usage=e,this}addUpdateRange(e,n){this.updateRanges.push({start:e,count:n})}clearUpdateRanges(){this.updateRanges.length=0}copy(e){return this.array=new e.array.constructor(e.array),this.count=e.count,this.stride=e.stride,this.usage=e.usage,this}copyAt(e,n,i){e*=this.stride,i*=n.stride;for(let r=0,s=this.stride;r<s;r++)this.array[e+r]=n.array[i+r];return this}set(e,n=0){return this.array.set(e,n),this}clone(e){e.arrayBuffers===void 0&&(e.arrayBuffers={}),this.array.buffer._uuid===void 0&&(this.array.buffer._uuid=Xi()),e.arrayBuffers[this.array.buffer._uuid]===void 0&&(e.arrayBuffers[this.array.buffer._uuid]=this.array.slice(0).buffer);const n=new this.array.constructor(e.arrayBuffers[this.array.buffer._uuid]),i=new this.constructor(n,this.stride);return i.setUsage(this.usage),i}onUpload(e){return this.onUploadCallback=e,this}toJSON(e){return e.arrayBuffers===void 0&&(e.arrayBuffers={}),this.array.buffer._uuid===void 0&&(this.array.buffer._uuid=Xi()),e.arrayBuffers[this.array.buffer._uuid]===void 0&&(e.arrayBuffers[this.array.buffer._uuid]=Array.from(new Uint32Array(this.array.buffer))),{uuid:this.uuid,buffer:this.array.buffer._uuid,type:this.array.constructor.name,stride:this.stride}}}const Vt=new G;class Ol{constructor(e,n,i,r=!1){this.isInterleavedBufferAttribute=!0,this.name="",this.data=e,this.itemSize=n,this.offset=i,this.normalized=r}get count(){return this.data.count}get array(){return this.data.array}set needsUpdate(e){this.data.needsUpdate=e}applyMatrix4(e){for(let n=0,i=this.data.count;n<i;n++)Vt.fromBufferAttribute(this,n),Vt.applyMatrix4(e),this.setXYZ(n,Vt.x,Vt.y,Vt.z);return this}applyNormalMatrix(e){for(let n=0,i=this.count;n<i;n++)Vt.fromBufferAttribute(this,n),Vt.applyNormalMatrix(e),this.setXYZ(n,Vt.x,Vt.y,Vt.z);return this}transformDirection(e){for(let n=0,i=this.count;n<i;n++)Vt.fromBufferAttribute(this,n),Vt.transformDirection(e),this.setXYZ(n,Vt.x,Vt.y,Vt.z);return this}getComponent(e,n){let i=this.array[e*this.data.stride+this.offset+n];return this.normalized&&(i=qn(i,this.array)),i}setComponent(e,n,i){return this.normalized&&(i=it(i,this.array)),this.data.array[e*this.data.stride+this.offset+n]=i,this}setX(e,n){return this.normalized&&(n=it(n,this.array)),this.data.array[e*this.data.stride+this.offset]=n,this}setY(e,n){return this.normalized&&(n=it(n,this.array)),this.data.array[e*this.data.stride+this.offset+1]=n,this}setZ(e,n){return this.normalized&&(n=it(n,this.array)),this.data.array[e*this.data.stride+this.offset+2]=n,this}setW(e,n){return this.normalized&&(n=it(n,this.array)),this.data.array[e*this.data.stride+this.offset+3]=n,this}getX(e){let n=this.data.array[e*this.data.stride+this.offset];return this.normalized&&(n=qn(n,this.array)),n}getY(e){let n=this.data.array[e*this.data.stride+this.offset+1];return this.normalized&&(n=qn(n,this.array)),n}getZ(e){let n=this.data.array[e*this.data.stride+this.offset+2];return this.normalized&&(n=qn(n,this.array)),n}getW(e){let n=this.data.array[e*this.data.stride+this.offset+3];return this.normalized&&(n=qn(n,this.array)),n}setXY(e,n,i){return e=e*this.data.stride+this.offset,this.normalized&&(n=it(n,this.array),i=it(i,this.array)),this.data.array[e+0]=n,this.data.array[e+1]=i,this}setXYZ(e,n,i,r){return e=e*this.data.stride+this.offset,this.normalized&&(n=it(n,this.array),i=it(i,this.array),r=it(r,this.array)),this.data.array[e+0]=n,this.data.array[e+1]=i,this.data.array[e+2]=r,this}setXYZW(e,n,i,r,s){return e=e*this.data.stride+this.offset,this.normalized&&(n=it(n,this.array),i=it(i,this.array),r=it(r,this.array),s=it(s,this.array)),this.data.array[e+0]=n,this.data.array[e+1]=i,this.data.array[e+2]=r,this.data.array[e+3]=s,this}clone(e){if(e===void 0){console.log("THREE.InterleavedBufferAttribute.clone(): Cloning an interleaved buffer attribute will de-interleave buffer data.");const n=[];for(let i=0;i<this.count;i++){const r=i*this.data.stride+this.offset;for(let s=0;s<this.itemSize;s++)n.push(this.data.array[r+s])}return new Bn(new this.array.constructor(n),this.itemSize,this.normalized)}else return e.interleavedBuffers===void 0&&(e.interleavedBuffers={}),e.interleavedBuffers[this.data.uuid]===void 0&&(e.interleavedBuffers[this.data.uuid]=this.data.clone(e)),new Ol(e.interleavedBuffers[this.data.uuid],this.itemSize,this.offset,this.normalized)}toJSON(e){if(e===void 0){console.log("THREE.InterleavedBufferAttribute.toJSON(): Serializing an interleaved buffer attribute will de-interleave buffer data.");const n=[];for(let i=0;i<this.count;i++){const r=i*this.data.stride+this.offset;for(let s=0;s<this.itemSize;s++)n.push(this.data.array[r+s])}return{itemSize:this.itemSize,type:this.array.constructor.name,array:n,normalized:this.normalized}}else return e.interleavedBuffers===void 0&&(e.interleavedBuffers={}),e.interleavedBuffers[this.data.uuid]===void 0&&(e.interleavedBuffers[this.data.uuid]=this.data.toJSON(e)),{isInterleavedBufferAttribute:!0,itemSize:this.itemSize,data:this.data.uuid,offset:this.offset,normalized:this.normalized}}}class ol extends er{constructor(e){super(),this.isSpriteMaterial=!0,this.type="SpriteMaterial",this.color=new Ge(16777215),this.map=null,this.alphaMap=null,this.rotation=0,this.sizeAttenuation=!0,this.transparent=!0,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.alphaMap=e.alphaMap,this.rotation=e.rotation,this.sizeAttenuation=e.sizeAttenuation,this.fog=e.fog,this}}let qr;const Js=new G,Kr=new G,Zr=new G,Qr=new We,eo=new We,__=new ct,Da=new G,to=new G,Ia=new G,dm=new We,cc=new We,hm=new We;class fc extends Pt{constructor(e=new ol){if(super(),this.isSprite=!0,this.type="Sprite",qr===void 0){qr=new dn;const n=new Float32Array([-.5,-.5,0,0,0,.5,-.5,0,1,0,.5,.5,0,1,1,-.5,.5,0,0,1]),i=new nT(n,5);qr.setIndex([0,1,2,0,2,3]),qr.setAttribute("position",new Ol(i,3,0,!1)),qr.setAttribute("uv",new Ol(i,2,3,!1))}this.geometry=qr,this.material=e,this.center=new We(.5,.5)}raycast(e,n){e.camera===null&&console.error('THREE.Sprite: "Raycaster.camera" needs to be set in order to raycast against sprites.'),Kr.setFromMatrixScale(this.matrixWorld),__.copy(e.camera.matrixWorld),this.modelViewMatrix.multiplyMatrices(e.camera.matrixWorldInverse,this.matrixWorld),Zr.setFromMatrixPosition(this.modelViewMatrix),e.camera.isPerspectiveCamera&&this.material.sizeAttenuation===!1&&Kr.multiplyScalar(-Zr.z);const i=this.material.rotation;let r,s;i!==0&&(s=Math.cos(i),r=Math.sin(i));const o=this.center;Ua(Da.set(-.5,-.5,0),Zr,o,Kr,r,s),Ua(to.set(.5,-.5,0),Zr,o,Kr,r,s),Ua(Ia.set(.5,.5,0),Zr,o,Kr,r,s),dm.set(0,0),cc.set(1,0),hm.set(1,1);let a=e.ray.intersectTriangle(Da,to,Ia,!1,Js);if(a===null&&(Ua(to.set(-.5,.5,0),Zr,o,Kr,r,s),cc.set(0,1),a=e.ray.intersectTriangle(Da,Ia,to,!1,Js),a===null))return;const l=e.ray.origin.distanceTo(Js);l<e.near||l>e.far||n.push({distance:l,point:Js.clone(),uv:yn.getInterpolation(Js,Da,to,Ia,dm,cc,hm,new We),face:null,object:this})}copy(e,n){return super.copy(e,n),e.center!==void 0&&this.center.copy(e.center),this.material=e.material,this}}function Ua(t,e,n,i,r,s){Qr.subVectors(t,n).addScalar(.5).multiply(i),r!==void 0?(eo.x=s*Qr.x-r*Qr.y,eo.y=r*Qr.x+s*Qr.y):eo.copy(Qr),t.copy(e),t.x+=eo.x,t.y+=eo.y,t.applyMatrix4(__)}class ds extends er{constructor(e){super(),this.isLineBasicMaterial=!0,this.type="LineBasicMaterial",this.color=new Ge(16777215),this.map=null,this.linewidth=1,this.linecap="round",this.linejoin="round",this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.linewidth=e.linewidth,this.linecap=e.linecap,this.linejoin=e.linejoin,this.fog=e.fog,this}}const kl=new G,zl=new G,pm=new ct,no=new Kd,Na=new su,dc=new G,mm=new G;class Wf extends Pt{constructor(e=new dn,n=new ds){super(),this.isLine=!0,this.type="Line",this.geometry=e,this.material=n,this.updateMorphTargets()}copy(e,n){return super.copy(e,n),this.material=Array.isArray(e.material)?e.material.slice():e.material,this.geometry=e.geometry,this}computeLineDistances(){const e=this.geometry;if(e.index===null){const n=e.attributes.position,i=[0];for(let r=1,s=n.count;r<s;r++)kl.fromBufferAttribute(n,r-1),zl.fromBufferAttribute(n,r),i[r]=i[r-1],i[r]+=kl.distanceTo(zl);e.setAttribute("lineDistance",new wn(i,1))}else console.warn("THREE.Line.computeLineDistances(): Computation only possible with non-indexed BufferGeometry.");return this}raycast(e,n){const i=this.geometry,r=this.matrixWorld,s=e.params.Line.threshold,o=i.drawRange;if(i.boundingSphere===null&&i.computeBoundingSphere(),Na.copy(i.boundingSphere),Na.applyMatrix4(r),Na.radius+=s,e.ray.intersectsSphere(Na)===!1)return;pm.copy(r).invert(),no.copy(e.ray).applyMatrix4(pm);const a=s/((this.scale.x+this.scale.y+this.scale.z)/3),l=a*a,u=this.isLineSegments?2:1,d=i.index,f=i.attributes.position;if(d!==null){const p=Math.max(0,o.start),x=Math.min(d.count,o.start+o.count);for(let y=p,m=x-1;y<m;y+=u){const c=d.getX(y),g=d.getX(y+1),_=Fa(this,e,no,l,c,g);_&&n.push(_)}if(this.isLineLoop){const y=d.getX(x-1),m=d.getX(p),c=Fa(this,e,no,l,y,m);c&&n.push(c)}}else{const p=Math.max(0,o.start),x=Math.min(f.count,o.start+o.count);for(let y=p,m=x-1;y<m;y+=u){const c=Fa(this,e,no,l,y,y+1);c&&n.push(c)}if(this.isLineLoop){const y=Fa(this,e,no,l,x-1,p);y&&n.push(y)}}}updateMorphTargets(){const n=this.geometry.morphAttributes,i=Object.keys(n);if(i.length>0){const r=n[i[0]];if(r!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let s=0,o=r.length;s<o;s++){const a=r[s].name||String(s);this.morphTargetInfluences.push(0),this.morphTargetDictionary[a]=s}}}}}function Fa(t,e,n,i,r,s){const o=t.geometry.attributes.position;if(kl.fromBufferAttribute(o,r),zl.fromBufferAttribute(o,s),n.distanceSqToSegment(kl,zl,dc,mm)>i)return;dc.applyMatrix4(t.matrixWorld);const l=e.ray.origin.distanceTo(dc);if(!(l<e.near||l>e.far))return{distance:l,point:mm.clone().applyMatrix4(t.matrixWorld),index:r,face:null,faceIndex:null,object:t}}const gm=new G,_m=new G;class Xf extends Wf{constructor(e,n){super(e,n),this.isLineSegments=!0,this.type="LineSegments"}computeLineDistances(){const e=this.geometry;if(e.index===null){const n=e.attributes.position,i=[];for(let r=0,s=n.count;r<s;r+=2)gm.fromBufferAttribute(n,r),_m.fromBufferAttribute(n,r+1),i[r]=r===0?0:i[r-1],i[r+1]=i[r]+gm.distanceTo(_m);e.setAttribute("lineDistance",new wn(i,1))}else console.warn("THREE.LineSegments.computeLineDistances(): Computation only possible with non-indexed BufferGeometry.");return this}}class v_ extends jt{constructor(e,n,i,r,s,o,a,l,u){super(e,n,i,r,s,o,a,l,u),this.isCanvasTexture=!0,this.needsUpdate=!0}}const Oa=new G,ka=new G,hc=new G,za=new yn;class vm extends dn{constructor(e=null,n=1){if(super(),this.type="EdgesGeometry",this.parameters={geometry:e,thresholdAngle:n},e!==null){const r=Math.pow(10,4),s=Math.cos(rl*n),o=e.getIndex(),a=e.getAttribute("position"),l=o?o.count:a.count,u=[0,0,0],d=["a","b","c"],h=new Array(3),f={},p=[];for(let x=0;x<l;x+=3){o?(u[0]=o.getX(x),u[1]=o.getX(x+1),u[2]=o.getX(x+2)):(u[0]=x,u[1]=x+1,u[2]=x+2);const{a:y,b:m,c}=za;if(y.fromBufferAttribute(a,u[0]),m.fromBufferAttribute(a,u[1]),c.fromBufferAttribute(a,u[2]),za.getNormal(hc),h[0]=`${Math.round(y.x*r)},${Math.round(y.y*r)},${Math.round(y.z*r)}`,h[1]=`${Math.round(m.x*r)},${Math.round(m.y*r)},${Math.round(m.z*r)}`,h[2]=`${Math.round(c.x*r)},${Math.round(c.y*r)},${Math.round(c.z*r)}`,!(h[0]===h[1]||h[1]===h[2]||h[2]===h[0]))for(let g=0;g<3;g++){const _=(g+1)%3,v=h[g],N=h[_],C=za[d[g]],w=za[d[_]],I=`${v}_${N}`,E=`${N}_${v}`;E in f&&f[E]?(hc.dot(f[E].normal)<=s&&(p.push(C.x,C.y,C.z),p.push(w.x,w.y,w.z)),f[E]=null):I in f||(f[I]={index0:u[g],index1:u[_],normal:hc.clone()})}}for(const x in f)if(f[x]){const{index0:y,index1:m}=f[x];Oa.fromBufferAttribute(a,y),ka.fromBufferAttribute(a,m),p.push(Oa.x,Oa.y,Oa.z),p.push(ka.x,ka.y,ka.z)}this.setAttribute("position",new wn(p,3))}}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}}class iT extends er{constructor(e){super(),this.isMeshPhongMaterial=!0,this.type="MeshPhongMaterial",this.color=new Ge(16777215),this.specular=new Ge(1118481),this.shininess=30,this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new Ge(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=$d,this.normalScale=new We(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.specularMap=null,this.alphaMap=null,this.envMap=null,this.envMapRotation=new Vn,this.combine=nu,this.reflectivity=1,this.refractionRatio=.98,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.specular.copy(e.specular),this.shininess=e.shininess,this.map=e.map,this.lightMap=e.lightMap,this.lightMapIntensity=e.lightMapIntensity,this.aoMap=e.aoMap,this.aoMapIntensity=e.aoMapIntensity,this.emissive.copy(e.emissive),this.emissiveMap=e.emissiveMap,this.emissiveIntensity=e.emissiveIntensity,this.bumpMap=e.bumpMap,this.bumpScale=e.bumpScale,this.normalMap=e.normalMap,this.normalMapType=e.normalMapType,this.normalScale.copy(e.normalScale),this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.specularMap=e.specularMap,this.alphaMap=e.alphaMap,this.envMap=e.envMap,this.envMapRotation.copy(e.envMapRotation),this.combine=e.combine,this.reflectivity=e.reflectivity,this.refractionRatio=e.refractionRatio,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this.wireframeLinecap=e.wireframeLinecap,this.wireframeLinejoin=e.wireframeLinejoin,this.flatShading=e.flatShading,this.fog=e.fog,this}}class pc extends er{constructor(e){super(),this.isMeshLambertMaterial=!0,this.type="MeshLambertMaterial",this.color=new Ge(16777215),this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new Ge(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=$d,this.normalScale=new We(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.specularMap=null,this.alphaMap=null,this.envMap=null,this.envMapRotation=new Vn,this.combine=nu,this.reflectivity=1,this.refractionRatio=.98,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.lightMap=e.lightMap,this.lightMapIntensity=e.lightMapIntensity,this.aoMap=e.aoMap,this.aoMapIntensity=e.aoMapIntensity,this.emissive.copy(e.emissive),this.emissiveMap=e.emissiveMap,this.emissiveIntensity=e.emissiveIntensity,this.bumpMap=e.bumpMap,this.bumpScale=e.bumpScale,this.normalMap=e.normalMap,this.normalMapType=e.normalMapType,this.normalScale.copy(e.normalScale),this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.specularMap=e.specularMap,this.alphaMap=e.alphaMap,this.envMap=e.envMap,this.envMapRotation.copy(e.envMapRotation),this.combine=e.combine,this.reflectivity=e.reflectivity,this.refractionRatio=e.refractionRatio,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this.wireframeLinecap=e.wireframeLinecap,this.wireframeLinejoin=e.wireframeLinejoin,this.flatShading=e.flatShading,this.fog=e.fog,this}}class x_ extends Pt{constructor(e,n=1){super(),this.isLight=!0,this.type="Light",this.color=new Ge(e),this.intensity=n}dispose(){}copy(e,n){return super.copy(e,n),this.color.copy(e.color),this.intensity=e.intensity,this}toJSON(e){const n=super.toJSON(e);return n.object.color=this.color.getHex(),n.object.intensity=this.intensity,this.groundColor!==void 0&&(n.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(n.object.distance=this.distance),this.angle!==void 0&&(n.object.angle=this.angle),this.decay!==void 0&&(n.object.decay=this.decay),this.penumbra!==void 0&&(n.object.penumbra=this.penumbra),this.shadow!==void 0&&(n.object.shadow=this.shadow.toJSON()),this.target!==void 0&&(n.object.target=this.target.uuid),n}}const mc=new ct,xm=new G,ym=new G;class rT{constructor(e){this.camera=e,this.intensity=1,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new We(512,512),this.map=null,this.mapPass=null,this.matrix=new ct,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new Qd,this._frameExtents=new We(1,1),this._viewportCount=1,this._viewports=[new Et(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(e){const n=this.camera,i=this.matrix;xm.setFromMatrixPosition(e.matrixWorld),n.position.copy(xm),ym.setFromMatrixPosition(e.target.matrixWorld),n.lookAt(ym),n.updateMatrixWorld(),mc.multiplyMatrices(n.projectionMatrix,n.matrixWorldInverse),this._frustum.setFromProjectionMatrix(mc),i.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),i.multiply(mc)}getViewport(e){return this._viewports[e]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(e){return this.camera=e.camera.clone(),this.intensity=e.intensity,this.bias=e.bias,this.radius=e.radius,this.mapSize.copy(e.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const e={};return this.intensity!==1&&(e.intensity=this.intensity),this.bias!==0&&(e.bias=this.bias),this.normalBias!==0&&(e.normalBias=this.normalBias),this.radius!==1&&(e.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(e.mapSize=this.mapSize.toArray()),e.camera=this.camera.toJSON(!1).object,delete e.camera.matrix,e}}class sT extends rT{constructor(){super(new f_(-5,5,5,-5,.5,500)),this.isDirectionalLightShadow=!0}}class oT extends x_{constructor(e,n){super(e,n),this.isDirectionalLight=!0,this.type="DirectionalLight",this.position.copy(Pt.DEFAULT_UP),this.updateMatrix(),this.target=new Pt,this.shadow=new sT}dispose(){this.shadow.dispose()}copy(e){return super.copy(e),this.target=e.target.clone(),this.shadow=e.shadow.clone(),this}}class aT extends x_{constructor(e,n){super(e,n),this.isAmbientLight=!0,this.type="AmbientLight"}}const Sm=new ct;class lT{constructor(e,n,i=0,r=1/0){this.ray=new Kd(e,n),this.near=i,this.far=r,this.camera=null,this.layers=new Zd,this.params={Mesh:{},Line:{threshold:1},LOD:{},Points:{threshold:1},Sprite:{}}}set(e,n){this.ray.set(e,n)}setFromCamera(e,n){n.isPerspectiveCamera?(this.ray.origin.setFromMatrixPosition(n.matrixWorld),this.ray.direction.set(e.x,e.y,.5).unproject(n).sub(this.ray.origin).normalize(),this.camera=n):n.isOrthographicCamera?(this.ray.origin.set(e.x,e.y,(n.near+n.far)/(n.near-n.far)).unproject(n),this.ray.direction.set(0,0,-1).transformDirection(n.matrixWorld),this.camera=n):console.error("THREE.Raycaster: Unsupported camera type: "+n.type)}setFromXRController(e){return Sm.identity().extractRotation(e.matrixWorld),this.ray.origin.setFromMatrixPosition(e.matrixWorld),this.ray.direction.set(0,0,-1).applyMatrix4(Sm),this}intersectObject(e,n=!0,i=[]){return jf(e,this,i,n),i.sort(Mm),i}intersectObjects(e,n=!0,i=[]){for(let r=0,s=e.length;r<s;r++)jf(e[r],this,i,n);return i.sort(Mm),i}}function Mm(t,e){return t.distance-e.distance}function jf(t,e,n,i){let r=!0;if(t.layers.test(e.layers)&&t.raycast(e,n)===!1&&(r=!1),r===!0&&i===!0){const s=t.children;for(let o=0,a=s.length;o<a;o++)jf(s[o],e,n,!0)}}class uT extends Xf{constructor(e=10,n=10,i=4473924,r=8947848){i=new Ge(i),r=new Ge(r);const s=n/2,o=e/n,a=e/2,l=[],u=[];for(let f=0,p=0,x=-a;f<=n;f++,x+=o){l.push(-a,0,x,a,0,x),l.push(x,0,-a,x,0,a);const y=f===s?i:r;y.toArray(u,p),p+=3,y.toArray(u,p),p+=3,y.toArray(u,p),p+=3,y.toArray(u,p),p+=3}const d=new dn;d.setAttribute("position",new wn(l,3)),d.setAttribute("color",new wn(u,3));const h=new ds({vertexColors:!0,toneMapped:!1});super(d,h),this.type="GridHelper"}dispose(){this.geometry.dispose(),this.material.dispose()}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:Hd}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=Hd);const cT={name:"40ft High Cube Container",innerLength:12032,innerWidth:2352,innerHeight:2698,doorWidth:2340,doorHeight:2585,maxPayload:26580},Em=[{name:"20ft Standard",innerLength:5898,innerWidth:2352,innerHeight:2393,doorWidth:2340,doorHeight:2280,maxPayload:28200},{name:"40ft Standard",innerLength:12032,innerWidth:2352,innerHeight:2393,doorWidth:2340,doorHeight:2280,maxPayload:26750},{name:"40ft High Cube",innerLength:12032,innerWidth:2352,innerHeight:2698,doorWidth:2340,doorHeight:2585,maxPayload:26580},{name:"45ft High Cube",innerLength:13556,innerWidth:2352,innerHeight:2698,doorWidth:2340,doorHeight:2585,maxPayload:27700},{name:"Custom",innerLength:12032,innerWidth:2352,innerHeight:2698,doorWidth:2340,doorHeight:2585,maxPayload:26580}],wm=[{id:"hilux_dc",name:"Hilux Revo (4Dr)",length:5325,width:1855,height:1815,weight:2050,wheelbase:3085,cabRatio:.55},{id:"hilux_sc",name:"Hilux Revo (2Dr)",length:5255,width:1855,height:1815,weight:1910,wheelbase:3085,cabRatio:.4},{id:"ranger_dc",name:"Ranger (4Dr)",length:5362,width:1860,height:1821,weight:2150,wheelbase:3220,cabRatio:.55},{id:"triton_dc",name:"Triton (4Dr)",length:5305,width:1815,height:1795,weight:1950,wheelbase:3e3,cabRatio:.55},{id:"dmax_dc",name:"D-Max (4Dr)",length:5265,width:1870,height:1790,weight:1990,wheelbase:3020,cabRatio:.55},{id:"navara_dc",name:"Navara (4Dr)",length:5260,width:1850,height:1840,weight:2050,wheelbase:3150,cabRatio:.55},{id:"custom",name:"กำหนดเอง (Custom)",length:5300,width:1850,height:1800,weight:2e3,wheelbase:3e3,cabRatio:.5}],Tm=[{id:"eu_pallet",name:"EU Pallet",length:1200,width:800,height:1450,weight:800},{id:"th_pallet",name:"TH Pallet",length:1100,width:1100,height:1450,weight:800},{id:"box_s",name:"กล่อง S",length:600,width:400,height:400,weight:20},{id:"box_m",name:"กล่อง M",length:800,width:600,height:600,weight:40},{id:"box_l",name:"กล่อง L",length:1200,width:800,height:800,weight:80},{id:"box_custom",name:"กำหนดเอง",length:1e3,width:800,height:800,weight:50}],Ba=["#3B82F6","#EF4444","#10B981","#F59E0B","#8B5CF6","#EC4899","#06B6D4","#F97316"],Am=()=>Math.random().toString(36).substr(2,9);function fT(t,e=45){const n=t.naturalWidth||t.width,i=t.naturalHeight||t.height,r=document.createElement("canvas");r.width=n,r.height=i;const s=r.getContext("2d");s.drawImage(t,0,0);const o=s.getImageData(0,0,n,i),a=o.data,l=a[0],u=a[1],d=a[2],h=new Uint8Array(n*i),f=[0,n-1,(i-1)*n,i*n-1];for(;f.length;){const p=f.pop();if(p<0||p>=n*i||h[p])continue;h[p]=1;const x=p*4;if(Math.abs(a[x]-l)+Math.abs(a[x+1]-u)+Math.abs(a[x+2]-d)>e*3)continue;a[x+3]=0;const y=p%n;y>0&&f.push(p-1),y<n-1&&f.push(p+1),f.push(p-n,p+n)}return s.putImageData(o,0,0),r}const dT=Ae.forwardRef(function({container:e,vehicles:n,selectedId:i,onSelectVehicle:r,onUpdateVehicle:s},o){const a=Ae.useRef(null);Ae.useImperativeHandle(o,()=>({getCanvas:()=>a.current}),[]);const l=Ae.useRef({}),[u,d]=Ae.useState(null),[h,f]=Ae.useState(1),[p,x]=Ae.useState({x:0,y:0}),y=Ae.useRef({zoom:1,pan:{x:0,y:0}}),m=Ae.useRef(null),c=Ae.useCallback((P,A)=>{y.current={zoom:P,pan:A},f(P),x(A)},[]),g=60;Ae.useEffect(()=>{n.forEach(P=>{if(!P.sideImage)return;const A=`${P.id}_${P.removeBg?1:0}`;if(l.current[A])return;const F=new Image;F.src=P.sideImage,F.onload=()=>{l.current[A]=P.removeBg?fT(F):F,v()}})},[n]);const _=Ae.useCallback(()=>{const P=a.current;if(!P)return{scale:1,ox:g,oy:g,cW:0,cH:0,baseScale:1};const A=P.getBoundingClientRect(),F=Math.min((A.width-g*2)/e.innerLength,(A.height-g*2)/e.innerHeight),Y=F*h,V=e.innerLength*Y,W=e.innerHeight*Y,j=(A.height-e.innerHeight*F)/2,L=g+p.x,H=j+p.y;return{scale:Y,ox:L,oy:H,cW:V,cH:W,baseScale:F}},[e,h,p]),v=Ae.useCallback(()=>{const P=a.current;if(!P)return;const A=P.getContext("2d"),F=P.getBoundingClientRect(),Y=Math.min(window.devicePixelRatio||1,2);P.width=F.width*Y,P.height=F.height*Y,A.scale(Y,Y);const V=F.width,W=F.height,{scale:j,ox:L,oy:H,cW:K,cH:te}=_();A.fillStyle="#18253a",A.fillRect(0,0,V,W),A.fillStyle="#ffffff",A.fillRect(L,H,K,te);const pe=(()=>{const he=45/j;return he<=100?100:he<=200?200:he<=500?500:he<=1e3?1e3:2e3})();for(let he=pe;he<e.innerLength;he+=pe){const U=L+he*j;U<L||U>L+K||(A.strokeStyle=he%1e3===0?"#00000060":"#00000035",A.lineWidth=he%1e3===0?1:.5,A.beginPath(),A.moveTo(U,H),A.lineTo(U,H+te),A.stroke())}for(let he=pe;he<e.innerHeight;he+=pe){const U=H+te-he*j;U<H||U>H+te||(A.strokeStyle=he%1e3===0?"#00000060":"#00000035",A.lineWidth=he%1e3===0?1:.5,A.beginPath(),A.moveTo(L,U),A.lineTo(L+K,U),A.stroke())}A.strokeStyle="#00ffaa",A.lineWidth=2,A.strokeRect(L,H,K,te),A.fillStyle="#d0e8d088",A.fillRect(L,H+te-5,K,5);const Fe=H+te-e.doorHeight*j;A.strokeStyle="#dd7700cc",A.lineWidth=1.5,A.setLineDash([8,4]),A.beginPath(),A.moveTo(L,Fe),A.lineTo(L+K,Fe),A.stroke(),A.setLineDash([]),A.fillStyle="#dd7700ee",A.font="bold 9px monospace",A.textAlign="right",A.fillText(`⚠ DOOR MAX ${e.doorHeight}mm`,L+K-4,Fe-4);const $=22,re=36,ve=Math.max(0,Math.floor(Math.max(0,-L)/j/100)*100),me=Math.min(e.innerLength,Math.ceil((V-L)/j/100)*100+100),Le=Math.max(0,Math.floor(Math.max(0,H+te-W)/j/100)*100),Ne=Math.min(e.innerHeight,Math.ceil((H+te)/j/100)*100+100),Be=he=>he>=1e3&&pe>=1e3?`${he/1e3}m`:`${he}`;[{base:H+te+2,dir:1},{base:H-2,dir:-1}].forEach(({base:he,dir:U})=>{A.fillStyle="#141e30ee",A.fillRect(L,U===1?he:he-$,K,$);for(let He=ve;He<=me;He+=100){const ce=L+He*j;if(ce<L-1||ce>L+K+1)continue;const ge=He%pe===0,ue=He%500===0&&!ge,De=(ge?13:ue?8:4)*U;A.strokeStyle=ge?"#00ffaadd":ue?"#00ffaa55":"#00000022",A.lineWidth=ge?1.2:.5,A.beginPath(),A.moveTo(ce,he),A.lineTo(ce,he+De),A.stroke(),ge&&(A.fillStyle="#00ffaaee",A.font="bold 8px monospace",A.textAlign="center",A.fillText(Be(He),ce,U===1?he+$:he-4))}}),[{base:L-2,dir:-1},{base:L+K+2,dir:1}].forEach(({base:he,dir:U})=>{A.fillStyle="#141e30ee",A.fillRect(U===-1?he-re:he,H,re,te);for(let He=Le;He<=Ne;He+=100){const ce=H+te-He*j;if(ce<H-1||ce>H+te+1)continue;const ge=He%pe===0,ue=He%500===0&&!ge,De=(ge?13:ue?8:4)*U;A.strokeStyle=ge?"#00ffaadd":ue?"#00ffaa55":"#00000022",A.lineWidth=ge?1.2:.5,A.beginPath(),A.moveTo(he,ce),A.lineTo(he+De,ce),A.stroke(),ge&&(A.fillStyle="#00ffaaee",A.font="bold 8px monospace",A.textAlign=U===-1?"right":"left",A.fillText(`${He}`,U===-1?he-4:he+4,ce+3))}}),A.fillStyle="#00ffaacc",A.font="bold 10px monospace",A.textAlign="center",A.fillText(`${e.innerLength} mm`,L+K/2,H-$-4),A.save(),A.translate(L-re-14,H+te/2),A.rotate(-Math.PI/2),A.fillText(`${e.innerHeight} mm`,0,0),A.restore(),n.forEach(he=>{const U=he.sideX??200,He=he.sideY??0,ce=(he.sideAngle??0)*Math.PI/180,ge=he.length*j,ue=he.height*j,De=L+U*j+ge/2,be=H+te-He*j-ue/2,Me=he.id===i;A.save(),A.translate(De,be),A.rotate(ce);const b=`${he.id}_${he.removeBg?1:0}`,M=l.current[b];if(M&&M.complete!==!1){const X=(he.imgRealLength??he.length)*j,ee=(he.imgRealHeight??he.height)*j;he.flipX&&A.scale(-1,1),A.drawImage(M,-X/2,-ee/2,X,ee),he.flipX&&A.scale(-1,1)}else{A.fillStyle=he.color+"22",A.strokeStyle=he.color+"cc",A.lineWidth=1.5,A.fillRect(-ge/2,-ue/2,ge,ue),A.strokeRect(-ge/2,-ue/2,ge,ue);const X=ge*(he.cabRatio??.5);A.strokeStyle=he.color+"77",A.lineWidth=1,A.beginPath(),A.moveTo(-ge/2+X,-ue/2),A.lineTo(-ge/2+X,ue/2),A.stroke(),A.fillStyle="#ffffffaa",A.font=`bold ${Math.max(8,ge*.04)}px sans-serif`,A.textAlign="center",A.textBaseline="middle",A.fillText(he.preset,0,0)}Me&&(A.strokeStyle="#ffffff",A.lineWidth=2,A.setLineDash([4,3]),A.strokeRect(-ge/2-3,-ue/2-3,ge+6,ue+6),A.setLineDash([]),A.strokeStyle="#00ffaa",A.lineWidth=1.5,A.beginPath(),A.moveTo(0,-ue/2-2),A.lineTo(0,-ue/2-14),A.stroke(),A.fillStyle="#00ffaadd",A.strokeStyle="#00ffaa",A.lineWidth=1,A.beginPath(),A.arc(0,-ue/2-21,7,0,Math.PI*2),A.fill(),A.stroke(),A.fillStyle="#ffffff88",A.font="8px monospace",A.textAlign="left",A.textBaseline="top",A.fillText(`${Math.round((he.sideAngle??0)*10)/10}°`,ge/2+5,-ue/2)),A.restore()})},[e,n,i,_]);Ae.useEffect(()=>{v()},[v]),Ae.useEffect(()=>(window.addEventListener("resize",v),()=>window.removeEventListener("resize",v)),[v]),Ae.useEffect(()=>{const P=a.current;if(!P)return;const A=F=>{F.preventDefault();const Y=P.getBoundingClientRect(),V=F.clientX-Y.left,W=F.clientY-Y.top,{zoom:j,pan:L}=y.current,H=Math.min((Y.width-g*2)/e.innerLength,(Y.height-g*2)/e.innerHeight),K=H*j,te=(Y.height-e.innerHeight*H)/2,pe=g+L.x,Fe=te+L.y,$=F.deltaY<0?1.15:1/1.15,re=Math.max(.5,Math.min(20,j*$)),ve=H*re,me=V-(V-pe)*ve/K,Le=W-(W-Fe)*ve/K;c(re,{x:me-g,y:Le-te})};return P.addEventListener("wheel",A,{passive:!1}),()=>P.removeEventListener("wheel",A)},[e,c]);const N=P=>{const A=a.current.getBoundingClientRect();return{mx:P.clientX-A.left,my:P.clientY-A.top}},C=P=>{const{scale:A,ox:F,oy:Y,cH:V}=_(),W=P.length*A,j=P.height*A,L=F+(P.sideX??200)*A+W/2,H=Y+V-(P.sideY??0)*A-j/2;return{cx:L,cy:H,vW:W,vH:j}},w=P=>{if(P.button===1){P.preventDefault();const{mx:Y,my:V}=N(P);m.current={mx:Y,my:V,panX:y.current.pan.x,panY:y.current.pan.y},d({id:null,type:"pan"});return}const{mx:A,my:F}=N(P);for(let Y=n.length-1;Y>=0;Y--){const V=n[Y],{cx:W,cy:j,vW:L,vH:H}=C(V),K=(V.sideAngle??0)*Math.PI/180;if(V.id===i){const Fe=-H/2-21,$=W-Fe*Math.sin(K),re=j+Fe*Math.cos(K);if(Math.hypot(A-$,F-re)<12){r(V.id),d({id:V.id,type:"rotate",cx:W,cy:j});return}}const te=(A-W)*Math.cos(-K)-(F-j)*Math.sin(-K),pe=(A-W)*Math.sin(-K)+(F-j)*Math.cos(-K);if(Math.abs(te)<=L/2+5&&Math.abs(pe)<=H/2+5){r(V.id),d({id:V.id,type:"move",offX:A-W,offY:F-j});return}}r(null),m.current={mx:A,my:F,panX:y.current.pan.x,panY:y.current.pan.y},d({id:null,type:"pan"})},I=P=>{if((u==null?void 0:u.type)==="pan"&&m.current){const{mx:H,my:K}=N(P);c(y.current.zoom,{x:m.current.panX+H-m.current.mx,y:m.current.panY+K-m.current.my});return}if(!u)return;const{mx:A,my:F}=N(P),{scale:Y,ox:V,oy:W,cH:j}=_(),L=n.find(H=>H.id===u.id);if(L){if(u.type==="move"){const H=L.length*Y,K=L.height*Y,te=A-u.offX,pe=F-u.offY;s(L.id,{sideX:Math.round((te-V-H/2)/Y),sideY:Math.max(0,Math.round((W+j-pe-K/2)/Y))})}else if(u.type==="rotate"){const H=Math.atan2(A-u.cx,-(F-u.cy))*180/Math.PI;s(L.id,{sideAngle:Math.round(H*10)/10})}}},E=()=>d(null),S=(u==null?void 0:u.type)==="pan"||u?"grabbing":"crosshair";return z.jsxs("div",{style:{position:"relative",width:"100%",height:"100%"},children:[z.jsx("canvas",{ref:a,style:{width:"100%",height:"100%",cursor:S,display:"block"},onMouseDown:w,onMouseMove:I,onMouseUp:E,onMouseLeave:E}),z.jsxs("div",{style:{position:"absolute",bottom:10,right:10,display:"flex",gap:4,alignItems:"center"},children:[z.jsx("button",{onClick:()=>c(Math.min(20,y.current.zoom*1.3),y.current.pan),style:{width:28,height:28,borderRadius:4,border:"1px solid #3a4a66",background:"#1e2a42",color:"#e8eaf5",cursor:"pointer",fontSize:16,lineHeight:1},children:"+"}),z.jsx("button",{onClick:()=>c(Math.max(.5,y.current.zoom/1.3),y.current.pan),style:{width:28,height:28,borderRadius:4,border:"1px solid #3a4a66",background:"#1e2a42",color:"#e8eaf5",cursor:"pointer",fontSize:16,lineHeight:1},children:"−"}),z.jsxs("button",{onClick:()=>c(1,{x:0,y:0}),style:{padding:"0 8px",height:28,borderRadius:4,border:"1px solid #3a4a66",background:"#1e2a42",color:"#00ddaa",cursor:"pointer",fontSize:10,fontFamily:"monospace"},children:[h.toFixed(1),"× ↺"]})]})]})});function hT({container:t,boxes:e,selectedId:n,onSelectBox:i,onMoveBox:r,collisions:s}){const o=Ae.useRef(null),[a,l]=Ae.useState(null),[u,d]=Ae.useState({x:0,y:0}),h=Ae.useRef(1),f=50,p=Ae.useCallback(()=>{const _=o.current;if(!_)return 1;const v=_.getBoundingClientRect();return Math.min((v.width-f*2)/t.innerLength,(v.height-f*2)/t.innerWidth)},[t]),x=Ae.useCallback(()=>{const _=o.current;if(!_)return;const v=_.getContext("2d"),N=_.getBoundingClientRect(),C=Math.min(window.devicePixelRatio||1,2);_.width=N.width*C,_.height=N.height*C,v.scale(C,C);const w=N.width,I=N.height,E=p();h.current=E;const S=f,P=f,A=t.innerLength*E,F=t.innerWidth*E;v.fillStyle="#18253a",v.fillRect(0,0,w,I),v.strokeStyle="#ffffff10",v.lineWidth=.5;for(let V=1e3;V<t.innerLength;V+=1e3)v.beginPath(),v.moveTo(S+V*E,P),v.lineTo(S+V*E,P+F),v.stroke();for(let V=500;V<t.innerWidth;V+=500)v.beginPath(),v.moveTo(S,P+V*E),v.lineTo(S+A,P+V*E),v.stroke();v.strokeStyle="#00ffaa",v.lineWidth=2,v.strokeRect(S,P,A,F);const Y=(t.innerWidth-t.doorWidth)/2;v.strokeStyle="#00ffaa88",v.lineWidth=3,v.setLineDash([8,4]),v.beginPath(),v.moveTo(S+A,P+Y*E),v.lineTo(S+A,P+(Y+t.doorWidth)*E),v.stroke(),v.setLineDash([]),v.fillStyle="#00ffaa",v.font="bold 11px monospace",v.textAlign="center",v.fillText(`${t.innerLength} mm`,S+A/2,P-16),v.save(),v.translate(S-20,P+F/2),v.rotate(-Math.PI/2),v.fillText(`${t.innerWidth} mm`,0,0),v.restore(),v.fillStyle="#00ffaa66",v.font="10px sans-serif",v.textAlign="left",v.fillText("DOOR →",S+A+8,P+F/2+4),e.forEach(V=>{const W=S+V.x*E,j=P+V.y*E,L=V.length*E,H=V.width*E,K=V.id===n,te=s.has(V.id);v.fillStyle="rgba(0,0,0,0.2)",v.fillRect(W+2,j+2,L,H),v.fillStyle=V.color+(te?"cc":"99"),v.fillRect(W,j,L,H),v.strokeStyle=te?"#ff4444":K?"#ffffff":V.color,v.lineWidth=K?2:1.5,v.strokeRect(W,j,L,H),v.strokeStyle=V.color+"44",v.lineWidth=.5,v.beginPath(),v.moveTo(W,j),v.lineTo(W+L,j+H),v.moveTo(W+L,j),v.lineTo(W,j+H),v.stroke();const pe=Math.max(8,Math.min(L,H)*.16);v.fillStyle="#ffffffcc",v.font=`${K?"bold ":""}${pe}px sans-serif`,v.textAlign="center",v.textBaseline="middle",v.fillText(V.preset,W+L/2,j+H/2-pe*.5),v.font=`${Math.max(7,pe*.8)}px monospace`,v.fillStyle="#ffffff88",v.fillText(`${V.length}×${V.width}×${V.height}`,W+L/2,j+H/2+pe*.5),K&&(v.strokeStyle="#ffffff",v.lineWidth=2,v.setLineDash([4,3]),v.strokeRect(W-3,j-3,L+6,H+6),v.setLineDash([]))})},[t,e,n,s,p]);Ae.useEffect(()=>{x()},[x]),Ae.useEffect(()=>(window.addEventListener("resize",x),()=>window.removeEventListener("resize",x)),[x]);const y=_=>{const v=o.current.getBoundingClientRect();return{cx:_.clientX-v.left,cy:_.clientY-v.top}},m=_=>{const{cx:v,cy:N}=y(_),C=h.current;for(let w=e.length-1;w>=0;w--){const I=e[w],E=f+I.x*C,S=f+I.y*C,P=I.length*C,A=I.width*C;if(v>=E&&v<=E+P&&N>=S&&N<=S+A){i(I.id),l(I.id),d({x:v-E,y:N-S});return}}i(null)},c=_=>{if(!a)return;const{cx:v,cy:N}=y(_),C=h.current;r(a,Math.round((v-f-u.x)/C),Math.round((N-f-u.y)/C))},g=()=>l(null);return z.jsx("canvas",{ref:o,style:{width:"100%",height:"100%",cursor:a?"grabbing":"crosshair",display:"block"},onMouseDown:m,onMouseMove:c,onMouseUp:g,onMouseLeave:g})}function pT(t,e){const n=document.createElement("canvas");n.width=400,n.height=72;const i=n.getContext("2d");return i.fillStyle="rgba(0,0,0,0.72)",i.fillRect(0,0,400,72),i.strokeStyle=e||"#ffffff",i.lineWidth=4,i.strokeRect(2,2,396,68),i.fillStyle="#ffffff",i.font="bold 26px monospace",i.textAlign="center",i.textBaseline="middle",i.fillText(t,200,36),new v_(n)}function mT({container:t,boxes:e,selectedId:n,onMoveBox:i,onSelectBox:r,onPlaceBox:s}){const o=Ae.useRef(null),a=Ae.useRef(null),l=Ae.useRef(null),u=Ae.useRef(null),d=Ae.useRef({}),h=Ae.useRef(null),f=Ae.useRef({});return Ae.useEffect(()=>{f.current={boxes:e,container:t,onMoveBox:i,onSelectBox:r,onPlaceBox:s,selectedId:n}}),Ae.useEffect(()=>{const p=o.current;if(!p)return;const x=p.clientWidth,y=p.clientHeight,m=new tT;m.background=new Ge(14477557),m.fog=new eh(14477557,4e-5);const c=new xn(50,x/y,10,1e5),g=new eT({antialias:!0});g.setSize(x,y),g.setPixelRatio(Math.min(window.devicePixelRatio,2)),g.shadowMap.enabled=!0,g.shadowMap.type=H0,p.appendChild(g.domElement),a.current=m,l.current=c,u.current=g,m.add(new aT(16777215,1.2));const _=new oT(16777215,1.8);_.position.set(15e3,2e4,1e4),_.castShadow=!0,_.shadow.mapSize.set(2048,2048),_.shadow.camera.near=100,_.shadow.camera.far=5e4,_.shadow.camera.left=-15e3,_.shadow.camera.right=15e3,_.shadow.camera.top=15e3,_.shadow.camera.bottom=-15e3,m.add(_);const v=new Zt(new Ui(6e4,6e4),new pc({color:13162728}));v.rotation.x=-Math.PI/2,v.position.y=-5,v.receiveShadow=!0,m.add(v),m.add(new uT(4e4,40,8952251,11189196));const N=new lT,C=new We,w=new Ri(new G(0,1,0),0),I=new G;let E=!1,S=0,P=0,A=.7,F=.55,Y=2e4,V=!1,W=null,j=0,L=0,H=0,K=0,te=!1,pe=null,Fe=0;const $=new G(6e3,1200,0),re=()=>{c.position.set($.x+Y*Math.sin(F)*Math.cos(A),$.y+Y*Math.cos(F),$.z+Y*Math.sin(F)*Math.sin(A)),c.lookAt($)};re();const ve=()=>{const ce=[];return m.traverse(ge=>{ge.userData.isBoxMesh&&ce.push(ge)}),ce},me=ce=>{var ge,ue;if(S=ce.clientX,P=ce.clientY,ce.altKey){ce.preventDefault();const De=f.current.selectedId,be=f.current.boxes.find(Me=>Me.id===De);be&&(pe=De,Fe=be.z,te=!0,g.domElement.style.cursor="ns-resize");return}if(!ce.ctrlKey&&!ce.shiftKey){const De=g.domElement.getBoundingClientRect();C.x=(ce.clientX-De.left)/De.width*2-1,C.y=-((ce.clientY-De.top)/De.height)*2+1,N.setFromCamera(C,c);const be=N.intersectObjects(ve());if(be.length>0){const Me=be[0].object.userData.boxId;(ue=(ge=f.current).onSelectBox)==null||ue.call(ge,Me),N.ray.intersectPlane(w,I);const b=f.current.boxes.find(X=>X.id===Me),M=f.current.container;b&&(j=I.x-(b.x+b.length/2),L=I.z-(b.y-M.innerWidth/2+b.width/2),H=b.x,K=b.y,W=Me,V=!0,g.domElement.style.cursor="grabbing");return}}E=!0,g.domElement.style.cursor="grabbing"},Le=ce=>{const ge=ce.clientX-S,ue=ce.clientY-P;if(S=ce.clientX,P=ce.clientY,te&&pe){const{boxes:De,container:be}=f.current,Me=De.find(X=>X.id===pe);if(!Me)return;const b=be.innerHeight/p.clientHeight*2;Fe=Math.max(0,Math.min(be.innerHeight-Me.height,Fe-ue*b));const M=d.current[pe];if(M){const X=Me.x+Me.length/2,ee=Me.y-be.innerWidth/2+Me.width/2;M.mesh.position.set(X,Fe+Me.height/2,ee),M.edges.position.set(X,Fe+Me.height/2,ee),M.label&&M.label.position.set(X,Fe+Me.height+280,ee)}return}if(V&&W){const De=g.domElement.getBoundingClientRect();if(C.x=(ce.clientX-De.left)/De.width*2-1,C.y=-((ce.clientY-De.top)/De.height)*2+1,N.setFromCamera(C,c),!N.ray.intersectPlane(w,I))return;const{boxes:be,container:Me}=f.current,b=be.find(xe=>xe.id===W);if(!b)return;const M=I.x-j,X=I.z-L;H=Math.max(0,Math.min(Me.innerLength-b.length,M-b.length/2)),K=Math.max(0,Math.min(Me.innerWidth-b.width,X+Me.innerWidth/2-b.width/2));const ee=H+b.length/2,oe=b.z+b.height/2,ie=K-Me.innerWidth/2+b.width/2,Pe=d.current[W];Pe&&(Pe.mesh.position.set(ee,oe,ie),Pe.edges.position.set(ee,oe,ie),Pe.label&&Pe.label.position.set(ee,b.z+b.height+280,ie));return}if(E){if(ce.shiftKey){const De=Y/p.clientHeight;$.y-=ue*De}else if(ce.ctrlKey){const De=Y/p.clientHeight;$.x-=Math.sin(A)*ge*De,$.z+=Math.cos(A)*ge*De,$.x-=Math.cos(A)*ue*De,$.z-=Math.sin(A)*ue*De}else A+=ge*.005,F=Math.max(.1,Math.min(Math.PI/2-.05,F-ue*.005));re()}},Ne=()=>{var ce,ge,ue,De;te&&pe&&((ge=(ce=f.current).onPlaceBox)==null||ge.call(ce,pe,null,null,Fe)),V&&W&&((De=(ue=f.current).onMoveBox)==null||De.call(ue,W,H,K)),te=!1,pe=null,V=!1,W=null,E=!1,g.domElement.style.cursor="grab"},Be=ce=>{if(ce.preventDefault(),ce.ctrlKey){const ge=Y/p.clientHeight;$.y-=ce.deltaY*ge*.5}else Y=Math.max(4e3,Math.min(45e3,Y+ce.deltaY*12));re()},he=ce=>{if(ce.target.tagName==="INPUT"||ce.target.tagName==="TEXTAREA")return;const ge=Y*.05;ce.key==="ArrowLeft"&&($.x-=Math.sin(A)*ge,$.z+=Math.cos(A)*ge),ce.key==="ArrowRight"&&($.x+=Math.sin(A)*ge,$.z-=Math.cos(A)*ge),ce.key==="ArrowUp"&&($.y+=ge*.4),ce.key==="ArrowDown"&&($.y-=ge*.4),re()};g.domElement.addEventListener("mousedown",me),g.domElement.addEventListener("mousemove",Le),g.domElement.addEventListener("mouseup",Ne),g.domElement.addEventListener("mouseleave",Ne),g.domElement.addEventListener("wheel",Be,{passive:!1}),g.domElement.style.cursor="grab",window.addEventListener("keydown",he);const U=()=>{h.current=requestAnimationFrame(U),g.render(m,c)};U();const He=()=>{const ce=p.clientWidth,ge=p.clientHeight;c.aspect=ce/ge,c.updateProjectionMatrix(),g.setSize(ce,ge)};return window.addEventListener("resize",He),()=>{cancelAnimationFrame(h.current),window.removeEventListener("resize",He),window.removeEventListener("keydown",he),g.domElement.removeEventListener("mousedown",me),g.domElement.removeEventListener("mousemove",Le),g.domElement.removeEventListener("mouseup",Ne),g.domElement.removeEventListener("mouseleave",Ne),g.domElement.removeEventListener("wheel",Be),p.contains(g.domElement)&&p.removeChild(g.domElement),g.dispose()}},[]),Ae.useEffect(()=>{const p=a.current;if(!p)return;const x=[];p.traverse(w=>{w.userData.dynamic&&x.push(w)}),x.forEach(w=>p.remove(w)),d.current={};const y=new Xf(new vm(new Cr(t.innerLength,t.innerHeight,t.innerWidth)),new ds({color:65450}));y.position.set(t.innerLength/2,t.innerHeight/2,0),y.userData.dynamic=!0,p.add(y);const m=new Zt(new Ui(t.innerLength,t.innerWidth),new pc({color:1718826,transparent:!0,opacity:.4,side:Nn}));m.rotation.x=-Math.PI/2,m.position.set(t.innerLength/2,2,0),m.receiveShadow=!0,m.userData.dynamic=!0,p.add(m);const c=new pc({color:8956620,transparent:!0,opacity:.1,side:Nn});[-1,1].forEach(w=>{const I=new Zt(new Ui(t.innerLength,t.innerHeight),c);I.position.set(t.innerLength/2,t.innerHeight/2,w*t.innerWidth/2),I.userData.dynamic=!0,p.add(I)});const g=new Zt(new Ui(t.innerWidth,t.innerHeight),c);g.rotation.y=Math.PI/2,g.position.set(0,t.innerHeight/2,0),g.userData.dynamic=!0,p.add(g);const _=w=>{const I=document.createElement("canvas");I.width=256,I.height=64;const E=I.getContext("2d");return E.fillStyle="rgba(0,20,40,0.82)",E.fillRect(0,0,256,64),E.fillStyle="#00ffaa",E.font="bold 28px monospace",E.textAlign="center",E.textBaseline="middle",E.fillText(w,128,32),new v_(I)},v=1e3;for(let w=0;w<=t.innerLength;w+=v){const I=new fc(new ol({map:_(`${w}`),depthTest:!1}));I.scale.set(700,175,1),I.position.set(w,-250,t.innerWidth/2+200),I.userData.dynamic=!0,p.add(I);const E=[new G(w,-10,t.innerWidth/2),new G(w,-300,t.innerWidth/2)],S=new Wf(new dn().setFromPoints(E),new ds({color:65450}));S.userData.dynamic=!0,p.add(S)}const N=500;for(let w=0;w<=t.innerHeight;w+=N){const I=new fc(new ol({map:_(`${w}`),depthTest:!1}));I.scale.set(600,150,1),I.position.set(-450,w,t.innerWidth/2),I.userData.dynamic=!0,p.add(I);const E=[new G(-10,w,t.innerWidth/2),new G(-300,w,t.innerWidth/2)],S=new Wf(new dn().setFromPoints(E),new ds({color:65450}));S.userData.dynamic=!0,p.add(S)}const C=new Set;for(let w=0;w<e.length;w++)for(let I=w+1;I<e.length;I++){const E=e[w],S=e[I];E.x<S.x+S.length&&E.x+E.length>S.x&&E.y<S.y+S.width&&E.y+E.width>S.y&&E.z<S.z+S.height&&E.z+E.height>S.z&&(C.add(E.id),C.add(S.id))}e.forEach(w=>{const E=C.has(w.id)?new Ge(8947848):new Ge(w.color),S=w.id===n,P=new Cr(w.length,w.height,w.width),A=new Zt(P,new iT({color:E,specular:2236962,shininess:40,transparent:!0,opacity:S?1:.88}));A.position.set(w.x+w.length/2,w.z+w.height/2,w.y-t.innerWidth/2+w.width/2),A.castShadow=!0,A.userData.dynamic=!0,A.userData.isBoxMesh=!0,A.userData.boxId=w.id,p.add(A);const F=new Xf(new vm(P),new ds({color:S?16777215:0,transparent:!0,opacity:S?.9:.25}));F.position.copy(A.position),F.userData.dynamic=!0,p.add(F);const Y=pT(`${w.length}×${w.width}×${w.height} mm`,w.color),V=new fc(new ol({map:Y,depthTest:!1})),W=Math.max(w.length,1400);V.scale.set(W,W*.18,1),V.position.set(w.x+w.length/2,w.z+w.height+280,w.y-t.innerWidth/2+w.width/2),V.userData.dynamic=!0,p.add(V),d.current[w.id]={mesh:A,edges:F,label:V}})},[t,e,n]),z.jsxs("div",{style:{position:"relative",width:"100%",height:"100%"},children:[z.jsx("div",{ref:o,style:{width:"100%",height:"100%"}}),z.jsx("div",{style:{position:"absolute",bottom:10,left:10,fontSize:10,color:"#6677aa",pointerEvents:"none",background:"rgba(0,0,0,0.4)",padding:"4px 9px",borderRadius:4,lineHeight:1.7},children:"🖱 Drag = หมุน  |  Ctrl+Drag = เลื่อน  |  Shift+Drag = บนล่าง  |  Scroll = ซูม  |  ↑↓←→ = เลื่อน  |  ลากกล่อง = จัดพื้น  |  Alt+ลาก(เลือกกล่องก่อน) = ยกขึ้นลง  |  ⬜ = ชนกัน"})]})}function gT(){const[t,e]=Ae.useState([]),[n,i]=Ae.useState(null),[r,s]=Ae.useState("car"),[o,a]=Ae.useState(!1),[l,u]=Ae.useState("hilux_dc"),[d,h]=Ae.useState({length:5300,width:1850,height:1800,weight:2e3,label:""}),[f,p]=Ae.useState({...cT}),[x,y]=Ae.useState(!1),[m,c]=Ae.useState([]),[g,_]=Ae.useState([]),[v,N]=Ae.useState([]),[C,w]=Ae.useState(null),[I,E]=Ae.useState(!1),[S,P]=Ae.useState("eu_pallet"),[A,F]=Ae.useState({length:1e3,width:800,height:800,weight:50,label:""}),[Y,V]=Ae.useState(-1500),[W,j]=Ae.useState(0),[L,H]=Ae.useState("My Project"),K=Ae.useRef([]);K.current=t;const te=Ae.useRef(null),pe=Ae.useRef(null),Fe=()=>{const D={projectName:L,container:f,vehicles:t,boxes:v},R=new Blob([JSON.stringify(D,null,2)],{type:"application/json"}),Q=document.createElement("a");Q.href=URL.createObjectURL(R),Q.download=`${L.replace(/\s+/g,"_")||"project"}.clp.json`,Q.click(),URL.revokeObjectURL(Q.href)},$=D=>{const R=new FileReader;R.onload=Q=>{try{const ae=JSON.parse(Q.target.result);ae.container&&p(ae.container),ae.vehicles&&(e(ae.vehicles),i(null)),ae.boxes&&(N(ae.boxes),w(null)),ae.projectName&&H(ae.projectName)}catch{alert("ไฟล์ไม่ถูกต้อง")}},R.readAsText(D)},re=()=>{var Q;const D=(Q=te.current)==null?void 0:Q.getCanvas();if(!D){alert("สลับไปหน้า Car Load ก่อน");return}const R=document.createElement("a");R.href=D.toDataURL("image/png"),R.download=`${L.replace(/\s+/g,"_")||"layout"}.png`,R.click()},ve=()=>{var ae;const D=(ae=te.current)==null?void 0:ae.getCanvas();if(!D){alert("สลับไปหน้า Car Load ก่อน");return}const R=D.toDataURL("image/png"),Q=window.open("","_blank");Q.document.write(`<!DOCTYPE html><html><head><title>${L}</title><style>*{margin:0;padding:0}body{background:#fff}img{max-width:100%;display:block}h3{font-family:sans-serif;padding:8px 12px;font-size:13px}@media print{h3{margin:0}}</style></head><body><h3>${L} — ${f.name} | ${new Date().toLocaleDateString("th-TH")}</h3><img src="${R}"/></body></html>`),Q.document.close(),Q.addEventListener("load",()=>Q.print())},me=t.reduce((D,R)=>D+R.weight,0),Le=me>f.maxPayload,Ne=Ae.useMemo(()=>{if(!t.length)return{lenUsed:0,lenLeft:f.innerLength};let D=0;return t.forEach(R=>{const Q=R.x+(R.rotated?R.width:R.length);Q>D&&(D=Q)}),{lenUsed:D,lenLeft:f.innerLength-D}},[t,f]),Be=Ae.useMemo(()=>{const D=new Set;for(let R=0;R<t.length;R++)for(let Q=R+1;Q<t.length;Q++){const ae=t[R],Se=t[Q],Te=ae.rotated?ae.width:ae.length,Ve=ae.rotated?ae.length:ae.width,Xe=Se.rotated?Se.width:Se.length,st=Se.rotated?Se.length:Se.width;ae.x<Se.x+Xe&&ae.x+Te>Se.x&&ae.y<Se.y+st&&ae.y+Ve>Se.y&&(D.add(ae.id),D.add(Se.id))}return t.forEach(R=>{const Q=R.rotated?R.width:R.length,ae=R.rotated?R.length:R.width;(R.x<0||R.y<0||R.x+Q>f.innerLength||R.y+ae>f.innerWidth)&&D.add(R.id)}),D},[t,f]),he=()=>{const D=wm.find(ae=>ae.id===l),R=l==="custom",Q={id:Am(),preset:R?d.label||"Custom":D.name,length:R?d.length:D.length,width:R?d.width:D.width,height:R?d.height:D.height,weight:R?d.weight:D.weight,cabRatio:R?.5:D.cabRatio,x:200,y:Math.round((f.innerWidth-(R?d.width:D.width))/2),rotated:!1,rearLifted:!1,color:Ba[t.length%Ba.length],sideX:200,sideY:0,sideAngle:0,sideImage:null,removeBg:!0,flipX:!1,imgRealLength:R?d.length:D.length,imgRealHeight:R?d.height:D.height};He(),e(ae=>[...ae,Q]),i(Q.id),a(!1)},U=(D,R)=>{const Q=new FileReader;Q.onload=ae=>ee(D,{sideImage:ae.target.result}),Q.readAsDataURL(R)},He=Ae.useCallback(()=>{c(D=>[...D.slice(-49),K.current]),_([])},[]),ce=Ae.useCallback(()=>{c(D=>{if(!D.length)return D;const R=D[D.length-1];return _(Q=>[K.current,...Q.slice(0,49)]),e(R),D.slice(0,-1)})},[]),ge=Ae.useCallback(()=>{_(D=>{if(!D.length)return D;const R=D[0];return c(Q=>[...Q.slice(-49),K.current]),e(R),D.slice(1)})},[]);Ae.useEffect(()=>{const D=R=>{R.target.tagName==="INPUT"||R.target.tagName==="TEXTAREA"||(R.ctrlKey&&!R.shiftKey&&R.key==="z"&&(R.preventDefault(),ce()),R.ctrlKey&&(R.key==="y"||R.shiftKey&&R.key==="z")&&(R.preventDefault(),ge()))};return window.addEventListener("keydown",D),()=>window.removeEventListener("keydown",D)},[ce,ge]);const ue=Ae.useMemo(()=>{const D=new Set;for(let R=0;R<v.length;R++)for(let Q=R+1;Q<v.length;Q++){const ae=v[R],Se=v[Q];ae.x<Se.x+Se.length&&ae.x+ae.length>Se.x&&ae.y<Se.y+Se.width&&ae.y+ae.width>Se.y&&(D.add(ae.id),D.add(Se.id))}return v.forEach(R=>{(R.x<0||R.y<0||R.x+R.length>f.innerLength||R.y+R.width>f.innerWidth)&&D.add(R.id)}),D},[v,f]),De=v.reduce((D,R)=>D+R.weight,0),be=()=>{const D=Tm.find(Se=>Se.id===S),R=S==="box_custom",Q=R?A.width:D.width;He();const ae={id:Am(),preset:R?A.label||"Custom":D.name,length:R?A.length:D.length,width:Q,height:R?A.height:D.height,weight:R?A.weight:D.weight,x:Y,y:Math.max(0,Math.min(f.innerWidth-Q,W)),z:0,color:Ba[v.length%Ba.length]};N(Se=>[...Se,ae]),w(ae.id),E(!1)},Me=(D,R)=>N(Q=>Q.map(ae=>ae.id===D?{...ae,...R}:ae)),b=(D,R,Q)=>Me(D,{x:Math.max(0,R),y:Math.max(0,Q)}),M=(D,R,Q,ae)=>{const Se={};R!=null&&(Se.x=Math.max(0,R)),Q!=null&&(Se.y=Math.max(0,Q)),ae!=null&&(Se.z=Math.max(0,ae)),Me(D,Se)},X=D=>{He(),N(R=>R.filter(Q=>Q.id!==D)),C===D&&w(null)},ee=(D,R)=>e(Q=>Q.map(ae=>ae.id===D?{...ae,...R}:ae)),oe=D=>{He(),e(R=>R.filter(Q=>Q.id!==D)),n===D&&i(null)},ie=()=>{He();const D=[...t].sort((Q,ae)=>ae.length-Q.length);let R=100;e(D.map(Q=>{const ae={...Q,x:R,y:Math.round((f.innerWidth-(Q.rotated?Q.length:Q.width))/2)};return R+=(Q.rotated?Q.width:Q.length)+200,ae}))},Pe=Ne.lenUsed/f.innerLength*100,xe=me/f.maxPayload*100,J={app:{fontFamily:"'Segoe UI','Noto Sans Thai',sans-serif",background:"#1c2333",color:"#e8eaf5",height:"100vh",display:"flex",flexDirection:"column",overflow:"hidden",fontSize:13},hdr:{background:"linear-gradient(135deg,#1e3a5f,#2d5a8e)",padding:"8px 16px",display:"flex",alignItems:"center",justifyContent:"space-between",borderBottom:"1px solid #00ddaa55",flexShrink:0},body:{display:"flex",flex:1,overflow:"hidden"},side:{width:290,background:"#212a3e",borderRight:"1px solid #2e3a52",display:"flex",flexDirection:"column",overflow:"hidden",flexShrink:0},sec:{padding:"10px 12px",borderBottom:"1px solid #2e3a52"},lbl:{fontSize:10,fontWeight:600,textTransform:"uppercase",letterSpacing:1,color:"#00ddaa",marginBottom:6},vp:{flex:1,display:"flex",flexDirection:"column",overflow:"hidden"},tb:{display:"flex",gap:5,padding:"6px 10px",background:"#1c2840",borderBottom:"1px solid #2e3a52",alignItems:"center",flexShrink:0},va:{flex:1,position:"relative",overflow:"hidden"},btn:{padding:"5px 10px",borderRadius:5,border:"1px solid #3a4a66",background:"#263048",color:"#c8cedf",cursor:"pointer",fontSize:11,fontWeight:500},btnA:{background:"#00ddaa22",borderColor:"#00ddaa",color:"#00ddaa"},btnP:{background:"linear-gradient(135deg,#00ddaa,#00aa88)",border:"none",color:"#0a1a14",fontWeight:700},btnD:{background:"#ff44441a",borderColor:"#ff6666",color:"#ff8888"},inp:{width:"100%",padding:"5px 7px",borderRadius:4,border:"1px solid #3a4a66",background:"#1e2a42",color:"#e8eaf5",fontSize:12,boxSizing:"border-box"},sel:{width:"100%",padding:"5px 7px",borderRadius:4,border:"1px solid #3a4a66",background:"#1e2a42",color:"#e8eaf5",fontSize:12,boxSizing:"border-box"},card:(D,R)=>({padding:"7px 9px",borderRadius:6,border:`1px solid ${R?"#ff6666":D?"#00ddaa":"#2e3a52"}`,background:D?"#00ddaa15":"#1e2a40",cursor:"pointer",marginBottom:5}),bar:{height:4,borderRadius:2,background:"#2e3a52",marginTop:3,overflow:"hidden"},fill:(D,R)=>({height:"100%",width:`${Math.min(100,D)}%`,background:D>95?"#ff5555":R,borderRadius:2,transition:"width .3s"}),badge:D=>({display:"inline-block",padding:"1px 5px",borderRadius:3,fontSize:9,fontWeight:600,background:D+"22",color:D,marginLeft:5}),status:{padding:"5px 12px",background:"#1a2235",borderTop:"1px solid #2e3a52",display:"flex",justifyContent:"space-between",fontSize:10,color:"#7a8aaa",flexShrink:0}};return z.jsxs("div",{style:J.app,children:[z.jsxs("div",{style:J.hdr,children:[z.jsxs("div",{style:{display:"flex",alignItems:"center",gap:10},children:[z.jsx("div",{style:{width:32,height:32,background:"linear-gradient(135deg,#00ffaa,#00aa77)",borderRadius:7,display:"flex",alignItems:"center",justifyContent:"center",fontSize:16,color:"#0a0a18"},children:"📦"}),z.jsxs("div",{children:[z.jsx("div",{style:{fontSize:15,fontWeight:700,color:"#00ffaa"},children:"CONTAINER LOADING PLANNER"}),z.jsx("input",{value:L,onChange:D=>H(D.target.value),style:{background:"transparent",border:"none",borderBottom:"1px solid #3a4a66",color:"#aab",fontSize:10,outline:"none",width:180,padding:"1px 2px"},placeholder:"ชื่อ Project..."})]})]}),z.jsxs("div",{style:{display:"flex",gap:5,alignItems:"center"},children:[z.jsx("button",{style:J.btn,onClick:Fe,title:"Export โปรเจกต์เป็น JSON",children:"💾 Export"}),z.jsxs("label",{style:{...J.btn,cursor:"pointer"},title:"Import โปรเจกต์จาก JSON",children:["📂 Import",z.jsx("input",{ref:pe,type:"file",accept:".json,.clp.json",style:{display:"none"},onChange:D=>{D.target.files[0]&&($(D.target.files[0]),D.target.value="")}})]}),z.jsx("button",{style:J.btn,onClick:re,title:"ดาวน์โหลด PNG (Car Load view)",children:"⬇ PNG"}),z.jsx("button",{style:J.btn,onClick:ve,title:"Print / PDF (Car Load view)",children:"🖨 Print"}),z.jsx("button",{style:J.btn,onClick:ie,disabled:!t.length,children:"⚡ Auto"})]})]}),z.jsxs("div",{style:J.body,children:[z.jsxs("div",{style:J.side,children:[z.jsxs("div",{style:J.sec,children:[z.jsx("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:6},children:z.jsxs("div",{onClick:()=>y(!x),style:{...J.lbl,cursor:"pointer",marginBottom:0},children:["📦 Container ",x?"▲":"▼"]})}),z.jsx("div",{style:{display:"flex",justifyContent:"space-between",padding:"2px 0"},children:z.jsx("span",{style:{color:"#888",fontSize:11},children:f.name})}),z.jsxs("div",{style:{display:"flex",justifyContent:"space-between",padding:"2px 0"},children:[z.jsx("span",{style:{color:"#888",fontSize:10},children:"L×W×H"}),z.jsxs("span",{style:{fontFamily:"monospace",fontWeight:600,fontSize:10},children:[f.innerLength,"×",f.innerWidth,"×",f.innerHeight]})]}),x&&z.jsxs("div",{style:{marginTop:8,display:"flex",flexDirection:"column",gap:5},children:[z.jsx("select",{style:J.sel,onChange:D=>{const R=Em.find(Q=>Q.name===D.target.value);R&&p({...R})},children:Em.map(D=>z.jsx("option",{value:D.name,children:D.name},D.name))}),z.jsx("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:4},children:[["ยาว (mm)","innerLength"],["กว้าง (mm)","innerWidth"],["สูง (mm)","innerHeight"],["Door H (mm)","doorHeight"],["Door W (mm)","doorWidth"],["Max kg","maxPayload"]].map(([D,R])=>z.jsxs("div",{children:[z.jsx("label",{style:{fontSize:9,color:"#777"},children:D}),z.jsx("input",{style:J.inp,type:"number",value:f[R],onChange:Q=>p(ae=>({...ae,[R]:Number(Q.target.value),name:"Custom"}))})]},R))})]})]}),z.jsxs("div",{style:J.sec,children:[z.jsx("div",{style:J.lbl,children:"📐 Clearance & Weight"}),z.jsxs("div",{style:{display:"flex",justifyContent:"space-between",padding:"3px 0"},children:[z.jsx("span",{style:{color:"#888",fontSize:11},children:"ใช้ความยาว"}),z.jsxs("span",{style:{fontFamily:"monospace",fontWeight:600,fontSize:11},children:[Math.round(Ne.lenUsed)," mm (",Math.round(Pe),"%)"]})]}),z.jsx("div",{style:J.bar,children:z.jsx("div",{style:J.fill(Pe,"#00ffaa")})}),z.jsxs("div",{style:{display:"flex",justifyContent:"space-between",padding:"3px 0",marginTop:4},children:[z.jsx("span",{style:{color:"#888",fontSize:11},children:"เหลือ"}),z.jsxs("span",{style:{fontFamily:"monospace",fontWeight:600,fontSize:11,color:Ne.lenLeft<500?"#ff6666":"#00ffaa"},children:[Math.round(Ne.lenLeft)," mm"]})]}),z.jsxs("div",{style:{display:"flex",justifyContent:"space-between",padding:"3px 0",marginTop:6},children:[z.jsx("span",{style:{color:"#888",fontSize:11},children:"น้ำหนักรวม"}),z.jsxs("span",{style:{fontFamily:"monospace",fontWeight:600,fontSize:11,color:Le?"#ff4444":"#ddd"},children:[me.toLocaleString()," / ",f.maxPayload.toLocaleString()," kg"]})]}),z.jsx("div",{style:J.bar,children:z.jsx("div",{style:J.fill(xe,Le?"#ff4444":"#F59E0B")})}),Le&&z.jsxs("div",{style:{color:"#ff4444",fontSize:10,marginTop:3,fontWeight:600},children:["⚠️ เกิน ",(me-f.maxPayload).toLocaleString()," kg"]}),Be.size>0&&z.jsxs("div",{style:{color:"#ff4444",fontSize:10,marginTop:4,fontWeight:600},children:["⚠️ ชนกัน/เกินขอบ ",Be.size," คัน"]})]}),r==="car"?z.jsxs("div",{style:{...J.sec,flex:1,overflow:"auto"},children:[z.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:6},children:[z.jsxs("div",{style:J.lbl,children:["🚗 รถในตู้ (",t.length,")"]}),z.jsx("button",{style:{...J.btn,...J.btnP,padding:"3px 8px"},onClick:()=>a(!o),children:"+ เพิ่มรถ"})]}),o&&z.jsxs("div",{style:{background:"#161638",borderRadius:7,padding:9,marginBottom:8,border:"1px solid #00ffaa33"},children:[z.jsx("select",{style:J.sel,value:l,onChange:D=>u(D.target.value),children:wm.map(D=>z.jsxs("option",{value:D.id,children:[D.name," ",D.id!=="custom"?`(${D.length}×${D.width})`:""]},D.id))}),l==="custom"&&z.jsx("div",{style:{marginTop:6,display:"grid",gridTemplateColumns:"1fr 1fr",gap:5},children:[["ชื่อ","label","text"],["น้ำหนัก kg","weight","number"],["ยาว mm","length","number"],["กว้าง mm","width","number"],["สูง mm","height","number"]].map(([D,R,Q])=>z.jsxs("div",{children:[z.jsx("label",{style:{fontSize:9,color:"#777"},children:D}),z.jsx("input",{style:J.inp,type:Q,value:d[R],onChange:ae=>h({...d,[R]:Q==="number"?Number(ae.target.value):ae.target.value})})]},R))}),z.jsx("button",{style:{...J.btn,...J.btnP,width:"100%",marginTop:7},onClick:he,children:"✓ เพิ่มรถเข้าตู้"})]}),t.map(D=>z.jsxs("div",{style:J.card(D.id===n,Be.has(D.id)),onClick:()=>i(D.id===n?null:D.id),children:[z.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[z.jsxs("div",{style:{display:"flex",alignItems:"center",gap:5},children:[z.jsx("div",{style:{width:10,height:10,borderRadius:2,background:D.color}}),z.jsx("span",{style:{fontWeight:600,fontSize:11},children:D.preset})]}),z.jsx("button",{style:{...J.btn,...J.btnD,padding:"1px 5px",fontSize:10},onClick:R=>{R.stopPropagation(),oe(D.id)},children:"✕"})]}),z.jsxs("div",{style:{fontSize:10,color:"#777",marginTop:3},children:[D.length,"×",D.width,"×",D.height," mm • ",D.weight," kg",D.rearLifted&&z.jsx("span",{style:J.badge("#F59E0B"),children:"ยกล้อหลัง"}),D.rotated&&z.jsx("span",{style:J.badge("#8B5CF6"),children:"หมุน 90°"})]}),D.id===n&&z.jsxs("div",{style:{marginTop:6,display:"flex",flexDirection:"column",gap:5},children:[z.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:4},children:[z.jsxs("div",{children:[z.jsx("label",{style:{fontSize:9,color:"#777"},children:"X (mm)"}),z.jsx("input",{style:J.inp,type:"number",value:D.x,onChange:R=>ee(D.id,{x:Number(R.target.value)}),onClick:R=>R.stopPropagation()})]}),z.jsxs("div",{children:[z.jsx("label",{style:{fontSize:9,color:"#777"},children:"Y (mm)"}),z.jsx("input",{style:J.inp,type:"number",value:D.y,onChange:R=>ee(D.id,{y:Number(R.target.value)}),onClick:R=>R.stopPropagation()})]})]}),z.jsxs("div",{style:{display:"flex",gap:4},children:[z.jsx("button",{style:{...J.btn,flex:1,...D.rearLifted?J.btnA:{},fontSize:10,padding:3},onClick:R=>{R.stopPropagation(),ee(D.id,{rearLifted:!D.rearLifted})},children:"⬆ ยกล้อหลัง"}),z.jsx("button",{style:{...J.btn,flex:1,...D.rotated?J.btnA:{},fontSize:10,padding:3},onClick:R=>{R.stopPropagation(),ee(D.id,{rotated:!D.rotated})},children:"🔄 หมุน 90°"})]}),z.jsx("button",{style:{...J.btn,fontSize:10,padding:3},onClick:R=>{R.stopPropagation(),ee(D.id,{x:Math.round(D.x/50)*50,y:Math.round(D.y/50)*50})},children:"📐 Snap 50mm"}),z.jsxs("div",{style:{borderTop:"1px solid #252540",paddingTop:5},children:[z.jsx("div",{style:{fontSize:9,color:"#00ffaa88",marginBottom:4,fontWeight:600,letterSpacing:1},children:"SIDE ELEV"}),z.jsxs("div",{style:{display:"flex",gap:4,marginBottom:4},children:[z.jsxs("label",{style:{...J.btn,flex:1,textAlign:"center",cursor:"pointer",fontSize:10,padding:"4px 0"},onClick:R=>R.stopPropagation(),children:["🖼 ",D.sideImage?"เปลี่ยนรูป":"Upload รูป",z.jsx("input",{type:"file",accept:"image/*",style:{display:"none"},onChange:R=>{R.target.files[0]&&U(D.id,R.target.files[0])},onClick:R=>R.stopPropagation()})]}),z.jsx("button",{style:{...J.btn,fontSize:10,padding:"4px 6px",...D.removeBg?J.btnA:{}},onClick:R=>{R.stopPropagation(),ee(D.id,{removeBg:!D.removeBg})},title:"ลบพื้นหลังสีขาว",children:"✂ BG"}),z.jsx("button",{style:{...J.btn,fontSize:10,padding:"4px 6px",...D.flipX?J.btnA:{}},onClick:R=>{R.stopPropagation(),ee(D.id,{flipX:!D.flipX})},title:"พลิกภาพซ้าย-ขวา",children:"⇄ Flip"})]}),z.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:4},children:[z.jsxs("div",{children:[z.jsx("label",{style:{fontSize:9,color:"#777"},children:"Side X"}),z.jsx("input",{style:J.inp,type:"number",value:D.sideX??200,onChange:R=>ee(D.id,{sideX:Number(R.target.value)}),onClick:R=>R.stopPropagation()})]}),z.jsxs("div",{children:[z.jsx("label",{style:{fontSize:9,color:"#777"},children:"Floor Y"}),z.jsx("input",{style:J.inp,type:"number",value:D.sideY??0,onChange:R=>ee(D.id,{sideY:Number(R.target.value)}),onClick:R=>R.stopPropagation()})]}),z.jsxs("div",{children:[z.jsx("label",{style:{fontSize:9,color:"#777"},children:"องศา°"}),z.jsx("input",{style:J.inp,type:"number",step:"0.5",value:D.sideAngle??0,onChange:R=>ee(D.id,{sideAngle:Number(R.target.value)}),onClick:R=>R.stopPropagation()})]})]}),z.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:4,marginTop:5},children:[z.jsxs("div",{children:[z.jsx("label",{style:{fontSize:9,color:"#00ddaa"},children:"ความยาวรูป (mm)"}),z.jsx("input",{style:J.inp,type:"number",step:"1",value:D.imgRealLength??D.length,onChange:R=>ee(D.id,{imgRealLength:Number(R.target.value)}),onClick:R=>R.stopPropagation()})]}),z.jsxs("div",{children:[z.jsx("label",{style:{fontSize:9,color:"#00ddaa"},children:"ความสูงรูป (mm)"}),z.jsx("input",{style:J.inp,type:"number",step:"1",value:D.imgRealHeight??D.height,onChange:R=>ee(D.id,{imgRealHeight:Number(R.target.value)}),onClick:R=>R.stopPropagation()})]})]}),z.jsx("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:4}})]})]})]},D.id)),!t.length&&z.jsx("div",{style:{textAlign:"center",color:"#444",padding:16,fontSize:12},children:'กด "+ เพิ่มรถ" เพื่อเริ่มวางแผน'})]}):z.jsxs("div",{style:{...J.sec,flex:1,overflow:"auto"},children:[z.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:6},children:[z.jsxs("div",{style:J.lbl,children:["📦 สินค้า (",v.length,") • ",De.toLocaleString()," kg"]}),z.jsx("button",{style:{...J.btn,...J.btnP,padding:"3px 8px"},onClick:()=>E(!I),children:"+ เพิ่ม"})]}),I&&z.jsxs("div",{style:{background:"#161638",borderRadius:7,padding:9,marginBottom:8,border:"1px solid #00ffaa33"},children:[z.jsx("select",{style:J.sel,value:S,onChange:D=>P(D.target.value),children:Tm.map(D=>z.jsxs("option",{value:D.id,children:[D.name," ",D.id!=="box_custom"?`(${D.length}×${D.width}×${D.height}mm)`:""]},D.id))}),S==="box_custom"&&z.jsx("div",{style:{marginTop:6,display:"grid",gridTemplateColumns:"1fr 1fr",gap:5},children:[["ชื่อ","label","text"],["ยาว mm","length","number"],["กว้าง mm","width","number"],["สูง mm","height","number"],["น้ำหนัก kg","weight","number"]].map(([D,R,Q])=>z.jsxs("div",{children:[z.jsx("label",{style:{fontSize:9,color:"#777"},children:D}),z.jsx("input",{style:J.inp,type:Q,value:A[R],onChange:ae=>F({...A,[R]:Q==="number"?Number(ae.target.value):ae.target.value})})]},R))}),z.jsxs("div",{style:{marginTop:6,display:"grid",gridTemplateColumns:"1fr 1fr",gap:4},children:[z.jsxs("div",{children:[z.jsx("label",{style:{fontSize:9,color:"#00ddaa"},children:"จุดเกิด X (mm)"}),z.jsx("input",{style:J.inp,type:"number",value:Y,onChange:D=>V(Number(D.target.value))}),z.jsx("div",{style:{fontSize:9,color:"#555",marginTop:1},children:"ลบ = นอกตู้ด้านหลัง"})]}),z.jsxs("div",{children:[z.jsx("label",{style:{fontSize:9,color:"#00ddaa"},children:"จุดเกิด Y (mm)"}),z.jsx("input",{style:J.inp,type:"number",value:W,onChange:D=>j(Number(D.target.value))}),z.jsx("div",{style:{fontSize:9,color:"#555",marginTop:1},children:"0 = ชิดผนังซ้าย"})]})]}),z.jsx("button",{style:{...J.btn,...J.btnP,width:"100%",marginTop:7},onClick:be,children:"✓ เพิ่มสินค้า"})]}),v.map(D=>z.jsxs("div",{style:J.card(D.id===C,ue.has(D.id)),onClick:()=>w(D.id===C?null:D.id),children:[z.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[z.jsxs("div",{style:{display:"flex",alignItems:"center",gap:5},children:[z.jsx("div",{style:{width:10,height:10,borderRadius:2,background:D.color}}),z.jsx("span",{style:{fontWeight:600,fontSize:11},children:D.preset})]}),z.jsx("button",{style:{...J.btn,...J.btnD,padding:"1px 5px",fontSize:10},onClick:R=>{R.stopPropagation(),X(D.id)},children:"✕"})]}),z.jsxs("div",{style:{fontSize:10,color:"#777",marginTop:3},children:[D.length,"×",D.width,"×",D.height," mm • ",D.weight," kg"]}),D.id===C&&z.jsxs("div",{style:{marginTop:6,display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:4},children:[z.jsxs("div",{children:[z.jsx("label",{style:{fontSize:9,color:"#777"},children:"X (mm)"}),z.jsx("input",{style:J.inp,type:"number",value:D.x,onChange:R=>Me(D.id,{x:Number(R.target.value)}),onClick:R=>R.stopPropagation()})]}),z.jsxs("div",{children:[z.jsx("label",{style:{fontSize:9,color:"#777"},children:"Y (mm)"}),z.jsx("input",{style:J.inp,type:"number",value:D.y,onChange:R=>Me(D.id,{y:Number(R.target.value)}),onClick:R=>R.stopPropagation()})]}),z.jsxs("div",{children:[z.jsx("label",{style:{fontSize:9,color:"#777"},children:"Z พื้น (mm)"}),z.jsx("input",{style:J.inp,type:"number",value:D.z,onChange:R=>Me(D.id,{z:Number(R.target.value)}),onClick:R=>R.stopPropagation()})]})]})]},D.id)),!v.length&&z.jsx("div",{style:{textAlign:"center",color:"#444",padding:16,fontSize:12},children:'กด "+ เพิ่ม" เพื่อเพิ่มสินค้า'})]})]}),z.jsxs("div",{style:J.vp,children:[z.jsxs("div",{style:J.tb,children:[z.jsx("span",{style:{fontSize:10,color:"#555",marginRight:3},children:"VIEW:"}),[["car","🚗 Car Load"],["boxtop","📦 Box Top"],["box3d","📦 Box 3D"]].map(([D,R])=>z.jsx("button",{style:{...J.btn,...r===D?J.btnA:{},padding:"3px 9px"},onClick:()=>s(D),children:R},D)),z.jsx("div",{style:{flex:1}}),z.jsx("button",{style:{...J.btn,padding:"3px 8px",opacity:m.length?1:.35},onClick:ce,disabled:!m.length,title:"Ctrl+Z",children:"↩ Undo"}),z.jsx("button",{style:{...J.btn,padding:"3px 8px",opacity:g.length?1:.35},onClick:ge,disabled:!g.length,title:"Ctrl+Y",children:"↪ Redo"})]}),z.jsxs("div",{style:J.va,children:[r==="car"&&z.jsx(dT,{ref:te,container:f,vehicles:t,selectedId:n,onSelectVehicle:i,onUpdateVehicle:ee}),r==="boxtop"&&z.jsx(hT,{container:f,boxes:v,selectedId:C,onSelectBox:w,onMoveBox:b,collisions:ue}),r==="box3d"&&z.jsx(mT,{container:f,boxes:v,selectedId:C,onMoveBox:b,onSelectBox:w,onPlaceBox:M})]})]})]}),z.jsxs("div",{style:J.status,children:[z.jsxs("span",{children:[f.name," | ",f.innerLength,"×",f.innerWidth,"×",f.innerHeight," mm"]}),r==="car"?z.jsxs("span",{children:["Vehicles: ",t.length," | ",me.toLocaleString()," kg | Length: ",Math.round(Pe),"%"]}):z.jsxs("span",{children:["Boxes: ",v.length," | ",De.toLocaleString()," kg ",De>f.maxPayload?`⚠️ +${(De-f.maxPayload).toLocaleString()}kg`:""]})]})]})}z0(document.getElementById("root")).render(z.jsx(Ae.StrictMode,{children:z.jsx(gT,{})}));
