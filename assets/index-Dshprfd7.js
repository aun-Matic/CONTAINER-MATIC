...
`)+`
`+u);const _=g+m+o,v=g+u+a,P=am(r,r.VERTEX_SHADER,_),C=am(r,r.FRAGMENT_SHADER,v);r.attachShader(y,P),r.attachShader(y,C),n.index0AttributeName!==void 0?r.bindAttribLocation(y,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(y,0,"position"),r.linkProgram(y);function R(b){if(t.debug.checkShaderErrors){const T=r.getProgramInfoLog(y).trim(),k=r.getShaderInfoLog(P).trim(),Y=r.getShaderInfoLog(C).trim();let W=!0,V=!0;if(r.getProgramParameter(y,r.LINK_STATUS)===!1)if(W=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,y,P,C);else{const X=lm(r,P,"vertex"),I=lm(r,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(y,r.VALIDATE_STATUS)+`
...
}`;function Bw(t,e,n){let i=new lh;const r=new $e,s=new $e,o=new Nt,a=new Fw({depthPacking:Uy}),l=new Ow,c={},f=n.maxTextureSize,h={[ar]:_n,[_n]:ar,[Kn]:Kn},d=new lr({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new $e},radius:{value:4}},vertexShader:kw,fragmentShader:zw}),p=d.clone();p.defines.HORIZONTAL_PASS=1;const x=new vn;x.setAttribute("position",new ti(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const y=new fn(x,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=W0;let u=this.type;this.render=function(C,R,A){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||C.length===0)return;const E=t.getRenderTarget(),S=t.getActiveCubeFace(),b=t.getActiveMipmapLevel(),T=t.state;T.setBlending(nr),T.buffers.color.setClear(1,1,1,1),T.buffers.depth.setTest(!0),T.setScissorTest(!1);const k=u!==_i&&this.type===_i,Y=u===_i&&this.type!==_i;for(let W=0,V=C.length;W<V;W++){const X=C[W],I=X.shadow;if(I===void 0){console.warn("THREE.WebGLShadowMap:",X,"has no shadow.");continue}if(I.autoUpdate===!1&&I.needsUpdate===!1)continue;r.copy(I.mapSize);const H=I.getFrameExtents();if(r.multiply(H),s.copy(I.mapSize),(r.x>f||r.y>f)&&(r.x>f&&(s.x=Math.floor(f/H.x),r.x=s.x*H.x,I.mapSize.x=s.x),r.y>f&&(s.y=Math.floor(f/H.y),r.y=s.y*H.y,I.mapSize.y=s.y)),I.map===null||k===!0||Y===!0){const te=this.type!==_i?{minFilter:On,magFilter:On}:{};I.map!==null&&I.map.dispose(),I.map=new zr(r.x,r.y,te),I.map.texture.name=X.name+".shadowMap",I.camera.updateProjectionMatrix()}t.setRenderTarget(I.map),t.clear();const Z=I.getViewportCount();for(let te=0;te<Z;te++){const _e=I.getViewport(te);o.set(s.x*_e.x,s.y*_e.y,s.x*_e.z,s.y*_e.w),T.viewport(o),I.updateMatrices(X,te),i=I.getFrustum(),v(R,A,I.camera,X,this.type)}I.isPointLightShadow!==!0&&this.type===_i&&g(I,A),I.needsUpdate=!1}u=this.type,m.needsUpdate=!1,t.setRenderTarget(E,S,b)};function g(C,R){const A=e.update(y);d.defines.VSM_SAMPLES!==C.blurSamples&&(d.defines.VSM_SAMPLES=C.blurSamples,p.defines.VSM_SAMPLES=C.blurSamples,d.needsUpdate=!0,p.needsUpdate=!0),C.mapPass===null&&(C.mapPass=new zr(r.x,r.y)),d.uniforms.shadow_pass.value=C.map.texture,d.uniforms.resolution.value=C.mapSize,d.uniforms.radius.value=C.radius,t.setRenderTarget(C.mapPass),t.clear(),t.renderBufferDirect(R,null,A,d,y,null),p.uniforms.shadow_pass.value=C.mapPass.texture,p.uniforms.resolution.value=C.mapSize,p.uniforms.radius.value=C.radius,t.setRenderTarget(C.map),t.clear(),t.renderBufferDirect(R,null,A,p,y,null)}function _(C,R,A,E){let S=null;const b=A.isPointLight===!0?C.customDistanceMaterial:C.customDepthMaterial;if(b!==void 0)S=b;else if(S=A.isPointLight===!0?l:a,t.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0){const T=S.uuid,k=R.uuid;let Y=c[T];Y===void 0&&(Y={},c[T]=Y);let W=Y[k];W===void 0&&(W=S.clone(),Y[k]=W,R.addEventListener("dispose",P)),S=W}if(S.visible=R.visible,S.wireframe=R.wireframe,E===_i?S.side=R.shadowSide!==null?R.shadowSide:R.side:S.side=R.shadowSide!==null?R.shadowSide:h[R.side],S.alphaMap=R.alphaMap,S.alphaTest=R.alphaTest,S.map=R.map,S.clipShadows=R.clipShadows,S.clippingPlanes=R.clippingPlanes,S.clipIntersection=R.clipIntersection,S.displacementMap=R.displacementMap,S.displacementScale=R.displacementScale,S.displacementBias=R.displacementBias,S.wireframeLinewidth=R.wireframeLinewidth,S.linewidth=R.linewidth,A.isPointLight===!0&&S.isMeshDistanceMaterial===!0){const T=t.properties.get(S);T.light=A}return S}function v(C,R,A,E,S){if(C.visible===!1)return;if(C.layers.test(R.layers)&&(C.isMesh||C.isLine||C.isPoints)&&(C.castShadow||C.receiveShadow&&S===_i)&&(!C.frustumCulled||i.intersectsObject(C))){C.modelViewMatrix.multiplyMatrices(A.matrixWorldInverse,C.matrixWorld);const k=e.update(C),Y=C.material;if(Array.isArray(Y)){const W=k.groups;for(let V=0,X=W.length;V<X;V++){const I=W[V],H=Y[I.materialIndex];if(H&&H.visible){const Z=_(C,H,E,S);C.onBeforeShadow(t,C,R,A,k,Z,I),t.renderBufferDirect(A,null,k,Z,C,I),C.onAfterShadow(t,C,R,A,k,Z,I)}}}else if(Y.visible){const W=_(C,Y,E,S);C.onBeforeShadow(t,C,R,A,k,W,null),t.renderBufferDirect(A,null,k,W,C,null),C.onAfterShadow(t,C,R,A,k,W,null)}}const T=C.children;for(let k=0,Y=T.length;k<Y;k++)v(T[k],R,A,E,S)}function P(C){C.target.removeEventListener("dispose",P);for(const A in c){const E=c[A],S=C.target.uuid;S in E&&(E[S].dispose(),delete E[S])}}}function Hw(t){function e(){let z=!1;const fe=new Nt;let ne=null;const Q=new Nt(0,0,0,0);return{setMask:function(ve){ne!==ve&&!z&&(t.colorMask(ve,ve,ve,ve),ne=ve)},setLocked:function(ve){z=ve},setClear:function(ve,Be,et,At,se){se===!0&&(ve*=At,Be*=At,et*=At),fe.set(ve,Be,et,At),Q.equals(fe)===!1&&(t.clearColor(ve,Be,et,At),Q.copy(fe))},reset:function(){z=!1,ne=null,Q.set(-1,0,0,0)}}}function n(){let z=!1,fe=null,ne=null,Q=null;return{setTest:function(ve){ve?me(t.DEPTH_TEST):xe(t.DEPTH_TEST)},setMask:function(ve){fe!==ve&&!z&&(t.depthMask(ve),fe=ve)},setFunc:function(ve){if(ne!==ve){switch(ve){case gy:t.depthFunc(t.NEVER);break;case _y:t.depthFunc(t.ALWAYS);break;case vy:t.depthFunc(t.LESS);break;case Gl:t.depthFunc(t.LEQUAL);break;case xy:t.depthFunc(t.EQUAL);break;case yy:t.depthFunc(t.GEQUAL);break;case Sy:t.depthFunc(t.GREATER);break;case My:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}ne=ve}},setLocked:function(ve){z=ve},setClear:function(ve){Q!==ve&&(t.clearDepth(ve),Q=ve)},reset:function(){z=!1,fe=null,ne=null,Q=null}}}function i(){let z=!1,fe=null,ne=null,Q=null,ve=null,Be=null,et=null,At=null,se=null;return{setTest:function(L){z||(L?me(t.STENCIL_TEST):xe(t.STENCIL_TEST))},setMask:function(L){fe!==L&&!z&&(t.stencilMask(L),fe=L)},setFunc:function(L,F,oe){(ne!==L||Q!==F||ve!==oe)&&(t.stencilFunc(L,F,oe),ne=L,Q=F,ve=oe)},setOp:function(L,F,oe){(Be!==L||et!==F||At!==oe)&&(t.stencilOp(L,F,oe),Be=L,et=F,At=oe)},setLocked:function(L){z=L},setClear:function(L){se!==L&&(t.clearStencil(L),se=L)},reset:function(){z=!1,fe=null,ne=null,Q=null,ve=null,Be=null,et=null,At=null,se=null}}}const r=new e,s=new n,o=new i,a=new WeakMap,l=new WeakMap;let c={},f={},h=new WeakMap,d=[],p=null,x=!1,y=null,m=null,u=null,g=null,_=null,v=null,P=null,C=new Ye(0,0,0),R=0,A=!1,E=null,S=null,b=null,T=null,k=null;const Y=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let W=!1,V=0;const X=t.getParameter(t.VERSION);X.indexOf("WebGL")!==-1?(V=parseFloat(/^WebGL (\d)/.exec(X)[1]),W=V>=1):X.indexOf("OpenGL ES")!==-1&&(V=parseFloat(/^OpenGL ES (\d)/.exec(X)[1]),W=V>=2);let I=null,H={};const Z=t.getParameter(t.SCISSOR_BOX),te=t.getParameter(t.VIEWPORT),_e=new Nt().fromArray(Z),Oe=new Nt().fromArray(te);function K(z,fe,ne,Q){const ve=new Uint8Array(4),Be=t.createTexture();t.bindTexture(z,Be),t.texParameteri(z,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(z,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let et=0;et<ne;et++)z===t.TEXTURE_3D||z===t.TEXTURE_2D_ARRAY?t.texImage3D(fe,0,t.RGBA,1,1,Q,0,t.RGBA,t.UNSIGNED_BYTE,ve):t.texImage2D(fe+et,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,ve);return Be}const re={};re[t.TEXTURE_2D]=K(t.TEXTURE_2D,t.TEXTURE_2D,1),re[t.TEXTURE_CUBE_MAP]=K(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),re[t.TEXTURE_2D_ARRAY]=K(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),re[t.TEXTURE_3D]=K(t.TEXTURE_3D,t.TEXTURE_3D,1,1),r.setClear(0,0,0,1),s.setClear(1),o.setClear(0),me(t.DEPTH_TEST),s.setFunc(Gl),pe(!1),ce(Mp),me(t.CULL_FACE),qe(nr);function me(z){c[z]!==!0&&(t.enable(z),c[z]=!0)}function xe(z){c[z]!==!1&&(t.disable(z),c[z]=!1)}function Ie(z,fe){return f[z]!==fe?(t.bindFramebuffer(z,fe),f[z]=fe,z===t.DRAW_FRAMEBUFFER&&(f[t.FRAMEBUFFER]=fe),z===t.FRAMEBUFFER&&(f[t.DRAW_FRAMEBUFFER]=fe),!0):!1}function ke(z,fe){let ne=d,Q=!1;if(z){ne=h.get(fe),ne===void 0&&(ne=[],h.set(fe,ne));const ve=z.textures;if(ne.length!==ve.length||ne[0]!==t.COLOR_ATTACHMENT0){for(let Be=0,et=ve.length;Be<et;Be++)ne[Be]=t.COLOR_ATTACHMENT0+Be;ne.length=ve.length,Q=!0}}else ne[0]!==t.BACK&&(ne[0]=t.BACK,Q=!0);Q&&t.drawBuffers(ne)}function Xe(z){return p!==z?(t.useProgram(z),p=z,!0):!1}const ge={[Er]:t.FUNC_ADD,[Jx]:t.FUNC_SUBTRACT,[ey]:t.FUNC_REVERSE_SUBTRACT};ge[ty]=t.MIN,ge[ny]=t.MAX;const U={[iy]:t.ZERO,[ry]:t.ONE,[sy]:t.SRC_COLOR,[xd]:t.SRC_ALPHA,[dy]:t.SRC_ALPHA_SATURATE,[cy]:t.DST_COLOR,[ay]:t.DST_ALPHA,[oy]:t.ONE_MINUS_SRC_COLOR,[yd]:t.ONE_MINUS_SRC_ALPHA,[uy]:t.ONE_MINUS_DST_COLOR,[ly]:t.ONE_MINUS_DST_ALPHA,[fy]:t.CONSTANT_COLOR,[hy]:t.ONE_MINUS_CONSTANT_COLOR,[py]:t.CONSTANT_ALPHA,[my]:t.ONE_MINUS_CONSTANT_ALPHA};function qe(z,fe,ne,Q,ve,Be,et,At,se,L){if(z===nr){x===!0&&(xe(t.BLEND),x=!1);return}if(x===!1&&(me(t.BLEND),x=!0),z!==Qx){if(z!==y||L!==A){if((m!==Er||_!==Er)&&(t.blendEquation(t.FUNC_ADD),m=Er,_=Er),L)switch(z){case Is:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Ep:t.blendFunc(t.ONE,t.ONE);break;case wp:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case Tp:t.blendFuncSeparate(t.ZERO,t.SRC_COLOR,t.ZERO,t.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",z);break}else switch(z){case Is:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Ep:t.blendFunc(t.SRC_ALPHA,t.ONE);break;case wp:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case Tp:t.blendFunc(t.ZERO,t.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",z);break}u=null,g=null,v=null,P=null,C.set(0,0,0),R=0,y=z,A=L}return}ve=ve||fe,Be=Be||ne,et=et||Q,(fe!==m||ve!==_)&&(t.blendEquationSeparate(ge[fe],ge[ve]),m=fe,_=ve),(ne!==u||Q!==g||Be!==v||et!==P)&&(t.blendFuncSeparate(U[ne],U[Q],U[Be],U[et]),u=ne,g=Q,v=Be,P=et),(At.equals(C)===!1||se!==R)&&(t.blendColor(At.r,At.g,At.b,se),C.copy(At),R=se),y=z,A=!1}function he(z,fe){z.side===Kn?xe(t.CULL_FACE):me(t.CULL_FACE);let ne=z.side===_n;fe&&(ne=!ne),pe(ne),z.blending===Is&&z.transparent===!1?qe(nr):qe(z.blending,z.blendEquation,z.blendSrc,z.blendDst,z.blendEquationAlpha,z.blendSrcAlpha,z.blendDstAlpha,z.blendColor,z.blendAlpha,z.premultipliedAlpha),s.setFunc(z.depthFunc),s.setTest(z.depthTest),s.setMask(z.depthWrite),r.setMask(z.colorWrite);const Q=z.stencilWrite;o.setTest(Q),Q&&(o.setMask(z.stencilWriteMask),o.setFunc(z.stencilFunc,z.stencilRef,z.stencilFuncMask),o.setOp(z.stencilFail,z.stencilZFail,z.stencilZPass)),be(z.polygonOffset,z.polygonOffsetFactor,z.polygonOffsetUnits),z.alphaToCoverage===!0?me(t.SAMPLE_ALPHA_TO_COVERAGE):xe(t.SAMPLE_ALPHA_TO_COVERAGE)}function pe(z){E!==z&&(z?t.frontFace(t.CW):t.frontFace(t.CCW),E=z)}function ce(z){z!==Kx?(me(t.CULL_FACE),z!==S&&(z===Mp?t.cullFace(t.BACK):z===Zx?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):xe(t.CULL_FACE),S=z}function Ue(z){z!==b&&(W&&t.lineWidth(z),b=z)}function be(z,fe,ne){z?(me(t.POLYGON_OFFSET_FILL),(T!==fe||k!==ne)&&(t.polygonOffset(fe,ne),T=fe,k=ne)):xe(t.POLYGON_OFFSET_FILL)}function we(z){z?me(t.SCISSOR_TEST):xe(t.SCISSOR_TEST)}function D(z){z===void 0&&(z=t.TEXTURE0+Y-1),I!==z&&(t.activeTexture(z),I=z)}function M(z,fe,ne){ne===void 0&&(I===null?ne=t.TEXTURE0+Y-1:ne=I);let Q=H[ne];Q===void 0&&(Q={type:void 0,texture:void 0},H[ne]=Q),(Q.type!==z||Q.texture!==fe)&&(I!==ne&&(t.activeTexture(ne),I=ne),t.bindTexture(z,fe||re[z]),Q.type=z,Q.texture=fe)}function $(){const z=H[I];z!==void 0&&z.type!==void 0&&(t.bindTexture(z.type,null),z.type=void 0,z.texture=void 0)}function J(){try{t.compressedTexImage2D.apply(t,arguments)}catch(z){console.error("THREE.WebGLState:",z)}}function ee(){try{t.compressedTexImage3D.apply(t,arguments)}catch(z){console.error("THREE.WebGLState:",z)}}function ie(){try{t.texSubImage2D.apply(t,arguments)}catch(z){console.error("THREE.WebGLState:",z)}}function Pe(){try{t.texSubImage3D.apply(t,arguments)}catch(z){console.error("THREE.WebGLState:",z)}}function Se(){try{t.compressedTexSubImage2D.apply(t,arguments)}catch(z){console.error("THREE.WebGLState:",z)}}function Ae(){try{t.compressedTexSubImage3D.apply(t,arguments)}catch(z){console.error("THREE.WebGLState:",z)}}function He(){try{t.texStorage2D.apply(t,arguments)}catch(z){console.error("THREE.WebGLState:",z)}}function de(){try{t.texStorage3D.apply(t,arguments)}catch(z){console.error("THREE.WebGLState:",z)}}function Te(){try{t.texImage2D.apply(t,arguments)}catch(z){console.error("THREE.WebGLState:",z)}}function nt(){try{t.texImage3D.apply(t,arguments)}catch(z){console.error("THREE.WebGLState:",z)}}function ze(z){_e.equals(z)===!1&&(t.scissor(z.x,z.y,z.z,z.w),_e.copy(z))}function Ce(z){Oe.equals(z)===!1&&(t.viewport(z.x,z.y,z.z,z.w),Oe.copy(z))}function Ge(z,fe){let ne=l.get(fe);ne===void 0&&(ne=new WeakMap,l.set(fe,ne));let Q=ne.get(z);Q===void 0&&(Q=t.getUniformBlockIndex(fe,z.name),ne.set(z,Q))}function Ke(z,fe){const Q=l.get(fe).get(z);a.get(fe)!==Q&&(t.uniformBlockBinding(fe,Q,z.__bindingPointIndex),a.set(fe,Q))}function pt(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),c={},I=null,H={},f={},h=new WeakMap,d=[],p=null,x=!1,y=null,m=null,u=null,g=null,_=null,v=null,P=null,C=new Ye(0,0,0),R=0,A=!1,E=null,S=null,b=null,T=null,k=null,_e.set(0,0,t.canvas.width,t.canvas.height),Oe.set(0,0,t.canvas.width,t.canvas.height),r.reset(),s.reset(),o.reset()}return{buffers:{color:r,depth:s,stencil:o},enable:me,disable:xe,bindFramebuffer:Ie,drawBuffers:ke,useProgram:Xe,setBlending:qe,setMaterial:he,setFlipSided:pe,setCullFace:ce,setLineWidth:Ue,setPolygonOffset:be,setScissorTest:we,activeTexture:D,bindTexture:M,unbindTexture:$,compressedTexImage2D:J,compressedTexImage3D:ee,texImage2D:Te,texImage3D:nt,updateUBOMapping:Ge,uniformBlockBinding:Ke,texStorage2D:He,texStorage3D:de,texSubImage2D:ie,texSubImage3D:Pe,compressedTexSubImage2D:Se,compressedTexSubImage3D:Ae,scissor:ze,viewport:Ce,reset:pt}}function gm(t,e,n,i){const r=Vw(i);switch(n){case K0:return t*e;case Q0:return t*e;case J0:return t*e*2;case e_:return t*e/r.components*r.byteLength;case th:return t*e/r.components*r.byteLength;case t_:return t*e*2/r.components*r.byteLength;case nh:return t*e*2/r.components*r.byteLength;case Z0:return t*e*3/r.components*r.byteLength;case Qn:return t*e*4/r.components*r.byteLength;case ih:return t*e*4/r.components*r.byteLength;case dl:case fl:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*8;case hl:case pl:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*16;case Ad:case Rd:return Math.max(t,16)*Math.max(e,8)/4;case Td:case Cd:return Math.max(t,8)*Math.max(e,8)/2;case bd:case Pd:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*8;case Ld:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*16;case Dd:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*16;case Id:return Math.floor((t+4)/5)*Math.floor((e+3)/4)*16;case Ud:return Math.floor((t+4)/5)*Math.floor((e+4)/5)*16;case Nd:return Math.floor((t+5)/6)*Math.floor((e+4)/5)*16;case Fd:return Math.floor((t+5)/6)*Math.floor((e+5)/6)*16;case Od:return Math.floor((t+7)/8)*Math.floor((e+4)/5)*16;case kd:return Math.floor((t+7)/8)*Math.floor((e+5)/6)*16;case zd:return Math.floor((t+7)/8)*Math.floor((e+7)/8)*16;case Bd:return Math.floor((t+9)/10)*Math.floor((e+4)/5)*16;case Hd:return Math.floor((t+9)/10)*Math.floor((e+5)/6)*16;case Vd:return Math.floor((t+9)/10)*Math.floor((e+7)/8)*16;case Gd:return Math.floor((t+9)/10)*Math.floor((e+9)/10)*16;case Wd:return Math.floor((t+11)/12)*Math.floor((e+9)/10)*16;case jd:return Math.floor((t+11)/12)*Math.floor((e+11)/12)*16;case ml:case Xd:case Yd:return Math.ceil(t/4)*Math.ceil(e/4)*16;case n_:case $d:return Math.ceil(t/4)*Math.ceil(e/4)*8;case qd:case Kd:return Math.ceil(t/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${n} format.`)}function Vw(t){switch(t){case bi:case Y0:return{byteLength:1,components:1};case Ko:case $0:case na:return{byteLength:2,components:1};case Jf:case eh:return{byteLength:2,components:4};case kr:case Qf:case Mi:return{byteLength:4,components:1};case q0:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${t}.`)}function Gw(t,e,n,i,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new $e,f=new WeakMap;let h;const d=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function x(D,M){return p?new OffscreenCanvas(D,M):$l("canvas")}function y(D,M,$){let J=1;const ee=we(D);if((ee.width>$||ee.height>$)&&(J=$/Math.max(ee.width,ee.height)),J<1)if(typeof HTMLImageElement<"u"&&D instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&D instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&D instanceof ImageBitmap||typeof VideoFrame<"u"&&D instanceof VideoFrame){const ie=Math.floor(J*ee.width),Pe=Math.floor(J*ee.height);h===void 0&&(h=x(ie,Pe));const Se=M?x(ie,Pe):h;return Se.width=ie,Se.height=Pe,Se.getContext("2d").drawImage(D,0,0,ie,Pe),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+ee.width+"x"+ee.height+") to ("+ie+"x"+Pe+")."),Se}else return"data"in D&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+ee.width+"x"+ee.height+")."),D;return D}function m(D){return D.generateMipmaps&&D.minFilter!==On&&D.minFilter!==Zn}function u(D){t.generateMipmap(D)}function g(D,M,$,J,ee=!1){if(D!==null){if(t[D]!==void 0)return t[D];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+D+"'")}let ie=M;if(M===t.RED&&($===t.FLOAT&&(ie=t.R32F),$===t.HALF_FLOAT&&(ie=t.R16F),$===t.UNSIGNED_BYTE&&(ie=t.R8)),M===t.RED_INTEGER&&($===t.UNSIGNED_BYTE&&(ie=t.R8UI),$===t.UNSIGNED_SHORT&&(ie=t.R16UI),$===t.UNSIGNED_INT&&(ie=t.R32UI),$===t.BYTE&&(ie=t.R8I),$===t.SHORT&&(ie=t.R16I),$===t.INT&&(ie=t.R32I)),M===t.RG&&($===t.FLOAT&&(ie=t.RG32F),$===t.HALF_FLOAT&&(ie=t.RG16F),$===t.UNSIGNED_BYTE&&(ie=t.RG8)),M===t.RG_INTEGER&&($===t.UNSIGNED_BYTE&&(ie=t.RG8UI),$===t.UNSIGNED_SHORT&&(ie=t.RG16UI),$===t.UNSIGNED_INT&&(ie=t.RG32UI),$===t.BYTE&&(ie=t.RG8I),$===t.SHORT&&(ie=t.RG16I),$===t.INT&&(ie=t.RG32I)),M===t.RGB&&$===t.UNSIGNED_INT_5_9_9_9_REV&&(ie=t.RGB9_E5),M===t.RGBA){const Pe=ee?Wl:lt.getTransfer(J);$===t.FLOAT&&(ie=t.RGBA32F),$===t.HALF_FLOAT&&(ie=t.RGBA16F),$===t.UNSIGNED_BYTE&&(ie=Pe===gt?t.SRGB8_ALPHA8:t.RGBA8),$===t.UNSIGNED_SHORT_4_4_4_4&&(ie=t.RGBA4),$===t.UNSIGNED_SHORT_5_5_5_1&&(ie=t.RGB5_A1)}return(ie===t.R16F||ie===t.R32F||ie===t.RG16F||ie===t.RG32F||ie===t.RGBA16F||ie===t.RGBA32F)&&e.get("EXT_color_buffer_float"),ie}function _(D,M){let $;return D?M===null||M===kr||M===Xs?$=t.DEPTH24_STENCIL8:M===Mi?$=t.DEPTH32F_STENCIL8:M===Ko&&($=t.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):M===null||M===kr||M===Xs?$=t.DEPTH_COMPONENT24:M===Mi?$=t.DEPTH_COMPONENT32F:M===Ko&&($=t.DEPTH_COMPONENT16),$}function v(D,M){return m(D)===!0||D.isFramebufferTexture&&D.minFilter!==On&&D.minFilter!==Zn?Math.log2(Math.max(M.width,M.height))+1:D.mipmaps!==void 0&&D.mipmaps.length>0?D.mipmaps.length:D.isCompressedTexture&&Array.isArray(D.image)?M.mipmaps.length:1}function P(D){const M=D.target;M.removeEventListener("dispose",P),R(M),M.isVideoTexture&&f.delete(M)}function C(D){const M=D.target;M.removeEventListener("dispose",C),E(M)}function R(D){const M=i.get(D);if(M.__webglInit===void 0)return;const $=D.source,J=d.get($);if(J){const ee=J[M.__cacheKey];ee.usedTimes--,ee.usedTimes===0&&A(D),Object.keys(J).length===0&&d.delete($)}i.remove(D)}function A(D){const M=i.get(D);t.deleteTexture(M.__webglTexture);const $=D.source,J=d.get($);delete J[M.__cacheKey],o.memory.textures--}function E(D){const M=i.get(D);if(D.depthTexture&&D.depthTexture.dispose(),D.isWebGLCubeRenderTarget)for(let J=0;J<6;J++){if(Array.isArray(M.__webglFramebuffer[J]))for(let ee=0;ee<M.__webglFramebuffer[J].length;ee++)t.deleteFramebuffer(M.__webglFramebuffer[J][ee]);else t.deleteFramebuffer(M.__webglFramebuffer[J]);M.__webglDepthbuffer&&t.deleteRenderbuffer(M.__webglDepthbuffer[J])}else{if(Array.isArray(M.__webglFramebuffer))for(let J=0;J<M.__webglFramebuffer.length;J++)t.deleteFramebuffer(M.__webglFramebuffer[J]);else t.deleteFramebuffer(M.__webglFramebuffer);if(M.__webglDepthbuffer&&t.deleteRenderbuffer(M.__webglDepthbuffer),M.__webglMultisampledFramebuffer&&t.deleteFramebuffer(M.__webglMultisampledFramebuffer),M.__webglColorRenderbuffer)for(let J=0;J<M.__webglColorRenderbuffer.length;J++)M.__webglColorRenderbuffer[J]&&t.deleteRenderbuffer(M.__webglColorRenderbuffer[J]);M.__webglDepthRenderbuffer&&t.deleteRenderbuffer(M.__webglDepthRenderbuffer)}const $=D.textures;for(let J=0,ee=$.length;J<ee;J++){const ie=i.get($[J]);ie.__webglTexture&&(t.deleteTexture(ie.__webglTexture),o.memory.textures--),i.remove($[J])}i.remove(D)}let S=0;function b(){S=0}function T(){const D=S;return D>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+D+" texture units while this GPU supports only "+r.maxTextures),S+=1,D}function k(D){const M=[];return M.push(D.wrapS),M.push(D.wrapT),M.push(D.wrapR||0),M.push(D.magFilter),M.push(D.minFilter),M.push(D.anisotropy),M.push(D.internalFormat),M.push(D.format),M.push(D.type),M.push(D.generateMipmaps),M.push(D.premultiplyAlpha),M.push(D.flipY),M.push(D.unpackAlignment),M.push(D.colorSpace),M.join()}function Y(D,M){const $=i.get(D);if(D.isVideoTexture&&Ue(D),D.isRenderTargetTexture===!1&&D.version>0&&$.__version!==D.version){const J=D.image;if(J===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(J.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Oe($,D,M);return}}n.bindTexture(t.TEXTURE_2D,$.__webglTexture,t.TEXTURE0+M)}function W(D,M){const $=i.get(D);if(D.version>0&&$.__version!==D.version){Oe($,D,M);return}n.bindTexture(t.TEXTURE_2D_ARRAY,$.__webglTexture,t.TEXTURE0+M)}function V(D,M){const $=i.get(D);if(D.version>0&&$.__version!==D.version){Oe($,D,M);return}n.bindTexture(t.TEXTURE_3D,$.__webglTexture,t.TEXTURE0+M)}function X(D,M){const $=i.get(D);if(D.version>0&&$.__version!==D.version){K($,D,M);return}n.bindTexture(t.TEXTURE_CUBE_MAP,$.__webglTexture,t.TEXTURE0+M)}const I={[Ed]:t.REPEAT,[br]:t.CLAMP_TO_EDGE,[wd]:t.MIRRORED_REPEAT},H={[On]:t.NEAREST,[Dy]:t.NEAREST_MIPMAP_NEAREST,[Ma]:t.NEAREST_MIPMAP_LINEAR,[Zn]:t.LINEAR,[$c]:t.LINEAR_MIPMAP_NEAREST,[Pr]:t.LINEAR_MIPMAP_LINEAR},Z={[Fy]:t.NEVER,[Vy]:t.ALWAYS,[Oy]:t.LESS,[i_]:t.LEQUAL,[ky]:t.EQUAL,[Hy]:t.GEQUAL,[zy]:t.GREATER,[By]:t.NOTEQUAL};function te(D,M){if(M.type===Mi&&e.has("OES_texture_float_linear")===!1&&(M.magFilter===Zn||M.magFilter===$c||M.magFilter===Ma||M.magFilter===Pr||M.minFilter===Zn||M.minFilter===$c||M.minFilter===Ma||M.minFilter===Pr)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),t.texParameteri(D,t.TEXTURE_WRAP_S,I[M.wrapS]),t.texParameteri(D,t.TEXTURE_WRAP_T,I[M.wrapT]),(D===t.TEXTURE_3D||D===t.TEXTURE_2D_ARRAY)&&t.texParameteri(D,t.TEXTURE_WRAP_R,I[M.wrapR]),t.texParameteri(D,t.TEXTURE_MAG_FILTER,H[M.magFilter]),t.texParameteri(D,t.TEXTURE_MIN_FILTER,H[M.minFilter]),M.compareFunction&&(t.texParameteri(D,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(D,t.TEXTURE_COMPARE_FUNC,Z[M.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(M.magFilter===On||M.minFilter!==Ma&&M.minFilter!==Pr||M.type===Mi&&e.has("OES_texture_float_linear")===!1)return;if(M.anisotropy>1||i.get(M).__currentAnisotropy){const $=e.get("EXT_texture_filter_anisotropic");t.texParameterf(D,$.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(M.anisotropy,r.getMaxAnisotropy())),i.get(M).__currentAnisotropy=M.anisotropy}}}function _e(D,M){let $=!1;D.__webglInit===void 0&&(D.__webglInit=!0,M.addEventListener("dispose",P));const J=M.source;let ee=d.get(J);ee===void 0&&(ee={},d.set(J,ee));const ie=k(M);if(ie!==D.__cacheKey){ee[ie]===void 0&&(ee[ie]={texture:t.createTexture(),usedTimes:0},o.memory.textures++,$=!0),ee[ie].usedTimes++;const Pe=ee[D.__cacheKey];Pe!==void 0&&(ee[D.__cacheKey].usedTimes--,Pe.usedTimes===0&&A(M)),D.__cacheKey=ie,D.__webglTexture=ee[ie].texture}return $}function Oe(D,M,$){let J=t.TEXTURE_2D;(M.isDataArrayTexture||M.isCompressedArrayTexture)&&(J=t.TEXTURE_2D_ARRAY),M.isData3DTexture&&(J=t.TEXTURE_3D);const ee=_e(D,M),ie=M.source;n.bindTexture(J,D.__webglTexture,t.TEXTURE0+$);const Pe=i.get(ie);if(ie.version!==Pe.__version||ee===!0){n.activeTexture(t.TEXTURE0+$);const Se=lt.getPrimaries(lt.workingColorSpace),Ae=M.colorSpace===Wi?null:lt.getPrimaries(M.colorSpace),He=M.colorSpace===Wi||Se===Ae?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,M.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,M.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,He);let de=y(M.image,!1,r.maxTextureSize);de=be(M,de);const Te=s.convert(M.format,M.colorSpace),nt=s.convert(M.type);let ze=g(M.internalFormat,Te,nt,M.colorSpace,M.isVideoTexture);te(J,M);let Ce;const Ge=M.mipmaps,Ke=M.isVideoTexture!==!0,pt=Pe.__version===void 0||ee===!0,z=ie.dataReady,fe=v(M,de);if(M.isDepthTexture)ze=_(M.format===Ys,M.type),pt&&(Ke?n.texStorage2D(t.TEXTURE_2D,1,ze,de.width,de.height):n.texImage2D(t.TEXTURE_2D,0,ze,de.width,de.height,0,Te,nt,null));else if(M.isDataTexture)if(Ge.length>0){Ke&&pt&&n.texStorage2D(t.TEXTURE_2D,fe,ze,Ge[0].width,Ge[0].height);for(let ne=0,Q=Ge.length;ne<Q;ne++)Ce=Ge[ne],Ke?z&&n.texSubImage2D(t.TEXTURE_2D,ne,0,0,Ce.width,Ce.height,Te,nt,Ce.data):n.texImage2D(t.TEXTURE_2D,ne,ze,Ce.width,Ce.height,0,Te,nt,Ce.data);M.generateMipmaps=!1}else Ke?(pt&&n.texStorage2D(t.TEXTURE_2D,fe,ze,de.width,de.height),z&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,de.width,de.height,Te,nt,de.data)):n.texImage2D(t.TEXTURE_2D,0,ze,de.width,de.height,0,Te,nt,de.data);else if(M.isCompressedTexture)if(M.isCompressedArrayTexture){Ke&&pt&&n.texStorage3D(t.TEXTURE_2D_ARRAY,fe,ze,Ge[0].width,Ge[0].height,de.depth);for(let ne=0,Q=Ge.length;ne<Q;ne++)if(Ce=Ge[ne],M.format!==Qn)if(Te!==null)if(Ke){if(z)if(M.layerUpdates.size>0){const ve=gm(Ce.width,Ce.height,M.format,M.type);for(const Be of M.layerUpdates){const et=Ce.data.subarray(Be*ve/Ce.data.BYTES_PER_ELEMENT,(Be+1)*ve/Ce.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,ne,0,0,Be,Ce.width,Ce.height,1,Te,et,0,0)}M.clearLayerUpdates()}else n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,ne,0,0,0,Ce.width,Ce.height,de.depth,Te,Ce.data,0,0)}else n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,ne,ze,Ce.width,Ce.height,de.depth,0,Ce.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ke?z&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,ne,0,0,0,Ce.width,Ce.height,de.depth,Te,nt,Ce.data):n.texImage3D(t.TEXTURE_2D_ARRAY,ne,ze,Ce.width,Ce.height,de.depth,0,Te,nt,Ce.data)}else{Ke&&pt&&n.texStorage2D(t.TEXTURE_2D,fe,ze,Ge[0].width,Ge[0].height);for(let ne=0,Q=Ge.length;ne<Q;ne++)Ce=Ge[ne],M.format!==Qn?Te!==null?Ke?z&&n.compressedTexSubImage2D(t.TEXTURE_2D,ne,0,0,Ce.width,Ce.height,Te,Ce.data):n.compressedTexImage2D(t.TEXTURE_2D,ne,ze,Ce.width,Ce.height,0,Ce.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ke?z&&n.texSubImage2D(t.TEXTURE_2D,ne,0,0,Ce.width,Ce.height,Te,nt,Ce.data):n.texImage2D(t.TEXTURE_2D,ne,ze,Ce.width,Ce.height,0,Te,nt,Ce.data)}else if(M.isDataArrayTexture)if(Ke){if(pt&&n.texStorage3D(t.TEXTURE_2D_ARRAY,fe,ze,de.width,de.height,de.depth),z)if(M.layerUpdates.size>0){const ne=gm(de.width,de.height,M.format,M.type);for(const Q of M.layerUpdates){const ve=de.data.subarray(Q*ne/de.data.BYTES_PER_ELEMENT,(Q+1)*ne/de.data.BYTES_PER_ELEMENT);n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,Q,de.width,de.height,1,Te,nt,ve)}M.clearLayerUpdates()}else n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,de.width,de.height,de.depth,Te,nt,de.data)}else n.texImage3D(t.TEXTURE_2D_ARRAY,0,ze,de.width,de.height,de.depth,0,Te,nt,de.data);else if(M.isData3DTexture)Ke?(pt&&n.texStorage3D(t.TEXTURE_3D,fe,ze,de.width,de.height,de.depth),z&&n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,de.width,de.height,de.depth,Te,nt,de.data)):n.texImage3D(t.TEXTURE_3D,0,ze,de.width,de.height,de.depth,0,Te,nt,de.data);else if(M.isFramebufferTexture){if(pt)if(Ke)n.texStorage2D(t.TEXTURE_2D,fe,ze,de.width,de.height);else{let ne=de.width,Q=de.height;for(let ve=0;ve<fe;ve++)n.texImage2D(t.TEXTURE_2D,ve,ze,ne,Q,0,Te,nt,null),ne>>=1,Q>>=1}}else if(Ge.length>0){if(Ke&&pt){const ne=we(Ge[0]);n.texStorage2D(t.TEXTURE_2D,fe,ze,ne.width,ne.height)}for(let ne=0,Q=Ge.length;ne<Q;ne++)Ce=Ge[ne],Ke?z&&n.texSubImage2D(t.TEXTURE_2D,ne,0,0,Te,nt,Ce):n.texImage2D(t.TEXTURE_2D,ne,ze,Te,nt,Ce);M.generateMipmaps=!1}else if(Ke){if(pt){const ne=we(de);n.texStorage2D(t.TEXTURE_2D,fe,ze,ne.width,ne.height)}z&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,Te,nt,de)}else n.texImage2D(t.TEXTURE_2D,0,ze,Te,nt,de);m(M)&&u(J),Pe.__version=ie.version,M.onUpdate&&M.onUpdate(M)}D.__version=M.version}function K(D,M,$){if(M.image.length!==6)return;const J=_e(D,M),ee=M.source;n.bindTexture(t.TEXTURE_CUBE_MAP,D.__webglTexture,t.TEXTURE0+$);const ie=i.get(ee);if(ee.version!==ie.__version||J===!0){n.activeTexture(t.TEXTURE0+$);const Pe=lt.getPrimaries(lt.workingColorSpace),Se=M.colorSpace===Wi?null:lt.getPrimaries(M.colorSpace),Ae=M.colorSpace===Wi||Pe===Se?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,M.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,M.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ae);const He=M.isCompressedTexture||M.image[0].isCompressedTexture,de=M.image[0]&&M.image[0].isDataTexture,Te=[];for(let Q=0;Q<6;Q++)!He&&!de?Te[Q]=y(M.image[Q],!0,r.maxCubemapSize):Te[Q]=de?M.image[Q].image:M.image[Q],Te[Q]=be(M,Te[Q]);const nt=Te[0],ze=s.convert(M.format,M.colorSpace),Ce=s.convert(M.type),Ge=g(M.internalFormat,ze,Ce,M.colorSpace),Ke=M.isVideoTexture!==!0,pt=ie.__version===void 0||J===!0,z=ee.dataReady;let fe=v(M,nt);te(t.TEXTURE_CUBE_MAP,M);let ne;if(He){Ke&&pt&&n.texStorage2D(t.TEXTURE_CUBE_MAP,fe,Ge,nt.width,nt.height);for(let Q=0;Q<6;Q++){ne=Te[Q].mipmaps;for(let ve=0;ve<ne.length;ve++){const Be=ne[ve];M.format!==Qn?ze!==null?Ke?z&&n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ve,0,0,Be.width,Be.height,ze,Be.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ve,Ge,Be.width,Be.height,0,Be.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ke?z&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ve,0,0,Be.width,Be.height,ze,Ce,Be.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ve,Ge,Be.width,Be.height,0,ze,Ce,Be.data)}}}else{if(ne=M.mipmaps,Ke&&pt){ne.length>0&&fe++;const Q=we(Te[0]);n.texStorage2D(t.TEXTURE_CUBE_MAP,fe,Ge,Q.width,Q.height)}for(let Q=0;Q<6;Q++)if(de){Ke?z&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,Te[Q].width,Te[Q].height,ze,Ce,Te[Q].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,Ge,Te[Q].width,Te[Q].height,0,ze,Ce,Te[Q].data);for(let ve=0;ve<ne.length;ve++){const et=ne[ve].image[Q].image;Ke?z&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ve+1,0,0,et.width,et.height,ze,Ce,et.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ve+1,Ge,et.width,et.height,0,ze,Ce,et.data)}}else{Ke?z&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,ze,Ce,Te[Q]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,Ge,ze,Ce,Te[Q]);for(let ve=0;ve<ne.length;ve++){const Be=ne[ve];Ke?z&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ve+1,0,0,ze,Ce,Be.image[Q]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ve+1,Ge,ze,Ce,Be.image[Q])}}}m(M)&&u(t.TEXTURE_CUBE_MAP),ie.__version=ee.version,M.onUpdate&&M.onUpdate(M)}D.__version=M.version}function re(D,M,$,J,ee,ie){const Pe=s.convert($.format,$.colorSpace),Se=s.convert($.type),Ae=g($.internalFormat,Pe,Se,$.colorSpace);if(!i.get(M).__hasExternalTextures){const de=Math.max(1,M.width>>ie),Te=Math.max(1,M.height>>ie);ee===t.TEXTURE_3D||ee===t.TEXTURE_2D_ARRAY?n.texImage3D(ee,ie,Ae,de,Te,M.depth,0,Pe,Se,null):n.texImage2D(ee,ie,Ae,de,Te,0,Pe,Se,null)}n.bindFramebuffer(t.FRAMEBUFFER,D),ce(M)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,J,ee,i.get($).__webglTexture,0,pe(M)):(ee===t.TEXTURE_2D||ee>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&ee<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,J,ee,i.get($).__webglTexture,ie),n.bindFramebuffer(t.FRAMEBUFFER,null)}function me(D,M,$){if(t.bindRenderbuffer(t.RENDERBUFFER,D),M.depthBuffer){const J=M.depthTexture,ee=J&&J.isDepthTexture?J.type:null,ie=_(M.stencilBuffer,ee),Pe=M.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,Se=pe(M);ce(M)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,Se,ie,M.width,M.height):$?t.renderbufferStorageMultisample(t.RENDERBUFFER,Se,ie,M.width,M.height):t.renderbufferStorage(t.RENDERBUFFER,ie,M.width,M.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,Pe,t.RENDERBUFFER,D)}else{const J=M.textures;for(let ee=0;ee<J.length;ee++){const ie=J[ee],Pe=s.convert(ie.format,ie.colorSpace),Se=s.convert(ie.type),Ae=g(ie.internalFormat,Pe,Se,ie.colorSpace),He=pe(M);$&&ce(M)===!1?t.renderbufferStorageMultisample(t.RENDERBUFFER,He,Ae,M.width,M.height):ce(M)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,He,Ae,M.width,M.height):t.renderbufferStorage(t.RENDERBUFFER,Ae,M.width,M.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function xe(D,M){if(M&&M.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(n.bindFramebuffer(t.FRAMEBUFFER,D),!(M.depthTexture&&M.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!i.get(M.depthTexture).__webglTexture||M.depthTexture.image.width!==M.width||M.depthTexture.image.height!==M.height)&&(M.depthTexture.image.width=M.width,M.depthTexture.image.height=M.height,M.depthTexture.needsUpdate=!0),Y(M.depthTexture,0);const J=i.get(M.depthTexture).__webglTexture,ee=pe(M);if(M.depthTexture.format===Us)ce(M)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,J,0,ee):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,J,0);else if(M.depthTexture.format===Ys)ce(M)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,J,0,ee):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,J,0);else throw new Error("Unknown depthTexture format")}function Ie(D){const M=i.get(D),$=D.isWebGLCubeRenderTarget===!0;if(M.__boundDepthTexture!==D.depthTexture){const J=D.depthTexture;if(M.__depthDisposeCallback&&M.__depthDisposeCallback(),J){const ee=()=>{delete M.__boundDepthTexture,delete M.__depthDisposeCallback,J.removeEventListener("dispose",ee)};J.addEventListener("dispose",ee),M.__depthDisposeCallback=ee}M.__boundDepthTexture=J}if(D.depthTexture&&!M.__autoAllocateDepthBuffer){if($)throw new Error("target.depthTexture not supported in Cube render targets");xe(M.__webglFramebuffer,D)}else if($){M.__webglDepthbuffer=[];for(let J=0;J<6;J++)if(n.bindFramebuffer(t.FRAMEBUFFER,M.__webglFramebuffer[J]),M.__webglDepthbuffer[J]===void 0)M.__webglDepthbuffer[J]=t.createRenderbuffer(),me(M.__webglDepthbuffer[J],D,!1);else{const ee=D.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ie=M.__webglDepthbuffer[J];t.bindRenderbuffer(t.RENDERBUFFER,ie),t.framebufferRenderbuffer(t.FRAMEBUFFER,ee,t.RENDERBUFFER,ie)}}else if(n.bindFramebuffer(t.FRAMEBUFFER,M.__webglFramebuffer),M.__webglDepthbuffer===void 0)M.__webglDepthbuffer=t.createRenderbuffer(),me(M.__webglDepthbuffer,D,!1);else{const J=D.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ee=M.__webglDepthbuffer;t.bindRenderbuffer(t.RENDERBUFFER,ee),t.framebufferRenderbuffer(t.FRAMEBUFFER,J,t.RENDERBUFFER,ee)}n.bindFramebuffer(t.FRAMEBUFFER,null)}function ke(D,M,$){const J=i.get(D);M!==void 0&&re(J.__webglFramebuffer,D,D.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),$!==void 0&&Ie(D)}function Xe(D){const M=D.texture,$=i.get(D),J=i.get(M);D.addEventListener("dispose",C);const ee=D.textures,ie=D.isWebGLCubeRenderTarget===!0,Pe=ee.length>1;if(Pe||(J.__webglTexture===void 0&&(J.__webglTexture=t.createTexture()),J.__version=M.version,o.memory.textures++),ie){$.__webglFramebuffer=[];for(let Se=0;Se<6;Se++)if(M.mipmaps&&M.mipmaps.length>0){$.__webglFramebuffer[Se]=[];for(let Ae=0;Ae<M.mipmaps.length;Ae++)$.__webglFramebuffer[Se][Ae]=t.createFramebuffer()}else $.__webglFramebuffer[Se]=t.createFramebuffer()}else{if(M.mipmaps&&M.mipmaps.length>0){$.__webglFramebuffer=[];for(let Se=0;Se<M.mipmaps.length;Se++)$.__webglFramebuffer[Se]=t.createFramebuffer()}else $.__webglFramebuffer=t.createFramebuffer();if(Pe)for(let Se=0,Ae=ee.length;Se<Ae;Se++){const He=i.get(ee[Se]);He.__webglTexture===void 0&&(He.__webglTexture=t.createTexture(),o.memory.textures++)}if(D.samples>0&&ce(D)===!1){$.__webglMultisampledFramebuffer=t.createFramebuffer(),$.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,$.__webglMultisampledFramebuffer);for(let Se=0;Se<ee.length;Se++){const Ae=ee[Se];$.__webglColorRenderbuffer[Se]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,$.__webglColorRenderbuffer[Se]);const He=s.convert(Ae.format,Ae.colorSpace),de=s.convert(Ae.type),Te=g(Ae.internalFormat,He,de,Ae.colorSpace,D.isXRRenderTarget===!0),nt=pe(D);t.renderbufferStorageMultisample(t.RENDERBUFFER,nt,Te,D.width,D.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+Se,t.RENDERBUFFER,$.__webglColorRenderbuffer[Se])}t.bindRenderbuffer(t.RENDERBUFFER,null),D.depthBuffer&&($.__webglDepthRenderbuffer=t.createRenderbuffer(),me($.__webglDepthRenderbuffer,D,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(ie){n.bindTexture(t.TEXTURE_CUBE_MAP,J.__webglTexture),te(t.TEXTURE_CUBE_MAP,M);for(let Se=0;Se<6;Se++)if(M.mipmaps&&M.mipmaps.length>0)for(let Ae=0;Ae<M.mipmaps.length;Ae++)re($.__webglFramebuffer[Se][Ae],D,M,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+Se,Ae);else re($.__webglFramebuffer[Se],D,M,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+Se,0);m(M)&&u(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(Pe){for(let Se=0,Ae=ee.length;Se<Ae;Se++){const He=ee[Se],de=i.get(He);n.bindTexture(t.TEXTURE_2D,de.__webglTexture),te(t.TEXTURE_2D,He),re($.__webglFramebuffer,D,He,t.COLOR_ATTACHMENT0+Se,t.TEXTURE_2D,0),m(He)&&u(t.TEXTURE_2D)}n.unbindTexture()}else{let Se=t.TEXTURE_2D;if((D.isWebGL3DRenderTarget||D.isWebGLArrayRenderTarget)&&(Se=D.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(Se,J.__webglTexture),te(Se,M),M.mipmaps&&M.mipmaps.length>0)for(let Ae=0;Ae<M.mipmaps.length;Ae++)re($.__webglFramebuffer[Ae],D,M,t.COLOR_ATTACHMENT0,Se,Ae);else re($.__webglFramebuffer,D,M,t.COLOR_ATTACHMENT0,Se,0);m(M)&&u(Se),n.unbindTexture()}D.depthBuffer&&Ie(D)}function ge(D){const M=D.textures;for(let $=0,J=M.length;$<J;$++){const ee=M[$];if(m(ee)){const ie=D.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:t.TEXTURE_2D,Pe=i.get(ee).__webglTexture;n.bindTexture(ie,Pe),u(ie),n.unbindTexture()}}}const U=[],qe=[];function he(D){if(D.samples>0){if(ce(D)===!1){const M=D.textures,$=D.width,J=D.height;let ee=t.COLOR_BUFFER_BIT;const ie=D.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,Pe=i.get(D),Se=M.length>1;if(Se)for(let Ae=0;Ae<M.length;Ae++)n.bindFramebuffer(t.FRAMEBUFFER,Pe.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+Ae,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,Pe.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+Ae,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,Pe.__webglMultisampledFramebuffer),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,Pe.__webglFramebuffer);for(let Ae=0;Ae<M.length;Ae++){if(D.resolveDepthBuffer&&(D.depthBuffer&&(ee|=t.DEPTH_BUFFER_BIT),D.stencilBuffer&&D.resolveStencilBuffer&&(ee|=t.STENCIL_BUFFER_BIT)),Se){t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,Pe.__webglColorRenderbuffer[Ae]);const He=i.get(M[Ae]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,He,0)}t.blitFramebuffer(0,0,$,J,0,0,$,J,ee,t.NEAREST),l===!0&&(U.length=0,qe.length=0,U.push(t.COLOR_ATTACHMENT0+Ae),D.depthBuffer&&D.resolveDepthBuffer===!1&&(U.push(ie),qe.push(ie),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,qe)),t.invalidateFramebuffer(t.READ_FRAMEBUFFER,U))}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),Se)for(let Ae=0;Ae<M.length;Ae++){n.bindFramebuffer(t.FRAMEBUFFER,Pe.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+Ae,t.RENDERBUFFER,Pe.__webglColorRenderbuffer[Ae]);const He=i.get(M[Ae]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,Pe.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+Ae,t.TEXTURE_2D,He,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,Pe.__webglMultisampledFramebuffer)}else if(D.depthBuffer&&D.resolveDepthBuffer===!1&&l){const M=D.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[M])}}}function pe(D){return Math.min(r.maxSamples,D.samples)}function ce(D){const M=i.get(D);return D.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&M.__useRenderToTexture!==!1}function Ue(D){const M=o.render.frame;f.get(D)!==M&&(f.set(D,M),D.update())}function be(D,M){const $=D.colorSpace,J=D.format,ee=D.type;return D.isCompressedTexture===!0||D.isVideoTexture===!0||$!==fr&&$!==Wi&&(lt.getTransfer($)===gt?(J!==Qn||ee!==bi)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",$)),M}function we(D){return typeof HTMLImageElement<"u"&&D instanceof HTMLImageElement?(c.width=D.naturalWidth||D.width,c.height=D.naturalHeight||D.height):typeof VideoFrame<"u"&&D instanceof VideoFrame?(c.width=D.displayWidth,c.height=D.displayHeight):(c.width=D.width,c.height=D.height),c}this.allocateTextureUnit=T,this.resetTextureUnits=b,this.setTexture2D=Y,this.setTexture2DArray=W,this.setTexture3D=V,this.setTextureCube=X,this.rebindTextures=ke,this.setupRenderTarget=Xe,this.updateRenderTargetMipmap=ge,this.updateMultisampleRenderTarget=he,this.setupDepthRenderbuffer=Ie,this.setupFrameBufferTexture=re,this.useMultisampledRTT=ce}function Ww(t,e){function n(i,r=Wi){let s;const o=lt.getTransfer(r);if(i===bi)return t.UNSIGNED_BYTE;if(i===Jf)return t.UNSIGNED_SHORT_4_4_4_4;if(i===eh)return t.UNSIGNED_SHORT_5_5_5_1;if(i===q0)return t.UNSIGNED_INT_5_9_9_9_REV;if(i===Y0)return t.BYTE;if(i===$0)return t.SHORT;if(i===Ko)return t.UNSIGNED_SHORT;if(i===Qf)return t.INT;if(i===kr)return t.UNSIGNED_INT;if(i===Mi)return t.FLOAT;if(i===na)return t.HALF_FLOAT;if(i===K0)return t.ALPHA;if(i===Z0)return t.RGB;if(i===Qn)return t.RGBA;if(i===Q0)return t.LUMINANCE;if(i===J0)return t.LUMINANCE_ALPHA;if(i===Us)return t.DEPTH_COMPONENT;if(i===Ys)return t.DEPTH_STENCIL;if(i===e_)return t.RED;if(i===th)return t.RED_INTEGER;if(i===t_)return t.RG;if(i===nh)return t.RG_INTEGER;if(i===ih)return t.RGBA_INTEGER;if(i===dl||i===fl||i===hl||i===pl)if(o===gt)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===dl)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===fl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===hl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===pl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===dl)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===fl)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===hl)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===pl)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Td||i===Ad||i===Cd||i===Rd)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===Td)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Ad)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Cd)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Rd)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===bd||i===Pd||i===Ld)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===bd||i===Pd)return o===gt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===Ld)return o===gt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===Dd||i===Id||i===Ud||i===Nd||i===Fd||i===Od||i===kd||i===zd||i===Bd||i===Hd||i===Vd||i===Gd||i===Wd||i===jd)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===Dd)return o===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Id)return o===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Ud)return o===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Nd)return o===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Fd)return o===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Od)return o===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===kd)return o===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===zd)return o===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Bd)return o===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Hd)return o===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Vd)return o===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Gd)return o===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Wd)return o===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===jd)return o===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===ml||i===Xd||i===Yd)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===ml)return o===gt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Xd)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Yd)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===n_||i===$d||i===qd||i===Kd)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===ml)return s.COMPRESSED_RED_RGTC1_EXT;if(i===$d)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===qd)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Kd)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Xs?t.UNSIGNED_INT_24_8:t[i]!==void 0?t[i]:null}return{convert:n}}class jw extends Un{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Wa extends Gt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Xw={type:"move"};class yu{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Wa,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Wa,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new G,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new G),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Wa,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new G,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new G),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const n=this._hand;if(n)for(const i of e.hand.values())this._getHandJoint(n,i)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,n,i){let r=null,s=null,o=null;const a=this._targetRay,l=this._grip,c=this._hand;if(e&&n.session.visibilityState!=="visible-blurred"){if(c&&e.hand){o=!0;for(const y of e.hand.values()){const m=n.getJointPose(y,i),u=this._getHandJoint(c,y);m!==null&&(u.matrix.fromArray(m.transform.matrix),u.matrix.decompose(u.position,u.rotation,u.scale),u.matrixWorldNeedsUpdate=!0,u.jointRadius=m.radius),u.visible=m!==null}const f=c.joints["index-finger-tip"],h=c.joints["thumb-tip"],d=f.position.distanceTo(h.position),p=.02,x=.005;c.inputState.pinching&&d>p+x?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&d<=p-x&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=n.getPose(e.gripSpace,i),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(r=n.getPose(e.targetRaySpace,i),r===null&&s!==null&&(r=s),r!==null&&(a.matrix.fromArray(r.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,r.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(r.linearVelocity)):a.hasLinearVelocity=!1,r.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(r.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(Xw)))}return a!==null&&(a.visible=r!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(e,n){if(e.joints[n.jointName]===void 0){const i=new Wa;i.matrixAutoUpdate=!1,i.visible=!1,e.joints[n.jointName]=i,e.add(i)}return e.joints[n.jointName]}}const Yw=`
void main() {
...
}`;class qw{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,n,i){if(this.texture===null){const r=new on,s=e.properties.get(r);s.__webglTexture=n.texture,(n.depthNear!=i.depthNear||n.depthFar!=i.depthFar)&&(this.depthNear=n.depthNear,this.depthFar=n.depthFar),this.texture=r}}getMesh(e){if(this.texture!==null&&this.mesh===null){const n=e.cameras[0].viewport,i=new lr({vertexShader:Yw,fragmentShader:$w,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new fn(new Yi(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class Kw extends Qs{constructor(e,n){super();const i=this;let r=null,s=1,o=null,a="local-floor",l=1,c=null,f=null,h=null,d=null,p=null,x=null;const y=new qw,m=n.getContextAttributes();let u=null,g=null;const _=[],v=[],P=new $e;let C=null;const R=new Un;R.layers.enable(1),R.viewport=new Nt;const A=new Un;A.layers.enable(2),A.viewport=new Nt;const E=[R,A],S=new jw;S.layers.enable(1),S.layers.enable(2);let b=null,T=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(K){let re=_[K];return re===void 0&&(re=new yu,_[K]=re),re.getTargetRaySpace()},this.getControllerGrip=function(K){let re=_[K];return re===void 0&&(re=new yu,_[K]=re),re.getGripSpace()},this.getHand=function(K){let re=_[K];return re===void 0&&(re=new yu,_[K]=re),re.getHandSpace()};function k(K){const re=v.indexOf(K.inputSource);if(re===-1)return;const me=_[re];me!==void 0&&(me.update(K.inputSource,K.frame,c||o),me.dispatchEvent({type:K.type,data:K.inputSource}))}function Y(){r.removeEventListener("select",k),r.removeEventListener("selectstart",k),r.removeEventListener("selectend",k),r.removeEventListener("squeeze",k),r.removeEventListener("squeezestart",k),r.removeEventListener("squeezeend",k),r.removeEventListener("end",Y),r.removeEventListener("inputsourceschange",W);for(let K=0;K<_.length;K++){const re=v[K];re!==null&&(v[K]=null,_[K].disconnect(re))}b=null,T=null,y.reset(),e.setRenderTarget(u),p=null,d=null,h=null,r=null,g=null,Oe.stop(),i.isPresenting=!1,e.setPixelRatio(C),e.setSize(P.width,P.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(K){s=K,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(K){a=K,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function(K){c=K},this.getBaseLayer=function(){return d!==null?d:p},this.getBinding=function(){return h},this.getFrame=function(){return x},this.getSession=function(){return r},this.setSession=async function(K){if(r=K,r!==null){if(u=e.getRenderTarget(),r.addEventListener("select",k),r.addEventListener("selectstart",k),r.addEventListener("selectend",k),r.addEventListener("squeeze",k),r.addEventListener("squeezestart",k),r.addEventListener("squeezeend",k),r.addEventListener("end",Y),r.addEventListener("inputsourceschange",W),m.xrCompatible!==!0&&await n.makeXRCompatible(),C=e.getPixelRatio(),e.getSize(P),r.renderState.layers===void 0){const re={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:s};p=new XRWebGLLayer(r,n,re),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),g=new zr(p.framebufferWidth,p.framebufferHeight,{format:Qn,type:bi,colorSpace:e.outputColorSpace,stencilBuffer:m.stencil})}else{let re=null,me=null,xe=null;m.depth&&(xe=m.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,re=m.stencil?Ys:Us,me=m.stencil?Xs:kr);const Ie={colorFormat:n.RGBA8,depthFormat:xe,scaleFactor:s};h=new XRWebGLBinding(r,n),d=h.createProjectionLayer(Ie),r.updateRenderState({layers:[d]}),e.setPixelRatio(1),e.setSize(d.textureWidth,d.textureHeight,!1),g=new zr(d.textureWidth,d.textureHeight,{format:Qn,type:bi,depthTexture:new g_(d.textureWidth,d.textureHeight,me,void 0,void 0,void 0,void 0,void 0,void 0,re),stencilBuffer:m.stencil,colorSpace:e.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1})}g.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await r.requestReferenceSpace(a),Oe.setContext(r),Oe.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return y.getDepthTexture()};function W(K){for(let re=0;re<K.removed.length;re++){const me=K.removed[re],xe=v.indexOf(me);xe>=0&&(v[xe]=null,_[xe].disconnect(me))}for(let re=0;re<K.added.length;re++){const me=K.added[re];let xe=v.indexOf(me);if(xe===-1){for(let ke=0;ke<_.length;ke++)if(ke>=v.length){v.push(me),xe=ke;break}else if(v[ke]===null){v[ke]=me,xe=ke;break}if(xe===-1)break}const Ie=_[xe];Ie&&Ie.connect(me)}}const V=new G,X=new G;function I(K,re,me){V.setFromMatrixPosition(re.matrixWorld),X.setFromMatrixPosition(me.matrixWorld);const xe=V.distanceTo(X),Ie=re.projectionMatrix.elements,ke=me.projectionMatrix.elements,Xe=Ie[14]/(Ie[10]-1),ge=Ie[14]/(Ie[10]+1),U=(Ie[9]+1)/Ie[5],qe=(Ie[9]-1)/Ie[5],he=(Ie[8]-1)/Ie[0],pe=(ke[8]+1)/ke[0],ce=Xe*he,Ue=Xe*pe,be=xe/(-he+pe),we=be*-he;if(re.matrixWorld.decompose(K.position,K.quaternion,K.scale),K.translateX(we),K.translateZ(be),K.matrixWorld.compose(K.position,K.quaternion,K.scale),K.matrixWorldInverse.copy(K.matrixWorld).invert(),Ie[10]===-1)K.projectionMatrix.copy(re.projectionMatrix),K.projectionMatrixInverse.copy(re.projectionMatrixInverse);else{const D=Xe+be,M=ge+be,$=ce-we,J=Ue+(xe-we),ee=U*ge/M*D,ie=qe*ge/M*D;K.projectionMatrix.makePerspective($,J,ee,ie,D,M),K.projectionMatrixInverse.copy(K.projectionMatrix).invert()}}function H(K,re){re===null?K.matrixWorld.copy(K.matrix):K.matrixWorld.multiplyMatrices(re.matrixWorld,K.matrix),K.matrixWorldInverse.copy(K.matrixWorld).invert()}this.updateCamera=function(K){if(r===null)return;let re=K.near,me=K.far;y.texture!==null&&(y.depthNear>0&&(re=y.depthNear),y.depthFar>0&&(me=y.depthFar)),S.near=A.near=R.near=re,S.far=A.far=R.far=me,(b!==S.near||T!==S.far)&&(r.updateRenderState({depthNear:S.near,depthFar:S.far}),b=S.near,T=S.far);const xe=K.parent,Ie=S.cameras;H(S,xe);for(let ke=0;ke<Ie.length;ke++)H(Ie[ke],xe);Ie.length===2?I(S,R,A):S.projectionMatrix.copy(R.projectionMatrix),Z(K,S,xe)};function Z(K,re,me){me===null?K.matrix.copy(re.matrixWorld):(K.matrix.copy(me.matrixWorld),K.matrix.invert(),K.matrix.multiply(re.matrixWorld)),K.matrix.decompose(K.position,K.quaternion,K.scale),K.updateMatrixWorld(!0),K.projectionMatrix.copy(re.projectionMatrix),K.projectionMatrixInverse.copy(re.projectionMatrixInverse),K.isPerspectiveCamera&&(K.fov=Qd*2*Math.atan(1/K.projectionMatrix.elements[5]),K.zoom=1)}this.getCamera=function(){return S},this.getFoveation=function(){if(!(d===null&&p===null))return l},this.setFoveation=function(K){l=K,d!==null&&(d.fixedFoveation=K),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=K)},this.hasDepthSensing=function(){return y.texture!==null},this.getDepthSensingMesh=function(){return y.getMesh(S)};let te=null;function _e(K,re){if(f=re.getViewerPose(c||o),x=re,f!==null){const me=f.views;p!==null&&(e.setRenderTargetFramebuffer(g,p.framebuffer),e.setRenderTarget(g));let xe=!1;me.length!==S.cameras.length&&(S.cameras.length=0,xe=!0);for(let ke=0;ke<me.length;ke++){const Xe=me[ke];let ge=null;if(p!==null)ge=p.getViewport(Xe);else{const qe=h.getViewSubImage(d,Xe);ge=qe.viewport,ke===0&&(e.setRenderTargetTextures(g,qe.colorTexture,d.ignoreDepthValues?void 0:qe.depthStencilTexture),e.setRenderTarget(g))}let U=E[ke];U===void 0&&(U=new Un,U.layers.enable(ke),U.viewport=new Nt,E[ke]=U),U.matrix.fromArray(Xe.transform.matrix),U.matrix.decompose(U.position,U.quaternion,U.scale),U.projectionMatrix.fromArray(Xe.projectionMatrix),U.projectionMatrixInverse.copy(U.projectionMatrix).invert(),U.viewport.set(ge.x,ge.y,ge.width,ge.height),ke===0&&(S.matrix.copy(U.matrix),S.matrix.decompose(S.position,S.quaternion,S.scale)),xe===!0&&S.cameras.push(U)}const Ie=r.enabledFeatures;if(Ie&&Ie.includes("depth-sensing")){const ke=h.getDepthInformation(me[0]);ke&&ke.isValid&&ke.texture&&y.init(e,ke,r.renderState)}}for(let me=0;me<_.length;me++){const xe=v[me],Ie=_[me];xe!==null&&Ie!==void 0&&Ie.update(xe,re,c||o)}te&&te(K,re),re.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:re}),x=null}const Oe=new p_;Oe.setAnimationLoop(_e),this.setAnimationLoop=function(K){te=K},this.dispose=function(){}}}const xr=new ii,Zw=new yt;function Qw(t,e){function n(m,u){m.matrixAutoUpdate===!0&&m.updateMatrix(),u.value.copy(m.matrix)}function i(m,u){u.color.getRGB(m.fogColor.value,d_(t)),u.isFog?(m.fogNear.value=u.near,m.fogFar.value=u.far):u.isFogExp2&&(m.fogDensity.value=u.density)}function r(m,u,g,_,v){u.isMeshBasicMaterial||u.isMeshLambertMaterial?s(m,u):u.isMeshToonMaterial?(s(m,u),h(m,u)):u.isMeshPhongMaterial?(s(m,u),f(m,u)):u.isMeshStandardMaterial?(s(m,u),d(m,u),u.isMeshPhysicalMaterial&&p(m,u,v)):u.isMeshMatcapMaterial?(s(m,u),x(m,u)):u.isMeshDepthMaterial?s(m,u):u.isMeshDistanceMaterial?(s(m,u),y(m,u)):u.isMeshNormalMaterial?s(m,u):u.isLineBasicMaterial?(o(m,u),u.isLineDashedMaterial&&a(m,u)):u.isPointsMaterial?l(m,u,g,_):u.isSpriteMaterial?c(m,u):u.isShadowMaterial?(m.color.value.copy(u.color),m.opacity.value=u.opacity):u.isShaderMaterial&&(u.uniformsNeedUpdate=!1)}function s(m,u){m.opacity.value=u.opacity,u.color&&m.diffuse.value.copy(u.color),u.emissive&&m.emissive.value.copy(u.emissive).multiplyScalar(u.emissiveIntensity),u.map&&(m.map.value=u.map,n(u.map,m.mapTransform)),u.alphaMap&&(m.alphaMap.value=u.alphaMap,n(u.alphaMap,m.alphaMapTransform)),u.bumpMap&&(m.bumpMap.value=u.bumpMap,n(u.bumpMap,m.bumpMapTransform),m.bumpScale.value=u.bumpScale,u.side===_n&&(m.bumpScale.value*=-1)),u.normalMap&&(m.normalMap.value=u.normalMap,n(u.normalMap,m.normalMapTransform),m.normalScale.value.copy(u.normalScale),u.side===_n&&m.normalScale.value.negate()),u.displacementMap&&(m.displacementMap.value=u.displacementMap,n(u.displacementMap,m.displacementMapTransform),m.displacementScale.value=u.displacementScale,m.displacementBias.value=u.displacementBias),u.emissiveMap&&(m.emissiveMap.value=u.emissiveMap,n(u.emissiveMap,m.emissiveMapTransform)),u.specularMap&&(m.specularMap.value=u.specularMap,n(u.specularMap,m.specularMapTransform)),u.alphaTest>0&&(m.alphaTest.value=u.alphaTest);const g=e.get(u),_=g.envMap,v=g.envMapRotation;_&&(m.envMap.value=_,xr.copy(v),xr.x*=-1,xr.y*=-1,xr.z*=-1,_.isCubeTexture&&_.isRenderTargetTexture===!1&&(xr.y*=-1,xr.z*=-1),m.envMapRotation.value.setFromMatrix4(Zw.makeRotationFromEuler(xr)),m.flipEnvMap.value=_.isCubeTexture&&_.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=u.reflectivity,m.ior.value=u.ior,m.refractionRatio.value=u.refractionRatio),u.lightMap&&(m.lightMap.value=u.lightMap,m.lightMapIntensity.value=u.lightMapIntensity,n(u.lightMap,m.lightMapTransform)),u.aoMap&&(m.aoMap.value=u.aoMap,m.aoMapIntensity.value=u.aoMapIntensity,n(u.aoMap,m.aoMapTransform))}function o(m,u){m.diffuse.value.copy(u.color),m.opacity.value=u.opacity,u.map&&(m.map.value=u.map,n(u.map,m.mapTransform))}function a(m,u){m.dashSize.value=u.dashSize,m.totalSize.value=u.dashSize+u.gapSize,m.scale.value=u.scale}function l(m,u,g,_){m.diffuse.value.copy(u.color),m.opacity.value=u.opacity,m.size.value=u.size*g,m.scale.value=_*.5,u.map&&(m.map.value=u.map,n(u.map,m.uvTransform)),u.alphaMap&&(m.alphaMap.value=u.alphaMap,n(u.alphaMap,m.alphaMapTransform)),u.alphaTest>0&&(m.alphaTest.value=u.alphaTest)}function c(m,u){m.diffuse.value.copy(u.color),m.opacity.value=u.opacity,m.rotation.value=u.rotation,u.map&&(m.map.value=u.map,n(u.map,m.mapTransform)),u.alphaMap&&(m.alphaMap.value=u.alphaMap,n(u.alphaMap,m.alphaMapTransform)),u.alphaTest>0&&(m.alphaTest.value=u.alphaTest)}function f(m,u){m.specular.value.copy(u.specular),m.shininess.value=Math.max(u.shininess,1e-4)}function h(m,u){u.gradientMap&&(m.gradientMap.value=u.gradientMap)}function d(m,u){m.metalness.value=u.metalness,u.metalnessMap&&(m.metalnessMap.value=u.metalnessMap,n(u.metalnessMap,m.metalnessMapTransform)),m.roughness.value=u.roughness,u.roughnessMap&&(m.roughnessMap.value=u.roughnessMap,n(u.roughnessMap,m.roughnessMapTransform)),u.envMap&&(m.envMapIntensity.value=u.envMapIntensity)}function p(m,u,g){m.ior.value=u.ior,u.sheen>0&&(m.sheenColor.value.copy(u.sheenColor).multiplyScalar(u.sheen),m.sheenRoughness.value=u.sheenRoughness,u.sheenColorMap&&(m.sheenColorMap.value=u.sheenColorMap,n(u.sheenColorMap,m.sheenColorMapTransform)),u.sheenRoughnessMap&&(m.sheenRoughnessMap.value=u.sheenRoughnessMap,n(u.sheenRoughnessMap,m.sheenRoughnessMapTransform))),u.clearcoat>0&&(m.clearcoat.value=u.clearcoat,m.clearcoatRoughness.value=u.clearcoatRoughness,u.clearcoatMap&&(m.clearcoatMap.value=u.clearcoatMap,n(u.clearcoatMap,m.clearcoatMapTransform)),u.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=u.clearcoatRoughnessMap,n(u.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),u.clearcoatNormalMap&&(m.clearcoatNormalMap.value=u.clearcoatNormalMap,n(u.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(u.clearcoatNormalScale),u.side===_n&&m.clearcoatNormalScale.value.negate())),u.dispersion>0&&(m.dispersion.value=u.dispersion),u.iridescence>0&&(m.iridescence.value=u.iridescence,m.iridescenceIOR.value=u.iridescenceIOR,m.iridescenceThicknessMinimum.value=u.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=u.iridescenceThicknessRange[1],u.iridescenceMap&&(m.iridescenceMap.value=u.iridescenceMap,n(u.iridescenceMap,m.iridescenceMapTransform)),u.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=u.iridescenceThicknessMap,n(u.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),u.transmission>0&&(m.transmission.value=u.transmission,m.transmissionSamplerMap.value=g.texture,m.transmissionSamplerSize.value.set(g.width,g.height),u.transmissionMap&&(m.transmissionMap.value=u.transmissionMap,n(u.transmissionMap,m.transmissionMapTransform)),m.thickness.value=u.thickness,u.thicknessMap&&(m.thicknessMap.value=u.thicknessMap,n(u.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=u.attenuationDistance,m.attenuationColor.value.copy(u.attenuationColor)),u.anisotropy>0&&(m.anisotropyVector.value.set(u.anisotropy*Math.cos(u.anisotropyRotation),u.anisotropy*Math.sin(u.anisotropyRotation)),u.anisotropyMap&&(m.anisotropyMap.value=u.anisotropyMap,n(u.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=u.specularIntensity,m.specularColor.value.copy(u.specularColor),u.specularColorMap&&(m.specularColorMap.value=u.specularColorMap,n(u.specularColorMap,m.specularColorMapTransform)),u.specularIntensityMap&&(m.specularIntensityMap.value=u.specularIntensityMap,n(u.specularIntensityMap,m.specularIntensityMapTransform))}function x(m,u){u.matcap&&(m.matcap.value=u.matcap)}function y(m,u){const g=e.get(u).light;m.referencePosition.value.setFromMatrixPosition(g.matrixWorld),m.nearDistance.value=g.shadow.camera.near,m.farDistance.value=g.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function Jw(t,e,n,i){let r={},s={},o=[];const a=t.getParameter(t.MAX_UNIFORM_BUFFER_BINDINGS);function l(g,_){const v=_.program;i.uniformBlockBinding(g,v)}function c(g,_){let v=r[g.id];v===void 0&&(x(g),v=f(g),r[g.id]=v,g.addEventListener("dispose",m));const P=_.program;i.updateUBOMapping(g,P);const C=e.render.frame;s[g.id]!==C&&(d(g),s[g.id]=C)}function f(g){const _=h();g.__bindingPointIndex=_;const v=t.createBuffer(),P=g.__size,C=g.usage;return t.bindBuffer(t.UNIFORM_BUFFER,v),t.bufferData(t.UNIFORM_BUFFER,P,C),t.bindBuffer(t.UNIFORM_BUFFER,null),t.bindBufferBase(t.UNIFORM_BUFFER,_,v),v}function h(){for(let g=0;g<a;g++)if(o.indexOf(g)===-1)return o.push(g),g;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(g){const _=r[g.id],v=g.uniforms,P=g.__cache;t.bindBuffer(t.UNIFORM_BUFFER,_);for(let C=0,R=v.length;C<R;C++){const A=Array.isArray(v[C])?v[C]:[v[C]];for(let E=0,S=A.length;E<S;E++){const b=A[E];if(p(b,C,E,P)===!0){const T=b.__offset,k=Array.isArray(b.value)?b.value:[b.value];let Y=0;for(let W=0;W<k.length;W++){const V=k[W],X=y(V);typeof V=="number"||typeof V=="boolean"?(b.__data[0]=V,t.bufferSubData(t.UNIFORM_BUFFER,T+Y,b.__data)):V.isMatrix3?(b.__data[0]=V.elements[0],b.__data[1]=V.elements[1],b.__data[2]=V.elements[2],b.__data[3]=0,b.__data[4]=V.elements[3],b.__data[5]=V.elements[4],b.__data[6]=V.elements[5],b.__data[7]=0,b.__data[8]=V.elements[6],b.__data[9]=V.elements[7],b.__data[10]=V.elements[8],b.__data[11]=0):(V.toArray(b.__data,Y),Y+=X.storage/Float32Array.BYTES_PER_ELEMENT)}t.bufferSubData(t.UNIFORM_BUFFER,T,b.__data)}}}t.bindBuffer(t.UNIFORM_BUFFER,null)}function p(g,_,v,P){const C=g.value,R=_+"_"+v;if(P[R]===void 0)return typeof C=="number"||typeof C=="boolean"?P[R]=C:P[R]=C.clone(),!0;{const A=P[R];if(typeof C=="number"||typeof C=="boolean"){if(A!==C)return P[R]=C,!0}else if(A.equals(C)===!1)return A.copy(C),!0}return!1}function x(g){const _=g.uniforms;let v=0;const P=16;for(let R=0,A=_.length;R<A;R++){const E=Array.isArray(_[R])?_[R]:[_[R]];for(let S=0,b=E.length;S<b;S++){const T=E[S],k=Array.isArray(T.value)?T.value:[T.value];for(let Y=0,W=k.length;Y<W;Y++){const V=k[Y],X=y(V),I=v%P,H=I%X.boundary,Z=I+H;v+=H,Z!==0&&P-Z<X.storage&&(v+=P-Z),T.__data=new Float32Array(X.storage/Float32Array.BYTES_PER_ELEMENT),T.__offset=v,v+=X.storage}}}const C=v%P;return C>0&&(v+=P-C),g.__size=v,g.__cache={},this}function y(g){const _={boundary:0,storage:0};return typeof g=="number"||typeof g=="boolean"?(_.boundary=4,_.storage=4):g.isVector2?(_.boundary=8,_.storage=8):g.isVector3||g.isColor?(_.boundary=16,_.storage=12):g.isVector4?(_.boundary=16,_.storage=16):g.isMatrix3?(_.boundary=48,_.storage=48):g.isMatrix4?(_.boundary=64,_.storage=64):g.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",g),_}function m(g){const _=g.target;_.removeEventListener("dispose",m);const v=o.indexOf(_.__bindingPointIndex);o.splice(v,1),t.deleteBuffer(r[_.id]),delete r[_.id],delete s[_.id]}function u(){for(const g in r)t.deleteBuffer(r[g]);o=[],r={},s={}}return{bind:l,update:c,dispose:u}}class eT{constructor(e={}){const{canvas:n=Wy(),context:i=null,depth:r=!0,stencil:s=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:f="default",failIfMajorPerformanceCaveat:h=!1}=e;this.isWebGLRenderer=!0;let d;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");d=i.getContextAttributes().alpha}else d=o;const p=new Uint32Array(4),x=new Int32Array(4);let y=null,m=null;const u=[],g=[];this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=oi,this.toneMapping=ir,this.toneMappingExposure=1;const _=this;let v=!1,P=0,C=0,R=null,A=-1,E=null;const S=new Nt,b=new Nt;let T=null;const k=new Ye(0);let Y=0,W=n.width,V=n.height,X=1,I=null,H=null;const Z=new Nt(0,0,W,V),te=new Nt(0,0,W,V);let _e=!1;const Oe=new lh;let K=!1,re=!1;const me=new yt,xe=new G,Ie=new Nt,ke={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Xe=!1;function ge(){return R===null?X:1}let U=i;function qe(w,O){return n.getContext(w,O)}try{const w={alpha:!0,depth:r,stencil:s,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:f,failIfMajorPerformanceCaveat:h};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${Zf}`),n.addEventListener("webglcontextlost",ne,!1),n.addEventListener("webglcontextrestored",Q,!1),n.addEventListener("webglcontextcreationerror",ve,!1),U===null){const O="webgl2";if(U=qe(O,w),U===null)throw qe(O)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(w){throw console.error("THREE.WebGLRenderer: "+w.message),w}let he,pe,ce,Ue,be,we,D,M,$,J,ee,ie,Pe,Se,Ae,He,de,Te,nt,ze,Ce,Ge,Ke,pt;function z(){he=new o1(U),he.init(),Ge=new Ww(U,he),pe=new e1(U,he,e,Ge),ce=new Hw(U),Ue=new c1(U),be=new Cw,we=new Gw(U,he,ce,be,pe,Ge,Ue),D=new n1(_),M=new s1(_),$=new gS(U),Ke=new QE(U,$),J=new a1(U,$,Ue,Ke),ee=new d1(U,J,$,Ue),nt=new u1(U,pe,we),He=new t1(be),ie=new Aw(_,D,M,he,pe,Ke,He),Pe=new Qw(_,be),Se=new bw,Ae=new Nw(he),Te=new ZE(_,D,M,ce,ee,d,l),de=new Bw(_,ee,pe),pt=new Jw(U,Ue,pe,ce),ze=new JE(U,he,Ue),Ce=new l1(U,he,Ue),Ue.programs=ie.programs,_.capabilities=pe,_.extensions=he,_.properties=be,_.renderLists=Se,_.shadowMap=de,_.state=ce,_.info=Ue}z();const fe=new Kw(_,U);this.xr=fe,this.getContext=function(){return U},this.getContextAttributes=function(){return U.getContextAttributes()},this.forceContextLoss=function(){const w=he.get("WEBGL_lose_context");w&&w.loseContext()},this.forceContextRestore=function(){const w=he.get("WEBGL_lose_context");w&&w.restoreContext()},this.getPixelRatio=function(){return X},this.setPixelRatio=function(w){w!==void 0&&(X=w,this.setSize(W,V,!1))},this.getSize=function(w){return w.set(W,V)},this.setSize=function(w,O,j=!0){if(fe.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}W=w,V=O,n.width=Math.floor(w*X),n.height=Math.floor(O*X),j===!0&&(n.style.width=w+"px",n.style.height=O+"px"),this.setViewport(0,0,w,O)},this.getDrawingBufferSize=function(w){return w.set(W*X,V*X).floor()},this.setDrawingBufferSize=function(w,O,j){W=w,V=O,X=j,n.width=Math.floor(w*j),n.height=Math.floor(O*j),this.setViewport(0,0,w,O)},this.getCurrentViewport=function(w){return w.copy(S)},this.getViewport=function(w){return w.copy(Z)},this.setViewport=function(w,O,j,q){w.isVector4?Z.set(w.x,w.y,w.z,w.w):Z.set(w,O,j,q),ce.viewport(S.copy(Z).multiplyScalar(X).round())},this.getScissor=function(w){return w.copy(te)},this.setScissor=function(w,O,j,q){w.isVector4?te.set(w.x,w.y,w.z,w.w):te.set(w,O,j,q),ce.scissor(b.copy(te).multiplyScalar(X).round())},this.getScissorTest=function(){return _e},this.setScissorTest=function(w){ce.setScissorTest(_e=w)},this.setOpaqueSort=function(w){I=w},this.setTransparentSort=function(w){H=w},this.getClearColor=function(w){return w.copy(Te.getClearColor())},this.setClearColor=function(){Te.setClearColor.apply(Te,arguments)},this.getClearAlpha=function(){return Te.getClearAlpha()},this.setClearAlpha=function(){Te.setClearAlpha.apply(Te,arguments)},this.clear=function(w=!0,O=!0,j=!0){let q=0;if(w){let B=!1;if(R!==null){const ue=R.texture.format;B=ue===ih||ue===nh||ue===th}if(B){const ue=R.texture.type,Ee=ue===bi||ue===kr||ue===Ko||ue===Xs||ue===Jf||ue===eh,Le=Te.getClearColor(),De=Te.getClearAlpha(),Ve=Le.r,We=Le.g,Ne=Le.b;Ee?(p[0]=Ve,p[1]=We,p[2]=Ne,p[3]=De,U.clearBufferuiv(U.COLOR,0,p)):(x[0]=Ve,x[1]=We,x[2]=Ne,x[3]=De,U.clearBufferiv(U.COLOR,0,x))}else q|=U.COLOR_BUFFER_BIT}O&&(q|=U.DEPTH_BUFFER_BIT),j&&(q|=U.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),U.clear(q)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){n.removeEventListener("webglcontextlost",ne,!1),n.removeEventListener("webglcontextrestored",Q,!1),n.removeEventListener("webglcontextcreationerror",ve,!1),Se.dispose(),Ae.dispose(),be.dispose(),D.dispose(),M.dispose(),ee.dispose(),Ke.dispose(),pt.dispose(),ie.dispose(),fe.dispose(),fe.removeEventListener("sessionstart",oe),fe.removeEventListener("sessionend",le),je.stop()};function ne(w){w.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),v=!0}function Q(){console.log("THREE.WebGLRenderer: Context Restored."),v=!1;const w=Ue.autoReset,O=de.enabled,j=de.autoUpdate,q=de.needsUpdate,B=de.type;z(),Ue.autoReset=w,de.enabled=O,de.autoUpdate=j,de.needsUpdate=q,de.type=B}function ve(w){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",w.statusMessage)}function Be(w){const O=w.target;O.removeEventListener("dispose",Be),et(O)}function et(w){At(w),be.remove(w)}function At(w){const O=be.get(w).programs;O!==void 0&&(O.forEach(function(j){ie.releaseProgram(j)}),w.isShaderMaterial&&ie.releaseShaderCache(w))}this.renderBufferDirect=function(w,O,j,q,B,ue){O===null&&(O=ke);const Ee=B.isMesh&&B.matrixWorld.determinant()<0,Le=ft(w,O,j,q,B);ce.setMaterial(q,Ee);let De=j.index,Ve=1;if(q.wireframe===!0){if(De=J.getWireframeAttribute(j),De===void 0)return;Ve=2}const We=j.drawRange,Ne=j.attributes.position;let st=We.start*Ve,Ct=(We.start+We.count)*Ve;ue!==null&&(st=Math.max(st,ue.start*Ve),Ct=Math.min(Ct,(ue.start+ue.count)*Ve)),De!==null?(st=Math.max(st,0),Ct=Math.min(Ct,De.count)):Ne!=null&&(st=Math.max(st,0),Ct=Math.min(Ct,Ne.count));const Rt=Ct-st;if(Rt<0||Rt===1/0)return;Ke.setup(B,q,Le,j,De);let yn,ot=ze;if(De!==null&&(yn=$.get(De),ot=Ce,ot.setIndex(yn)),B.isMesh)q.wireframe===!0?(ce.setLineWidth(q.wireframeLinewidth*ge()),ot.setMode(U.LINES)):ot.setMode(U.TRIANGLES);else if(B.isLine){let Fe=q.linewidth;Fe===void 0&&(Fe=1),ce.setLineWidth(Fe*ge()),B.isLineSegments?ot.setMode(U.LINES):B.isLineLoop?ot.setMode(U.LINE_LOOP):ot.setMode(U.LINE_STRIP)}else B.isPoints?ot.setMode(U.POINTS):B.isSprite&&ot.setMode(U.TRIANGLES);if(B.isBatchedMesh)if(B._multiDrawInstances!==null)ot.renderMultiDrawInstances(B._multiDrawStarts,B._multiDrawCounts,B._multiDrawCount,B._multiDrawInstances);else if(he.get("WEBGL_multi_draw"))ot.renderMultiDraw(B._multiDrawStarts,B._multiDrawCounts,B._multiDrawCount);else{const Fe=B._multiDrawStarts,Wt=B._multiDrawCounts,at=B._multiDrawCount,Vn=De?$.get(De).bytesPerElement:1,Gr=be.get(q).currentProgram.getUniforms();for(let Sn=0;Sn<at;Sn++)Gr.setValue(U,"_gl_DrawID",Sn),ot.render(Fe[Sn]/Vn,Wt[Sn])}else if(B.isInstancedMesh)ot.renderInstances(st,Rt,B.count);else if(j.isInstancedBufferGeometry){const Fe=j._maxInstanceCount!==void 0?j._maxInstanceCount:1/0,Wt=Math.min(j.instanceCount,Fe);ot.renderInstances(st,Rt,Wt)}else ot.render(st,Rt)};function se(w,O,j){w.transparent===!0&&w.side===Kn&&w.forceSinglePass===!1?(w.side=_n,w.needsUpdate=!0,it(w,O,j),w.side=ar,w.needsUpdate=!0,it(w,O,j),w.side=Kn):it(w,O,j)}this.compile=function(w,O,j=null){j===null&&(j=w),m=Ae.get(j),m.init(O),g.push(m),j.traverseVisible(function(B){B.isLight&&B.layers.test(O.layers)&&(m.pushLight(B),B.castShadow&&m.pushShadow(B))}),w!==j&&w.traverseVisible(function(B){B.isLight&&B.layers.test(O.layers)&&(m.pushLight(B),B.castShadow&&m.pushShadow(B))}),m.setupLights();const q=new Set;return w.traverse(function(B){const ue=B.material;if(ue)if(Array.isArray(ue))for(let Ee=0;Ee<ue.length;Ee++){const Le=ue[Ee];se(Le,j,B),q.add(Le)}else se(ue,j,B),q.add(ue)}),g.pop(),m=null,q},this.compileAsync=function(w,O,j=null){const q=this.compile(w,O,j);return new Promise(B=>{function ue(){if(q.forEach(function(Ee){be.get(Ee).currentProgram.isReady()&&q.delete(Ee)}),q.size===0){B(w);return}setTimeout(ue,10)}he.get("KHR_parallel_shader_compile")!==null?ue():setTimeout(ue,10)})};let L=null;function F(w){L&&L(w)}function oe(){je.stop()}function le(){je.start()}const je=new p_;je.setAnimationLoop(F),typeof self<"u"&&je.setContext(self),this.setAnimationLoop=function(w){L=w,fe.setAnimationLoop(w),w===null?je.stop():je.start()},fe.addEventListener("sessionstart",oe),fe.addEventListener("sessionend",le),this.render=function(w,O){if(O!==void 0&&O.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(v===!0)return;if(w.matrixWorldAutoUpdate===!0&&w.updateMatrixWorld(),O.parent===null&&O.matrixWorldAutoUpdate===!0&&O.updateMatrixWorld(),fe.enabled===!0&&fe.isPresenting===!0&&(fe.cameraAutoUpdate===!0&&fe.updateCamera(O),O=fe.getCamera()),w.isScene===!0&&w.onBeforeRender(_,w,O,R),m=Ae.get(w,g.length),m.init(O),g.push(m),me.multiplyMatrices(O.projectionMatrix,O.matrixWorldInverse),Oe.setFromProjectionMatrix(me),re=this.localClippingEnabled,K=He.init(this.clippingPlanes,re),y=Se.get(w,u.length),y.init(),u.push(y),fe.enabled===!0&&fe.isPresenting===!0){const ue=_.xr.getDepthSensingMesh();ue!==null&&$t(ue,O,-1/0,_.sortObjects)}$t(w,O,0,_.sortObjects),y.finish(),_.sortObjects===!0&&y.sort(I,H),Xe=fe.enabled===!1||fe.isPresenting===!1||fe.hasDepthSensing()===!1,Xe&&Te.addToRenderList(y,w),this.info.render.frame++,K===!0&&He.beginShadows();const j=m.state.shadowsArray;de.render(j,w,O),K===!0&&He.endShadows(),this.info.autoReset===!0&&this.info.reset();const q=y.opaque,B=y.transmissive;if(m.setupLights(),O.isArrayCamera){const ue=O.cameras;if(B.length>0)for(let Ee=0,Le=ue.length;Ee<Le;Ee++){const De=ue[Ee];xn(q,B,w,De)}Xe&&Te.render(w);for(let Ee=0,Le=ue.length;Ee<Le;Ee++){const De=ue[Ee];cn(y,w,De,De.viewport)}}else B.length>0&&xn(q,B,w,O),Xe&&Te.render(w),cn(y,w,O);R!==null&&(we.updateMultisampleRenderTarget(R),we.updateRenderTargetMipmap(R)),w.isScene===!0&&w.onAfterRender(_,w,O),Ke.resetDefaultState(),A=-1,E=null,g.pop(),g.length>0?(m=g[g.length-1],K===!0&&He.setGlobalState(_.clippingPlanes,m.state.camera)):m=null,u.pop(),u.length>0?y=u[u.length-1]:y=null};function $t(w,O,j,q){if(w.visible===!1)return;if(w.layers.test(O.layers)){if(w.isGroup)j=w.renderOrder;else if(w.isLOD)w.autoUpdate===!0&&w.update(O);else if(w.isLight)m.pushLight(w),w.castShadow&&m.pushShadow(w);else if(w.isSprite){if(!w.frustumCulled||Oe.intersectsSprite(w)){q&&Ie.setFromMatrixPosition(w.matrixWorld).applyMatrix4(me);const Ee=ee.update(w),Le=w.material;Le.visible&&y.push(w,Ee,Le,j,Ie.z,null)}}else if((w.isMesh||w.isLine||w.isPoints)&&(!w.frustumCulled||Oe.intersectsObject(w))){const Ee=ee.update(w),Le=w.material;if(q&&(w.boundingSphere!==void 0?(w.boundingSphere===null&&w.computeBoundingSphere(),Ie.copy(w.boundingSphere.center)):(Ee.boundingSphere===null&&Ee.computeBoundingSphere(),Ie.copy(Ee.boundingSphere.center)),Ie.applyMatrix4(w.matrixWorld).applyMatrix4(me)),Array.isArray(Le)){const De=Ee.groups;for(let Ve=0,We=De.length;Ve<We;Ve++){const Ne=De[Ve],st=Le[Ne.materialIndex];st&&st.visible&&y.push(w,Ee,st,j,Ie.z,Ne)}}else Le.visible&&y.push(w,Ee,Le,j,Ie.z,null)}}const ue=w.children;for(let Ee=0,Le=ue.length;Ee<Le;Ee++)$t(ue[Ee],O,j,q)}function cn(w,O,j,q){const B=w.opaque,ue=w.transmissive,Ee=w.transparent;m.setupLightsView(j),K===!0&&He.setGlobalState(_.clippingPlanes,j),q&&ce.viewport(S.copy(q)),B.length>0&&Ze(B,O,j),ue.length>0&&Ze(ue,O,j),Ee.length>0&&Ze(Ee,O,j),ce.buffers.depth.setTest(!0),ce.buffers.depth.setMask(!0),ce.buffers.color.setMask(!0),ce.setPolygonOffset(!1)}function xn(w,O,j,q){if((j.isScene===!0?j.overrideMaterial:null)!==null)return;m.state.transmissionRenderTarget[q.id]===void 0&&(m.state.transmissionRenderTarget[q.id]=new zr(1,1,{generateMipmaps:!0,type:he.has("EXT_color_buffer_half_float")||he.has("EXT_color_buffer_float")?na:bi,minFilter:Pr,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:lt.workingColorSpace}));const ue=m.state.transmissionRenderTarget[q.id],Ee=q.viewport||S;ue.setSize(Ee.z,Ee.w);const Le=_.getRenderTarget();_.setRenderTarget(ue),_.getClearColor(k),Y=_.getClearAlpha(),Y<1&&_.setClearColor(16777215,.5),_.clear(),Xe&&Te.render(j);const De=_.toneMapping;_.toneMapping=ir;const Ve=q.viewport;if(q.viewport!==void 0&&(q.viewport=void 0),m.setupLightsView(q),K===!0&&He.setGlobalState(_.clippingPlanes,q),Ze(w,j,q),we.updateMultisampleRenderTarget(ue),we.updateRenderTargetMipmap(ue),he.has("WEBGL_multisampled_render_to_texture")===!1){let We=!1;for(let Ne=0,st=O.length;Ne<st;Ne++){const Ct=O[Ne],Rt=Ct.object,yn=Ct.geometry,ot=Ct.material,Fe=Ct.group;if(ot.side===Kn&&Rt.layers.test(q.layers)){const Wt=ot.side;ot.side=_n,ot.needsUpdate=!0,St(Rt,j,q,yn,ot,Fe),ot.side=Wt,ot.needsUpdate=!0,We=!0}}We===!0&&(we.updateMultisampleRenderTarget(ue),we.updateRenderTargetMipmap(ue))}_.setRenderTarget(Le),_.setClearColor(k,Y),Ve!==void 0&&(q.viewport=Ve),_.toneMapping=De}function Ze(w,O,j){const q=O.isScene===!0?O.overrideMaterial:null;for(let B=0,ue=w.length;B<ue;B++){const Ee=w[B],Le=Ee.object,De=Ee.geometry,Ve=q===null?Ee.material:q,We=Ee.group;Le.layers.test(j.layers)&&St(Le,O,j,De,Ve,We)}}function St(w,O,j,q,B,ue){w.onBeforeRender(_,O,j,q,B,ue),w.modelViewMatrix.multiplyMatrices(j.matrixWorldInverse,w.matrixWorld),w.normalMatrix.getNormalMatrix(w.modelViewMatrix),B.onBeforeRender(_,O,j,q,w,ue),B.transparent===!0&&B.side===Kn&&B.forceSinglePass===!1?(B.side=_n,B.needsUpdate=!0,_.renderBufferDirect(j,O,q,B,w,ue),B.side=ar,B.needsUpdate=!0,_.renderBufferDirect(j,O,q,B,w,ue),B.side=Kn):_.renderBufferDirect(j,O,q,B,w,ue),w.onAfterRender(_,O,j,q,B,ue)}function it(w,O,j){O.isScene!==!0&&(O=ke);const q=be.get(w),B=m.state.lights,ue=m.state.shadowsArray,Ee=B.state.version,Le=ie.getParameters(w,B.state,ue,O,j),De=ie.getProgramCacheKey(Le);let Ve=q.programs;q.environment=w.isMeshStandardMaterial?O.environment:null,q.fog=O.fog,q.envMap=(w.isMeshStandardMaterial?M:D).get(w.envMap||q.environment),q.envMapRotation=q.environment!==null&&w.envMap===null?O.environmentRotation:w.envMapRotation,Ve===void 0&&(w.addEventListener("dispose",Be),Ve=new Map,q.programs=Ve);let We=Ve.get(De);if(We!==void 0){if(q.currentProgram===We&&q.lightsStateVersion===Ee)return vt(w,Le),We}else Le.uniforms=ie.getUniforms(w),w.onBeforeCompile(Le,_),We=ie.acquireProgram(Le,De),Ve.set(De,We),q.uniforms=Le.uniforms;const Ne=q.uniforms;return(!w.isShaderMaterial&&!w.isRawShaderMaterial||w.clipping===!0)&&(Ne.clippingPlanes=He.uniform),vt(w,Le),q.needsLights=dt(w),q.lightsStateVersion=Ee,q.needsLights&&(Ne.ambientLightColor.value=B.state.ambient,Ne.lightProbe.value=B.state.probe,Ne.directionalLights.value=B.state.directional,Ne.directionalLightShadows.value=B.state.directionalShadow,Ne.spotLights.value=B.state.spot,Ne.spotLightShadows.value=B.state.spotShadow,Ne.rectAreaLights.value=B.state.rectArea,Ne.ltc_1.value=B.state.rectAreaLTC1,Ne.ltc_2.value=B.state.rectAreaLTC2,Ne.pointLights.value=B.state.point,Ne.pointLightShadows.value=B.state.pointShadow,Ne.hemisphereLights.value=B.state.hemi,Ne.directionalShadowMap.value=B.state.directionalShadowMap,Ne.directionalShadowMatrix.value=B.state.directionalShadowMatrix,Ne.spotShadowMap.value=B.state.spotShadowMap,Ne.spotLightMatrix.value=B.state.spotLightMatrix,Ne.spotLightMap.value=B.state.spotLightMap,Ne.pointShadowMap.value=B.state.pointShadowMap,Ne.pointShadowMatrix.value=B.state.pointShadowMatrix),q.currentProgram=We,q.uniformsList=null,We}function zt(w){if(w.uniformsList===null){const O=w.currentProgram.getUniforms();w.uniformsList=_l.seqWithValue(O.seq,w.uniforms)}return w.uniformsList}function vt(w,O){const j=be.get(w);j.outputColorSpace=O.outputColorSpace,j.batching=O.batching,j.batchingColor=O.batchingColor,j.instancing=O.instancing,j.instancingColor=O.instancingColor,j.instancingMorph=O.instancingMorph,j.skinning=O.skinning,j.morphTargets=O.morphTargets,j.morphNormals=O.morphNormals,j.morphColors=O.morphColors,j.morphTargetsCount=O.morphTargetsCount,j.numClippingPlanes=O.numClippingPlanes,j.numIntersection=O.numClipIntersection,j.vertexAlphas=O.vertexAlphas,j.vertexTangents=O.vertexTangents,j.toneMapping=O.toneMapping}function ft(w,O,j,q,B){O.isScene!==!0&&(O=ke),we.resetTextureUnits();const ue=O.fog,Ee=q.isMeshStandardMaterial?O.environment:null,Le=R===null?_.outputColorSpace:R.isXRRenderTarget===!0?R.texture.colorSpace:fr,De=(q.isMeshStandardMaterial?M:D).get(q.envMap||Ee),Ve=q.vertexColors===!0&&!!j.attributes.color&&j.attributes.color.itemSize===4,We=!!j.attributes.tangent&&(!!q.normalMap||q.anisotropy>0),Ne=!!j.morphAttributes.position,st=!!j.morphAttributes.normal,Ct=!!j.morphAttributes.color;let Rt=ir;q.toneMapped&&(R===null||R.isXRRenderTarget===!0)&&(Rt=_.toneMapping);const yn=j.morphAttributes.position||j.morphAttributes.normal||j.morphAttributes.color,ot=yn!==void 0?yn.length:0,Fe=be.get(q),Wt=m.state.lights;if(K===!0&&(re===!0||w!==E)){const Pn=w===E&&q.id===A;He.setState(q,w,Pn)}let at=!1;q.version===Fe.__version?(Fe.needsLights&&Fe.lightsStateVersion!==Wt.state.version||Fe.outputColorSpace!==Le||B.isBatchedMesh&&Fe.batching===!1||!B.isBatchedMesh&&Fe.batching===!0||B.isBatchedMesh&&Fe.batchingColor===!0&&B.colorTexture===null||B.isBatchedMesh&&Fe.batchingColor===!1&&B.colorTexture!==null||B.isInstancedMesh&&Fe.instancing===!1||!B.isInstancedMesh&&Fe.instancing===!0||B.isSkinnedMesh&&Fe.skinning===!1||!B.isSkinnedMesh&&Fe.skinning===!0||B.isInstancedMesh&&Fe.instancingColor===!0&&B.instanceColor===null||B.isInstancedMesh&&Fe.instancingColor===!1&&B.instanceColor!==null||B.isInstancedMesh&&Fe.instancingMorph===!0&&B.morphTexture===null||B.isInstancedMesh&&Fe.instancingMorph===!1&&B.morphTexture!==null||Fe.envMap!==De||q.fog===!0&&Fe.fog!==ue||Fe.numClippingPlanes!==void 0&&(Fe.numClippingPlanes!==He.numPlanes||Fe.numIntersection!==He.numIntersection)||Fe.vertexAlphas!==Ve||Fe.vertexTangents!==We||Fe.morphTargets!==Ne||Fe.morphNormals!==st||Fe.morphColors!==Ct||Fe.toneMapping!==Rt||Fe.morphTargetsCount!==ot)&&(at=!0):(at=!0,Fe.__version=q.version);let Vn=Fe.currentProgram;at===!0&&(Vn=it(q,O,B));let Gr=!1,Sn=!1,xc=!1;const Lt=Vn.getUniforms(),Li=Fe.uniforms;if(ce.useProgram(Vn.program)&&(Gr=!0,Sn=!0,xc=!0),q.id!==A&&(A=q.id,Sn=!0),Gr||E!==w){Lt.setValue(U,"projectionMatrix",w.projectionMatrix),Lt.setValue(U,"viewMatrix",w.matrixWorldInverse);const Pn=Lt.map.cameraPosition;Pn!==void 0&&Pn.setValue(U,xe.setFromMatrixPosition(w.matrixWorld)),pe.logarithmicDepthBuffer&&Lt.setValue(U,"logDepthBufFC",2/(Math.log(w.far+1)/Math.LN2)),(q.isMeshPhongMaterial||q.isMeshToonMaterial||q.isMeshLambertMaterial||q.isMeshBasicMaterial||q.isMeshStandardMaterial||q.isShaderMaterial)&&Lt.setValue(U,"isOrthographic",w.isOrthographicCamera===!0),E!==w&&(E=w,Sn=!0,xc=!0)}if(B.isSkinnedMesh){Lt.setOptional(U,B,"bindMatrix"),Lt.setOptional(U,B,"bindMatrixInverse");const Pn=B.skeleton;Pn&&(Pn.boneTexture===null&&Pn.computeBoneTexture(),Lt.setValue(U,"boneTexture",Pn.boneTexture,we))}B.isBatchedMesh&&(Lt.setOptional(U,B,"batchingTexture"),Lt.setValue(U,"batchingTexture",B._matricesTexture,we),Lt.setOptional(U,B,"batchingIdTexture"),Lt.setValue(U,"batchingIdTexture",B._indirectTexture,we),Lt.setOptional(U,B,"batchingColorTexture"),B._colorsTexture!==null&&Lt.setValue(U,"batchingColorTexture",B._colorsTexture,we));const yc=j.morphAttributes;if((yc.position!==void 0||yc.normal!==void 0||yc.color!==void 0)&&nt.update(B,j,Vn),(Sn||Fe.receiveShadow!==B.receiveShadow)&&(Fe.receiveShadow=B.receiveShadow,Lt.setValue(U,"receiveShadow",B.receiveShadow)),q.isMeshGouraudMaterial&&q.envMap!==null&&(Li.envMap.value=De,Li.flipEnvMap.value=De.isCubeTexture&&De.isRenderTargetTexture===!1?-1:1),q.isMeshStandardMaterial&&q.envMap===null&&O.environment!==null&&(Li.envMapIntensity.value=O.environmentIntensity),Sn&&(Lt.setValue(U,"toneMappingExposure",_.toneMappingExposure),Fe.needsLights&&Mt(Li,xc),ue&&q.fog===!0&&Pe.refreshFogUniforms(Li,ue),Pe.refreshMaterialUniforms(Li,q,X,V,m.state.transmissionRenderTarget[w.id]),_l.upload(U,zt(Fe),Li,we)),q.isShaderMaterial&&q.uniformsNeedUpdate===!0&&(_l.upload(U,zt(Fe),Li,we),q.uniformsNeedUpdate=!1),q.isSpriteMaterial&&Lt.setValue(U,"center",B.center),Lt.setValue(U,"modelViewMatrix",B.modelViewMatrix),Lt.setValue(U,"normalMatrix",B.normalMatrix),Lt.setValue(U,"modelMatrix",B.matrixWorld),q.isShaderMaterial||q.isRawShaderMaterial){const Pn=q.uniformsGroups;for(let Sc=0,E_=Pn.length;Sc<E_;Sc++){const fh=Pn[Sc];pt.update(fh,Vn),pt.bind(fh,Vn)}}return Vn}function Mt(w,O){w.ambientLightColor.needsUpdate=O,w.lightProbe.needsUpdate=O,w.directionalLights.needsUpdate=O,w.directionalLightShadows.needsUpdate=O,w.pointLights.needsUpdate=O,w.pointLightShadows.needsUpdate=O,w.spotLights.needsUpdate=O,w.spotLightShadows.needsUpdate=O,w.rectAreaLights.needsUpdate=O,w.hemisphereLights.needsUpdate=O}function dt(w){return w.isMeshLambertMaterial||w.isMeshToonMaterial||w.isMeshPhongMaterial||w.isMeshStandardMaterial||w.isShadowMaterial||w.isShaderMaterial&&w.lights===!0}this.getActiveCubeFace=function(){return P},this.getActiveMipmapLevel=function(){return C},this.getRenderTarget=function(){return R},this.setRenderTargetTextures=function(w,O,j){be.get(w.texture).__webglTexture=O,be.get(w.depthTexture).__webglTexture=j;const q=be.get(w);q.__hasExternalTextures=!0,q.__autoAllocateDepthBuffer=j===void 0,q.__autoAllocateDepthBuffer||he.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),q.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(w,O){const j=be.get(w);j.__webglFramebuffer=O,j.__useDefaultFramebuffer=O===void 0},this.setRenderTarget=function(w,O=0,j=0){R=w,P=O,C=j;let q=!0,B=null,ue=!1,Ee=!1;if(w){const De=be.get(w);if(De.__useDefaultFramebuffer!==void 0)ce.bindFramebuffer(U.FRAMEBUFFER,null),q=!1;else if(De.__webglFramebuffer===void 0)we.setupRenderTarget(w);else if(De.__hasExternalTextures)we.rebindTextures(w,be.get(w.texture).__webglTexture,be.get(w.depthTexture).__webglTexture);else if(w.depthBuffer){const Ne=w.depthTexture;if(De.__boundDepthTexture!==Ne){if(Ne!==null&&be.has(Ne)&&(w.width!==Ne.image.width||w.height!==Ne.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");we.setupDepthRenderbuffer(w)}}const Ve=w.texture;(Ve.isData3DTexture||Ve.isDataArrayTexture||Ve.isCompressedArrayTexture)&&(Ee=!0);const We=be.get(w).__webglFramebuffer;w.isWebGLCubeRenderTarget?(Array.isArray(We[O])?B=We[O][j]:B=We[O],ue=!0):w.samples>0&&we.useMultisampledRTT(w)===!1?B=be.get(w).__webglMultisampledFramebuffer:Array.isArray(We)?B=We[j]:B=We,S.copy(w.viewport),b.copy(w.scissor),T=w.scissorTest}else S.copy(Z).multiplyScalar(X).floor(),b.copy(te).multiplyScalar(X).floor(),T=_e;if(ce.bindFramebuffer(U.FRAMEBUFFER,B)&&q&&ce.drawBuffers(w,B),ce.viewport(S),ce.scissor(b),ce.setScissorTest(T),ue){const De=be.get(w.texture);U.framebufferTexture2D(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_CUBE_MAP_POSITIVE_X+O,De.__webglTexture,j)}else if(Ee){const De=be.get(w.texture),Ve=O||0;U.framebufferTextureLayer(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0,De.__webglTexture,j||0,Ve)}A=-1},this.readRenderTargetPixels=function(w,O,j,q,B,ue,Ee){if(!(w&&w.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Le=be.get(w).__webglFramebuffer;if(w.isWebGLCubeRenderTarget&&Ee!==void 0&&(Le=Le[Ee]),Le){ce.bindFramebuffer(U.FRAMEBUFFER,Le);try{const De=w.texture,Ve=De.format,We=De.type;if(!pe.textureFormatReadable(Ve)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!pe.textureTypeReadable(We)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}O>=0&&O<=w.width-q&&j>=0&&j<=w.height-B&&U.readPixels(O,j,q,B,Ge.convert(Ve),Ge.convert(We),ue)}finally{const De=R!==null?be.get(R).__webglFramebuffer:null;ce.bindFramebuffer(U.FRAMEBUFFER,De)}}},this.readRenderTargetPixelsAsync=async function(w,O,j,q,B,ue,Ee){if(!(w&&w.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Le=be.get(w).__webglFramebuffer;if(w.isWebGLCubeRenderTarget&&Ee!==void 0&&(Le=Le[Ee]),Le){ce.bindFramebuffer(U.FRAMEBUFFER,Le);try{const De=w.texture,Ve=De.format,We=De.type;if(!pe.textureFormatReadable(Ve))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!pe.textureTypeReadable(We))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(O>=0&&O<=w.width-q&&j>=0&&j<=w.height-B){const Ne=U.createBuffer();U.bindBuffer(U.PIXEL_PACK_BUFFER,Ne),U.bufferData(U.PIXEL_PACK_BUFFER,ue.byteLength,U.STREAM_READ),U.readPixels(O,j,q,B,Ge.convert(Ve),Ge.convert(We),0),U.flush();const st=U.fenceSync(U.SYNC_GPU_COMMANDS_COMPLETE,0);await jy(U,st,4);try{U.bindBuffer(U.PIXEL_PACK_BUFFER,Ne),U.getBufferSubData(U.PIXEL_PACK_BUFFER,0,ue)}finally{U.deleteBuffer(Ne),U.deleteSync(st)}return ue}}finally{const De=R!==null?be.get(R).__webglFramebuffer:null;ce.bindFramebuffer(U.FRAMEBUFFER,De)}}},this.copyFramebufferToTexture=function(w,O=null,j=0){w.isTexture!==!0&&(Ns("WebGLRenderer: copyFramebufferToTexture function signature has changed."),O=arguments[0]||null,w=arguments[1]);const q=Math.pow(2,-j),B=Math.floor(w.image.width*q),ue=Math.floor(w.image.height*q),Ee=O!==null?O.x:0,Le=O!==null?O.y:0;we.setTexture2D(w,0),U.copyTexSubImage2D(U.TEXTURE_2D,j,0,0,Ee,Le,B,ue),ce.unbindTexture()},this.copyTextureToTexture=function(w,O,j=null,q=null,B=0){w.isTexture!==!0&&(Ns("WebGLRenderer: copyTextureToTexture function signature has changed."),q=arguments[0]||null,w=arguments[1],O=arguments[2],B=arguments[3]||0,j=null);let ue,Ee,Le,De,Ve,We;j!==null?(ue=j.max.x-j.min.x,Ee=j.max.y-j.min.y,Le=j.min.x,De=j.min.y):(ue=w.image.width,Ee=w.image.height,Le=0,De=0),q!==null?(Ve=q.x,We=q.y):(Ve=0,We=0);const Ne=Ge.convert(O.format),st=Ge.convert(O.type);we.setTexture2D(O,0),U.pixelStorei(U.UNPACK_FLIP_Y_WEBGL,O.flipY),U.pixelStorei(U.UNPACK_PREMULTIPLY_ALPHA_WEBGL,O.premultiplyAlpha),U.pixelStorei(U.UNPACK_ALIGNMENT,O.unpackAlignment);const Ct=U.getParameter(U.UNPACK_ROW_LENGTH),Rt=U.getParameter(U.UNPACK_IMAGE_HEIGHT),yn=U.getParameter(U.UNPACK_SKIP_PIXELS),ot=U.getParameter(U.UNPACK_SKIP_ROWS),Fe=U.getParameter(U.UNPACK_SKIP_IMAGES),Wt=w.isCompressedTexture?w.mipmaps[B]:w.image;U.pixelStorei(U.UNPACK_ROW_LENGTH,Wt.width),U.pixelStorei(U.UNPACK_IMAGE_HEIGHT,Wt.height),U.pixelStorei(U.UNPACK_SKIP_PIXELS,Le),U.pixelStorei(U.UNPACK_SKIP_ROWS,De),w.isDataTexture?U.texSubImage2D(U.TEXTURE_2D,B,Ve,We,ue,Ee,Ne,st,Wt.data):w.isCompressedTexture?U.compressedTexSubImage2D(U.TEXTURE_2D,B,Ve,We,Wt.width,Wt.height,Ne,Wt.data):U.texSubImage2D(U.TEXTURE_2D,B,Ve,We,ue,Ee,Ne,st,Wt),U.pixelStorei(U.UNPACK_ROW_LENGTH,Ct),U.pixelStorei(U.UNPACK_IMAGE_HEIGHT,Rt),U.pixelStorei(U.UNPACK_SKIP_PIXELS,yn),U.pixelStorei(U.UNPACK_SKIP_ROWS,ot),U.pixelStorei(U.UNPACK_SKIP_IMAGES,Fe),B===0&&O.generateMipmaps&&U.generateMipmap(U.TEXTURE_2D),ce.unbindTexture()},this.copyTextureToTexture3D=function(w,O,j=null,q=null,B=0){w.isTexture!==!0&&(Ns("WebGLRenderer: copyTextureToTexture3D function signature has changed."),j=arguments[0]||null,q=arguments[1]||null,w=arguments[2],O=arguments[3],B=arguments[4]||0);let ue,Ee,Le,De,Ve,We,Ne,st,Ct;const Rt=w.isCompressedTexture?w.mipmaps[B]:w.image;j!==null?(ue=j.max.x-j.min.x,Ee=j.max.y-j.min.y,Le=j.max.z-j.min.z,De=j.min.x,Ve=j.min.y,We=j.min.z):(ue=Rt.width,Ee=Rt.height,Le=Rt.depth,De=0,Ve=0,We=0),q!==null?(Ne=q.x,st=q.y,Ct=q.z):(Ne=0,st=0,Ct=0);const yn=Ge.convert(O.format),ot=Ge.convert(O.type);let Fe;if(O.isData3DTexture)we.setTexture3D(O,0),Fe=U.TEXTURE_3D;else if(O.isDataArrayTexture||O.isCompressedArrayTexture)we.setTexture2DArray(O,0),Fe=U.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}U.pixelStorei(U.UNPACK_FLIP_Y_WEBGL,O.flipY),U.pixelStorei(U.UNPACK_PREMULTIPLY_ALPHA_WEBGL,O.premultiplyAlpha),U.pixelStorei(U.UNPACK_ALIGNMENT,O.unpackAlignment);const Wt=U.getParameter(U.UNPACK_ROW_LENGTH),at=U.getParameter(U.UNPACK_IMAGE_HEIGHT),Vn=U.getParameter(U.UNPACK_SKIP_PIXELS),Gr=U.getParameter(U.UNPACK_SKIP_ROWS),Sn=U.getParameter(U.UNPACK_SKIP_IMAGES);U.pixelStorei(U.UNPACK_ROW_LENGTH,Rt.width),U.pixelStorei(U.UNPACK_IMAGE_HEIGHT,Rt.height),U.pixelStorei(U.UNPACK_SKIP_PIXELS,De),U.pixelStorei(U.UNPACK_SKIP_ROWS,Ve),U.pixelStorei(U.UNPACK_SKIP_IMAGES,We),w.isDataTexture||w.isData3DTexture?U.texSubImage3D(Fe,B,Ne,st,Ct,ue,Ee,Le,yn,ot,Rt.data):O.isCompressedArrayTexture?U.compressedTexSubImage3D(Fe,B,Ne,st,Ct,ue,Ee,Le,yn,Rt.data):U.texSubImage3D(Fe,B,Ne,st,Ct,ue,Ee,Le,yn,ot,Rt),U.pixelStorei(U.UNPACK_ROW_LENGTH,Wt),U.pixelStorei(U.UNPACK_IMAGE_HEIGHT,at),U.pixelStorei(U.UNPACK_SKIP_PIXELS,Vn),U.pixelStorei(U.UNPACK_SKIP_ROWS,Gr),U.pixelStorei(U.UNPACK_SKIP_IMAGES,Sn),B===0&&O.generateMipmaps&&U.generateMipmap(Fe),ce.unbindTexture()},this.initRenderTarget=function(w){be.get(w).__webglFramebuffer===void 0&&we.setupRenderTarget(w)},this.initTexture=function(w){w.isCubeTexture?we.setTextureCube(w,0):w.isData3DTexture?we.setTexture3D(w,0):w.isDataArrayTexture||w.isCompressedArrayTexture?we.setTexture2DArray(w,0):we.setTexture2D(w,0),ce.unbindTexture()},this.resetState=function(){P=0,C=0,R=null,ce.reset(),Ke.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Ei}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const n=this.getContext();n.drawingBufferColorSpace=e===sh?"display-p3":"srgb",n.unpackColorSpace=lt.workingColorSpace===gc?"display-p3":"srgb"}}class uh{constructor(e,n=25e-5){this.isFogExp2=!0,this.name="",this.color=new Ye(e),this.density=n}clone(){return new uh(this.color,this.density)}toJSON(){return{type:"FogExp2",name:this.name,color:this.color.getHex(),density:this.density}}}class tT extends Gt{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new ii,this.environmentIntensity=1,this.environmentRotation=new ii,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,n){return super.copy(e,n),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,this.backgroundRotation.copy(e.backgroundRotation),this.environmentIntensity=e.environmentIntensity,this.environmentRotation.copy(e.environmentRotation),e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const n=super.toJSON(e);return this.fog!==null&&(n.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(n.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(n.object.backgroundIntensity=this.backgroundIntensity),n.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(n.object.environmentIntensity=this.environmentIntensity),n.object.environmentRotation=this.environmentRotation.toArray(),n}}class nT{constructor(e,n){this.isInterleavedBuffer=!0,this.array=e,this.stride=n,this.count=e!==void 0?e.length/n:0,this.usage=Zd,this._updateRange={offset:0,count:-1},this.updateRanges=[],this.version=0,this.uuid=rr()}onUploadCallback(){}set needsUpdate(e){e===!0&&this.version++}get updateRange(){return Ns("THREE.InterleavedBuffer: updateRange() is deprecated and will be removed in r169. Use addUpdateRange() instead."),this._updateRange}setUsage(e){return this.usage=e,this}addUpdateRange(e,n){this.updateRanges.push({start:e,count:n})}clearUpdateRanges(){this.updateRanges.length=0}copy(e){return this.array=new e.array.constructor(e.array),this.count=e.count,this.stride=e.stride,this.usage=e.usage,this}copyAt(e,n,i){e*=this.stride,i*=n.stride;for(let r=0,s=this.stride;r<s;r++)this.array[e+r]=n.array[i+r];return this}set(e,n=0){return this.array.set(e,n),this}clone(e){e.arrayBuffers===void 0&&(e.arrayBuffers={}),this.array.buffer._uuid===void 0&&(this.array.buffer._uuid=rr()),e.arrayBuffers[this.array.buffer._uuid]===void 0&&(e.arrayBuffers[this.array.buffer._uuid]=this.array.slice(0).buffer);const n=new this.array.constructor(e.arrayBuffers[this.array.buffer._uuid]),i=new this.constructor(n,this.stride);return i.setUsage(this.usage),i}onUpload(e){return this.onUploadCallback=e,this}toJSON(e){return e.arrayBuffers===void 0&&(e.arrayBuffers={}),this.array.buffer._uuid===void 0&&(this.array.buffer._uuid=rr()),e.arrayBuffers[this.array.buffer._uuid]===void 0&&(e.arrayBuffers[this.array.buffer._uuid]=Array.from(new Uint32Array(this.array.buffer))),{uuid:this.uuid,buffer:this.array.buffer._uuid,type:this.array.constructor.name,stride:this.stride}}}const tn=new G;class ql{constructor(e,n,i,r=!1){this.isInterleavedBufferAttribute=!0,this.name="",this.data=e,this.itemSize=n,this.offset=i,this.normalized=r}get count(){return this.data.count}get array(){return this.data.array}set needsUpdate(e){this.data.needsUpdate=e}applyMatrix4(e){for(let n=0,i=this.data.count;n<i;n++)tn.fromBufferAttribute(this,n),tn.applyMatrix4(e),this.setXYZ(n,tn.x,tn.y,tn.z);return this}applyNormalMatrix(e){for(let n=0,i=this.count;n<i;n++)tn.fromBufferAttribute(this,n),tn.applyNormalMatrix(e),this.setXYZ(n,tn.x,tn.y,tn.z);return this}transformDirection(e){for(let n=0,i=this.count;n<i;n++)tn.fromBufferAttribute(this,n),tn.transformDirection(e),this.setXYZ(n,tn.x,tn.y,tn.z);return this}getComponent(e,n){let i=this.array[e*this.data.stride+this.offset+n];return this.normalized&&(i=ci(i,this.array)),i}setComponent(e,n,i){return this.normalized&&(i=ut(i,this.array)),this.data.array[e*this.data.stride+this.offset+n]=i,this}setX(e,n){return this.normalized&&(n=ut(n,this.array)),this.data.array[e*this.data.stride+this.offset]=n,this}setY(e,n){return this.normalized&&(n=ut(n,this.array)),this.data.array[e*this.data.stride+this.offset+1]=n,this}setZ(e,n){return this.normalized&&(n=ut(n,this.array)),this.data.array[e*this.data.stride+this.offset+2]=n,this}setW(e,n){return this.normalized&&(n=ut(n,this.array)),this.data.array[e*this.data.stride+this.offset+3]=n,this}getX(e){let n=this.data.array[e*this.data.stride+this.offset];return this.normalized&&(n=ci(n,this.array)),n}getY(e){let n=this.data.array[e*this.data.stride+this.offset+1];return this.normalized&&(n=ci(n,this.array)),n}getZ(e){let n=this.data.array[e*this.data.stride+this.offset+2];return this.normalized&&(n=ci(n,this.array)),n}getW(e){let n=this.data.array[e*this.data.stride+this.offset+3];return this.normalized&&(n=ci(n,this.array)),n}setXY(e,n,i){return e=e*this.data.stride+this.offset,this.normalized&&(n=ut(n,this.array),i=ut(i,this.array)),this.data.array[e+0]=n,this.data.array[e+1]=i,this}setXYZ(e,n,i,r){return e=e*this.data.stride+this.offset,this.normalized&&(n=ut(n,this.array),i=ut(i,this.array),r=ut(r,this.array)),this.data.array[e+0]=n,this.data.array[e+1]=i,this.data.array[e+2]=r,this}setXYZW(e,n,i,r,s){return e=e*this.data.stride+this.offset,this.normalized&&(n=ut(n,this.array),i=ut(i,this.array),r=ut(r,this.array),s=ut(s,this.array)),this.data.array[e+0]=n,this.data.array[e+1]=i,this.data.array[e+2]=r,this.data.array[e+3]=s,this}clone(e){if(e===void 0){console.log("THREE.InterleavedBufferAttribute.clone(): Cloning an interleaved buffer attribute will de-interleave buffer data.");const n=[];for(let i=0;i<this.count;i++){const r=i*this.data.stride+this.offset;for(let s=0;s<this.itemSize;s++)n.push(this.data.array[r+s])}return new ti(new this.array.constructor(n),this.itemSize,this.normalized)}else return e.interleavedBuffers===void 0&&(e.interleavedBuffers={}),e.interleavedBuffers[this.data.uuid]===void 0&&(e.interleavedBuffers[this.data.uuid]=this.data.clone(e)),new ql(e.interleavedBuffers[this.data.uuid],this.itemSize,this.offset,this.normalized)}toJSON(e){if(e===void 0){console.log("THREE.InterleavedBufferAttribute.toJSON(): Serializing an interleaved buffer attribute will de-interleave buffer data.");const n=[];for(let i=0;i<this.count;i++){const r=i*this.data.stride+this.offset;for(let s=0;s<this.itemSize;s++)n.push(this.data.array[r+s])}return{itemSize:this.itemSize,type:this.array.constructor.name,array:n,normalized:this.normalized}}else return e.interleavedBuffers===void 0&&(e.interleavedBuffers={}),e.interleavedBuffers[this.data.uuid]===void 0&&(e.interleavedBuffers[this.data.uuid]=this.data.toJSON(e)),{isInterleavedBufferAttribute:!0,itemSize:this.itemSize,data:this.data.uuid,offset:this.offset,normalized:this.normalized}}}class hs extends hr{constructor(e){super(),this.isSpriteMaterial=!0,this.type="SpriteMaterial",this.color=new Ye(16777215),this.map=null,this.alphaMap=null,this.rotation=0,this.sizeAttenuation=!0,this.transparent=!0,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.alphaMap=e.alphaMap,this.rotation=e.rotation,this.sizeAttenuation=e.sizeAttenuation,this.fog=e.fog,this}}let ls;const po=new G,cs=new G,us=new G,ds=new $e,mo=new $e,S_=new yt,ja=new G,go=new G,Xa=new G,_m=new $e,Su=new $e,vm=new $e;class _o extends Gt{constructor(e=new hs){if(super(),this.isSprite=!0,this.type="Sprite",ls===void 0){ls=new vn;const n=new Float32Array([-.5,-.5,0,0,0,.5,-.5,0,1,0,.5,.5,0,1,1,-.5,.5,0,0,1]),i=new nT(n,5);ls.setIndex([0,1,2,0,2,3]),ls.setAttribute("position",new ql(i,3,0,!1)),ls.setAttribute("uv",new ql(i,2,3,!1))}this.geometry=ls,this.material=e,this.center=new $e(.5,.5)}raycast(e,n){e.camera===null&&console.error('THREE.Sprite: "Raycaster.camera" needs to be set in order to raycast against sprites.'),cs.setFromMatrixScale(this.matrixWorld),S_.copy(e.camera.matrixWorld),this.modelViewMatrix.multiplyMatrices(e.camera.matrixWorldInverse,this.matrixWorld),us.setFromMatrixPosition(this.modelViewMatrix),e.camera.isPerspectiveCamera&&this.material.sizeAttenuation===!1&&cs.multiplyScalar(-us.z);const i=this.material.rotation;let r,s;i!==0&&(s=Math.cos(i),r=Math.sin(i));const o=this.center;Ya(ja.set(-.5,-.5,0),us,o,cs,r,s),Ya(go.set(.5,-.5,0),us,o,cs,r,s),Ya(Xa.set(.5,.5,0),us,o,cs,r,s),_m.set(0,0),Su.set(1,0),vm.set(1,1);let a=e.ray.intersectTriangle(ja,go,Xa,!1,po);if(a===null&&(Ya(go.set(-.5,.5,0),us,o,cs,r,s),Su.set(0,1),a=e.ray.intersectTriangle(ja,Xa,go,!1,po),a===null))return;const l=e.ray.origin.distanceTo(po);l<e.near||l>e.far||n.push({distance:l,point:po.clone(),uv:Nn.getInterpolation(po,ja,go,Xa,_m,Su,vm,new $e),face:null,object:this})}copy(e,n){return super.copy(e,n),e.center!==void 0&&this.center.copy(e.center),this.material=e.material,this}}function Ya(t,e,n,i,r,s){ds.subVectors(t,n).addScalar(.5).multiply(i),r!==void 0?(mo.x=s*ds.x-r*ds.y,mo.y=r*ds.x+s*ds.y):mo.copy(ds),t.copy(e),t.x+=mo.x,t.y+=mo.y,t.applyMatrix4(S_)}class Tr extends hr{constructor(e){super(),this.isLineBasicMaterial=!0,this.type="LineBasicMaterial",this.color=new Ye(16777215),this.map=null,this.linewidth=1,this.linecap="round",this.linejoin="round",this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.linewidth=e.linewidth,this.linecap=e.linecap,this.linejoin=e.linejoin,this.fog=e.fog,this}}const Kl=new G,Zl=new G,xm=new yt,vo=new oh,$a=new _c,Mu=new G,ym=new G;class vl extends Gt{constructor(e=new vn,n=new Tr){super(),this.isLine=!0,this.type="Line",this.geometry=e,this.material=n,this.updateMorphTargets()}copy(e,n){return super.copy(e,n),this.material=Array.isArray(e.material)?e.material.slice():e.material,this.geometry=e.geometry,this}computeLineDistances(){const e=this.geometry;if(e.index===null){const n=e.attributes.position,i=[0];for(let r=1,s=n.count;r<s;r++)Kl.fromBufferAttribute(n,r-1),Zl.fromBufferAttribute(n,r),i[r]=i[r-1],i[r]+=Kl.distanceTo(Zl);e.setAttribute("lineDistance",new zn(i,1))}else console.warn("THREE.Line.computeLineDistances(): Computation only possible with non-indexed BufferGeometry.");return this}raycast(e,n){const i=this.geometry,r=this.matrixWorld,s=e.params.Line.threshold,o=i.drawRange;if(i.boundingSphere===null&&i.computeBoundingSphere(),$a.copy(i.boundingSphere),$a.applyMatrix4(r),$a.radius+=s,e.ray.intersectsSphere($a)===!1)return;xm.copy(r).invert(),vo.copy(e.ray).applyMatrix4(xm);const a=s/((this.scale.x+this.scale.y+this.scale.z)/3),l=a*a,c=this.isLineSegments?2:1,f=i.index,d=i.attributes.position;if(f!==null){const p=Math.max(0,o.start),x=Math.min(f.count,o.start+o.count);for(let y=p,m=x-1;y<m;y+=c){const u=f.getX(y),g=f.getX(y+1),_=qa(this,e,vo,l,u,g);_&&n.push(_)}if(this.isLineLoop){const y=f.getX(x-1),m=f.getX(p),u=qa(this,e,vo,l,y,m);u&&n.push(u)}}else{const p=Math.max(0,o.start),x=Math.min(d.count,o.start+o.count);for(let y=p,m=x-1;y<m;y+=c){const u=qa(this,e,vo,l,y,y+1);u&&n.push(u)}if(this.isLineLoop){const y=qa(this,e,vo,l,x-1,p);y&&n.push(y)}}}updateMorphTargets(){const n=this.geometry.morphAttributes,i=Object.keys(n);if(i.length>0){const r=n[i[0]];if(r!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let s=0,o=r.length;s<o;s++){const a=r[s].name||String(s);this.morphTargetInfluences.push(0),this.morphTargetDictionary[a]=s}}}}}function qa(t,e,n,i,r,s){const o=t.geometry.attributes.position;if(Kl.fromBufferAttribute(o,r),Zl.fromBufferAttribute(o,s),n.distanceSqToSegment(Kl,Zl,Mu,ym)>i)return;Mu.applyMatrix4(t.matrixWorld);const l=e.ray.origin.distanceTo(Mu);if(!(l<e.near||l>e.far))return{distance:l,point:ym.clone().applyMatrix4(t.matrixWorld),index:r,face:null,faceIndex:null,object:t}}const Sm=new G,Mm=new G;class ef extends vl{constructor(e,n){super(e,n),this.isLineSegments=!0,this.type="LineSegments"}computeLineDistances(){const e=this.geometry;if(e.index===null){const n=e.attributes.position,i=[];for(let r=0,s=n.count;r<s;r+=2)Sm.fromBufferAttribute(n,r),Mm.fromBufferAttribute(n,r+1),i[r]=r===0?0:i[r-1],i[r+1]=i[r]+Sm.distanceTo(Mm);e.setAttribute("lineDistance",new zn(i,1))}else console.warn("THREE.LineSegments.computeLineDistances(): Computation only possible with non-indexed BufferGeometry.");return this}}class dh extends on{constructor(e,n,i,r,s,o,a,l,c){super(e,n,i,r,s,o,a,l,c),this.isCanvasTexture=!0,this.needsUpdate=!0}}const Ka=new G,Za=new G,Eu=new G,Qa=new Nn;class Em extends vn{constructor(e=null,n=1){if(super(),this.type="EdgesGeometry",this.parameters={geometry:e,thresholdAngle:n},e!==null){const r=Math.pow(10,4),s=Math.cos(gl*n),o=e.getIndex(),a=e.getAttribute("position"),l=o?o.count:a.count,c=[0,0,0],f=["a","b","c"],h=new Array(3),d={},p=[];for(let x=0;x<l;x+=3){o?(c[0]=o.getX(x),c[1]=o.getX(x+1),c[2]=o.getX(x+2)):(c[0]=x,c[1]=x+1,c[2]=x+2);const{a:y,b:m,c:u}=Qa;if(y.fromBufferAttribute(a,c[0]),m.fromBufferAttribute(a,c[1]),u.fromBufferAttribute(a,c[2]),Qa.getNormal(Eu),h[0]=`${Math.round(y.x*r)},${Math.round(y.y*r)},${Math.round(y.z*r)}`,h[1]=`${Math.round(m.x*r)},${Math.round(m.y*r)},${Math.round(m.z*r)}`,h[2]=`${Math.round(u.x*r)},${Math.round(u.y*r)},${Math.round(u.z*r)}`,!(h[0]===h[1]||h[1]===h[2]||h[2]===h[0]))for(let g=0;g<3;g++){const _=(g+1)%3,v=h[g],P=h[_],C=Qa[f[g]],R=Qa[f[_]],A=`${v}_${P}`,E=`${P}_${v}`;E in d&&d[E]?(Eu.dot(d[E].normal)<=s&&(p.push(C.x,C.y,C.z),p.push(R.x,R.y,R.z)),d[E]=null):A in d||(d[A]={index0:c[g],index1:c[_],normal:Eu.clone()})}}for(const x in d)if(d[x]){const{index0:y,index1:m}=d[x];Ka.fromBufferAttribute(a,y),Za.fromBufferAttribute(a,m),p.push(Ka.x,Ka.y,Ka.z),p.push(Za.x,Za.y,Za.z)}this.setAttribute("position",new zn(p,3))}}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}}class iT extends hr{constructor(e){super(),this.isMeshPhongMaterial=!0,this.type="MeshPhongMaterial",this.color=new Ye(16777215),this.specular=new Ye(1118481),this.shininess=30,this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new Ye(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=rh,this.normalScale=new $e(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.specularMap=null,this.alphaMap=null,this.envMap=null,this.envMapRotation=new ii,this.combine=pc,this.reflectivity=1,this.refractionRatio=.98,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.specular.copy(e.specular),this.shininess=e.shininess,this.map=e.map,this.lightMap=e.lightMap,this.lightMapIntensity=e.lightMapIntensity,this.aoMap=e.aoMap,this.aoMapIntensity=e.aoMapIntensity,this.emissive.copy(e.emissive),this.emissiveMap=e.emissiveMap,this.emissiveIntensity=e.emissiveIntensity,this.bumpMap=e.bumpMap,this.bumpScale=e.bumpScale,this.normalMap=e.normalMap,this.normalMapType=e.normalMapType,this.normalScale.copy(e.normalScale),this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.specularMap=e.specularMap,this.alphaMap=e.alphaMap,this.envMap=e.envMap,this.envMapRotation.copy(e.envMapRotation),this.combine=e.combine,this.reflectivity=e.reflectivity,this.refractionRatio=e.refractionRatio,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this.wireframeLinecap=e.wireframeLinecap,this.wireframeLinejoin=e.wireframeLinejoin,this.flatShading=e.flatShading,this.fog=e.fog,this}}class wu extends hr{constructor(e){super(),this.isMeshLambertMaterial=!0,this.type="MeshLambertMaterial",this.color=new Ye(16777215),this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new Ye(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=rh,this.normalScale=new $e(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.specularMap=null,this.alphaMap=null,this.envMap=null,this.envMapRotation=new ii,this.combine=pc,this.reflectivity=1,this.refractionRatio=.98,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.lightMap=e.lightMap,this.lightMapIntensity=e.lightMapIntensity,this.aoMap=e.aoMap,this.aoMapIntensity=e.aoMapIntensity,this.emissive.copy(e.emissive),this.emissiveMap=e.emissiveMap,this.emissiveIntensity=e.emissiveIntensity,this.bumpMap=e.bumpMap,this.bumpScale=e.bumpScale,this.normalMap=e.normalMap,this.normalMapType=e.normalMapType,this.normalScale.copy(e.normalScale),this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.specularMap=e.specularMap,this.alphaMap=e.alphaMap,this.envMap=e.envMap,this.envMapRotation.copy(e.envMapRotation),this.combine=e.combine,this.reflectivity=e.reflectivity,this.refractionRatio=e.refractionRatio,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this.wireframeLinecap=e.wireframeLinecap,this.wireframeLinejoin=e.wireframeLinejoin,this.flatShading=e.flatShading,this.fog=e.fog,this}}class M_ extends Gt{constructor(e,n=1){super(),this.isLight=!0,this.type="Light",this.color=new Ye(e),this.intensity=n}dispose(){}copy(e,n){return super.copy(e,n),this.color.copy(e.color),this.intensity=e.intensity,this}toJSON(e){const n=super.toJSON(e);return n.object.color=this.color.getHex(),n.object.intensity=this.intensity,this.groundColor!==void 0&&(n.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(n.object.distance=this.distance),this.angle!==void 0&&(n.object.angle=this.angle),this.decay!==void 0&&(n.object.decay=this.decay),this.penumbra!==void 0&&(n.object.penumbra=this.penumbra),this.shadow!==void 0&&(n.object.shadow=this.shadow.toJSON()),this.target!==void 0&&(n.object.target=this.target.uuid),n}}const Tu=new yt,wm=new G,Tm=new G;class rT{constructor(e){this.camera=e,this.intensity=1,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new $e(512,512),this.map=null,this.mapPass=null,this.matrix=new yt,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new lh,this._frameExtents=new $e(1,1),this._viewportCount=1,this._viewports=[new Nt(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(e){const n=this.camera,i=this.matrix;wm.setFromMatrixPosition(e.matrixWorld),n.position.copy(wm),Tm.setFromMatrixPosition(e.target.matrixWorld),n.lookAt(Tm),n.updateMatrixWorld(),Tu.multiplyMatrices(n.projectionMatrix,n.matrixWorldInverse),this._frustum.setFromProjectionMatrix(Tu),i.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),i.multiply(Tu)}getViewport(e){return this._viewports[e]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(e){return this.camera=e.camera.clone(),this.intensity=e.intensity,this.bias=e.bias,this.radius=e.radius,this.mapSize.copy(e.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const e={};return this.intensity!==1&&(e.intensity=this.intensity),this.bias!==0&&(e.bias=this.bias),this.normalBias!==0&&(e.normalBias=this.normalBias),this.radius!==1&&(e.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(e.mapSize=this.mapSize.toArray()),e.camera=this.camera.toJSON(!1).object,delete e.camera.matrix,e}}class sT extends rT{constructor(){super(new m_(-5,5,5,-5,.5,500)),this.isDirectionalLightShadow=!0}}class oT extends M_{constructor(e,n){super(e,n),this.isDirectionalLight=!0,this.type="DirectionalLight",this.position.copy(Gt.DEFAULT_UP),this.updateMatrix(),this.target=new Gt,this.shadow=new sT}dispose(){this.shadow.dispose()}copy(e){return super.copy(e),this.target=e.target.clone(),this.shadow=e.shadow.clone(),this}}class aT extends M_{constructor(e,n){super(e,n),this.isAmbientLight=!0,this.type="AmbientLight"}}const Am=new yt;class lT{constructor(e,n,i=0,r=1/0){this.ray=new oh(e,n),this.near=i,this.far=r,this.camera=null,this.layers=new ah,this.params={Mesh:{},Line:{threshold:1},LOD:{},Points:{threshold:1},Sprite:{}}}set(e,n){this.ray.set(e,n)}setFromCamera(e,n){n.isPerspectiveCamera?(this.ray.origin.setFromMatrixPosition(n.matrixWorld),this.ray.direction.set(e.x,e.y,.5).unproject(n).sub(this.ray.origin).normalize(),this.camera=n):n.isOrthographicCamera?(this.ray.origin.set(e.x,e.y,(n.near+n.far)/(n.near-n.far)).unproject(n),this.ray.direction.set(0,0,-1).transformDirection(n.matrixWorld),this.camera=n):console.error("THREE.Raycaster: Unsupported camera type: "+n.type)}setFromXRController(e){return Am.identity().extractRotation(e.matrixWorld),this.ray.origin.setFromMatrixPosition(e.matrixWorld),this.ray.direction.set(0,0,-1).applyMatrix4(Am),this}intersectObject(e,n=!0,i=[]){return tf(e,this,i,n),i.sort(Cm),i}intersectObjects(e,n=!0,i=[]){for(let r=0,s=e.length;r<s;r++)tf(e[r],this,i,n);return i.sort(Cm),i}}function Cm(t,e){return t.distance-e.distance}function tf(t,e,n,i){let r=!0;if(t.layers.test(e.layers)&&t.raycast(e,n)===!1&&(r=!1),r===!0&&i===!0){const s=t.children;for(let o=0,a=s.length;o<a;o++)tf(s[o],e,n,!0)}}class cT extends ef{constructor(e=10,n=10,i=4473924,r=8947848){i=new Ye(i),r=new Ye(r);const s=n/2,o=e/n,a=e/2,l=[],c=[];for(let d=0,p=0,x=-a;d<=n;d++,x+=o){l.push(-a,0,x,a,0,x),l.push(x,0,-a,x,0,a);const y=d===s?i:r;y.toArray(c,p),p+=3,y.toArray(c,p),p+=3,y.toArray(c,p),p+=3,y.toArray(c,p),p+=3}const f=new vn;f.setAttribute("position",new zn(l,3)),f.setAttribute("color",new zn(c,3));const h=new Tr({vertexColors:!0,toneMapped:!1});super(f,h),this.type="GridHelper"}dispose(){this.geometry.dispose(),this.material.dispose()}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:Zf}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=Zf);const uT={name:"40ft High Cube Container",innerLength:12032,innerWidth:2352,innerHeight:2698,doorWidth:2340,doorHeight:2585,maxPayload:26580},Rm=[{name:"20ft Standard",innerLength:5898,innerWidth:2352,innerHeight:2393,doorWidth:2340,doorHeight:2280,maxPayload:28200},{name:"40ft Standard",innerLength:12032,innerWidth:2352,innerHeight:2393,doorWidth:2340,doorHeight:2280,maxPayload:26750},{name:"40ft High Cube",innerLength:12032,innerWidth:2352,innerHeight:2698,doorWidth:2340,doorHeight:2585,maxPayload:26580},{name:"45ft High Cube",innerLength:13556,innerWidth:2352,innerHeight:2698,doorWidth:2340,doorHeight:2585,maxPayload:27700},{name:"Custom",innerLength:12032,innerWidth:2352,innerHeight:2698,doorWidth:2340,doorHeight:2585,maxPayload:26580}],bm=[{id:"hilux_dc",name:"Hilux Revo (4Dr)",length:5325,width:1855,height:1815,weight:2050,wheelbase:3085,cabRatio:.55},{id:"hilux_sc",name:"Hilux Revo (2Dr)",length:5255,width:1855,height:1815,weight:1910,wheelbase:3085,cabRatio:.4},{id:"ranger_dc",name:"Ranger (4Dr)",length:5362,width:1860,height:1821,weight:2150,wheelbase:3220,cabRatio:.55},{id:"triton_dc",name:"Triton (4Dr)",length:5305,width:1815,height:1795,weight:1950,wheelbase:3e3,cabRatio:.55},{id:"dmax_dc",name:"D-Max (4Dr)",length:5265,width:1870,height:1790,weight:1990,wheelbase:3020,cabRatio:.55},{id:"navara_dc",name:"Navara (4Dr)",length:5260,width:1850,height:1840,weight:2050,wheelbase:3150,cabRatio:.55},{id:"custom",name:"กำหนดเอง (Custom)",length:5300,width:1850,height:1800,weight:2e3,wheelbase:3e3,cabRatio:.5}],Pm=[{id:"eu_pallet",name:"EU Pallet",length:1200,width:800,height:1450,weight:800},{id:"th_pallet",name:"TH Pallet",length:1100,width:1100,height:1450,weight:800},{id:"box_s",name:"กล่อง S",length:600,width:400,height:400,weight:20},{id:"box_m",name:"กล่อง M",length:800,width:600,height:600,weight:40},{id:"box_l",name:"กล่อง L",length:1200,width:800,height:800,weight:80},{id:"box_custom",name:"กำหนดเอง",length:1e3,width:800,height:800,weight:50}],fs=["#3B82F6","#EF4444","#10B981","#F59E0B","#8B5CF6","#EC4899","#06B6D4","#F97316"],Au=()=>Math.random().toString(36).substr(2,9);function dT(t,e=45){const n=t.naturalWidth||t.width,i=t.naturalHeight||t.height,r=document.createElement("canvas");r.width=n,r.height=i;const s=r.getContext("2d");s.drawImage(t,0,0);const o=s.getImageData(0,0,n,i),a=o.data,l=a[0],c=a[1],f=a[2],h=new Uint8Array(n*i),d=[0,n-1,(i-1)*n,i*n-1];for(;d.length;){const p=d.pop();if(p<0||p>=n*i||h[p])continue;h[p]=1;const x=p*4;if(Math.abs(a[x]-l)+Math.abs(a[x+1]-c)+Math.abs(a[x+2]-f)>e*3)continue;a[x+3]=0;const y=p%n;y>0&&d.push(p-1),y<n-1&&d.push(p+1),d.push(p-n,p+n)}return s.putImageData(o,0,0),r}const fT=ye.forwardRef(function({container:e,vehicles:n,selectedId:i,onSelectVehicle:r,onUpdateVehicle:s},o){const a=ye.useRef(null);ye.useImperativeHandle(o,()=>({getCanvas:()=>a.current}),[]);const l=ye.useRef({}),[c,f]=ye.useState(null),[h,d]=ye.useState(1),[p,x]=ye.useState({x:0,y:0}),y=ye.useRef({zoom:1,pan:{x:0,y:0}}),m=ye.useRef(null),u=ye.useCallback((b,T)=>{y.current={zoom:b,pan:T},d(b),x(T)},[]),g=60;ye.useEffect(()=>{n.forEach(b=>{if(!b.sideImage)return;const T=`${b.id}_${b.removeBg?1:0}`;if(l.current[T])return;const k=new Image;k.src=b.sideImage,k.onload=()=>{l.current[T]=b.removeBg?dT(k):k,v()}})},[n]);const _=ye.useCallback(()=>{const b=a.current;if(!b)return{scale:1,ox:g,oy:g,cW:0,cH:0,baseScale:1};const T=b.getBoundingClientRect(),k=Math.min((T.width-g*2)/e.innerLength,(T.height-g*2)/e.innerHeight),Y=k*h,W=e.innerLength*Y,V=e.innerHeight*Y,X=(T.height-e.innerHeight*k)/2,I=g+p.x,H=X+p.y;return{scale:Y,ox:I,oy:H,cW:W,cH:V,baseScale:k}},[e,h,p]),v=ye.useCallback(()=>{const b=a.current;if(!b)return;const T=b.getContext("2d"),k=b.getBoundingClientRect(),Y=Math.min(window.devicePixelRatio||1,2);b.width=k.width*Y,b.height=k.height*Y,T.scale(Y,Y);const W=k.width,V=k.height,{scale:X,ox:I,oy:H,cW:Z,cH:te}=_();T.fillStyle="#18253a",T.fillRect(0,0,W,V),T.fillStyle="#ffffff",T.fillRect(I,H,Z,te);const _e=(()=>{const ge=45/X;return ge<=100?100:ge<=200?200:ge<=500?500:ge<=1e3?1e3:2e3})();for(let ge=_e;ge<e.innerLength;ge+=_e){const U=I+ge*X;U<I||U>I+Z||(T.strokeStyle=ge%1e3===0?"#00000060":"#00000035",T.lineWidth=ge%1e3===0?1:.5,T.beginPath(),T.moveTo(U,H),T.lineTo(U,H+te),T.stroke())}for(let ge=_e;ge<e.innerHeight;ge+=_e){const U=H+te-ge*X;U<H||U>H+te||(T.strokeStyle=ge%1e3===0?"#00000060":"#00000035",T.lineWidth=ge%1e3===0?1:.5,T.beginPath(),T.moveTo(I,U),T.lineTo(I+Z,U),T.stroke())}T.strokeStyle="#00ffaa",T.lineWidth=2,T.strokeRect(I,H,Z,te),T.fillStyle="#d0e8d088",T.fillRect(I,H+te-5,Z,5);const Oe=H+te-e.doorHeight*X;T.strokeStyle="#dd7700cc",T.lineWidth=1.5,T.setLineDash([8,4]),T.beginPath(),T.moveTo(I,Oe),T.lineTo(I+Z,Oe),T.stroke(),T.setLineDash([]),T.fillStyle="#dd7700ee",T.font="bold 9px monospace",T.textAlign="right",T.fillText(`⚠ DOOR MAX ${e.doorHeight}mm`,I+Z-4,Oe-4);const K=22,re=36,me=Math.max(0,Math.floor(Math.max(0,-I)/X/100)*100),xe=Math.min(e.innerLength,Math.ceil((W-I)/X/100)*100+100),Ie=Math.max(0,Math.floor(Math.max(0,H+te-V)/X/100)*100),ke=Math.min(e.innerHeight,Math.ceil((H+te)/X/100)*100+100),Xe=ge=>ge>=1e3&&_e>=1e3?`${ge/1e3}m`:`${ge}`;[{base:H+te+2,dir:1},{base:H-2,dir:-1}].forEach(({base:ge,dir:U})=>{T.fillStyle="#141e30ee",T.fillRect(I,U===1?ge:ge-K,Z,K);for(let qe=me;qe<=xe;qe+=100){const he=I+qe*X;if(he<I-1||he>I+Z+1)continue;const pe=qe%_e===0,ce=qe%500===0&&!pe,Ue=(pe?13:ce?8:4)*U;T.strokeStyle=pe?"#00ffaadd":ce?"#00ffaa55":"#00000022",T.lineWidth=pe?1.2:.5,T.beginPath(),T.moveTo(he,ge),T.lineTo(he,ge+Ue),T.stroke(),pe&&(T.fillStyle="#00ffaaee",T.font="bold 8px monospace",T.textAlign="center",T.fillText(Xe(qe),he,U===1?ge+K:ge-4))}}),[{base:I-2,dir:-1},{base:I+Z+2,dir:1}].forEach(({base:ge,dir:U})=>{T.fillStyle="#141e30ee",T.fillRect(U===-1?ge-re:ge,H,re,te);for(let qe=Ie;qe<=ke;qe+=100){const he=H+te-qe*X;if(he<H-1||he>H+te+1)continue;const pe=qe%_e===0,ce=qe%500===0&&!pe,Ue=(pe?13:ce?8:4)*U;T.strokeStyle=pe?"#00ffaadd":ce?"#00ffaa55":"#00000022",T.lineWidth=pe?1.2:.5,T.beginPath(),T.moveTo(ge,he),T.lineTo(ge+Ue,he),T.stroke(),pe&&(T.fillStyle="#00ffaaee",T.font="bold 8px monospace",T.textAlign=U===-1?"right":"left",T.fillText(`${qe}`,U===-1?ge-4:ge+4,he+3))}}),T.fillStyle="#00ffaacc",T.font="bold 10px monospace",T.textAlign="center",T.fillText(`${e.innerLength} mm`,I+Z/2,H-K-4),T.save(),T.translate(I-re-14,H+te/2),T.rotate(-Math.PI/2),T.fillText(`${e.innerHeight} mm`,0,0),T.restore(),n.forEach(ge=>{const U=ge.sideX??200,qe=ge.sideY??0,he=(ge.sideAngle??0)*Math.PI/180,pe=ge.length*X,ce=ge.height*X,Ue=I+U*X+pe/2,be=H+te-qe*X-ce/2,we=ge.id===i;T.save(),T.translate(Ue,be),T.rotate(he);const D=`${ge.id}_${ge.removeBg?1:0}`,M=l.current[D];if(M&&M.complete!==!1){const $=(ge.imgRealLength??ge.length)*X,J=(ge.imgRealHeight??ge.height)*X;ge.flipX&&T.scale(-1,1),T.drawImage(M,-$/2,-J/2,$,J),ge.flipX&&T.scale(-1,1)}else{T.fillStyle=ge.color+"22",T.strokeStyle=ge.color+"cc",T.lineWidth=1.5,T.fillRect(-pe/2,-ce/2,pe,ce),T.strokeRect(-pe/2,-ce/2,pe,ce);const $=pe*(ge.cabRatio??.5);T.strokeStyle=ge.color+"77",T.lineWidth=1,T.beginPath(),T.moveTo(-pe/2+$,-ce/2),T.lineTo(-pe/2+$,ce/2),T.stroke(),T.fillStyle="#ffffffaa",T.font=`bold ${Math.max(8,pe*.04)}px sans-serif`,T.textAlign="center",T.textBaseline="middle",T.fillText(ge.preset,0,0)}we&&(T.strokeStyle="#ffffff",T.lineWidth=2,T.setLineDash([4,3]),T.strokeRect(-pe/2-3,-ce/2-3,pe+6,ce+6),T.setLineDash([]),T.strokeStyle="#00ffaa",T.lineWidth=1.5,T.beginPath(),T.moveTo(0,-ce/2-2),T.lineTo(0,-ce/2-14),T.stroke(),T.fillStyle="#00ffaadd",T.strokeStyle="#00ffaa",T.lineWidth=1,T.beginPath(),T.arc(0,-ce/2-21,7,0,Math.PI*2),T.fill(),T.stroke(),T.fillStyle="#ffffff88",T.font="8px monospace",T.textAlign="left",T.textBaseline="top",T.fillText(`${Math.round((ge.sideAngle??0)*10)/10}°`,pe/2+5,-ce/2)),T.restore()})},[e,n,i,_]);ye.useEffect(()=>{v()},[v]),ye.useEffect(()=>(window.addEventListener("resize",v),()=>window.removeEventListener("resize",v)),[v]),ye.useEffect(()=>{const b=a.current;if(!b)return;const T=k=>{k.preventDefault();const Y=b.getBoundingClientRect(),W=k.clientX-Y.left,V=k.clientY-Y.top,{zoom:X,pan:I}=y.current,H=Math.min((Y.width-g*2)/e.innerLength,(Y.height-g*2)/e.innerHeight),Z=H*X,te=(Y.height-e.innerHeight*H)/2,_e=g+I.x,Oe=te+I.y,K=k.deltaY<0?1.15:1/1.15,re=Math.max(.5,Math.min(20,X*K)),me=H*re,xe=W-(W-_e)*me/Z,Ie=V-(V-Oe)*me/Z;u(re,{x:xe-g,y:Ie-te})};return b.addEventListener("wheel",T,{passive:!1}),()=>b.removeEventListener("wheel",T)},[e,u]);const P=b=>{const T=a.current.getBoundingClientRect();return{mx:b.clientX-T.left,my:b.clientY-T.top}},C=b=>{const{scale:T,ox:k,oy:Y,cH:W}=_(),V=b.length*T,X=b.height*T,I=k+(b.sideX??200)*T+V/2,H=Y+W-(b.sideY??0)*T-X/2;return{cx:I,cy:H,vW:V,vH:X}},R=b=>{if(b.button===1){b.preventDefault();const{mx:Y,my:W}=P(b);m.current={mx:Y,my:W,panX:y.current.pan.x,panY:y.current.pan.y},f({id:null,type:"pan"});return}const{mx:T,my:k}=P(b);for(let Y=n.length-1;Y>=0;Y--){const W=n[Y],{cx:V,cy:X,vW:I,vH:H}=C(W),Z=(W.sideAngle??0)*Math.PI/180;if(W.id===i){const Oe=-H/2-21,K=V-Oe*Math.sin(Z),re=X+Oe*Math.cos(Z);if(Math.hypot(T-K,k-re)<12){r(W.id),f({id:W.id,type:"rotate",cx:V,cy:X});return}}const te=(T-V)*Math.cos(-Z)-(k-X)*Math.sin(-Z),_e=(T-V)*Math.sin(-Z)+(k-X)*Math.cos(-Z);if(Math.abs(te)<=I/2+5&&Math.abs(_e)<=H/2+5){r(W.id),f({id:W.id,type:"move",offX:T-V,offY:k-X});return}}r(null),m.current={mx:T,my:k,panX:y.current.pan.x,panY:y.current.pan.y},f({id:null,type:"pan"})},A=b=>{if((c==null?void 0:c.type)==="pan"&&m.current){const{mx:H,my:Z}=P(b);u(y.current.zoom,{x:m.current.panX+H-m.current.mx,y:m.current.panY+Z-m.current.my});return}if(!c)return;const{mx:T,my:k}=P(b),{scale:Y,ox:W,oy:V,cH:X}=_(),I=n.find(H=>H.id===c.id);if(I){if(c.type==="move"){const H=I.length*Y,Z=I.height*Y,te=T-c.offX,_e=k-c.offY;s(I.id,{sideX:Math.round((te-W-H/2)/Y),sideY:Math.max(0,Math.round((V+X-_e-Z/2)/Y))})}else if(c.type==="rotate"){const H=Math.atan2(T-c.cx,-(k-c.cy))*180/Math.PI;s(I.id,{sideAngle:Math.round(H*10)/10})}}},E=()=>f(null),S=(c==null?void 0:c.type)==="pan"||c?"grabbing":"crosshair";return N.jsxs("div",{style:{position:"relative",width:"100%",height:"100%"},children:[N.jsx("canvas",{ref:a,style:{width:"100%",height:"100%",cursor:S,display:"block"},onMouseDown:R,onMouseMove:A,onMouseUp:E,onMouseLeave:E}),N.jsxs("div",{style:{position:"absolute",bottom:10,right:10,display:"flex",gap:4,alignItems:"center"},children:[N.jsx("button",{onClick:()=>u(Math.min(20,y.current.zoom*1.3),y.current.pan),style:{width:28,height:28,borderRadius:4,border:"1px solid #3a4a66",background:"#1e2a42",color:"#e8eaf5",cursor:"pointer",fontSize:16,lineHeight:1},children:"+"}),N.jsx("button",{onClick:()=>u(Math.max(.5,y.current.zoom/1.3),y.current.pan),style:{width:28,height:28,borderRadius:4,border:"1px solid #3a4a66",background:"#1e2a42",color:"#e8eaf5",cursor:"pointer",fontSize:16,lineHeight:1},children:"−"}),N.jsxs("button",{onClick:()=>u(1,{x:0,y:0}),style:{padding:"0 8px",height:28,borderRadius:4,border:"1px solid #3a4a66",background:"#1e2a42",color:"#00ddaa",cursor:"pointer",fontSize:10,fontFamily:"monospace"},children:[h.toFixed(1),"× ↺"]})]})]})});function hT({container:t,boxes:e,selectedId:n,onSelectBox:i,onMoveBox:r,collisions:s}){const o=ye.useRef(null),[a,l]=ye.useState(null),[c,f]=ye.useState({x:0,y:0}),h=ye.useRef(1),d=50,p=ye.useCallback(()=>{const _=o.current;if(!_)return 1;const v=_.getBoundingClientRect();return Math.min((v.width-d*2)/t.innerLength,(v.height-d*2)/t.innerWidth)},[t]),x=ye.useCallback(()=>{const _=o.current;if(!_)return;const v=_.getContext("2d"),P=_.getBoundingClientRect(),C=Math.min(window.devicePixelRatio||1,2);_.width=P.width*C,_.height=P.height*C,v.scale(C,C);const R=P.width,A=P.height,E=p();h.current=E;const S=d,b=d,T=t.innerLength*E,k=t.innerWidth*E;v.fillStyle="#18253a",v.fillRect(0,0,R,A),v.strokeStyle="#ffffff10",v.lineWidth=.5;for(let W=1e3;W<t.innerLength;W+=1e3)v.beginPath(),v.moveTo(S+W*E,b),v.lineTo(S+W*E,b+k),v.stroke();for(let W=500;W<t.innerWidth;W+=500)v.beginPath(),v.moveTo(S,b+W*E),v.lineTo(S+T,b+W*E),v.stroke();v.strokeStyle="#00ffaa",v.lineWidth=2,v.strokeRect(S,b,T,k);const Y=(t.innerWidth-t.doorWidth)/2;v.strokeStyle="#00ffaa88",v.lineWidth=3,v.setLineDash([8,4]),v.beginPath(),v.moveTo(S+T,b+Y*E),v.lineTo(S+T,b+(Y+t.doorWidth)*E),v.stroke(),v.setLineDash([]),v.fillStyle="#00ffaa",v.font="bold 11px monospace",v.textAlign="center",v.fillText(`${t.innerLength} mm`,S+T/2,b-16),v.save(),v.translate(S-20,b+k/2),v.rotate(-Math.PI/2),v.fillText(`${t.innerWidth} mm`,0,0),v.restore(),v.fillStyle="#00ffaa66",v.font="10px sans-serif",v.textAlign="left",v.fillText("DOOR →",S+T+8,b+k/2+4),e.forEach(W=>{const V=S+W.x*E,X=b+W.y*E,I=W.length*E,H=W.width*E,Z=W.id===n,te=s.has(W.id);v.fillStyle="rgba(0,0,0,0.2)",v.fillRect(V+2,X+2,I,H),v.fillStyle=W.color+(te?"cc":"99"),v.fillRect(V,X,I,H),v.strokeStyle=te?"#ff4444":Z?"#ffffff":W.color,v.lineWidth=Z?2:1.5,v.strokeRect(V,X,I,H),v.strokeStyle=W.color+"44",v.lineWidth=.5,v.beginPath(),v.moveTo(V,X),v.lineTo(V+I,X+H),v.moveTo(V+I,X),v.lineTo(V,X+H),v.stroke();const _e=Math.max(8,Math.min(I,H)*.16);v.fillStyle="#ffffffcc",v.font=`${Z?"bold ":""}${_e}px sans-serif`,v.textAlign="center",v.textBaseline="middle",v.fillText(W.name||W.preset,V+I/2,X+H/2-_e*.5),v.font=`${Math.max(7,_e*.8)}px monospace`,v.fillStyle="#ffffff88",v.fillText(`${W.length}×${W.width}×${W.height}`,V+I/2,X+H/2+_e*.5),Z&&(v.strokeStyle="#ffffff",v.lineWidth=2,v.setLineDash([4,3]),v.strokeRect(V-3,X-3,I+6,H+6),v.setLineDash([]))})},[t,e,n,s,p]);ye.useEffect(()=>{x()},[x]),ye.useEffect(()=>(window.addEventListener("resize",x),()=>window.removeEventListener("resize",x)),[x]);const y=_=>{const v=o.current.getBoundingClientRect();return{cx:_.clientX-v.left,cy:_.clientY-v.top}},m=_=>{const{cx:v,cy:P}=y(_),C=h.current;for(let R=e.length-1;R>=0;R--){const A=e[R],E=d+A.x*C,S=d+A.y*C,b=A.length*C,T=A.width*C;if(v>=E&&v<=E+b&&P>=S&&P<=S+T){i(A.id),l(A.id),f({x:v-E,y:P-S});return}}i(null)},u=_=>{if(!a)return;const{cx:v,cy:P}=y(_),C=h.current,R=e.find(S=>S.id===a);if(!R)return;const A=Math.max(0,Math.min(t.innerLength-R.length,Math.round((v-d-c.x)/C))),E=Math.max(0,Math.min(t.innerWidth-R.width,Math.round((P-d-c.y)/C)));r(a,A,E)},g=()=>l(null);return N.jsx("canvas",{ref:o,style:{width:"100%",height:"100%",cursor:a?"grabbing":"crosshair",display:"block"},onMouseDown:m,onMouseMove:u,onMouseUp:g,onMouseLeave:g})}function pT(t,e){const n=document.createElement("canvas");n.width=256,n.height=44;const i=n.getContext("2d");return i.fillStyle="rgba(0,0,0,0.60)",i.fillRect(0,0,256,44),i.strokeStyle=e||"#ffffff",i.lineWidth=2,i.strokeRect(1,1,254,42),i.fillStyle="#ffffffdd",i.font="bold 18px monospace",i.textAlign="center",i.textBaseline="middle",i.fillText(t,128,22),new dh(n)}function mT(t,e){const n=document.createElement("canvas");n.width=512,n.height=80;const i=n.getContext("2d");return i.fillStyle=e||"#00ddaa",i.globalAlpha=.92,i.beginPath(),i.roundRect(0,0,512,80,10),i.fill(),i.globalAlpha=1,i.fillStyle="#000000cc",i.font="bold 38px sans-serif",i.textAlign="center",i.textBaseline="middle",i.fillText(t,256,40),new dh(n)}function gT({container:t,boxes:e,selectedId:n,onMoveBox:i,onSelectBox:r,onPlaceBox:s}){const o=ye.useRef(null),a=ye.useRef(null),l=ye.useRef(null),c=ye.useRef(null),f=ye.useRef({}),h=ye.useRef(null),d=ye.useRef({});return ye.useEffect(()=>{d.current={boxes:e,container:t,onMoveBox:i,onSelectBox:r,onPlaceBox:s,selectedId:n}}),ye.useEffect(()=>{const p=o.current;if(!p)return;const x=p.clientWidth,y=p.clientHeight,m=new tT;m.background=new Ye(14477557),m.fog=new uh(14477557,4e-5);const u=new Un(50,x/y,10,1e5),g=new eT({antialias:!0});g.setSize(x,y),g.setPixelRatio(Math.min(window.devicePixelRatio,2)),g.shadowMap.enabled=!0,g.shadowMap.type=j0,p.appendChild(g.domElement),a.current=m,l.current=u,c.current=g,m.add(new aT(16777215,1.2));const _=new oT(16777215,1.8);_.position.set(15e3,2e4,1e4),_.castShadow=!0,_.shadow.mapSize.set(2048,2048),_.shadow.camera.near=100,_.shadow.camera.far=5e4,_.shadow.camera.left=-15e3,_.shadow.camera.right=15e3,_.shadow.camera.top=15e3,_.shadow.camera.bottom=-15e3,m.add(_);const v=new fn(new Yi(6e4,6e4),new wu({color:13162728}));v.rotation.x=-Math.PI/2,v.position.y=-5,v.receiveShadow=!0,m.add(v),m.add(new cT(4e4,40,8952251,11189196));const P=new lT,C=new $e,R=new Hi(new G(0,1,0),0),A=new G;let E=!1,S=0,b=0,T=.7,k=.55,Y=2e4,W=!1,V=null,X=0,I=0,H=0,Z=0,te=!1,_e=null,Oe=0;const K=new G(6e3,1200,0),re=()=>{u.position.set(K.x+Y*Math.sin(k)*Math.cos(T),K.y+Y*Math.cos(k),K.z+Y*Math.sin(k)*Math.sin(T)),u.lookAt(K)};re();const me=()=>{const he=[];return m.traverse(pe=>{pe.userData.isBoxMesh&&he.push(pe)}),he},xe=he=>{var pe,ce;if(S=he.clientX,b=he.clientY,he.altKey){he.preventDefault();const Ue=d.current.selectedId,be=d.current.boxes.find(we=>we.id===Ue);be&&(_e=Ue,Oe=be.z,te=!0,g.domElement.style.cursor="ns-resize");return}if(!he.ctrlKey&&!he.shiftKey){const Ue=g.domElement.getBoundingClientRect();C.x=(he.clientX-Ue.left)/Ue.width*2-1,C.y=-((he.clientY-Ue.top)/Ue.height)*2+1,P.setFromCamera(C,u);const be=P.intersectObjects(me());if(be.length>0){const we=be[0].object.userData.boxId;(ce=(pe=d.current).onSelectBox)==null||ce.call(pe,we),P.ray.intersectPlane(R,A);const D=d.current.boxes.find($=>$.id===we),M=d.current.container;D&&(X=A.x-(D.x+D.length/2),I=A.z-(D.y-M.innerWidth/2+D.width/2),H=D.x,Z=D.y,V=we,W=!0,g.domElement.style.cursor="grabbing");return}}E=!0,g.domElement.style.cursor="grabbing"},Ie=he=>{const pe=he.clientX-S,ce=he.clientY-b;if(S=he.clientX,b=he.clientY,te&&_e){const{boxes:Ue,container:be}=d.current,we=Ue.find($=>$.id===_e);if(!we)return;const D=be.innerHeight/p.clientHeight*2;Oe=Math.max(0,Math.min(be.innerHeight-we.height,Oe-ce*D));const M=f.current[_e];if(M){const $=we.x+we.length/2,J=we.y-be.innerWidth/2+we.width/2;M.mesh.position.set($,Oe+we.height/2,J),M.edges.position.set($,Oe+we.height/2,J),M.label&&M.label.position.set($,Oe+we.height+280,J)}return}if(W&&V){const Ue=g.domElement.getBoundingClientRect();if(C.x=(he.clientX-Ue.left)/Ue.width*2-1,C.y=-((he.clientY-Ue.top)/Ue.height)*2+1,P.setFromCamera(C,u),!P.ray.intersectPlane(R,A))return;const{boxes:be,container:we}=d.current,D=be.find(Se=>Se.id===V);if(!D)return;const M=A.x-X,$=A.z-I;H=Math.max(0,Math.min(we.innerLength-D.length,M-D.length/2)),Z=Math.max(0,Math.min(we.innerWidth-D.width,$+we.innerWidth/2-D.width/2));const J=H+D.length/2,ee=D.z+D.height/2,ie=Z-we.innerWidth/2+D.width/2,Pe=f.current[V];Pe&&(Pe.mesh.position.set(J,ee,ie),Pe.edges.position.set(J,ee,ie),Pe.label&&Pe.label.position.set(J,D.z+D.height+280,ie));return}if(E){if(he.shiftKey){const Ue=Y/p.clientHeight;K.y-=ce*Ue}else if(he.ctrlKey){const Ue=Y/p.clientHeight;K.x-=Math.sin(T)*pe*Ue,K.z+=Math.cos(T)*pe*Ue,K.x-=Math.cos(T)*ce*Ue,K.z-=Math.sin(T)*ce*Ue}else T+=pe*.005,k=Math.max(.1,Math.min(Math.PI/2-.05,k-ce*.005));re()}},ke=()=>{var he,pe,ce,Ue;te&&_e&&((pe=(he=d.current).onPlaceBox)==null||pe.call(he,_e,null,null,Oe)),W&&V&&((Ue=(ce=d.current).onMoveBox)==null||Ue.call(ce,V,H,Z)),te=!1,_e=null,W=!1,V=null,E=!1,g.domElement.style.cursor="grab"},Xe=he=>{if(he.preventDefault(),he.ctrlKey){const pe=Y/p.clientHeight;K.y-=he.deltaY*pe*.5}else Y=Math.max(4e3,Math.min(45e3,Y+he.deltaY*12));re()},ge=he=>{if(he.target.tagName==="INPUT"||he.target.tagName==="TEXTAREA")return;const pe=Y*.05;he.key==="ArrowLeft"&&(K.x-=Math.sin(T)*pe,K.z+=Math.cos(T)*pe),he.key==="ArrowRight"&&(K.x+=Math.sin(T)*pe,K.z-=Math.cos(T)*pe),he.key==="ArrowUp"&&(K.y+=pe*.4),he.key==="ArrowDown"&&(K.y-=pe*.4),re()};g.domElement.addEventListener("mousedown",xe),g.domElement.addEventListener("mousemove",Ie),g.domElement.addEventListener("mouseup",ke),g.domElement.addEventListener("mouseleave",ke),g.domElement.addEventListener("wheel",Xe,{passive:!1}),g.domElement.style.cursor="grab",window.addEventListener("keydown",ge);const U=()=>{h.current=requestAnimationFrame(U),g.render(m,u)};U();const qe=()=>{const he=p.clientWidth,pe=p.clientHeight;u.aspect=he/pe,u.updateProjectionMatrix(),g.setSize(he,pe)};return window.addEventListener("resize",qe),()=>{cancelAnimationFrame(h.current),window.removeEventListener("resize",qe),window.removeEventListener("keydown",ge),g.domElement.removeEventListener("mousedown",xe),g.domElement.removeEventListener("mousemove",Ie),g.domElement.removeEventListener("mouseup",ke),g.domElement.removeEventListener("mouseleave",ke),g.domElement.removeEventListener("wheel",Xe),p.contains(g.domElement)&&p.removeChild(g.domElement),g.dispose()}},[]),ye.useEffect(()=>{const p=a.current;if(!p)return;const x=[];p.traverse(A=>{A.userData.dynamic&&x.push(A)}),x.forEach(A=>p.remove(A)),f.current={};const y=new ef(new Em(new Br(t.innerLength,t.innerHeight,t.innerWidth)),new Tr({color:65450}));y.position.set(t.innerLength/2,t.innerHeight/2,0),y.userData.dynamic=!0,p.add(y);const m=new fn(new Yi(t.innerLength,t.innerWidth),new wu({color:1718826,transparent:!0,opacity:.4,side:Kn}));m.rotation.x=-Math.PI/2,m.position.set(t.innerLength/2,2,0),m.receiveShadow=!0,m.userData.dynamic=!0,p.add(m);const u=new wu({color:8956620,transparent:!0,opacity:.1,side:Kn});[-1,1].forEach(A=>{const E=new fn(new Yi(t.innerLength,t.innerHeight),u);E.position.set(t.innerLength/2,t.innerHeight/2,A*t.innerWidth/2),E.userData.dynamic=!0,p.add(E)});const g=new fn(new Yi(t.innerWidth,t.innerHeight),u);g.rotation.y=Math.PI/2,g.position.set(0,t.innerHeight/2,0),g.userData.dynamic=!0,p.add(g);const _=A=>{const E=document.createElement("canvas");E.width=256,E.height=64;const S=E.getContext("2d");return S.fillStyle="rgba(0,20,40,0.82)",S.fillRect(0,0,256,64),S.fillStyle="#00ffaa",S.font="bold 28px monospace",S.textAlign="center",S.textBaseline="middle",S.fillText(A,128,32),new dh(E)},v=1e3;for(let A=0;A<=t.innerLength;A+=v){const E=new _o(new hs({map:_(`${A}`),depthTest:!1}));E.scale.set(700,175,1),E.position.set(A,-250,t.innerWidth/2+200),E.userData.dynamic=!0,p.add(E);const S=[new G(A,-10,t.innerWidth/2),new G(A,-300,t.innerWidth/2)],b=new vl(new vn().setFromPoints(S),new Tr({color:65450}));b.userData.dynamic=!0,p.add(b)}const P=500;for(let A=0;A<=t.innerHeight;A+=P){const E=new _o(new hs({map:_(`${A}`),depthTest:!1}));E.scale.set(600,150,1),E.position.set(-450,A,t.innerWidth/2),E.userData.dynamic=!0,p.add(E);const S=[new G(-10,A,t.innerWidth/2),new G(-300,A,t.innerWidth/2)],b=new vl(new vn().setFromPoints(S),new Tr({color:65450}));b.userData.dynamic=!0,p.add(b)}const C=500;for(let A=0;A<=t.innerWidth;A+=C){const E=A-t.innerWidth/2,S=new _o(new hs({map:_(`${A}`),depthTest:!1}));S.scale.set(600,150,1),S.position.set(t.innerLength+500,-250,E),S.userData.dynamic=!0,p.add(S);const b=[new G(t.innerLength+50,-10,E),new G(t.innerLength+300,-10,E)],T=new vl(new vn().setFromPoints(b),new Tr({color:65450}));T.userData.dynamic=!0,p.add(T)}const R=new Set;for(let A=0;A<e.length;A++)for(let E=A+1;E<e.length;E++){const S=e[A],b=e[E];S.x<b.x+b.length&&S.x+S.length>b.x&&S.y<b.y+b.width&&S.y+S.width>b.y&&S.z<b.z+b.height&&S.z+S.height>b.z&&(R.add(S.id),R.add(b.id))}e.forEach(A=>{const S=R.has(A.id)?new Ye(8947848):new Ye(A.color),b=A.id===n,T=new Br(A.length,A.height,A.width),k=new fn(T,new iT({color:S,specular:2236962,shininess:40,transparent:!0,opacity:b?1:.88}));k.position.set(A.x+A.length/2,A.z+A.height/2,A.y-t.innerWidth/2+A.width/2),k.castShadow=!0,k.userData.dynamic=!0,k.userData.isBoxMesh=!0,k.userData.boxId=A.id,p.add(k);const Y=new ef(new Em(T),new Tr({color:b?16777215:0,transparent:!0,opacity:b?.9:.25}));Y.position.copy(k.position),Y.userData.dynamic=!0,p.add(Y);const W=pT(`${A.length}×${A.width}×${A.height} mm`,A.color),V=new _o(new hs({map:W,depthTest:!1})),X=Math.max(A.length*.65,700);if(V.scale.set(X,X*.172,1),V.position.set(A.x+A.length/2,A.z+A.height/2,A.y-t.innerWidth/2+A.width+180),V.userData.dynamic=!0,p.add(V),b){const I=mT(A.name||A.preset,A.color),H=new _o(new hs({map:I,depthTest:!1})),Z=Math.max(A.length,1200);H.scale.set(Z,Z*.156,1),H.position.set(A.x+A.length/2,A.z+A.height+380,A.y-t.innerWidth/2+A.width/2),H.userData.dynamic=!0,p.add(H)}f.current[A.id]={mesh:k,edges:Y,label:V}})},[t,e,n]),N.jsxs("div",{style:{position:"relative",width:"100%",height:"100%"},children:[N.jsx("div",{ref:o,style:{width:"100%",height:"100%"}}),N.jsx("div",{style:{position:"absolute",bottom:10,left:10,fontSize:10,color:"#6677aa",pointerEvents:"none",background:"rgba(0,0,0,0.4)",padding:"4px 9px",borderRadius:4,lineHeight:1.7},children:"🖱 Drag = หมุน  |  Ctrl+Drag = เลื่อน  |  Shift+Drag = บนล่าง  |  Scroll = ซูม  |  ↑↓←→ = เลื่อน  |  ลากกล่อง = จัดพื้น  |  Alt+ลาก(เลือกกล่องก่อน) = ยกขึ้นลง  |  ⬜ = ชนกัน"})]})}function _T({boxes:t,container:e,projectName:n,contInsts:i,onClose:r}){var m;const s=ye.useRef({}),[o,a]=ye.useState(0),l=i&&i.length>0?i:[{name:"ตู้ที่ 1"}],c=ye.useMemo(()=>t.filter(u=>(u.cIdx||0)===o),[t,o]),f=ye.useMemo(()=>{const u=[...c].filter(_=>_.x>=-50).sort((_,v)=>_.x!==v.x?_.x-v.x:_.z!==v.z?_.z-v.z:_.y-v.y),g=Math.max(...u.filter(_=>_.z<100).map(_=>_.height),800);return u.map(_=>({..._,floor:_.z<100?1:_.z<g*1.2?2:3}))},[c]),h=ye.useMemo(()=>[...new Set(f.map(u=>u.floor))].sort(),[f]),d=ye.useCallback((u,g)=>{if(!u)return;const _=u.width,v=u.height,P=u.getContext("2d"),C=32,R=Math.min((_-C*2)/e.innerLength,(v-C*2-20)/e.innerWidth),A=C,E=C,S=e.innerLength*R,b=e.innerWidth*R;P.clearRect(0,0,_,v),P.fillStyle="#f5f7fa",P.fillRect(0,0,_,v),P.fillStyle="#dde4ee",P.fillRect(A,E,S,b),P.strokeStyle="#445",P.lineWidth=2,P.strokeRect(A,E,S,b),P.fillStyle="#44bb77",P.fillRect(A+S-3,E,6,b),P.font="10px sans-serif",P.fillStyle="#556",P.textAlign="left",P.textBaseline="alphabetic",P.fillText("ใน",A+2,E-6),P.textAlign="right",P.fillText("ประตู ▶",A+S,E-6),f.forEach((T,k)=>{if(T.floor!==g)return;const Y=A+T.x*R,W=E+T.y*R,V=T.length*R,X=T.width*R;P.fillStyle=T.color+"bb",P.fillRect(Y,W,V,X),P.strokeStyle=T.color,P.lineWidth=1.5,P.strokeRect(Y,W,V,X);const I=Math.max(7,Math.min(12,Math.min(V,X)*.55));P.fillStyle="#111",P.font=`bold ${I}px sans-serif`,P.textAlign="center",P.textBaseline="middle",P.fillText(String(k+1),Y+V/2,W+X/2)})},[f,e]);ye.useEffect(()=>{h.forEach(u=>d(s.current[u],u))},[h,d]);const p=()=>{const u=["#4488ff","#ff8833","#ff4455"],g=h.map(P=>{const C=s.current[P];return C?`<div class="floor-hdr">Layout ชั้น ${P}</div><img src="${C.toDataURL()}"/>`:""}).join(""),_=f.map((P,C)=>`
